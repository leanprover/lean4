...
* Add pretty printer settings to omit deeply nested terms (`pp.omitDeepTerms` and `pp.omitDeepTerms.threshold`) ([PR #3201](https://github.com/leanprover/lean4/pull/3201))

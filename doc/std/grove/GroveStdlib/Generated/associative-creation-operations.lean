...
def table : RestoreStateM (AssociationTable.Data .subexpression) := do
  return {
    widgetId := "associative-creation-operations"
    rows := #[
      ⟨"2cb3c441-9663-4ce7-9527-0f40fc29925a", "empty", #[⟨"Std.DHashMap", ← migrateName "Std.DHashMap.emptyWithCapacity"⟩,⟨"Std.DHashMap.Raw", ← migrateName "Std.DHashMap.Raw.emptyWithCapacity"⟩,⟨"Std.ExtDHashMap", ← migrateName "Std.ExtDHashMap.emptyWithCapacity"⟩,⟨"Std.DTreeMap", ← migrateName "Std.DTreeMap.empty"⟩,⟨"Std.DTreeMap.Raw", ← migrateName "Std.DTreeMap.Raw.empty"⟩,⟨"Std.ExtDTreeMap", ← migrateName "Std.ExtDTreeMap.empty"⟩,⟨"Std.HashMap", ← migrateName "Std.HashMap.emptyWithCapacity"⟩,⟨"Std.HashMap.Raw", ← migrateName "Std.HashMap.Raw.emptyWithCapacity"⟩,⟨"Std.ExtHashMap", ← migrateName "Std.ExtHashMap.emptyWithCapacity"⟩,⟨"Std.TreeMap", ← migrateName "Std.TreeMap.empty"⟩,⟨"Std.TreeMap.Raw", ← migrateName "Std.TreeMap.Raw.empty"⟩,⟨"Std.ExtTreeMap", ← migrateName "Std.ExtTreeMap.empty"⟩,⟨"Std.HashSet", ← migrateName "Std.HashSet.emptyWithCapacity"⟩,⟨"Std.HashSet.Raw", ← migrateName "Std.HashSet.Raw.emptyWithCapacity"⟩,⟨"Std.ExtHashSet", ← migrateName "Std.ExtHashSet.emptyWithCapacity"⟩,⟨"Std.TreeSet", ← migrateName "Std.TreeSet.empty"⟩,⟨"Std.TreeSet.Raw", ← migrateName "Std.TreeSet.Raw.empty"⟩,⟨"Std.ExtTreeSet", ← migrateName "Std.ExtTreeSet.empty"⟩,]⟩,
      ⟨"7743a485-024d-43b6-bd5f-ebd3182eb94d", "ofList", #[⟨"Std.DHashMap", ← migrateName "Std.DHashMap.ofList"⟩,⟨"Std.DHashMap.Raw", ← migrateName "Std.DHashMap.Raw.ofList"⟩,⟨"Std.ExtDHashMap", ← migrateName "Std.ExtDHashMap.ofList"⟩,⟨"Std.DTreeMap", ← migrateName "Std.DTreeMap.ofList"⟩,⟨"Std.DTreeMap.Raw", ← migrateName "Std.DTreeMap.Raw.ofList"⟩,⟨"Std.ExtDTreeMap", ← migrateName "Std.ExtDTreeMap.ofList"⟩,⟨"Std.HashMap", ← migrateName "Std.HashMap.ofList"⟩,⟨"Std.HashMap.Raw", ← migrateName "Std.HashMap.Raw.ofList"⟩,⟨"Std.ExtHashMap", ← migrateName "Std.ExtHashMap.ofList"⟩,⟨"Std.TreeMap", ← migrateName "Std.TreeMap.ofList"⟩,⟨"Std.TreeMap.Raw", ← migrateName "Std.TreeMap.Raw.ofList"⟩,⟨"Std.ExtTreeMap", ← migrateName "Std.ExtTreeMap.ofList"⟩,⟨"Std.HashSet", ← migrateName "Std.HashSet.ofList"⟩,⟨"Std.HashSet.Raw", ← migrateName "Std.HashSet.Raw.ofList"⟩,⟨"Std.ExtHashSet", ← migrateName "Std.ExtHashSet.ofList"⟩,⟨"Std.TreeSet", ← migrateName "Std.TreeSet.ofList"⟩,⟨"Std.TreeSet.Raw", ← migrateName "Std.TreeSet.Raw.ofList"⟩,⟨"Std.ExtTreeSet", ← migrateName "Std.ExtTreeSet.ofList"⟩,]⟩,
      ⟨"5ceaa26a-d2cb-4df3-9ac8-b5c11db2ae9d", "emptyCollection", #[⟨"Std.DHashMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.DHashMap*)"⟩,⟨"Std.DHashMap.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.DHashMap.Raw*)"⟩,⟨"Std.ExtDHashMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtDHashMap*)"⟩,⟨"Std.DTreeMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.DTreeMap*)"⟩,⟨"Std.DTreeMap.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.DTreeMap.Raw*)"⟩,⟨"Std.ExtDTreeMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtDTreeMap*)"⟩,⟨"Std.HashMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.HashMap*)"⟩,⟨"Std.HashMap.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.HashMap.Raw*)"⟩,⟨"Std.ExtHashMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtHashMap*)"⟩,⟨"Std.TreeMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.TreeMap*)"⟩,⟨"Std.TreeMap.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.TreeMap.Raw*)"⟩,⟨"Std.ExtTreeMap", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtTreeMap*)"⟩,⟨"Std.HashSet", ← migrateName "app (EmptyCollection.emptyCollection) (Std.HashSet*)"⟩,⟨"Std.HashSet.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.HashSet.Raw*)"⟩,⟨"Std.ExtHashSet", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtHashSet*)"⟩,⟨"Std.TreeSet", ← migrateName "app (EmptyCollection.emptyCollection) (Std.TreeSet*)"⟩,⟨"Std.TreeSet.Raw", ← migrateName "app (EmptyCollection.emptyCollection) (Std.TreeSet.Raw*)"⟩,⟨"Std.ExtTreeSet", ← migrateName "app (EmptyCollection.emptyCollection) (Std.ExtTreeSet*)"⟩,]⟩,
    ]
    facts := #[
      «2cb3c441-9663-4ce7-9527-0f40fc29925a»,

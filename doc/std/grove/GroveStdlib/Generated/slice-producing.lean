...
def «c8a13d6d-7ed6-4cd1-a386-23e2d55ce6f7» : AssociationTable.Fact .declaration where
  ...
  { name := `String.Slice.Pos.ofSlice,
    ...
    isDeprecated := false }⟩,⟨"string-pos-noproof", "String.Pos.sliceOrPanic", Grove.Framework.Declaration.def
  { name := `String.Pos.sliceOrPanic,
    renderedStatement := "String.Pos.sliceOrPanic {s : String} (pos p₀ p₁ : s.Pos) {h : p₀ ≤ p₁} : (s.slice p₀ p₁ h).Pos",
    isDeprecated := false }⟩,⟨"string-slice-pos-noproof", "String.Slice.Pos.sliceOrPanic", Grove.Framework.Declaration.def
...
def «a3bdf66d-bc11-4019-aee9-2f1c1701de52» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.trimAsciiStart", Grove.Framework.Declaration.def
  { name := `String.trimAsciiStart,
    renderedStatement := "String.trimAsciiStart (s : String) : String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.trimAsciiStart", Grove.Framework.Declaration.def
...
def «f12b2730-7a4d-465c-8a6d-9d051c300fd5» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.trimAsciiEnd", Grove.Framework.Declaration.def
  { name := `String.trimAsciiEnd,
    renderedStatement := "String.trimAsciiEnd (s : String) : String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.trimAsciiEnd", Grove.Framework.Declaration.def
...
def «32307b55-d6d1-4756-a947-dbe4dfde573c» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.trimAscii", Grove.Framework.Declaration.def
  { name := `String.trimAscii,
    renderedStatement := "String.trimAscii (s : String) : String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.trimAscii", Grove.Framework.Declaration.def
...
def «dce95a38-f55a-4d6a-ae79-078ffe4b5c15» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.toSlice", Grove.Framework.Declaration.def
  { name := `String.toSlice, renderedStatement := "String.toSlice (s : String) : String.Slice", isDeprecated := false }⟩,⟨"string-pos-forwards", "String.Pos.toSlice", Grove.Framework.Declaration.def
  { name := `String.Pos.toSlice,
    renderedStatement := "String.Pos.toSlice {s : String} (pos : s.Pos) : s.toSlice.Pos",
    isDeprecated := false }⟩,⟨"string-pos-backwards", "String.Pos.ofToSlice", Grove.Framework.Declaration.def
...
def «005a3f30-5dab-493f-b168-32c36a2bdf7c» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String.Slice", "String.Slice.str", Grove.Framework.Declaration.def
  { name := `String.Slice.str,
    renderedStatement := "String.Slice.str (self : String.Slice) : String",
    isDeprecated := false }⟩,⟨"string-slice-pos-forwards", "String.Slice.Pos.str", Grove.Framework.Declaration.def
  { name := `String.Slice.Pos.str,
    renderedStatement := "String.Slice.Pos.str {s : String.Slice} (pos : s.Pos) : s.str.Pos",
    isDeprecated := false }⟩,⟨"string-slice-pos-backwards", "String.Slice.Pos.ofStr", Grove.Framework.Declaration.def
...
def «5f1a154c-ae2f-43a1-9409-2ce95b163ef3» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.drop", Grove.Framework.Declaration.def
  { name := `String.drop,
    renderedStatement := "String.drop (s : String) (n : Nat) : String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.drop", Grove.Framework.Declaration.def
...
def «179518d1-ad07-4b2b-8ffe-3b7616e4c4ab» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.take", Grove.Framework.Declaration.def
  { name := `String.take,
    renderedStatement := "String.take (s : String) (n : Nat) : String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.take", Grove.Framework.Declaration.def
...
def «55c587fd-a7a8-4633-a4ae-e2c4e768ad28» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.dropWhile", Grove.Framework.Declaration.def
  { name := `String.dropWhile,
    renderedStatement := "String.dropWhile {ρ : Type} (s : String) (pat : ρ) [String.Slice.Pattern.ForwardPattern pat] :\n  String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.dropWhile", Grove.Framework.Declaration.def
...
def «d4444684-4279-4400-9be2-561a7cdb32c1» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.takeWhile", Grove.Framework.Declaration.def
  { name := `String.takeWhile,
    renderedStatement := "String.takeWhile {ρ : Type} (s : String) (pat : ρ) [String.Slice.Pattern.ForwardPattern pat] :\n  String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.takeWhile", Grove.Framework.Declaration.def
...
def «1c9e6689-65a0-4d4b-b001-256e83917d98» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.dropEndWhile", Grove.Framework.Declaration.def
  { name := `String.dropEndWhile,
    ...
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.dropEndWhile", Grove.Framework.Declaration.def
...
def «b836052b-3470-4a8e-8989-6951c898de37» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.takeEndWhile", Grove.Framework.Declaration.def
  { name := `String.takeEndWhile,
    ...
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.takeEndWhile", Grove.Framework.Declaration.def
...
def «5aa777d8-9642-43d8-9e20-30400fb8bb9d» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.dropPrefix", Grove.Framework.Declaration.def
  { name := `String.dropPrefix,
    renderedStatement := "String.dropPrefix {ρ : Type} (s : String) (pat : ρ) [String.Slice.Pattern.ForwardPattern pat] :\n  String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.dropPrefix", Grove.Framework.Declaration.def
...
def «80e3869d-fcfe-459d-8433-fe221f7b3c7a» : AssociationTable.Fact .declaration where
  ...
  rowState := #[⟨"String", "String.dropSuffix", Grove.Framework.Declaration.def
  { name := `String.dropSuffix,
    renderedStatement := "String.dropSuffix {ρ : Type} (s : String) (pat : ρ) [String.Slice.Pattern.BackwardPattern pat] :\n  String.Slice",
    isDeprecated := false }⟩,⟨"String.Slice", "String.Slice.dropSuffix", Grove.Framework.Declaration.def
...
def table : RestoreStateM (AssociationTable.Data .declaration) := do
  return {
    widgetId := "slice-producing"
    rows := #[
      ⟨"c8a13d6d-7ed6-4cd1-a386-23e2d55ce6f7", "slice", #[⟨"String", ← migrateName "String.slice"⟩,⟨"String.Slice", ← migrateName "String.Slice.slice"⟩,⟨"string-pos-forwards", ← migrateName "String.Pos.slice"⟩,⟨"string-pos-backwards", ← migrateName "String.Pos.ofSlice"⟩,⟨"string-slice-pos-forwards", ← migrateName "String.Slice.Pos.slice"⟩,⟨"string-slice-pos-backwards", ← migrateName "String.Slice.Pos.ofSlice"⟩,⟨"string-pos-noproof", ← migrateName "String.Pos.sliceOrPanic"⟩,⟨"string-slice-pos-noproof", ← migrateName "String.Slice.Pos.sliceOrPanic"⟩,]⟩,
      ⟨"21b4fdfd-f8b3-44f5-a59e-57f1dc1d6819", "slice?", #[⟨"String", ← migrateName "String.slice?"⟩,⟨"String.Slice", ← migrateName "String.Slice.slice?"⟩,]⟩,
      ⟨"6f2b6ecb-2f0c-4e45-9da3-eb7f2e15eff0", "slice!", #[⟨"String", ← migrateName "String.slice!"⟩,⟨"String.Slice", ← migrateName "String.Slice.slice!"⟩,⟨"string-pos-forwards", ← migrateName "String.Pos.slice!"⟩,⟨"string-pos-backwards", ← migrateName "String.Pos.ofSlice!"⟩,⟨"string-slice-pos-forwards", ← migrateName "String.Slice.Pos.slice!"⟩,⟨"string-slice-pos-backwards", ← migrateName "String.Slice.Pos.ofSlice!"⟩,]⟩,
      ⟨"a3bdf66d-bc11-4019-aee9-2f1c1701de52", "trimAsciiStart", #[⟨"String", ← migrateName "String.trimAsciiStart"⟩,⟨"String.Slice", ← migrateName "String.Slice.trimAsciiStart"⟩,]⟩,
      ⟨"f12b2730-7a4d-465c-8a6d-9d051c300fd5", "trimAsciiEnd", #[⟨"String", ← migrateName "String.trimAsciiEnd"⟩,⟨"String.Slice", ← migrateName "String.Slice.trimAsciiEnd"⟩,]⟩,
      ⟨"32307b55-d6d1-4756-a947-dbe4dfde573c", "trimAscii", #[⟨"String", ← migrateName "String.trimAscii"⟩,⟨"String.Slice", ← migrateName "String.Slice.trimAscii"⟩,]⟩,
      ⟨"dce95a38-f55a-4d6a-ae79-078ffe4b5c15", "toSlice", #[⟨"String", ← migrateName "String.toSlice"⟩,⟨"string-pos-forwards", ← migrateName "String.Pos.toSlice"⟩,⟨"string-pos-backwards", ← migrateName "String.Pos.ofToSlice"⟩,]⟩,
      ⟨"005a3f30-5dab-493f-b168-32c36a2bdf7c", "str", #[⟨"String.Slice", ← migrateName "String.Slice.str"⟩,⟨"string-slice-pos-forwards", ← migrateName "String.Slice.Pos.str"⟩,⟨"string-slice-pos-backwards", ← migrateName "String.Slice.Pos.ofStr"⟩,]⟩,
      ⟨"5f1a154c-ae2f-43a1-9409-2ce95b163ef3", "drop", #[⟨"String", ← migrateName "String.drop"⟩,⟨"String.Slice", ← migrateName "String.Slice.drop"⟩,]⟩,
      ⟨"179518d1-ad07-4b2b-8ffe-3b7616e4c4ab", "take", #[⟨"String", ← migrateName "String.take"⟩,⟨"String.Slice", ← migrateName "String.Slice.take"⟩,]⟩,
      ⟨"55c587fd-a7a8-4633-a4ae-e2c4e768ad28", "dropWhile", #[⟨"String", ← migrateName "String.dropWhile"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropWhile"⟩,]⟩,
      ⟨"d4444684-4279-4400-9be2-561a7cdb32c1", "takeWhile", #[⟨"String", ← migrateName "String.takeWhile"⟩,⟨"String.Slice", ← migrateName "String.Slice.takeWhile"⟩,]⟩,
      ⟨"1c9e6689-65a0-4d4b-b001-256e83917d98", "dropEndWhile", #[⟨"String", ← migrateName "String.dropEndWhile"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropEndWhile"⟩,]⟩,
      ⟨"b836052b-3470-4a8e-8989-6951c898de37", "takeEndWhile", #[⟨"String", ← migrateName "String.takeEndWhile"⟩,⟨"String.Slice", ← migrateName "String.Slice.takeEndWhile"⟩,]⟩,
      ⟨"5aa777d8-9642-43d8-9e20-30400fb8bb9d", "dropPrefix", #[⟨"String", ← migrateName "String.dropPrefix"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropPrefix"⟩,]⟩,
      ⟨"80e3869d-fcfe-459d-8433-fe221f7b3c7a", "dropSuffix", #[⟨"String", ← migrateName "String.dropSuffix"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropSuffix"⟩,]⟩,
      ⟨"4feda3e0-903b-4d52-b34e-0af70f7866e0", "dropPrefix?", #[⟨"String", ← migrateName "String.dropPrefix?"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropPrefix?"⟩,]⟩,
      ⟨"45ca44c8-fbd5-4400-8297-a60778f302b0", "dropSuffix?", #[⟨"String", ← migrateName "String.dropSuffix?"⟩,⟨"String.Slice", ← migrateName "String.Slice.dropSuffix?"⟩,]⟩,
    ]
    facts := #[

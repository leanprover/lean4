...
@[extern c "lean_uint8_of_nat" cpp "lean::uint8_of_nat"]
def UInt8.ofNat (n : @& Nat) : UInt8 := ⟨Fin.ofNat n⟩
@[extern c "lean_uint8_to_nat" cpp "lean::uint8_to_nat"]
def UInt8.toNat (n : UInt8) : Nat := n.val.val
@[extern c inline "#1 + #2" cpp inline "#1 + #2"]
...
@[extern c inline "#2 == 0 ? 0 : #1 / #2" cpp inline "#2 == 0 ? 0 : #1 / #2"]
def UInt8.div (a b : UInt8) : UInt8 := ⟨a.val / b.val⟩
@[extern c inline "#2 == 0 ? 0 : #1 % #2" cpp inline "#2 == 0 ? 0 : #1 % #2"]
def UInt8.mod (a b : UInt8) : UInt8 := ⟨a.val % b.val⟩
@[extern c "lean_uint8_modn" cpp "lean::uint8_modn"]
...
@[extern c "lean_uint16_of_nat" cpp "lean::uint16_of_nat"]
def UInt16.ofNat (n : @& Nat) : UInt16 := ⟨Fin.ofNat n⟩
@[extern c "lean_uint16_to_nat" cpp "lean::uint16_to_nat"]
...
@[extern c "lean_uint16_modn" cpp "lean::uint16_modn"]
...
@[extern c "lean_uint32_of_nat" cpp "lean::uint32_of_nat"]
def UInt32.ofNat (n : @& Nat) : UInt32 := ⟨Fin.ofNat n⟩
@[extern c "lean_uint32_to_nat" cpp "lean::uint32_to_nat"]
...
@[extern c "lean_uint32_modn" cpp "lean::uint32_modn"]
...
@[extern c "lean_uint64_of_nat" cpp "lean::uint64_of_nat"]
def UInt64.ofNat (n : @& Nat) : UInt64 := ⟨Fin.ofNat n⟩
@[extern c "lean_uint64_to_nat" cpp "lean::uint64_to_nat"]
...
@[extern c "lean_uint64_modn" cpp "lean::uint64_modn"]
...
@[extern c "lean_usize_of_nat" cpp "lean::usize_of_nat"]
def USize.ofNat (n : @& Nat) : USize := ⟨Fin.ofNat' n usizeSzGt0⟩
@[extern c "lean_usize_to_nat" cpp "lean::usize_to_nat"]
...
@[extern c "lean_usize_modn" cpp "lean::usize_modn"]
...
@[extern c inline "#1" cpp inline "#1"]
def USize.ofUInt32 (a : UInt32) : USize := USize.ofNat (UInt32.toNat a)
@[extern c inline "((size_t)#1)" cpp inline "((lean::usize)#1)"]

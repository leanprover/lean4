...
/- Private name support.
   ...
   We say `_private.<module_name>.<index>` is the "private unique prefix"
...
| n@(Name.mkString p _) := n == privatePrefix || isPrivateName p

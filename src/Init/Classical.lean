...
/-- **Diaconescu's theorem**: the law of the excluded middle derived from the axiom of choice, together with function extensionality and propositional extensionality. -/

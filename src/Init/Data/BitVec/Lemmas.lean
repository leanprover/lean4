...
theorem clzAux_eq_iff {x : BitVec w} {n : Nat} :
    clzAux x 0 = (n + 1) ↔ (∀ i, i < n + 1 → x.getLsbD i = false) := by sorry
  -- induction n

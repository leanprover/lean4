...
-/
@[always_inline, inline, deprecated "The consumers on iterators do not require proofs of termination anymore. For example, us `it.toList` instead of `it.allowNontermination.toList`." (since := "2026-01-28")]

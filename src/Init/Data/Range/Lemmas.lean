...
private theorem forInNew'_loop_eq_forInNew'_range' [Monad m] (r : Std.Range)
...
@[simp] theorem forInNew'_eq_forInNew'_range' [Monad m] (r : Std.Range)
...
@[simp] theorem forInNew_eq_forInNew_range' [Monad m] (r : Std.Range)

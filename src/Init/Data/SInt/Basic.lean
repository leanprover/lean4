...
-/
@[inline, instance_reducible] def Int8.toBitVec (x : Int8) : BitVec 8 := x.toUInt8.toBitVec --
 ...
 * `Int8.ofNat 255 = -1`
-/
@[extern "lean_int8_of_nat", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int8_to_int", tagged_return, instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int8_neg", instance_reducible]
...
-/
@[inline, instance_reducible] def Int16.toBitVec (x : Int16) : BitVec 16 := x.toUInt16.toBitVec
...
-/
@[extern "lean_int16_of_nat", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int16_to_int", tagged_return, instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int16_neg", instance_reducible]
...
-/
@[inline, instance_reducible] def Int32.toBitVec (x : Int32) : BitVec 32 := x.toUInt32.toBitVec
...
-/
@[extern "lean_int32_of_nat", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int32_to_int", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int32_neg", instance_reducible]
...
-/
@[extern "lean_int64_of_nat", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int64_to_int_sint", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_int64_neg", instance_reducible]
...
-/
@[inline, instance_reducible] def ISize.toBitVec (x : ISize) : BitVec System.Platform.numBits := x.toUSize.toBitVec
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_isize_of_nat", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_isize_to_int", instance_reducible]
...
This function is overridden at runtime with an efficient implementation.
-/
@[extern "lean_isize_neg", instance_reducible]

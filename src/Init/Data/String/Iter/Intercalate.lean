...
-/
public def Iter.joinString {α β : Type} [Iterator α Id β] [IteratorLoop α Id Id.{0}] [ToString β]
...
-/
@[inline]
public def Iter.intercalateString {α β : Type} [Iterator α Id β] [IteratorLoop α Id Id.{0}] [ToString β]

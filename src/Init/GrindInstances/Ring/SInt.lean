...
-- [ToInt experiment] example : ToInt.Add Int8 (.sint 8) := inferInstance
-- [ToInt experiment] example : ToInt.Neg Int8 (.sint 8) := inferInstance
-- [ToInt experiment] example : ToInt.Sub Int8 (.sint 8) := inferInstance

-- [ToInt experiment] instance : ToInt.Pow Int8 (.sint 8) := ToInt.pow_of_semiring (by simp)
...
-- Verify we can derive the instances showing how `toInt` interacts with operations:
-- [ToInt experiment] example : ToInt.Add Int16 (.sint 16) := inferInstance
-- [ToInt experiment] example : ToInt.Neg Int16 (.sint 16) := inferInstance
-- [ToInt experiment] example : ToInt.Sub Int16 (.sint 16) := inferInstance

-- [ToInt experiment] instance : ToInt.Pow Int16 (.sint 16) := ToInt.pow_of_semiring (by simp)
...
-- Verify we can derive the instances showing how `toInt` interacts with operations:
-- [ToInt experiment] example : ToInt.Add Int32 (.sint 32) := inferInstance
-- [ToInt experiment] example : ToInt.Neg Int32 (.sint 32) := inferInstance
-- [ToInt experiment] example : ToInt.Sub Int32 (.sint 32) := inferInstance

-- [ToInt experiment] instance : ToInt.Pow Int32 (.sint 32) := ToInt.pow_of_semiring (by simp)
...
-- Verify we can derive the instances showing how `toInt` interacts with operations:
-- [ToInt experiment] example : ToInt.Add Int64 (.sint 64) := inferInstance
-- [ToInt experiment] example : ToInt.Neg Int64 (.sint 64) := inferInstance
-- [ToInt experiment] example : ToInt.Sub Int64 (.sint 64) := inferInstance

-- [ToInt experiment] instance : ToInt.Pow Int64 (.sint 64) := ToInt.pow_of_semiring (by simp)
...
-- Verify we can derive the instances showing how `toInt` interacts with operations:
-- [ToInt experiment] example : ToInt.Add ISize (.sint numBits) := inferInstance
-- [ToInt experiment] example : ToInt.Neg ISize (.sint numBits) := inferInstance
-- [ToInt experiment] example : ToInt.Sub ISize (.sint numBits) := inferInstance

-- [ToInt experiment] instance : ToInt.Pow ISize (.sint numBits) :=

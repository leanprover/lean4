...
set_option bootstrap.genMatcherCode false in
@[extern "lean_uint8_dec_eq"] --   inline "#1 == #2"]
...
set_option bootstrap.genMatcherCode false in
@[extern "lean_uint16_dec_eq"] -- c inline "#1 == #2"]
...
set_option bootstrap.genMatcherCode false in
@[extern "lean_uint32_dec_lt"] --"#1 < #2"]
def UInt32.decLt (a b : UInt32) : Decidable (LT.lt a b) :=
  match a, b with
  | ⟨n⟩, ⟨m⟩ => inferInstanceAs (Decidable (LT.lt n m))

set_option bootstrap.genMatcherCode false in
@[extern "lean_uint32_dec_le"] -- "#1 <= #2"]
...
set_option bootstrap.genMatcherCode false in
@[extern c "lean_uint64_dec_eq"] -- "#1 == #2"]
...
set_option bootstrap.genMatcherCode false in
@[extern c "lean_usize_dec_eq"] --"#1 == #2"]

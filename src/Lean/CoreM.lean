...
partial def compileDecls (decls : Array Name) (logErrors := true) : CoreM Unit := do
  ...
  -- Do not display reporting range; compilation is an elaboration "side effect" about whose
  -- progress users should not need to worry, especially when triggered on aux declarations such as
  -- splitters generated by `simp`.

...
where go
  ...
  | .str p header => do
    ...
    addScope isNewNamespace header (if isNewNamespace then Name.mkStr currNamespace header else currNamespace) isNoncomputable isPublic attrs (delimitsLocal := delimitsLocal)

...
meta import Lean.Meta.Sym.Simp.RegisterCommand
...
@[builtin_fmt Lean.Meta.Sym.Simp._root_.Lean.Parser.Command.registerSymSimpAttr]
public def fmtRegisterSymSimpAttr : Fmt := fun
  | `(Parser.Command.registerSymSimpAttr|
      $[$docComment?:docComment]? register_sym_simp_attr%$registerTk $id:ident) => do

...
private partial def isDefEqBindingAux (lctx : LocalContext) (fvars : Array Expr) (e₁ e₂ : Expr) (ds₂ : Array Expr) : DefEqM Bool :=
...
partial def isExprDefEqAuxImpl (t : Expr) (s : Expr) : DefEqM Bool := do

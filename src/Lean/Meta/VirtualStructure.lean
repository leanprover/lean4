...
/--
Registered by the `type_def` command for a declaration such as
```
...
/-- If `typeName` was declared via `type_def`, return its virtual structure info. -/
...
/-- If `ctorName` is the constructor auto-generated by `type_def`, return its virtual structure
info. -/
...
/-- If `projName` is the projector auto-generated by `type_def`, return its virtual structure
info. -/

...
builtin_initialize
  ...
  registerAlias (.mkSimple "notFollowedBy") ``notFollowedBy (notFollowedBy · "element")
  Parenthesizer.registerAlias (.mkSimple "notFollowedBy") notFollowedBy.parenthesizer
  Formatter.registerAlias (.mkSimple "notFollowedBy") notFollowedBy.formatter

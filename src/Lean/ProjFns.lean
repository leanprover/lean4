...
builtin_initialize projectionFnInfoExt : MapDeclarationExtension ProjectionFunctionInfo ←
  -- covered: projection facts are immutable per declaration and monotone
  mkMapDeclarationExtension (synthCovered := true)
...
builtin_initialize auxParentProjInfoExt : MapDeclarationExtension AuxParentProjectionInfo ←
  -- covered: parent-projection facts are immutable per declaration and monotone
  mkMapDeclarationExtension (synthCovered := true)

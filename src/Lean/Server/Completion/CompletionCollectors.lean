...
/--
Generate completion items for a syntax object generated by `identWithPartialTrailingDot` given a known collection of completion candidates. Should only be used in contexts where namespaces do not affect the set of eligible completion candidates.
-/

...
/--
Compute the Levenshtein distance between two strings, up to some optional cutoff.
...
cutoff.
-/
def levenshtein (str1 str2 : String) (cutoff? : Option Nat) : Option Nat := Id.run do

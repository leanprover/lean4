...
theorem Comparable.compare_isLE [Ord α] [Comparable α] [LawfulComparable α] [LawfulOrd α] {a b : α} :
...
theorem Comparable.compare_isGE [Ord α] [Comparable α] [LawfulComparable α] [LawfulOrd α] {a b : α} :
...
theorem Comparable.compare_eq_lt [Ord α] [Comparable α] [LawfulComparable α] [LawfulOrd α]

...
@[inline, inherit_doc Raw.ofList] def ofArray [BEq α] [Hashable α] (l : Array ((a : α) × β a)) :
    DHashMap α β :=
  insertMany ∅ l
...
@[inline, inherit_doc Raw.Const.ofList] def Const.ofArray {β : Type v} [BEq α] [Hashable α]

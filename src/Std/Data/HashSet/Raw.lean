...
-/
@[inline] def getKey [BEq α] [Hashable α] (m : Raw α) (a : α) (h : a ∈ m) : α :=
  m.inner.getKey a h
...
-/
@[inline] def getKeyD [BEq α] [Hashable α] (m : Raw α) (a : α) (fallback : α) : α :=
...
-/
@[inline] def getKey! [BEq α] [Hashable α] [Inhabited α] (m : Raw α) (a : α) : α :=
  m.inner.getKey! a

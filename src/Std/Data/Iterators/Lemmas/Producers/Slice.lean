...
theorem Internal.iter_eq_iter [ToIterator (Slice γ) Id β] {s : Slice γ} :
...
theorem size_eq_count_iter [ToIterator (Slice γ) Id β]
...
theorem count_iter_eq_size [ToIterator (Slice γ) Id β]
    [Iterator (ToIterator.State (Slice γ) Id) Id β] {s : Slice γ}
    [Finite (ToIterator.State (Slice γ) Id) Id]
    [IteratorLoop (ToIterator.State (Slice γ) Id) Id Id] [LawfulIteratorLoop (ToIterator.State (Slice γ) Id) Id Id]
    [SliceSize γ] [LawfulSliceSize γ] :
...
@[simp]
theorem toArray_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
...
theorem toArray_eq_toArray_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
    [Iterator (ToIterator.State (Slice γ) Id) Id β] [IteratorCollect (ToIterator.State (Slice γ) Id) Id Id]
    [Finite (ToIterator.State (Slice γ) Id) Id] :
...
@[simp]
theorem toList_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
    [Iterator (ToIterator.State (Slice γ) Id) Id β] [IteratorCollect (ToIterator.State (Slice γ) Id) Id Id]
    [Finite (ToIterator.State (Slice γ) Id) Id] :
...
theorem toList_eq_toList_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
    [Iterator (ToIterator.State (Slice γ) Id) Id β] [IteratorCollect (ToIterator.State (Slice γ) Id) Id Id]
    [Finite (ToIterator.State (Slice γ) Id) Id] :
...
@[simp]
theorem toListRev_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
...
theorem toListRev_eq_toListRev_iter {s : Slice γ} [ToIterator (Slice γ) Id β]
    [Iterator (ToIterator.State (Slice γ) Id) Id β] [Finite (ToIterator.State (Slice γ) Id) Id] :

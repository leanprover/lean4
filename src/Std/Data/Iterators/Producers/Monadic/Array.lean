...
@[always_inline, inline]
instance ArrayIterator.instIteratorCollectPartial {α : Type w} [Monad m] {n : Type w → Type w''} [Monad n] :
...
@[always_inline, inline]
instance ArrayIterator.instIteratorLoopPartial {α : Type w} [Monad m] {n : Type x → Type x'} [Monad n] :

...
@[inline, inherit_doc DTreeMap.Const.ofList, deprecated ofList (since := "2025-02-06")]
...
@[inline, inherit_doc DTreeMap.Const.ofArray, deprecated ofArray (since := "2025-02-06")]

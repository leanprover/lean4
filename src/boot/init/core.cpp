...
lean::inc(x_27);
lean::dec(x_3);
x_30 = lean::apply_2(x_1, x_20, x_27);
...
{
obj* x_21; obj* x_24; obj* x_27; uint8 x_28; 
...
lean::inc(x_24);
lean::dec(x_5);
x_27 = lean::apply_2(x_3, x_21, x_24);
...
lean::mark_persistent(l_opt__param);
 l_out__param = _init_l_out__param();
lean::mark_persistent(l_out__param);
 l_unit = _init_l_unit();
lean::mark_persistent(l_unit);
 l_unit_star = _init_l_unit_star();
lean::mark_persistent(l_unit_star);
 l_not = _init_l_not();
lean::mark_persistent(l_not);
 l_and_elim__left = _init_l_and_elim__left();
lean::mark_persistent(l_and_elim__left);
 l_and_elim__right = _init_l_and_elim__right();
lean::mark_persistent(l_and_elim__right);
 l_rfl = _init_l_rfl();
lean::mark_persistent(l_rfl);
 l_heq_rfl = _init_l_heq_rfl();
lean::mark_persistent(l_heq_rfl);
 l_or_intro__left = _init_l_or_intro__left();
lean::mark_persistent(l_or_intro__left);
 l_or_intro__right = _init_l_or_intro__right();
lean::mark_persistent(l_or_intro__right);
 l_decidable__pred = _init_l_decidable__pred();
lean::mark_persistent(l_decidable__pred);
 l_decidable__rel = _init_l_decidable__rel();
lean::mark_persistent(l_decidable__rel);
 l_ge = _init_l_ge();
lean::mark_persistent(l_ge);
 l_gt = _init_l_gt();
lean::mark_persistent(l_gt);
 l_superset = _init_l_superset();
lean::mark_persistent(l_superset);
 l_ssuperset = _init_l_ssuperset();
lean::mark_persistent(l_ssuperset);
...
lean::mark_persistent(l_implies);
 l_trivial = _init_l_trivial();
lean::mark_persistent(l_trivial);
 l_ne = _init_l_ne();
lean::mark_persistent(l_ne);
 l_type__eq__of__heq = _init_l_type__eq__of__heq();
lean::mark_persistent(l_type__eq__of__heq);
 l_and_symm = _init_l_and_symm();
lean::mark_persistent(l_and_symm);
 l_not__not__em = _init_l_not__not__em();
lean::mark_persistent(l_not__not__em);
 l_or_symm = _init_l_or_symm();
lean::mark_persistent(l_or_symm);
 l_xor = _init_l_xor();
lean::mark_persistent(l_xor);
 l_not__true__iff = _init_l_not__true__iff();
lean::mark_persistent(l_not__true__iff);
 l_and__implies = _init_l_and__implies();
lean::mark_persistent(l_and__implies);
 l_exists_intro = _init_l_exists_intro();
lean::mark_persistent(l_exists_intro);
...
lean::mark_persistent(l_is__dec__eq);
 l_is__dec__refl = _init_l_is__dec__refl();
lean::mark_persistent(l_is__dec__refl);
 l_as__true = _init_l_as__true();
lean::mark_persistent(l_as__true);
 l_as__false = _init_l_as__false();
lean::mark_persistent(l_as__false);
 l_of__as__true = _init_l_of__as__true();
lean::mark_persistent(l_of__as__true);
 l_prop_inhabited = _init_l_prop_inhabited();
lean::mark_persistent(l_prop_inhabited);

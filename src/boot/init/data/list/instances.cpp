...
lean::inc(x_0);
x_8 = l_list_map___main___at_list_alternative___spec__1___rarg(x_0, x_4);
if (lean::is_scalar(x_6)) {
 x_9 = lean::alloc_cnstr(1, 2, 0);
} else {
 x_9 = x_6;
...
{
obj* x_2; 
x_2 = lean::alloc_closure(reinterpret_cast<void*>(l_list_map___main___at_list_alternative___spec__1___rarg), 2, 0);
return x_2;
}
}
...
lean::cnstr_set(x_9, 0, x_0);
lean::cnstr_set(x_9, 1, x_7);
x_10 = l_list_map___main___at_list_alternative___spec__3___rarg(x_0, x_4);
x_11 = lean::alloc_cnstr(1, 2, 0);
lean::cnstr_set(x_11, 0, x_9);
lean::cnstr_set(x_11, 1, x_10);
return x_11;
...
{
obj* x_2; 
x_2 = lean::alloc_closure(reinterpret_cast<void*>(l_list_map___main___at_list_alternative___spec__3___rarg), 2, 0);
return x_2;
}
}
...
x_11 = l_list_join___main___rarg(x_10);
x_12 = l_list_map___main___at_list_alternative___spec__4___rarg(x_0, x_6);
if (lean::is_scalar(x_8)) {
 x_13 = lean::alloc_cnstr(1, 2, 0);
} else {
 x_13 = x_8;
...
lean::inc(x_0);
x_8 = l_list_map___main___at_list_alternative___spec__5___rarg(x_0, x_4);
if (lean::is_scalar(x_6)) {
 x_9 = lean::alloc_cnstr(1, 2, 0);
} else {
 x_9 = x_6;
...
{
obj* x_2; 
x_2 = lean::alloc_closure(reinterpret_cast<void*>(l_list_map___main___at_list_alternative___spec__5___rarg), 2, 0);
return x_2;
}
}

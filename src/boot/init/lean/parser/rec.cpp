...
x_6 = lean::alloc_closure(reinterpret_cast<void*>(l_state__t_monad__except___rarg___lambda__2), 3, 1);
lean::closure_set(x_6, 0, x_4);
x_7 = lean::alloc_closure(reinterpret_cast<void*>(l_fix__core___rarg___boxed), 3, 2);

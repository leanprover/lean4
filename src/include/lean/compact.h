...
class compacted_region {
    ...
    void * m_base_addr;
    // Address of the `mmap`ed file, if any. Used for unmapping the file in the destructor.
    // `m_mmap_addr` may not be equal to `m_base_addr` because of header fields in front of
...
public:
    ...
    compacted_region(size_t sz, void * data, void * base_addr, void * mmap_addr);

...
extern "C" object* lean_kernel_record_unfold_ctx (object*, object*, object*);
...
void diagnostics::record_unfold(name const & decl_name, name const & context) {
    m_obj = lean_kernel_record_unfold_ctx(m_obj, decl_name.to_obj_arg(), context.to_obj_arg());
}

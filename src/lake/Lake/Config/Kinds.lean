...
@[reducible] public def Package.keyword : Name := `package
...
-/
@[reducible] public def Module.keyword : Name := `module
...
@[reducible] public def LeanLib.keyword : Name := `lean_lib
...
@[reducible] public def LeanExe.keyword : Name := `lean_exe
...
@[reducible] public def ExternLib.keyword : Name := `extern_lib
...
@[reducible] public def InputFile.keyword : Name := `input_file
...
@[reducible] public def InputDir.keyword : Name := `input_dir
...
-/
public def facetKindForNamespace (ns : Name) : Name :=
  match ns with

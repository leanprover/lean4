...
/**
    \brief Return the user name associated with the private name \c n.

    \remark The "user name" is the argument provided to \c add_private_name, and "private name" is the name returned
...
/* Create a private name based on \c c, and register it using \c add_private_name */

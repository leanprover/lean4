...
struct vm_backward_lemmas : public vm_external {
    ...
    virtual vm_external * ts_clone() override { return new vm_backward_lemmas(m_val); }
    virtual vm_external * clone() override { return new (get_vm_allocator().allocate(sizeof(vm_backward_lemmas))) vm_backward_lemmas(m_val); }
};

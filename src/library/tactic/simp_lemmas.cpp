...
struct vm_simp_lemmas : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_simp_lemmas(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_simp_lemmas))) vm_simp_lemmas(m_val); }
};

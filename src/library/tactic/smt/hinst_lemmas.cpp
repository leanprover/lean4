...
struct vm_hinst_lemma : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_hinst_lemma(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_hinst_lemma))) vm_hinst_lemma(m_val); }
};
...
struct vm_hinst_lemmas : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_hinst_lemmas(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_hinst_lemmas))) vm_hinst_lemmas(m_val); }
};

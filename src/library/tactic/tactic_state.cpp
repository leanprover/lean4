...
struct vm_tactic_state : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_tactic_state(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_tactic_state))) vm_tactic_state(m_val); }
};

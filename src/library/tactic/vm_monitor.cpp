...
struct vm_vm_decl : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_vm_decl(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_vm_decl))) vm_vm_decl(m_val); }
};

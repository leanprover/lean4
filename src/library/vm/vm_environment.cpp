...
struct vm_environment : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_environment(m_val); }
    virtual vm_external * clone()  { return new (get_vm_allocator().allocate(sizeof(vm_environment))) vm_environment(m_val); }
};

...
struct vm_format : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_format(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_format))) vm_format(m_val); }
};
...
struct vm_format_thunk : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_format_thunk(m_val); }
    virtual vm_external * clone() { return new (get_vm_allocator().allocate(sizeof(vm_format_thunk))) vm_format_thunk(m_val); }
};

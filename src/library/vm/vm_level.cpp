...
struct vm_level : public vm_external {
    ...
    virtual vm_external * ts_clone() override { return new vm_level(m_val); }
    virtual vm_external * clone() override { return new (get_vm_allocator().allocate(sizeof(vm_level))) vm_level(m_val); }
};

...
struct vm_options : public vm_external {
    ...
    virtual vm_external * ts_clone() { return new vm_options(m_val); }
    virtual vm_external * clone()  { return new (get_vm_allocator().allocate(sizeof(vm_options))) vm_options(m_val); }
};

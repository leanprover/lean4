...
/* `lean_dealloc`, `lean_free_object`, `lean_alloc_object`, `lean_dec_ref_cold`, and the RC
   deletion machinery live in `object_rc.cpp` so that mimalloc's fast paths can inline into them;

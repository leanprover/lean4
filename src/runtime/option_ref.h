...
public:
    ...
    option_ref(option_ref && other) noexcept:object_ref(std::move(other)) {}
    ...
    option_ref & operator=(option_ref && other) noexcept { object_ref::operator=(std::move(other)); return *this; }

...
__atribute__((always_inline)) bool lean_is_big_object_tag(uint8_t tag) {
...
__atribute__((always_inline)) bool lean_is_scalar(lean_object * o) { return ((size_t)(o) & 1) == 1 }
__atribute__((always_inline)) lean_object * lean_box(size_t n) { return (lean_object*)(((size_t)(n) << 1) | 1) }
__atribute__((always_inline)) size_t lean_unbox(lean_object * o) { return (size_t)(o) >> 1 }
...
__atribute__((always_inline)) size_t lean_align(size_t v, size_t a) {
    return (v / a)*a + a * (v % a != 0)
}

__atribute__((always_inline)) unsigned lean_get_slot_idx(unsigned sz) {
    assert(sz > 0)
...
__atribute__((always_inline)) lean_object * lean_alloc_small_object(unsigned sz) {
...
__atribute__((always_inline)) lean_object * lean_alloc_ctor_memory(unsigned sz) {
#ifdef LEAN_SMALL_ALLOCATOR
...
__atribute__((always_inline)) unsigned lean_small_object_size(lean_object * o) {
#ifdef LEAN_SMALL_ALLOCATOR
...
__atribute__((always_inline)) void lean_free_small_object(lean_object * o) {
#ifdef LEAN_SMALL_ALLOCATOR
    lean_free_small(o)
#else
    free((size_t*)o - 1)
...
__atribute__((always_inline)) uint8_t lean_ptr_tag(lean_object * o) {
    return o->m_tag
}

__atribute__((always_inline)) unsigned lean_ptr_other(lean_object * o) {
    return o->m_other
}
...
__atribute__((always_inline)) bool lean_is_mt(lean_object * o) {
    return o->m_rc < 0
}

__atribute__((always_inline)) bool lean_is_st(lean_object * o) {
    return o->m_rc > 0
}

/* We never update the reference counter of objects stored in compact regions and allocated at initialization time. */
__atribute__((always_inline)) bool lean_is_persistent(lean_object * o) {
    return o->m_rc == 0
}

__atribute__((always_inline)) bool lean_has_rc(lean_object * o) {
    return o->m_rc != 0
}

__atribute__((always_inline)) _Atomic(int) * lean_get_rc_mt_addr(lean_object* o) {
...
__atribute__((always_inline)) void lean_inc_ref(lean_object * o) {
...
__atribute__((always_inline)) void lean_inc_ref_n(lean_object * o, size_t n) {
    if (LEAN_LIKELY(lean_is_st(o))) {
        o->m_rc += n
    } else if (o->m_rc != 0) {
...
__atribute__((always_inline)) void lean_dec_ref(lean_object * o) {
...
__atribute__((always_inline)) void lean_inc(lean_object * o) { if (!lean_is_scalar(o)) lean_inc_ref(o) }
__atribute__((always_inline)) void lean_inc_n(lean_object * o, size_t n) { if (!lean_is_scalar(o)) lean_inc_ref_n(o, n) }
__atribute__((always_inline)) void lean_dec(lean_object * o) { if (!lean_is_scalar(o)) lean_dec_ref(o) }

/* Just free memory */
LEAN_SHARED void lean_dealloc(lean_object * o)

__atribute__((always_inline)) bool lean_is_ctor(lean_object * o) { return lean_ptr_tag(o) <= LeanMaxCtorTag }
__atribute__((always_inline)) bool lean_is_closure(lean_object * o) { return lean_ptr_tag(o) == LeanClosure }
__atribute__((always_inline)) bool lean_is_array(lean_object * o) { return lean_ptr_tag(o) == LeanArray }
__atribute__((always_inline)) bool lean_is_sarray(lean_object * o) { return lean_ptr_tag(o) == LeanScalarArray }
__atribute__((always_inline)) bool lean_is_string(lean_object * o) { return lean_ptr_tag(o) == LeanString }
__atribute__((always_inline)) bool lean_is_mpz(lean_object * o) { return lean_ptr_tag(o) == LeanMPZ }
__atribute__((always_inline)) bool lean_is_thunk(lean_object * o) { return lean_ptr_tag(o) == LeanThunk }
__atribute__((always_inline)) bool lean_is_task(lean_object * o) { return lean_ptr_tag(o) == LeanTask }
__atribute__((always_inline)) bool lean_is_external(lean_object * o) { return lean_ptr_tag(o) == LeanExternal }
__atribute__((always_inline)) bool lean_is_ref(lean_object * o) { return lean_ptr_tag(o) == LeanRef }

__atribute__((always_inline)) unsigned lean_obj_tag(lean_object * o) {
    if (lean_is_scalar(o)) return lean_unbox(o) else return lean_ptr_tag(o)
}

__atribute__((always_inline)) lean_ctor_object * lean_to_ctor(lean_object * o) { assert(lean_is_ctor(o)) return (lean_ctor_object*)(o) }
__atribute__((always_inline)) lean_closure_object * lean_to_closure(lean_object * o) { assert(lean_is_closure(o)) return (lean_closure_object*)(o) }
__atribute__((always_inline)) lean_array_object * lean_to_array(lean_object * o) { assert(lean_is_array(o)) return (lean_array_object*)(o) }
__atribute__((always_inline)) lean_sarray_object * lean_to_sarray(lean_object * o) { assert(lean_is_sarray(o)) return (lean_sarray_object*)(o) }
__atribute__((always_inline)) lean_string_object * lean_to_string(lean_object * o) { assert(lean_is_string(o)) return (lean_string_object*)(o) }
__atribute__((always_inline)) lean_thunk_object * lean_to_thunk(lean_object * o) { assert(lean_is_thunk(o)) return (lean_thunk_object*)(o) }
__atribute__((always_inline)) lean_task_object * lean_to_task(lean_object * o) { assert(lean_is_task(o)) return (lean_task_object*)(o) }
__atribute__((always_inline)) lean_ref_object * lean_to_ref(lean_object * o) { assert(lean_is_ref(o)) return (lean_ref_object*)(o) }
__atribute__((always_inline)) lean_external_object * lean_to_external(lean_object * o) { assert(lean_is_external(o)) return (lean_external_object*)(o) }

__atribute__((always_inline)) bool lean_is_exclusive(lean_object * o) {
    if (LEAN_LIKELY(lean_is_st(o))) {
        return o->m_rc == 1
    } else {
        return false
...
__atribute__((always_inline)) bool lean_is_shared(lean_object * o) {
    if (LEAN_LIKELY(lean_is_st(o))) {
        return o->m_rc > 1
    } else {
        return false
...
__atribute__((always_inline)) void lean_set_st_header(lean_object * o, unsigned tag, unsigned other) {
    o->m_rc       = 1
    o->m_tag      = tag
    o->m_other    = other
    o->m_cs_sz    = 0
...
__atribute__((always_inline)) void lean_set_non_heap_header(lean_object * o, size_t sz, unsigned tag, unsigned other) {
    assert(sz > 0)
    assert(sz < (1ull << 16))
...
__atribute__((always_inline)) void lean_set_non_heap_header_for_big(lean_object * o, unsigned tag, unsigned other) {
    lean_set_non_heap_header(o, 1, tag, other)
}

/* Constructor objects */

__atribute__((always_inline)) unsigned lean_ctor_num_objs(lean_object * o) {
    assert(lean_is_ctor(o))
    return lean_ptr_other(o)
}

__atribute__((always_inline)) lean_object ** lean_ctor_obj_cptr(lean_object * o) {
    assert(lean_is_ctor(o))
    return lean_to_ctor(o)->m_objs
}

__atribute__((always_inline)) uint8_t * lean_ctor_scalar_cptr(lean_object * o) {
    assert(lean_is_ctor(o))
    return (uint8_t*)(lean_ctor_obj_cptr(o) + lean_ctor_num_objs(o))
}

__atribute__((always_inline)) lean_object * lean_alloc_ctor(unsigned tag, unsigned num_objs, unsigned scalar_sz) {
...
__atribute__((always_inline)) b_lean_obj_res lean_ctor_get(b_lean_obj_arg o, unsigned i) {
    assert(i < lean_ctor_num_objs(o))
    return lean_ctor_obj_cptr(o)[i]
}

__atribute__((always_inline)) void lean_ctor_set(b_lean_obj_arg o, unsigned i, lean_obj_arg v) {
    assert(i < lean_ctor_num_objs(o))
    lean_ctor_obj_cptr(o)[i] = v
}

__atribute__((always_inline)) void lean_ctor_set_tag(b_lean_obj_arg o, uint8_t new_tag) {
    assert(new_tag <= LeanMaxCtorTag)
    o->m_tag = new_tag
}

__atribute__((always_inline)) void lean_ctor_release(b_lean_obj_arg o, unsigned i) {
    assert(i < lean_ctor_num_objs(o))
...
__atribute__((always_inline)) size_t lean_ctor_get_usize(b_lean_obj_arg o, unsigned i) {
    assert(i >= lean_ctor_num_objs(o))
    return *((size_t*)(lean_ctor_obj_cptr(o) + i))
}

__atribute__((always_inline)) uint8_t lean_ctor_get_uint8(b_lean_obj_arg o, unsigned offset) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    return *((uint8_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset))
}

__atribute__((always_inline)) uint16_t lean_ctor_get_uint16(b_lean_obj_arg o, unsigned offset) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    return *((uint16_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset))
}

__atribute__((always_inline)) uint32_t lean_ctor_get_uint32(b_lean_obj_arg o, unsigned offset) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    return *((uint32_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset))
}

__atribute__((always_inline)) uint64_t lean_ctor_get_uint64(b_lean_obj_arg o, unsigned offset) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    return *((uint64_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset))
}

__atribute__((always_inline)) double lean_ctor_get_float(b_lean_obj_arg o, unsigned offset) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    return *((double*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset))
}

__atribute__((always_inline)) void lean_ctor_set_usize(b_lean_obj_arg o, unsigned i, size_t v) {
    assert(i >= lean_ctor_num_objs(o))
    *((size_t*)(lean_ctor_obj_cptr(o) + i)) = v
}

__atribute__((always_inline)) void lean_ctor_set_uint8(b_lean_obj_arg o, unsigned offset, uint8_t v) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    *((uint8_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset)) = v
}

__atribute__((always_inline)) void lean_ctor_set_uint16(b_lean_obj_arg o, unsigned offset, uint16_t v) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    *((uint16_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset)) = v
}

__atribute__((always_inline)) void lean_ctor_set_uint32(b_lean_obj_arg o, unsigned offset, uint32_t v) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    *((uint32_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset)) = v
}

__atribute__((always_inline)) void lean_ctor_set_uint64(b_lean_obj_arg o, unsigned offset, uint64_t v) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
    *((uint64_t*)((uint8_t*)(lean_ctor_obj_cptr(o)) + offset)) = v
}

__atribute__((always_inline)) void lean_ctor_set_float(b_lean_obj_arg o, unsigned offset, double v) {
    assert(offset >= lean_ctor_num_objs(o) * sizeof(void*))
...
__atribute__((always_inline)) void * lean_closure_fun(lean_object * o) { return lean_to_closure(o)->m_fun }
__atribute__((always_inline)) unsigned lean_closure_arity(lean_object * o) { return lean_to_closure(o)->m_arity }
__atribute__((always_inline)) unsigned lean_closure_num_fixed(lean_object * o) { return lean_to_closure(o)->m_num_fixed }
__atribute__((always_inline)) lean_object ** lean_closure_arg_cptr(lean_object * o) { return lean_to_closure(o)->m_objs }
__atribute__((always_inline)) lean_obj_res lean_alloc_closure(void * fun, unsigned arity, unsigned num_fixed) {
    assert(arity > 0)
...
__atribute__((always_inline)) b_lean_obj_res lean_closure_get(b_lean_obj_arg o, unsigned i) {
    assert(i < lean_closure_num_fixed(o))
    return lean_to_closure(o)->m_objs[i]
}
__atribute__((always_inline)) void lean_closure_set(u_lean_obj_arg o, unsigned i, lean_obj_arg a) {
    assert(i < lean_closure_num_fixed(o))
...
__atribute__((always_inline)) lean_obj_res lean_alloc_array(size_t size, size_t capacity) {
...
__atribute__((always_inline)) size_t lean_array_size(b_lean_obj_arg o) { return lean_to_array(o)->m_size }
__atribute__((always_inline)) size_t lean_array_capacity(b_lean_obj_arg o) { return lean_to_array(o)->m_capacity }
__atribute__((always_inline)) size_t lean_array_byte_size(lean_object * o) {
    return sizeof(lean_array_object) + sizeof(void*)*lean_array_capacity(o)
}
__atribute__((always_inline)) lean_object ** lean_array_cptr(lean_object * o) { return lean_to_array(o)->m_data }
__atribute__((always_inline)) void lean_array_set_size(u_lean_obj_arg o, size_t sz) {
    assert(lean_is_array(o))
    assert(lean_is_exclusive(o))
    assert(sz <= lean_array_capacity(o))
    lean_to_array(o)->m_size = sz
}
__atribute__((always_inline)) b_lean_obj_res lean_array_get_core(b_lean_obj_arg o, size_t i) {
    assert(i < lean_array_size(o))
    return lean_to_array(o)->m_data[i]
}
__atribute__((always_inline)) void lean_array_set_core(u_lean_obj_arg o, size_t i, lean_obj_arg v) {
...
__atribute__((always_inline)) lean_object * lean_array_sz(lean_obj_arg a) {
    lean_object * r = lean_box(lean_array_size(a))
    lean_dec(a)
    return r
}

__atribute__((always_inline)) lean_object * lean_array_get_size(b_lean_obj_arg a) {
    return lean_box(lean_array_size(a))
}

__atribute__((always_inline)) lean_object * lean_mk_empty_array() {
    return lean_alloc_array(0, 0)
}

__atribute__((always_inline)) lean_object * lean_mk_empty_array_with_capacity(b_lean_obj_arg capacity) {
    if (!lean_is_scalar(capacity)) lean_internal_panic_out_of_memory()
    return lean_alloc_array(0, lean_unbox(capacity))
}

__atribute__((always_inline)) lean_object * lean_array_uget(b_lean_obj_arg a, size_t i) {
    lean_object * r = lean_array_get_core(a, i) lean_inc(r)
    return r
}

__atribute__((always_inline)) lean_obj_res lean_array_fget(b_lean_obj_arg a, b_lean_obj_arg i) {
    return lean_array_uget(a, lean_unbox(i))
}

LEAN_SHARED lean_obj_res lean_array_get_panic(lean_obj_arg def_val)

__atribute__((always_inline)) lean_object * lean_array_get(lean_obj_arg def_val, b_lean_obj_arg a, b_lean_obj_arg i) {
    if (lean_is_scalar(i)) {
...
__atribute__((always_inline)) lean_obj_res lean_copy_array(lean_obj_arg a) {
    return lean_copy_expand_array(a, false)
}

__atribute__((always_inline)) lean_obj_res lean_ensure_exclusive_array(lean_obj_arg a) {
    if (lean_is_exclusive(a)) return a
    return lean_copy_array(a)
}

__atribute__((always_inline)) lean_object * lean_array_uset(lean_obj_arg a, size_t i, lean_obj_arg v) {
...
__atribute__((always_inline)) lean_object * lean_array_fset(lean_obj_arg a, b_lean_obj_arg i, lean_obj_arg v) {
    return lean_array_uset(a, lean_unbox(i), v)
}

LEAN_SHARED lean_obj_res lean_array_set_panic(lean_obj_arg a, lean_obj_arg v)

__atribute__((always_inline)) lean_object * lean_array_set(lean_obj_arg a, b_lean_obj_arg i, lean_obj_arg v) {
    if (lean_is_scalar(i)) {
        size_t idx = lean_unbox(i)
        if (idx < lean_array_size(a))
...
__atribute__((always_inline)) lean_object * lean_array_pop(lean_obj_arg a) {
    lean_object * r  = lean_ensure_exclusive_array(a)
...
__atribute__((always_inline)) lean_object * lean_array_uswap(lean_obj_arg a, size_t i, size_t j) {
    lean_object * r   = lean_ensure_exclusive_array(a)
...
__atribute__((always_inline)) lean_object * lean_array_fswap(lean_obj_arg a, b_lean_obj_arg i, b_lean_obj_arg j) {
    return lean_array_uswap(a, lean_unbox(i), lean_unbox(j))
}

__atribute__((always_inline)) lean_object * lean_array_swap(lean_obj_arg a, b_lean_obj_arg i, b_lean_obj_arg j) {
...
__atribute__((always_inline)) lean_obj_res lean_alloc_sarray(unsigned elem_size, size_t size, size_t capacity) {
...
__atribute__((always_inline)) unsigned lean_sarray_elem_size(lean_object * o) {
    assert(lean_is_sarray(o))
    return lean_ptr_other(o)
}
__atribute__((always_inline)) size_t lean_sarray_capacity(lean_object * o) { return lean_to_sarray(o)->m_capacity }
__atribute__((always_inline)) size_t lean_sarray_byte_size(lean_object * o) {
    return sizeof(lean_sarray_object) + lean_sarray_elem_size(o)*lean_sarray_capacity(o)
}
__atribute__((always_inline)) size_t lean_sarray_size(b_lean_obj_arg o) { return lean_to_sarray(o)->m_size }
__atribute__((always_inline)) void lean_sarray_set_size(u_lean_obj_arg o, size_t sz) {
    assert(lean_is_exclusive(o))
    assert(sz <= lean_sarray_capacity(o))
    lean_to_sarray(o)->m_size = sz
}
__atribute__((always_inline)) uint8_t* lean_sarray_cptr(lean_object * o) { return lean_to_sarray(o)->m_data }
...
__atribute__((always_inline)) lean_obj_res lean_mk_empty_byte_array(b_lean_obj_arg capacity) {
    if (!lean_is_scalar(capacity)) lean_internal_panic_out_of_memory()
    return lean_alloc_sarray(1, 0, lean_unbox(capacity))
}

__atribute__((always_inline)) lean_obj_res lean_byte_array_size(b_lean_obj_arg a) {
    return lean_box(lean_sarray_size(a))
}
__atribute__((always_inline)) uint8_t lean_byte_array_uget(b_lean_obj_arg a, size_t i) {
    assert(i < lean_sarray_size(a))
    return lean_sarray_cptr(a)[i]
}
__atribute__((always_inline)) uint8_t lean_byte_array_get(b_lean_obj_arg a, b_lean_obj_arg i) {
    if (lean_is_scalar(i)) {
        size_t idx = lean_unbox(i)
...
__atribute__((always_inline)) uint8_t lean_byte_array_fget(b_lean_obj_arg a, b_lean_obj_arg i) {
    return lean_byte_array_uget(a, lean_unbox(i))
}

LEAN_SHARED lean_obj_res lean_byte_array_push(lean_obj_arg a, uint8_t b)

__atribute__((always_inline)) lean_object * lean_byte_array_uset(lean_obj_arg a, size_t i, uint8_t v) {
    lean_obj_res r
...
__atribute__((always_inline)) lean_obj_res lean_byte_array_set(lean_obj_arg a, b_lean_obj_arg i, uint8_t b) {
    if (!lean_is_scalar(i)) {
        return a
    } else {
        size_t idx = lean_unbox(i)
...
__atribute__((always_inline)) lean_obj_res lean_byte_array_fset(lean_obj_arg a, b_lean_obj_arg i, uint8_t b) {
...
__atribute__((always_inline)) lean_obj_res lean_mk_empty_float_array(b_lean_obj_arg capacity) {
    if (!lean_is_scalar(capacity)) lean_internal_panic_out_of_memory()
    return lean_alloc_sarray(sizeof(double), 0, lean_unbox(capacity)) // NOLINT
}

__atribute__((always_inline)) lean_obj_res lean_float_array_size(b_lean_obj_arg a) {
    return lean_box(lean_sarray_size(a))
}

__atribute__((always_inline)) double * lean_float_array_cptr(b_lean_obj_arg a) {
    return (double*)(lean_sarray_cptr(a)) // NOLINT
}

__atribute__((always_inline)) double lean_float_array_uget(b_lean_obj_arg a, size_t i) {
    return lean_float_array_cptr(a)[i]
}

__atribute__((always_inline)) double lean_float_array_fget(b_lean_obj_arg a, b_lean_obj_arg i) {
    return lean_float_array_uget(a, lean_unbox(i))
}

__atribute__((always_inline)) double lean_float_array_get(b_lean_obj_arg a, b_lean_obj_arg i) {
    if (lean_is_scalar(i)) {
        size_t idx = lean_unbox(i)
...
__atribute__((always_inline)) lean_obj_res lean_float_array_uset(lean_obj_arg a, size_t i, double d) {
    lean_obj_res r
    if (lean_is_exclusive(a)) r = a
...
__atribute__((always_inline)) lean_obj_res lean_float_array_fset(lean_obj_arg a, b_lean_obj_arg i, double d) {
    return lean_float_array_uset(a, lean_unbox(i), d)
}

__atribute__((always_inline)) lean_obj_res lean_float_array_set(lean_obj_arg a, b_lean_obj_arg i, double d) {
    if (!lean_is_scalar(i)) {
        return a
    } else {
        size_t idx = lean_unbox(i)
...
__atribute__((always_inline)) lean_obj_res lean_alloc_string(size_t size, size_t capacity, size_t len) {
...
__atribute__((always_inline)) size_t lean_string_capacity(lean_object * o) { return lean_to_string(o)->m_capacity }
__atribute__((always_inline)) size_t lean_string_byte_size(lean_object * o) { return sizeof(lean_string_object) + lean_string_capacity(o) }
/* instance : inhabited char := ⟨'A'⟩ */
__atribute__((always_inline)) uint32_t lean_char_default_value() { return 'A' }
...
__atribute__((always_inline)) char const * lean_string_cstr(b_lean_obj_arg o) {
    assert(lean_is_string(o))
    return lean_to_string(o)->m_data
}
__atribute__((always_inline)) size_t lean_string_size(b_lean_obj_arg o) { return lean_to_string(o)->m_size }
__atribute__((always_inline)) size_t lean_string_len(b_lean_obj_arg o) { return lean_to_string(o)->m_length }
...
__atribute__((always_inline)) lean_obj_res lean_string_length(b_lean_obj_arg s) { return lean_box(lean_string_len(s)) }
...
__atribute__((always_inline)) uint32_t lean_string_utf8_get_fast(b_lean_obj_arg s, b_lean_obj_arg i) {
...
__atribute__((always_inline)) lean_obj_res lean_string_utf8_next_fast(b_lean_obj_arg s, b_lean_obj_arg i) {
  char const * str = lean_string_cstr(s)
  size_t idx = lean_unbox(i)
  unsigned char c = (unsigned char)(str[idx])
...
__atribute__((always_inline)) uint8_t lean_string_utf8_at_end(b_lean_obj_arg s, b_lean_obj_arg i) {
...
__atribute__((always_inline)) lean_obj_res lean_string_utf8_byte_size(b_lean_obj_arg s) { return lean_box(lean_string_size(s) - 1) }
LEAN_SHARED bool lean_string_eq_cold(b_lean_obj_arg s1, b_lean_obj_arg s2)
__atribute__((always_inline)) bool lean_string_eq(b_lean_obj_arg s1, b_lean_obj_arg s2) {
    return s1 == s2 || (lean_string_size(s1) == lean_string_size(s2) && lean_string_eq_cold(s1, s2))
}
__atribute__((always_inline)) bool lean_string_ne(b_lean_obj_arg s1, b_lean_obj_arg s2) { return !lean_string_eq(s1, s2) }
LEAN_SHARED bool lean_string_lt(b_lean_obj_arg s1, b_lean_obj_arg s2)
__atribute__((always_inline)) uint8_t lean_string_dec_eq(b_lean_obj_arg s1, b_lean_obj_arg s2) { return lean_string_eq(s1, s2) }
__atribute__((always_inline)) uint8_t lean_string_dec_lt(b_lean_obj_arg s1, b_lean_obj_arg s2) { return lean_string_lt(s1, s2) }
LEAN_SHARED uint64_t lean_string_hash(b_lean_obj_arg)

/* Thunks */

__atribute__((always_inline)) lean_obj_res lean_mk_thunk(lean_obj_arg c) {
...
__atribute__((always_inline)) lean_obj_res lean_thunk_pure(lean_obj_arg v) {
    lean_thunk_object * o = (lean_thunk_object*)lean_alloc_small_object(sizeof(lean_thunk_object))
    lean_set_st_header((lean_object*)o, LeanThunk, 0)
    o->m_value   = v
...
__atribute__((always_inline)) b_lean_obj_res lean_thunk_get(b_lean_obj_arg t) {
...
__atribute__((always_inline)) lean_obj_res lean_thunk_get_own(b_lean_obj_arg t) {
...
__atribute__((always_inline)) lean_obj_res lean_task_spawn(lean_obj_arg c, lean_obj_arg prio) { return lean_task_spawn_core(c, lean_unbox(prio), false) }
...
__atribute__((always_inline)) lean_obj_res lean_task_bind(lean_obj_arg x, lean_obj_arg f, lean_obj_arg prio) { return lean_task_bind_core(x, f, lean_unbox(prio), false) }
...
__atribute__((always_inline)) lean_obj_res lean_task_map(lean_obj_arg f, lean_obj_arg t, lean_obj_arg prio) { return lean_task_map_core(f, t, lean_unbox(prio), false) }
LEAN_SHARED b_lean_obj_res lean_task_get(b_lean_obj_arg t)
/* Primitive for implementing Task.get : Task A -> A */
__atribute__((always_inline)) lean_obj_res lean_task_get_own(lean_obj_arg t) {
...
__atribute__((always_inline)) lean_object * lean_alloc_external(lean_external_class * cls, void * data) {
...
__atribute__((always_inline)) lean_external_class * lean_get_external_class(lean_object * o) {
    return lean_to_external(o)->m_class
}

__atribute__((always_inline)) void * lean_get_external_data(lean_object * o) {
...
__atribute__((always_inline)) lean_obj_res lean_usize_to_nat(size_t n) {
    if (LEAN_LIKELY(n <= LEAN_MAX_SMALL_NAT))
        return lean_box(n)
    else
        return lean_big_usize_to_nat(n)
}
__atribute__((always_inline)) lean_obj_res lean_unsigned_to_nat(unsigned n) {
    return lean_usize_to_nat(n)
}
__atribute__((always_inline)) lean_obj_res lean_uint64_to_nat(uint64_t n) {
    if (LEAN_LIKELY(n <= LEAN_MAX_SMALL_NAT))
        return lean_box(n)
    else
...
__atribute__((always_inline)) lean_obj_res lean_nat_succ(b_lean_obj_arg a) {
...
__atribute__((always_inline)) lean_obj_res lean_nat_add(b_lean_obj_arg a1, b_lean_obj_arg a2) {
...
__atribute__((always_inline)) lean_obj_res lean_nat_sub(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
...
__atribute__((always_inline)) lean_obj_res lean_nat_mul(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        size_t n1 = lean_unbox(a1)
        if (n1 == 0)
            return a1
...
__atribute__((always_inline)) lean_obj_res lean_nat_div(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        size_t n1 = lean_unbox(a1)
        size_t n2 = lean_unbox(a2)
        if (n2 == 0)
...
__atribute__((always_inline)) lean_obj_res lean_nat_mod(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        size_t n1 = lean_unbox(a1)
        size_t n2 = lean_unbox(a2)
        if (n2 == 0)
...
__atribute__((always_inline)) bool lean_nat_eq(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return a1 == a2
    } else {
...
__atribute__((always_inline)) uint8_t lean_nat_dec_eq(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    return lean_nat_eq(a1, a2)
}

__atribute__((always_inline)) bool lean_nat_ne(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    return !lean_nat_eq(a1, a2)
}

__atribute__((always_inline)) bool lean_nat_le(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return a1 <= a2
    } else {
...
__atribute__((always_inline)) uint8_t lean_nat_dec_le(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    return lean_nat_le(a1, a2)
}

__atribute__((always_inline)) bool lean_nat_lt(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return a1 < a2
    } else {
...
__atribute__((always_inline)) uint8_t lean_nat_dec_lt(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    return lean_nat_lt(a1, a2)
}

__atribute__((always_inline)) lean_obj_res lean_nat_land(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
...
__atribute__((always_inline)) lean_obj_res lean_nat_lor(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return (lean_object*)((size_t)(a1) | (size_t)(a2))
    } else {
...
__atribute__((always_inline)) lean_obj_res lean_nat_lxor(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
...
__atribute__((always_inline)) lean_obj_res lean_int_to_int(int n) {
    if (sizeof(void*) == 8)
...
__atribute__((always_inline)) lean_obj_res lean_int64_to_int(int64_t n) {
...
__atribute__((always_inline)) int64_t lean_scalar_to_int64(b_lean_obj_arg a) {
...
__atribute__((always_inline)) int lean_scalar_to_int(b_lean_obj_arg a) {
    assert(lean_is_scalar(a))
    if (sizeof(void*) == 8)
        return (int)((unsigned)lean_unbox(a)) /* NOLINT */
    else
...
__atribute__((always_inline)) lean_obj_res lean_nat_to_int(lean_obj_arg a) {
    if (lean_is_scalar(a)) {
...
__atribute__((always_inline)) lean_obj_res lean_int_neg(b_lean_obj_arg a) {
    if (LEAN_LIKELY(lean_is_scalar(a))) {
...
__atribute__((always_inline)) lean_obj_res lean_int_neg_succ_of_nat(lean_obj_arg a) {
...
__atribute__((always_inline)) lean_obj_res lean_int_add(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
...
__atribute__((always_inline)) lean_obj_res lean_int_sub(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return lean_int64_to_int(lean_scalar_to_int64(a1) - lean_scalar_to_int64(a2))
    } else {
...
__atribute__((always_inline)) lean_obj_res lean_int_mul(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return lean_int64_to_int(lean_scalar_to_int64(a1) * lean_scalar_to_int64(a2))
    } else {
...
__atribute__((always_inline)) lean_obj_res lean_int_div(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        if (sizeof(void*) == 8) {
...
__atribute__((always_inline)) lean_obj_res lean_int_mod(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        if (sizeof(void*) == 8) {
            /* 64-bit version, we use 64-bit numbers to avoid overflow when v1 == LEAN_MIN_SMALL_INT. */
...
__atribute__((always_inline)) bool lean_int_eq(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return a1 == a2
    } else {
...
__atribute__((always_inline)) bool lean_int_ne(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    return !lean_int_eq(a1, a2)
}

__atribute__((always_inline)) bool lean_int_le(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
...
__atribute__((always_inline)) bool lean_int_lt(b_lean_obj_arg a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a1) && lean_is_scalar(a2))) {
        return lean_scalar_to_int(a1) < lean_scalar_to_int(a2)
    } else {
...
__atribute__((always_inline)) lean_obj_res lean_int_to_nat(lean_obj_arg a) {
...
__atribute__((always_inline)) lean_obj_res lean_nat_abs(b_lean_obj_arg i) {
...
__atribute__((always_inline)) uint8_t lean_int_dec_eq(b_lean_obj_arg a1, b_lean_obj_arg a2) { return lean_int_eq(a1, a2) }

__atribute__((always_inline)) uint8_t lean_int_dec_le(b_lean_obj_arg a1, b_lean_obj_arg a2) { return lean_int_le(a1, a2) }

__atribute__((always_inline)) uint8_t lean_int_dec_lt(b_lean_obj_arg a1, b_lean_obj_arg a2) { return lean_int_lt(a1, a2) }

__atribute__((always_inline)) uint8_t lean_int_dec_nonneg(b_lean_obj_arg a) {
    if (LEAN_LIKELY(lean_is_scalar(a)))
...
__atribute__((always_inline)) uint64_t lean_bool_to_uint64(uint8_t a) { return ((uint64_t)a) }


/* UInt8 */

LEAN_SHARED uint8_t lean_uint8_of_big_nat(b_lean_obj_arg a)
__atribute__((always_inline)) uint8_t lean_uint8_of_nat(b_lean_obj_arg a) { return lean_is_scalar(a) ? (uint8_t)(lean_unbox(a)) : lean_uint8_of_big_nat(a) }
/* Remark: the following function is used to implement the constructor `UInt8.mk`. We can't annotate constructors with `@&` */
__atribute__((always_inline)) uint8_t lean_uint8_of_nat_mk(lean_obj_arg a) { uint8_t r = lean_uint8_of_nat(a) lean_dec(a) return r }
__atribute__((always_inline)) lean_obj_res lean_uint8_to_nat(uint8_t a) { return lean_usize_to_nat((size_t)a) }
__atribute__((always_inline)) uint8_t lean_uint8_add(uint8_t a1, uint8_t a2) { return a1+a2 }
__atribute__((always_inline)) uint8_t lean_uint8_sub(uint8_t a1, uint8_t a2) { return a1-a2 }
__atribute__((always_inline)) uint8_t lean_uint8_mul(uint8_t a1, uint8_t a2) { return a1*a2 }
__atribute__((always_inline)) uint8_t lean_uint8_div(uint8_t a1, uint8_t a2) { return a2 == 0 ? 0  : a1/a2 }
__atribute__((always_inline)) uint8_t lean_uint8_mod(uint8_t a1, uint8_t a2) { return a2 == 0 ? a1 : a1%a2 }
__atribute__((always_inline)) uint8_t lean_uint8_land(uint8_t a, uint8_t b) { return a & b }
__atribute__((always_inline)) uint8_t lean_uint8_lor(uint8_t a, uint8_t b) { return a | b }
__atribute__((always_inline)) uint8_t lean_uint8_xor(uint8_t a, uint8_t b) { return a ^ b }
__atribute__((always_inline)) uint8_t lean_uint8_shift_left(uint8_t a, uint8_t b) { return a << (b % 8) }
__atribute__((always_inline)) uint8_t lean_uint8_shift_right(uint8_t a, uint8_t b) { return a >> (b % 8) }
__atribute__((always_inline)) uint8_t lean_uint8_complement(uint8_t a) { return ~a }
__atribute__((always_inline)) uint8_t lean_uint8_modn(uint8_t a1, b_lean_obj_arg a2) {
...
__atribute__((always_inline)) uint8_t lean_uint8_dec_eq(uint8_t a1, uint8_t a2) { return a1 == a2 }
__atribute__((always_inline)) uint8_t lean_uint8_dec_lt(uint8_t a1, uint8_t a2) { return a1 < a2 }
__atribute__((always_inline)) uint8_t lean_uint8_dec_le(uint8_t a1, uint8_t a2) { return a1 <= a2 }


/* Unit8 -> other */
__atribute__((always_inline)) uint16_t lean_uint8_to_uint16(uint8_t a) { return ((uint16_t)a) }
__atribute__((always_inline)) uint32_t lean_uint8_to_uint32(uint8_t a) { return ((uint32_t)a) }
__atribute__((always_inline)) uint64_t lean_uint8_to_uint64(uint8_t a) { return ((uint64_t)a) }

/* UInt16 */

LEAN_SHARED uint16_t lean_uint16_of_big_nat(b_lean_obj_arg a)
__atribute__((always_inline)) uint16_t lean_uint16_of_nat(b_lean_obj_arg a) { return lean_is_scalar(a) ? (int16_t)(lean_unbox(a)) : lean_uint16_of_big_nat(a) }
/* Remark: the following function is used to implement the constructor `UInt16.mk`. We can't annotate constructors with `@&` */
__atribute__((always_inline)) uint16_t lean_uint16_of_nat_mk(lean_obj_arg a) { uint16_t r = lean_uint16_of_nat(a) lean_dec(a) return r }
__atribute__((always_inline)) lean_obj_res lean_uint16_to_nat(uint16_t a) { return lean_usize_to_nat((size_t)a) }
__atribute__((always_inline)) uint16_t lean_uint16_add(uint16_t a1, uint16_t a2) { return a1+a2 }
__atribute__((always_inline)) uint16_t lean_uint16_sub(uint16_t a1, uint16_t a2) { return a1-a2 }
__atribute__((always_inline)) uint16_t lean_uint16_mul(uint16_t a1, uint16_t a2) { return a1*a2 }
__atribute__((always_inline)) uint16_t lean_uint16_div(uint16_t a1, uint16_t a2) { return a2 == 0 ? 0  : a1/a2 }
__atribute__((always_inline)) uint16_t lean_uint16_mod(uint16_t a1, uint16_t a2) { return a2 == 0 ? a1 : a1%a2 }
__atribute__((always_inline)) uint16_t lean_uint16_land(uint16_t a, uint16_t b) { return a & b }
__atribute__((always_inline)) uint16_t lean_uint16_lor(uint16_t a, uint16_t b) { return a | b }
__atribute__((always_inline)) uint16_t lean_uint16_xor(uint16_t a, uint16_t b) { return a ^ b }
__atribute__((always_inline)) uint16_t lean_uint16_shift_left(uint16_t a, uint16_t b) { return a << (b % 16) }
__atribute__((always_inline)) uint16_t lean_uint16_shift_right(uint16_t a, uint16_t b) { return a >> (b % 16) }
__atribute__((always_inline)) uint16_t lean_uint16_complement(uint16_t a) { return ~a }
__atribute__((always_inline)) uint16_t lean_uint16_modn(uint16_t a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a2))) {
        unsigned n2 = lean_unbox(a2)
        return n2 == 0 ? a1 : a1 % n2
    } else {
...
__atribute__((always_inline)) uint8_t lean_uint16_dec_eq(uint16_t a1, uint16_t a2) { return a1 == a2 }
__atribute__((always_inline)) uint8_t lean_uint16_dec_lt(uint16_t a1, uint16_t a2) { return a1 < a2 }
__atribute__((always_inline)) uint8_t lean_uint16_dec_le(uint16_t a1, uint16_t a2) { return a1 <= a2 }

/*uint16 -> other */
__atribute__((always_inline)) uint8_t lean_uint16_to_uint8(uint16_t a) { return ((uint8_t)a) }
__atribute__((always_inline)) uint32_t lean_uint16_to_uint32(uint16_t a) { return ((uint32_t)a) }
__atribute__((always_inline)) uint64_t lean_uint16_to_uint64(uint16_t a) { return ((uint64_t)a) }

/* UInt32 */

LEAN_SHARED uint32_t lean_uint32_of_big_nat(b_lean_obj_arg a)
__atribute__((always_inline)) uint32_t lean_uint32_of_nat(b_lean_obj_arg a) { return lean_is_scalar(a) ? (uint32_t)(lean_unbox(a)) : lean_uint32_of_big_nat(a) }
/* Remark: the following function is used to implement the constructor `UInt32.mk`. We can't annotate constructors with `@&` */
__atribute__((always_inline)) uint32_t lean_uint32_of_nat_mk(lean_obj_arg a) { uint32_t r = lean_uint32_of_nat(a) lean_dec(a) return r }
__atribute__((always_inline)) lean_obj_res lean_uint32_to_nat(uint32_t a) { return lean_usize_to_nat((size_t)a) }
__atribute__((always_inline)) uint32_t lean_uint32_add(uint32_t a1, uint32_t a2) { return a1+a2 }
__atribute__((always_inline)) uint32_t lean_uint32_sub(uint32_t a1, uint32_t a2) { return a1-a2 }
__atribute__((always_inline)) uint32_t lean_uint32_mul(uint32_t a1, uint32_t a2) { return a1*a2 }
__atribute__((always_inline)) uint32_t lean_uint32_div(uint32_t a1, uint32_t a2) { return a2 == 0 ? 0  : a1/a2 }
__atribute__((always_inline)) uint32_t lean_uint32_mod(uint32_t a1, uint32_t a2) { return a2 == 0 ? a1 : a1%a2 }
__atribute__((always_inline)) uint32_t lean_uint32_land(uint32_t a, uint32_t b) { return a & b }
__atribute__((always_inline)) uint32_t lean_uint32_lor(uint32_t a, uint32_t b) { return a | b }
__atribute__((always_inline)) uint32_t lean_uint32_xor(uint32_t a, uint32_t b) { return a ^ b }
__atribute__((always_inline)) uint32_t lean_uint32_shift_left(uint32_t a, uint32_t b) { return a << (b % 32) }
__atribute__((always_inline)) uint32_t lean_uint32_shift_right(uint32_t a, uint32_t b) { return a >> (b % 32) }
__atribute__((always_inline)) uint32_t lean_uint32_complement(uint32_t a) { return ~a }
LEAN_SHARED uint32_t lean_uint32_big_modn(uint32_t a1, b_lean_obj_arg a2)
__atribute__((always_inline)) uint32_t lean_uint32_modn(uint32_t a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a2))) {
        size_t n2 = lean_unbox(a2)
        return n2 == 0 ? a1 : a1 % n2
...
__atribute__((always_inline)) uint8_t lean_uint32_dec_eq(uint32_t a1, uint32_t a2) { return a1 == a2 }
__atribute__((always_inline)) uint8_t lean_uint32_dec_lt(uint32_t a1, uint32_t a2) { return a1 < a2 }
__atribute__((always_inline)) uint8_t lean_uint32_dec_le(uint32_t a1, uint32_t a2) { return a1 <= a2 }

/* uint32 -> other */
__atribute__((always_inline)) uint8_t lean_uint32_to_uint8(uint32_t a) { return ((uint8_t)a) }
__atribute__((always_inline)) uint16_t lean_uint32_to_uint16(uint32_t a) { return ((uint16_t)a) }
__atribute__((always_inline)) uint64_t lean_uint32_to_uint64(uint32_t a) { return ((uint64_t)a) }
__atribute__((always_inline)) size_t lean_uint32_to_usize(uint32_t a) { return a }


/* UInt64 */

LEAN_SHARED uint64_t lean_uint64_of_big_nat(b_lean_obj_arg a)
__atribute__((always_inline)) uint64_t lean_uint64_of_nat(b_lean_obj_arg a) { return lean_is_scalar(a) ? (uint64_t)(lean_unbox(a)) : lean_uint64_of_big_nat(a) }
/* Remark: the following function is used to implement the constructor `UInt64.mk`. We can't annotate constructors with `@&` */
__atribute__((always_inline)) uint64_t lean_uint64_of_nat_mk(lean_obj_arg a) { uint64_t r = lean_uint64_of_nat(a) lean_dec(a) return r }
__atribute__((always_inline)) uint64_t lean_uint64_add(uint64_t a1, uint64_t a2) { return a1+a2 }
__atribute__((always_inline)) uint64_t lean_uint64_sub(uint64_t a1, uint64_t a2) { return a1-a2 }
__atribute__((always_inline)) uint64_t lean_uint64_mul(uint64_t a1, uint64_t a2) { return a1*a2 }
__atribute__((always_inline)) uint64_t lean_uint64_div(uint64_t a1, uint64_t a2) { return a2 == 0 ? 0  : a1/a2 }
__atribute__((always_inline)) uint64_t lean_uint64_mod(uint64_t a1, uint64_t a2) { return a2 == 0 ? a1 : a1%a2 }
__atribute__((always_inline)) uint64_t lean_uint64_land(uint64_t a, uint64_t b) { return a & b }
__atribute__((always_inline)) uint64_t lean_uint64_lor(uint64_t a, uint64_t b) { return a | b }
__atribute__((always_inline)) uint64_t lean_uint64_xor(uint64_t a, uint64_t b) { return a ^ b }
__atribute__((always_inline)) uint64_t lean_uint64_shift_left(uint64_t a, uint64_t b) { return a << (b % 64) }
__atribute__((always_inline)) uint64_t lean_uint64_shift_right(uint64_t a, uint64_t b) { return a >> (b % 64) }
__atribute__((always_inline)) uint64_t lean_uint64_complement(uint64_t a) { return ~a }
LEAN_SHARED uint64_t lean_uint64_big_modn(uint64_t a1, b_lean_obj_arg a2)
__atribute__((always_inline)) uint64_t lean_uint64_modn(uint64_t a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a2))) {
        size_t n2 = lean_unbox(a2)
        return n2 == 0 ? a1 : a1 % n2
    } else {
...
__atribute__((always_inline)) uint8_t lean_uint64_dec_eq(uint64_t a1, uint64_t a2) { return a1 == a2 }
__atribute__((always_inline)) uint8_t lean_uint64_dec_lt(uint64_t a1, uint64_t a2) { return a1 < a2 }
__atribute__((always_inline)) uint8_t lean_uint64_dec_le(uint64_t a1, uint64_t a2) { return a1 <= a2 }
LEAN_SHARED uint64_t lean_uint64_mix_hash(uint64_t a1, uint64_t a2)


/* uint64 -> other */
__atribute__((always_inline)) uint8_t lean_uint64_to_uint8(uint64_t a) { return ((uint8_t)a) }
__atribute__((always_inline)) uint16_t lean_uint64_to_uint16(uint64_t a) { return ((uint16_t)a) }
__atribute__((always_inline)) uint32_t lean_uint64_to_uint32(uint64_t a) { return ((uint32_t)a) }
__atribute__((always_inline)) size_t lean_uint64_to_usize(uint64_t a) { return ((size_t)a) }

/* USize */

LEAN_SHARED size_t lean_usize_of_big_nat(b_lean_obj_arg a)
__atribute__((always_inline)) size_t lean_usize_of_nat(b_lean_obj_arg a) { return lean_is_scalar(a) ? lean_unbox(a) : lean_usize_of_big_nat(a) }
/* Remark: the following function is used to implement the constructor `USize.mk`. We can't annotate constructors with `@&` */
__atribute__((always_inline)) size_t lean_usize_of_nat_mk(lean_obj_arg a) { size_t r = lean_usize_of_nat(a) lean_dec(a) return r }
__atribute__((always_inline)) size_t lean_usize_add(size_t a1, size_t a2) { return a1+a2 }
__atribute__((always_inline)) size_t lean_usize_sub(size_t a1, size_t a2) { return a1-a2 }
__atribute__((always_inline)) size_t lean_usize_mul(size_t a1, size_t a2) { return a1*a2 }
__atribute__((always_inline)) size_t lean_usize_div(size_t a1, size_t a2) { return a2 == 0 ? 0  : a1/a2 }
__atribute__((always_inline)) size_t lean_usize_mod(size_t a1, size_t a2) { return a2 == 0 ? a1 : a1%a2 }
__atribute__((always_inline)) size_t lean_usize_land(size_t a, size_t b) { return a & b }
__atribute__((always_inline)) size_t lean_usize_lor(size_t a, size_t b) { return a | b }
__atribute__((always_inline)) size_t lean_usize_xor(size_t a, size_t b) { return a ^ b }
__atribute__((always_inline)) size_t lean_usize_shift_left(size_t a, size_t b) { return a << (b %  (sizeof(size_t) * 8)) }
__atribute__((always_inline)) size_t lean_usize_shift_right(size_t a, size_t b) { return a >> (b % (sizeof(size_t) * 8)) }
__atribute__((always_inline)) size_t lean_usize_complement(size_t a) { return ~a }
LEAN_SHARED size_t lean_usize_big_modn(size_t a1, b_lean_obj_arg a2)
__atribute__((always_inline)) size_t lean_usize_modn(size_t a1, b_lean_obj_arg a2) {
    if (LEAN_LIKELY(lean_is_scalar(a2))) {
        size_t n2 = lean_unbox(a2)
        return n2 == 0 ? a1 : a1 % n2
    } else {
...
__atribute__((always_inline)) uint8_t lean_usize_dec_eq(size_t a1, size_t a2) { return a1 == a2 }
__atribute__((always_inline)) uint8_t lean_usize_dec_lt(size_t a1, size_t a2) { return a1 < a2 }
__atribute__((always_inline)) uint8_t lean_usize_dec_le(size_t a1, size_t a2) { return a1 <= a2 }
LEAN_SHARED size_t lean_usize_mix_hash(size_t a1, size_t a2)



/* usize -> other */
__atribute__((always_inline)) uint32_t lean_usize_to_uint32(size_t a) { return ((uint32_t)a) }
__atribute__((always_inline)) uint64_t lean_usize_to_uint64(size_t a) { return ((uint64_t)a) }
...
__atribute__((always_inline)) lean_obj_res lean_box_uint32(uint32_t v) {
    if (sizeof(void*) == 4) {
...
__atribute__((always_inline)) unsigned lean_unbox_uint32(b_lean_obj_arg o) {
    if (sizeof(void*) == 4) {
        /* 32-bit implementation */
...
__atribute__((always_inline)) lean_obj_res lean_box_uint64(uint64_t v) {
    lean_obj_res r = lean_alloc_ctor(0, 0, sizeof(uint64_t))
    lean_ctor_set_uint64(r, 0, v)
    return r
}

__atribute__((always_inline)) uint64_t lean_unbox_uint64(b_lean_obj_arg o) {
    return lean_ctor_get_uint64(o, 0)
}

__atribute__((always_inline)) lean_obj_res lean_box_usize(size_t v) {
    lean_obj_res r = lean_alloc_ctor(0, 0, sizeof(size_t))
    lean_ctor_set_usize(r, 0, v)
    return r
}

__atribute__((always_inline)) size_t lean_unbox_usize(b_lean_obj_arg o) {
    return lean_ctor_get_usize(o, 0)
}

__atribute__((always_inline)) lean_obj_res lean_box_float(double v) {
    lean_obj_res r = lean_alloc_ctor(0, 0, sizeof(double)) // NOLINT
    lean_ctor_set_float(r, 0, v)
    return r
}

__atribute__((always_inline)) double lean_unbox_float(b_lean_obj_arg o) {
...
__atribute__((always_inline)) lean_obj_res lean_io_mk_world() { return lean_box(0) }
__atribute__((always_inline)) bool lean_io_result_is_ok(b_lean_obj_arg r) { return lean_ptr_tag(r) == 0 }
__atribute__((always_inline)) bool lean_io_result_is_error(b_lean_obj_arg r) { return lean_ptr_tag(r) == 1 }
__atribute__((always_inline)) b_lean_obj_res lean_io_result_get_value(b_lean_obj_arg r) { assert(lean_io_result_is_ok(r)) return lean_ctor_get(r, 0) }
__atribute__((always_inline)) b_lean_obj_res lean_io_result_get_error(b_lean_obj_arg r) { assert(lean_io_result_is_error(r)) return lean_ctor_get(r, 0) }
LEAN_SHARED void lean_io_result_show_error(b_lean_obj_arg r)
LEAN_SHARED void lean_io_mark_end_initialization()
__atribute__((always_inline)) lean_obj_res lean_io_result_mk_ok(lean_obj_arg a) {
    lean_object * r = lean_alloc_ctor(0, 2, 0)
    lean_ctor_set(r, 0, a)
    lean_ctor_set(r, 1, lean_box(0))
    return r
}
__atribute__((always_inline)) lean_obj_res lean_io_result_mk_error(lean_obj_arg e) {
...
__atribute__((always_inline)) size_t lean_ptr_addr(b_lean_obj_arg a) { return (size_t)a }

/* Name primitives */
LEAN_SHARED uint8_t lean_name_eq(b_lean_obj_arg n1, b_lean_obj_arg n2)

__atribute__((always_inline)) uint64_t lean_name_hash_ptr(b_lean_obj_arg n) {
    assert(!lean_is_scalar(n))
    return lean_ctor_get_uint64(n, sizeof(lean_object*)*2)
}

__atribute__((always_inline)) uint64_t lean_name_hash(b_lean_obj_arg n) {
    if (lean_is_scalar(n))
        return 1723
    else
...
/* float primitives */
__atribute__((always_inline)) uint8_t lean_float_to_uint8(double a) {
    return 0. <= a ? (a < 256. ? (uint8_t)a : UINT8_MAX) : 0
}
__atribute__((always_inline)) uint16_t lean_float_to_uint16(double a) {
    return 0. <= a ? (a < 65536. ? (uint16_t)a : UINT16_MAX) : 0
}
__atribute__((always_inline)) uint32_t lean_float_to_uint32(double a) {
    return 0. <= a ? (a < 4294967296. ? (uint32_t)a : UINT32_MAX) : 0
}
__atribute__((always_inline)) uint64_t lean_float_to_uint64(double a) {
    return 0. <= a ? (a < 18446744073709551616. ? (uint64_t)a : UINT64_MAX) : 0
}
__atribute__((always_inline)) size_t lean_float_to_usize(double a) {
...
__atribute__((always_inline)) double lean_float_add(double a, double b) { return a + b }
__atribute__((always_inline)) double lean_float_sub(double a, double b) { return a - b }
__atribute__((always_inline)) double lean_float_mul(double a, double b) { return a * b }
__atribute__((always_inline)) double lean_float_div(double a, double b) { return a / b }
__atribute__((always_inline)) double lean_float_negate(double a) { return -a }
__atribute__((always_inline)) uint8_t lean_float_beq(double a, double b) { return a == b }
__atribute__((always_inline)) uint8_t lean_float_decLe(double a, double b) { return a <= b }
__atribute__((always_inline)) uint8_t lean_float_decLt(double a, double b) { return a < b }
__atribute__((always_inline)) double lean_uint64_to_float(uint64_t a) { return (double) a }

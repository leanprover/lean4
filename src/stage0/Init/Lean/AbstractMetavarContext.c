...
x_16 = lean_unsigned_to_nat(190u);
x_17 = lean_unsigned_to_nat(12u);
x_18 = l_Lean_AbstractMetavarContext_InstantiateExprMVars_instantiateDelayedAux___main___rarg___closed__2;
...
x_15 = lean_unsigned_to_nat(190u);

...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name("lift"), 2, l_lift);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftT"), 2, l_liftT);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeB"), 2, l_coeB);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeT"), 2, l_coeT);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeFnB"), 1, l_coeFnB);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coe"), 2, l_coe);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeFn"), 1, l_coeFn);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeSort"), 1, l_coeSort);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftTrans"), 3, l_liftTrans);
l_liftRefl___closed__1 = _init_l_liftRefl___closed__1();
lean::mark_persistent(l_liftRefl___closed__1);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftRefl"), 1, l_liftRefl);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeTrans"), 3, l_coeTrans);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeBase"), 2, l_coeBase);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeOption"), 1, l_coeOption);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeTransAux"), 3, l_coeTransAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeBaseAux"), 2, l_coeBaseAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeFnTrans"), 2, l_coeFnTrans);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeSortTrans"), 2, l_coeSortTrans);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeToLift"), 2, l_coeToLift);
l_coeBoolToProp = _init_l_coeBoolToProp();
l_coeSortBool = _init_l_coeSortBool();
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeDecidableEq"), 1, l_coeDecidableEq___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("coeSubtype"), 2, l_coeSubtype___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftFn"), 4, l_liftFn);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftFnRange"), 3, l_liftFnRange);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftFnDom"), 3, l_liftFnDom);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftPair"), 4, l_liftPair);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftPair₁"), 3, l_liftPair_u2081);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftPair₂"), 3, l_liftPair_u2082);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("liftList"), 2, l_liftList);
return w;
}

...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "run"), 2, l_OptionT_run___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "bindCont"), 1, l_OptionT_bindCont___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "bind"), 1, l_OptionT_bind___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "pure"), 1, l_OptionT_pure___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "Monad"), 1, l_OptionT_Monad___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "orelse"), 1, l_OptionT_orelse___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "fail"), 1, l_OptionT_fail___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "Alternative"), 1, l_OptionT_Alternative___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "lift"), 1, l_OptionT_lift___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "HasMonadLift"), 1, l_OptionT_HasMonadLift___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "monadMap"), 5, l_OptionT_monadMap___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "MonadFunctor"), 5, l_OptionT_MonadFunctor___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "catch"), 1, l_OptionT_catch___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "MonadExcept"), 1, l_OptionT_MonadExcept___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("OptionT"), "MonadRun"), 2, l_OptionT_MonadRun___boxed);
return w;
}

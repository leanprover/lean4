...
obj* l_List_toString___main___at_ByteArray_HasToString___spec__1(obj* x_1) {
_start:
{
if (lean::obj_tag(x_1) == 0)
{
...
obj* x_2; obj* x_3; 
x_2 = l_ByteArray_toList(x_1);
x_3 = l_List_toString___main___at_ByteArray_HasToString___spec__1(x_2);
return x_3;
}
}
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("ByteArray"), "set"), 3, l_ByteArray_set___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("ByteArray"), "isEmpty"), 1, l_ByteArray_isEmpty___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("ByteArray"), "toListAux"), 3, l_ByteArray_toListAux___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("ByteArray"), "toList"), 1, l_ByteArray_toList___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "toByteArrayAux"), 2, l_List_toByteArrayAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "toByteArray"), 1, l_List_toByteArray);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("ByteArray"), "HasToString"), 1, l_ByteArray_HasToString___boxed);
return w;
}

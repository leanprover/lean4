...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("DList"), "ofList"), 1, l_DList_ofList);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("DList"), "cons"), 1, l_DList_cons);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("DList"), "append"), 1, l_DList_append);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("DList"), "push"), 1, l_DList_push);
l_DList_HasAppend___closed__1 = _init_l_DList_HasAppend___closed__1();
lean::mark_persistent(l_DList_HasAppend___closed__1);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("DList"), "HasAppend"), 1, l_DList_HasAppend);
return w;
}

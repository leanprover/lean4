...
lean::register_constant(lean::mk_const_name(lean::mk_const_name("Int"), "HasZero"), l_Int_HasZero);
l_Int_HasOne = _init_l_Int_HasOne();
lean::mark_persistent(l_Int_HasOne);
lean::register_constant(lean::mk_const_name(lean::mk_const_name("Int"), "HasOne"), l_Int_HasOne);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Int"), "negOfNat"), 1, l_Int_negOfNat___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Int"), "neg"), 1, l_Int_neg___boxed);
...
lean::register_constant(lean::mk_const_name(lean::mk_const_name("Int"), "HasLessEq"), l_Int_HasLessEq);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Int"), "decLe"), 2, l_Int_decLe___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Int"), "decLt"), 2, l_Int_decLt___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Int"), "toNat"), 1, l_Int_toNat___boxed);

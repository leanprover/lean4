...
lean::mark_persistent(l_Int_HasSub);
 l_Int_HasLe = _init_l_Int_HasLe();
lean::mark_persistent(l_Int_HasLe);
 l_Int_HasLt = _init_l_Int_HasLt();
lean::mark_persistent(l_Int_HasLt);

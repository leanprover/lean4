...
obj* lean_int_neg_succ_of_nat(obj*);
...
obj* _init_l_Int_repr___closed__1() {
_start:
{
obj* x_1; 
x_1 = lean::mk_string("-");
...
lean::mark_persistent(l_Int_repr___closed__1);

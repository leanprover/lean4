...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "Inhabited"), 1, l_List_Inhabited);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "hasDecEq"), 1, l_List_hasDecEq);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "DecidableEq"), 1, l_List_DecidableEq);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "reverseAux"), 1, l_List_reverseAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "reverse"), 1, l_List_reverse);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "append"), 1, l_List_append);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "length"), 1, l_List_length);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "isEmpty"), 1, l_List_isEmpty);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "get"), 1, l_List_get);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "getOpt"), 1, l_List_getOpt);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "set"), 1, l_List_set);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "head"), 1, l_List_head);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "tail"), 1, l_List_tail);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "map"), 2, l_List_map);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "map₂"), 3, l_List_map_u2082);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "join"), 1, l_List_join);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "filterMap"), 2, l_List_filterMap);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "filterAux"), 1, l_List_filterAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "filter"), 1, l_List_filter);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "partitionAux"), 1, l_List_partitionAux);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "partition"), 1, l_List_partition);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "dropWhile"), 1, l_List_dropWhile);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "find"), 1, l_List_find);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "elem"), 1, l_List_elem);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "notElem"), 1, l_List_notElem);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "spanAux"), 1, l_List_spanAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "span"), 1, l_List_span);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "lookup"), 2, l_List_lookup);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "removeAll"), 1, l_List_removeAll);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "drop"), 1, l_List_drop);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "take"), 1, l_List_take);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "foldl"), 2, l_List_foldl);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "foldr"), 2, l_List_foldr);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "foldr1"), 1, l_List_foldr1);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "foldr1Opt"), 1, l_List_foldr1Opt);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "any"), 1, l_List_any);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "all"), 1, l_List_all);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "or"), 1, l_List_or___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "and"), 1, l_List_and___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "zipWith"), 3, l_List_zipWith);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "iota"), 1, l_List_iota___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "enumFrom"), 1, l_List_enumFrom);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "enum"), 1, l_List_enum);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "getLastOfNonNil"), 1, l_List_getLastOfNonNil);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "getLast"), 1, l_List_getLast);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "init"), 1, l_List_init);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "intersperse"), 1, l_List_intersperse);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "intercalate"), 1, l_List_intercalate);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "bind"), 2, l_List_bind);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "pure"), 1, l_List_pure);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "HasLess"), 2, l_List_HasLess___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "hasDecidableLt"), 1, l_List_hasDecidableLt);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "HasLessEq"), 2, l_List_HasLessEq___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "hasDecidableLe"), 1, l_List_hasDecidableLe);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "isPrefixOf"), 1, l_List_isPrefixOf);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "isSuffixOf"), 1, l_List_isSuffixOf);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("List"), "isEqv"), 1, l_List_isEqv);
return w;
}

...
lean::inc(x_1);
lean::dec(x_0);
x_4 = lean::alloc_closure(reinterpret_cast<void*>(l_List_Alternative___lambda__1___boxed), 1, 0);
x_5 = lean::alloc_closure(reinterpret_cast<void*>(l_List_append___boxed), 1, 0);

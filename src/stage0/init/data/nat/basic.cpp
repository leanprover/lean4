...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "ble"), 2, l_Nat_ble___boxed);
l_Nat_HasLessEq = _init_l_Nat_HasLessEq();
lean::mark_persistent(l_Nat_HasLessEq);
lean::register_constant(lean::mk_const_name(lean::mk_const_name("Nat"), "HasLessEq"), l_Nat_HasLessEq);
l_Nat_HasLess = _init_l_Nat_HasLess();
lean::mark_persistent(l_Nat_HasLess);
lean::register_constant(lean::mk_const_name(lean::mk_const_name("Nat"), "HasLess"), l_Nat_HasLess);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "foldAux"), 1, l_Nat_foldAux);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "fold"), 1, l_Nat_fold);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "anyAux"), 3, l_Nat_anyAux___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "any"), 2, l_Nat_any___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "all"), 2, l_Nat_all___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "decLe"), 2, l_Nat_decLe___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "decLt"), 2, l_Nat_decLt___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Nat"), "max"), 2, l_Nat_max___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Prod"), "foldI"), 1, l_Prod_foldI);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Prod"), "anyI"), 2, l_Prod_anyI___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("Prod"), "allI"), 2, l_Prod_allI___boxed);
return w;
}

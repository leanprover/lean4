...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "mfold"), 4, l_RBTree_mfold___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "mfor"), 4, l_RBTree_mfor___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "isEmpty"), 2, l_RBTree_isEmpty___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "toList"), 2, l_RBTree_toList___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "min"), 2, l_RBTree_min___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "max"), 2, l_RBTree_max___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "contains"), 1, l_RBTree_contains);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "fromList"), 1, l_RBTree_fromList);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "all"), 2, l_RBTree_all___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "any"), 2, l_RBTree_any___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "subset"), 1, l_RBTree_subset);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name("RBTree"), "seteq"), 1, l_RBTree_seteq);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("rbtreeOf"), 1, l_rbtreeOf);
return w;
}

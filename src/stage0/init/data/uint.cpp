...
uint16 lean_uint16_modn(uint16, obj*);
...
uint8 lean_uint8_modn(uint8, obj*);
...
uint64 lean_uint64_modn(uint64, obj*);
obj* l_UInt16_decLt___boxed(obj*, obj*);
uint32 lean_uint32_modn(uint32, obj*);

...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix1"), 2, l_bfix1);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore1"), 5, l_fixCore1___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore"), 2, l_fixCore);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix1"), 2, l_fix1);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix"), 2, l_fix);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix2"), 3, l_bfix2);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore2"), 7, l_fixCore2___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix2"), 3, l_fix2);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix3"), 4, l_bfix3);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore3"), 9, l_fixCore3___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix3"), 4, l_fix3);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix4"), 5, l_bfix4);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore4"), 11, l_fixCore4___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix4"), 5, l_fix4);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix5"), 6, l_bfix5);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore5"), 13, l_fixCore5___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix5"), 6, l_fix5);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("bfix6"), 7, l_bfix6);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fixCore6"), 15, l_fixCore6___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name("fix6"), 7, l_fix6);
return w;
}

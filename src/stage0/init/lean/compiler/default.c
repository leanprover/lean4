...
// Imports: init.lean.compiler.inlineattrs init.lean.compiler.specialize init.lean.compiler.constfolding init.lean.compiler.closedtermcache init.lean.compiler.externattr init.lean.compiler.implementedbyattr init.lean.compiler.effectfulattr init.lean.compiler.neverextractattr init.lean.compiler.ir.default

...
// Imports: init.lean.compiler.attributes init.lean.compiler.constfolding init.lean.compiler.closedtermcache init.lean.compiler.ir.default
...
#endif
obj* initialize_init_lean_compiler_attributes(obj*);
...
w = initialize_init_lean_compiler_attributes(w);
if (io_result_is_error(w)) return w;

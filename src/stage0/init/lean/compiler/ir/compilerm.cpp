...
extern "C" obj* lean_ir_log_to_string(obj*);
...
extern "C" obj* lean_ir_add_decl(obj*, obj*);
...
lean::cnstr_set_uint8(x_13, sizeof(void*)*2, x_8);
...
lean::cnstr_set_uint8(x_18, sizeof(void*)*2, x_7);
return x_18;
}
else
{
...
obj* lean_ir_log_to_string(obj* x_1) {
_start:
{
...
{
uint8 x_8; 
x_8 = lean::cnstr_get_uint8(x_7, 0);
lean::dec(x_7);
return x_8;
}
else
...
obj* lean_ir_add_decl(obj* x_1, obj* x_2) {
_start:
{
obj* x_3; obj* x_4; 
x_3 = l_Lean_IR_declMapExt;
...
if (lean::io_result_is_error(w)) return w;
l_Lean_IR_declMapExt = lean::io_result_get_value(w);

...
lean::dec(x_0);
lean::inc(x_1);
x_28 = l_Lean_Format_spaceUptoLine___main(x_22, x_1);
lean::inc(x_1);
x_30 = lean::alloc_closure(reinterpret_cast<void*>(l_Lean_Format_spaceUptoLine___main___lambda__1___boxed), 3, 2);

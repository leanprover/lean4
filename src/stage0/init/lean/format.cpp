...
namespace lean {
obj* format_pretty_aux_core(obj*, obj*);
}
...
namespace lean {
obj* format_pretty_aux_core(obj* x_1, obj* x_2) {
_start:
{
...
lean::dec(x_2);
x_4 = lean::format_pretty_aux_core(x_1, x_3);
return x_4;
}
}
}
...
x_3 = lean::format_pretty_core(x_1, x_2);
return x_3;
}
}

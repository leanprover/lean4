...
uint8 l_Lean_Level_hasMvar___main(obj* x_1) {
_start:
{
switch (lean::obj_tag(x_1)) {
case 0:
...
obj* l_Lean_Level_hasMvar___main___boxed(obj* x_1) {
_start:
{
uint8 x_2; obj* x_3; 
...
obj* l_Lean_LevelToFormat_Result_succ___main(obj* x_1) {
_start:
{
switch (lean::obj_tag(x_1)) {
case 1:
...
{
obj* x_2; 
x_2 = l_Lean_LevelToFormat_Result_succ___main(x_1);
return x_2;
}
}
obj* l_Lean_LevelToFormat_Result_max___main(obj* x_1, obj* x_2) {
_start:
{
obj* x_3; 
...
{
obj* x_3; 
x_3 = l_Lean_LevelToFormat_Result_max___main(x_1, x_2);
return x_3;
}
}
obj* l_Lean_LevelToFormat_Result_imax___main(obj* x_1, obj* x_2) {
_start:
{
obj* x_3; 
...
{
obj* x_3; 
x_3 = l_Lean_LevelToFormat_Result_imax___main(x_1, x_2);
return x_3;
}
}
obj* l_Lean_LevelToFormat_parenIfFalse___main(obj* x_1, uint8 x_2) {
_start:
{
if (x_2 == 0)
{
...
x_3 = 0;
x_4 = l_Lean_Format_paren___closed__1;
...
obj* l_Lean_LevelToFormat_parenIfFalse___main___boxed(obj* x_1, obj* x_2) {
_start:
{
uint8 x_3; obj* x_4; 
x_3 = lean::unbox(x_2);
lean::dec(x_2);
x_4 = l_Lean_LevelToFormat_parenIfFalse___main(x_1, x_3);
return x_4;
}
}
...
{
obj* x_3; 
x_3 = l_Lean_LevelToFormat_parenIfFalse___main(x_1, x_2);
return x_3;
}
}
...
x_15 = l_Lean_LevelToFormat_Result_format___main___closed__1;
...
x_20 = l_Lean_LevelToFormat_parenIfFalse___main(x_19, x_2);
return x_20;
}
else
{
...
x_24 = 0;
x_25 = l_Lean_LevelToFormat_Result_format___main___closed__2;
...
x_28 = l_Lean_LevelToFormat_parenIfFalse___main(x_27, x_2);
return x_28;
}
default: 
{
...
x_31 = 0;
x_32 = l_Lean_LevelToFormat_Result_format___main___closed__3;
x_33 = lean::alloc_cnstr(4, 2, 1);
lean::cnstr_set(x_33, 0, x_32);
lean::cnstr_set(x_33, 1, x_30);
lean::cnstr_set_scalar(x_33, sizeof(void*)*2, x_31);
x_34 = l_Lean_Format_group___main(x_33);
x_35 = l_Lean_LevelToFormat_parenIfFalse___main(x_34, x_2);
return x_35;
}
}
}
...
x_5 = l_Lean_LevelToFormat_Result_succ___main(x_4);
return x_5;
}
case 2:
{
...
x_10 = l_Lean_LevelToFormat_Result_max___main(x_8, x_9);
return x_10;
}
case 3:
{
...
x_15 = l_Lean_LevelToFormat_Result_imax___main(x_13, x_14);
return x_15;
}
default: 
{
...
x_2 = lean::alloc_closure(reinterpret_cast<void*>(l_Lean_LevelToFormat_Level_format), 1, 0);
...
if (io_result_is_error(w)) return w;
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "succ"), 1, l_Lean_Level_succ___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "max"), 2, l_Lean_Level_max___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "imax"), 2, l_Lean_Level_imax___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "Param"), 1, l_Lean_Level_Param___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Nat"), "imax"), 2, l_Lean_Nat_imax___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "toNat"), 1, l_Lean_Level_toNat___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "toOffset"), 1, l_Lean_Level_toOffset);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "instantiate"), 2, l_Lean_Level_instantiate);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "Level"), "hash"), 1, l_Lean_Level_hash___boxed);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "Result"), "succ"), 1, l_Lean_LevelToFormat_Result_succ);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "Result"), "max"), 2, l_Lean_LevelToFormat_Result_max);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "Result"), "imax"), 2, l_Lean_LevelToFormat_Result_imax);
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "parenIfFalse"), 2, l_Lean_LevelToFormat_parenIfFalse___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "Result"), "format"), 2, l_Lean_LevelToFormat_Result_format___boxed);
...
REGISTER_LEAN_FUNCTION(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name(lean::mk_const_name("Lean"), "LevelToFormat"), "Level"), "toResult"), 1, l_Lean_LevelToFormat_Level_toResult);

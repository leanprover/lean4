...
obj* l_Lean_Name_appendIndexAfter___closed__1;
...
uint8 lean_string_dec_lt(obj*, obj*);
...
obj* _init_l_Lean_Name_appendIndexAfter___closed__1() {
_start:
{
obj* x_1; 
...
lean::mark_persistent(l_Lean_Name_appendIndexAfter___closed__1);

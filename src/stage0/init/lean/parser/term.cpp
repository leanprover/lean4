...
lean::inc(x_32);
x_33 = lean_nat_dec_eq(x_32, x_10);
lean::dec(x_32);
if (x_33 == 0)
{
...
lean::inc(x_46);
x_47 = lean_nat_dec_eq(x_46, x_37);
lean::dec(x_46);
if (x_47 == 0)
{
obj* x_48; obj* x_49; 
...
lean::inc(x_53);
x_54 = lean_nat_dec_eq(x_53, x_37);
lean::dec(x_53);
if (x_54 == 0)
{
obj* x_55; obj* x_56; 
...
x_60 = lean_nat_dec_eq(x_42, x_42);
if (x_60 == 0)
{
obj* x_61; obj* x_62; 
lean::dec(x_42);
...
lean::inc(x_34);
x_35 = lean_nat_dec_eq(x_34, x_14);
lean::dec(x_34);
if (x_35 == 0)
{
obj* x_36; obj* x_37; obj* x_38; obj* x_39; 
...
if (lean::io_result_is_error(w)) return w;
l_Lean_Parser_builtinTermParsingTable = lean::io_result_get_value(w);
...
if (lean::io_result_is_error(w)) return w;
l_Lean_Parser_termParserAttribute = lean::io_result_get_value(w);

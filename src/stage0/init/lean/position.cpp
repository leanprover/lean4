...
obj* l_Lean_fmt___at_Lean_Position_Lean_HasFormat___spec__1(obj* x_0) {
_start:
{
obj* x_1; obj* x_2; 
x_1 = l_Nat_repr(x_0);
...
obj* l_Lean_Position_Lean_HasFormat(obj* x_0) {
_start:
{
...
lean::dec(x_0);
x_8 = l_String_OldIterator_hasNext___main(x_1);
if (x_8 == 0)
{
obj* x_11; 
lean::dec(x_6);
...
{
uint32 x_12; uint32 x_13; uint8 x_14; 
...
lean::inc(x_18);
x_20 = lean::nat_add(x_2, x_5);
lean::inc(x_20);
x_22 = lean::alloc_cnstr(0, 2, 0);
lean::cnstr_set(x_22, 0, x_18);
lean::cnstr_set(x_22, 1, x_20);
x_23 = l___private_init_lean_position_1__fromStringAux___main(x_6, x_17, x_20);
lean::dec(x_20);

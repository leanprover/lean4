...
def whereStructInst  := leading_parser " where" >> sepBy1Indent (ppLine >> ppGroup (whereStructField)) ";" semicolonOrLinebreak (allowTrailingSep := true) >> optional Term.whereDecls
/-

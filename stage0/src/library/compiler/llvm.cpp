...
extern "C" LEAN_EXPORT lean_object *lean_llvm_write_bitcode_to_file(
    size_t ctx, size_t mod, lean_object *filepath, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_clear_insertion_position(
    size_t ctx, size_t builder, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_call(
    size_t ctc, size_t builder, size_t fnval, lean_object *args,
    lean_object *name, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_cond_br(
    size_t ctx, size_t builder, size_t if_, size_t thenbb, size_t elsebb,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_br(size_t ctx,
                                                       size_t builder,
                                                       size_t bb,
                                                       lean_object * /* w */) {
#ifndef LEAN_LLVM
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_store(
    size_t ctx, size_t builder, size_t v, size_t slot, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_load(
    size_t ctx, size_t builder, size_t slot, lean_object *name,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_alloca(
    size_t ctx, size_t builder, size_t type, lean_object *name,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_ret(size_t ctx,
                                                        size_t builder,
                                                        size_t v,
                                                        lean_object * /* w */) {
#ifndef LEAN_LLVM
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_inbounds_gep(
    size_t ctx, size_t builder, size_t pointer, lean_object *indices,
    lean_object *name, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_gep(
    size_t ctx, size_t builder, size_t pointer, lean_object *indices,
    lean_object *name, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_pointer_cast(
    size_t ctx, size_t builder, size_t val, size_t destty, lean_object *name,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_switch(
    size_t ctx, size_t builder, size_t val, size_t elsebb, uint64_t numCases,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_ptr_to_int(
    size_t ctx, size_t builder, size_t ptr, size_t destty, lean_object *name,
    lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_add(size_t ctx,
                                                        size_t builder,
                                                        size_t lhs, size_t rhs,
                                                        lean_object *name,
                                                        lean_object * /* w */) {
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_sub(size_t ctx,
                                                        size_t builder,
                                                        size_t lhs, size_t rhs,
                                                        lean_object *name,
                                                        lean_object * /* w */) {
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_not(size_t ctx,
                                                        size_t builder,
                                                        size_t v,
                                                        lean_object *name,
                                                        lean_object * /* w */) {
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_build_icmp(
    size_t ctx, size_t builder, uint64_t predicate, size_t x, size_t y,
    lean_object *name, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_add_case(size_t ctx,
                                                       size_t switch_,
                                                       size_t onVal,
                                                       size_t destbb,
                                                       lean_object * /* w */) {
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_basic_block_parent(
    size_t ctx, size_t bb, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_print_module_to_file(
    size_t ctx, size_t mod, lean_object *file, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_const_int(size_t ctx, size_t ty,
                                                        uint64_t val,
                                                        uint8_t sext,
                                                        lean_object * /* w */) {
#ifndef LEAN_LLVM
...
extern "C" LEAN_EXPORT lean_object *llvm_get_param(size_t ctx, size_t f,
                                                   uint64_t ix,
                                                   lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
...
lean_llvm_create_memory_buffer_with_contents_of_file(size_t ctx,
                                                     lean_object *path,
                                                     lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_link_modules(
    size_t ctx, size_t dest_module, size_t src_module, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_create_target_machine(
    size_t ctx, size_t target, lean_object *tripleStr, lean_object *cpuStr,
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_get_target_from_triple(
    size_t ctx, lean_object *triple, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_target_machine_emit_to_file(
    size_t ctx, size_t target_machine, size_t module, lean_object *filepath,
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_create_pass_manager(
    size_t ctx, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
#else
  return lean_io_result_mk_ok(
      lean_box_usize(PassManager_to_lean(LLVMCreatePassManager())));
#endif  // LEAN_LLVM
}

extern "C" LEAN_EXPORT lean_object *lean_llvm_run_pass_manager(
    size_t ctx, size_t pm, size_t mod, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_dispose_pass_manager(
    size_t ctx, size_t pm, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_create_pass_manager_builder(
    size_t ctx, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
...
#else
  return lean_io_result_mk_ok(lean_box_usize(
      PassManagerBuilder_to_lean(LLVMPassManagerBuilderCreate())));
#endif  // LEAN_LLVM
}

extern "C" LEAN_EXPORT lean_object *lean_llvm_dispose_pass_manager_builder(
    size_t ctx, size_t pmb, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *
lean_llvm_pass_manager_builder_set_opt_level(size_t ctx, size_t pmb,
                                             unsigned opt_level,
                                             lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
...
extern "C" LEAN_EXPORT lean_object *
lean_llvm_pass_manager_builder_populate_module_pass_manager(
    size_t ctx, size_t pmb, size_t pm, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
  ...
  LLVMPassManagerBuilderPopulateModulePassManager(
      lean_to_PassManagerBuilder(pmb), lean_to_PassManager(pm));
  return lean_io_result_mk_ok(lean_box(0));
#endif  // LEAN_LLVM
}

extern "C" LEAN_EXPORT lean_object *lean_llvm_dispose_target_machine(
    size_t ctx, size_t tm, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "
                "the LLVM backend function."));
...
extern "C" LEAN_EXPORT lean_object *lean_llvm_dispose_module(
    size_t ctx, size_t mod, lean_object * /* w */) {
#ifndef LEAN_LLVM
  lean_always_assert(
      false && ("Please build a version of Lean4 with -DLLVM=ON to invoke "

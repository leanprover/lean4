...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("Bootstrap.Data.RBMap", 20);
return x_1;
}
}
...
LEAN_EXPORT lean_object* initialize_Bootstrap_Data_RBMap(uint8_t builtin, lean_object* w) {
lean_object * res;

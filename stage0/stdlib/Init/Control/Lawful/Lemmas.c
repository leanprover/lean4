...
// Imports: public import Init.Control.Lawful.Basic public import Init.ByCases
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Control_Lawful_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;

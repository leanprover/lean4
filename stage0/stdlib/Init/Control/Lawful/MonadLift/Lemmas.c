...
// Imports: public import Init.Control.Lawful.Basic public import Init.Control.Lawful.MonadLift.Basic import Init.Ext
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Control_Lawful_MonadLift_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Control_Lawful_MonadLift_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Control_Lawful_MonadLift_Lemmas(uint8_t builtin) {
lean_object * res;

...
// Imports: public import Init.Data.Array.Lemmas public import Init.Data.List.Nat.InsertIdx
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Array_InsertIdx(uint8_t builtin, lean_object* w) {
lean_object * res;

...
lean_object* runtime_initialize_Init_Data_Dyadic_Round(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Dyadic_Inv(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Dyadic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Dyadic(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Init_Data_Dyadic_Inv(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Init_Data_Dyadic(uint8_t builtin) {
lean_object * res;

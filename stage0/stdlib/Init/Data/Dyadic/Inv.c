...
// Imports: import Init.Data.Dyadic.Basic import Init.Data.Dyadic.Round import Init.Grind.Ordered.Ring
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Dyadic_Inv(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Imports: public import Init.Data.Nat.Bitwise public import Init.Data.Fin.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Fin_Bitwise(uint8_t builtin, lean_object* w) {
lean_object * res;

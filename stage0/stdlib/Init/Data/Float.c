...
// Imports: public import Init.Data.Float.Float public import Init.Data.Float.Float32 public import Init.Data.Float.Model
#include <lean/lean.h>
...
lean_object* runtime_initialize_Init_Data_Float_Model(uint8_t builtin);
...
lean_object* initialize_Init_Data_Float_Model(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Init_Data_Float_Model(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

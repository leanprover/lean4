...
// Module: Init.Data.Float.Model.Unpacked
// Imports: public import Init.Data.Float.Model.Unpacked.Basic public import Init.Data.Float.Model.Unpacked.Sign public import Init.Data.Float.Model.Unpacked.Round public import Init.Data.Float.Model.Unpacked.Pack public import Init.Data.Float.Model.Unpacked.Operations
#include <lean/lean.h>
...
lean_object* runtime_initialize_Init_Data_Float_Model_Unpacked_Pack(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Float_Model_Unpacked_Operations(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Float_Model_Unpacked(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Float_Model_Unpacked(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Init_Data_Float_Model_Unpacked_Pack(uint8_t builtin);
lean_object* initialize_Init_Data_Float_Model_Unpacked_Operations(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Init_Data_Float_Model_Unpacked(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Init_Data_Float_Model_Unpacked_Pack(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_Float_Model_Unpacked(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_Float_Model_Unpacked(builtin);
}
#ifdef __cplusplus
}
#endif

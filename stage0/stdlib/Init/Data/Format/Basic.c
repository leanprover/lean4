...
if (v___x_673_ == 0)
{
lean_dec_ref_known(v_____x_670_, 2);
...
lean_dec_ref_known(v_fst_1320_, 2);
...
lean_dec_ref_known(v_f_1221_, 0);
...
lean_inc(v_f_1419_);
lean_dec_ref_known(v_f_1221_, 2);

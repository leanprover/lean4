...
// Imports: public import Init.Data.Ord.Basic public import Init.Data.Order.ClassesExtra import all Init.Data.Ord.Basic import Init.Omega
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Int_Compare(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Int_Compare(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_Int_Compare(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_Int_Compare(builtin);
}
#ifdef __cplusplus
}
#endif

...
// Module: Init.Data.Int.Cutsat
// Imports: Init.Data.AC Init.Data.Int.Gcd
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Int_Cutsat(uint8_t builtin, lean_object* w) {
lean_object * res;

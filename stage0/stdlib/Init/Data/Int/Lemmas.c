...
// Imports: public import Init.Conv public import Init.NotationExtra public import Init.PropLemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Int_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;

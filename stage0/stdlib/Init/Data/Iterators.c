...
lean_object* runtime_initialize_Init_Data_Iterators_Producers(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Iterators_Combinators(uint8_t builtin);
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Iterators(uint8_t builtin) {
lean_object * res;

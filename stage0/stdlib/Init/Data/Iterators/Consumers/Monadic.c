...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Iterators_Consumers_Monadic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Iterators_Consumers_Monadic(uint8_t builtin) {
lean_object * res;

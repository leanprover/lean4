...
LEAN_EXPORT lean_object* l_Std_IterM_ensureTermination___redArg(lean_object* v_it_1_){
_start:
{
lean_inc(v_it_1_);
return v_it_1_;
...
LEAN_EXPORT lean_object* l_Std_IterM_ensureTermination___redArg___boxed(lean_object* v_it_2_){
_start:
{
lean_object* v_res_3_; 
v_res_3_ = l_Std_IterM_ensureTermination___redArg(v_it_2_);
lean_dec(v_it_2_);
return v_res_3_;
}
}
LEAN_EXPORT lean_object* l_Std_IterM_ensureTermination(lean_object* v_00_u03b1_4_, lean_object* v_00_u03b2_5_, lean_object* v_m_6_, lean_object* v_it_7_){
_start:
{
lean_inc(v_it_7_);
return v_it_7_;
...
LEAN_EXPORT lean_object* l_Std_IterM_ensureTermination___boxed(lean_object* v_00_u03b1_8_, lean_object* v_00_u03b2_9_, lean_object* v_m_10_, lean_object* v_it_11_){
_start:
{
lean_object* v_res_12_; 
v_res_12_ = l_Std_IterM_ensureTermination(v_00_u03b1_8_, v_00_u03b2_9_, v_m_10_, v_it_11_);
lean_dec(v_it_11_);
return v_res_12_;
}
}
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Iterators_Consumers_Monadic_Total(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Iterators_Consumers_Monadic_Total(uint8_t builtin) {
lean_object * res;

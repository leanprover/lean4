...
lean_object* runtime_initialize_Init_Data_List_MinMaxIdx(uint8_t builtin);
...
lean_object* runtime_initialize_Init_Data_List_Nat(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_List_Int(uint8_t builtin);
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_List(uint8_t builtin) {
lean_object * res;

...
// Module: Init.Data.List.Int.Prod
// Imports: import Init.Data.List.Lemmas import Init.Data.Int.Lemmas public import Init.Data.Int.Pow public import Init.Data.List.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_List_Int_Prod(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_List_Int_Prod(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_Int_Prod(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_List_Int_Prod(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_List_Int_Prod(builtin);
}
#ifdef __cplusplus
}
#endif

...
// Imports: Init.Data.Array.Lemmas Init.Data.List.Nat.Range
#include <lean/lean.h>
...
static lean_object* l_List_mapIdx___rarg___closed__1;
...
static lean_object* _init_l_List_mapIdx___rarg___closed__1() {
_start:
{
...
x_3 = l_List_mapIdx___rarg___closed__1;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
l_List_mapIdx___rarg___closed__1 = _init_l_List_mapIdx___rarg___closed__1();
lean_mark_persistent(l_List_mapIdx___rarg___closed__1);

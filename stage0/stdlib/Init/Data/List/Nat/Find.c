...
// Imports: public import Init.Data.List.Nat.Range public import Init.Data.List.Find
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_Nat_Find(uint8_t builtin, lean_object* w) {
lean_object * res;

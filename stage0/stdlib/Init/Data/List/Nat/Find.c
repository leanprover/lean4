...
// Imports: public import Init.BinderPredicates public import Init.NotationExtra import Init.Data.List.Find import Init.Data.List.Nat.Range import Init.Data.List.Nat.TakeDrop import Init.Data.List.TakeDrop import Init.Data.Option.Lemmas import Init.Data.Prod import Init.Omega
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_List_Nat_Find(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_List_Nat_Find(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_Nat_Find(uint8_t builtin) {
lean_object * res;

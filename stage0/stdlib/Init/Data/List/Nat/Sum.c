...
// Imports: import Init.Data.List.MinMax public import Init.BinderPredicates public import Init.NotationExtra import Init.Data.Nat.Div.Lemmas import Init.Data.Nat.Lemmas import Init.Data.Nat.MinMax import Init.Data.Option.Lemmas import Init.Omega
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_List_Nat_Sum(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_List_Nat_Sum(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_Nat_Sum(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_List_Nat_Sum(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_List_Nat_Sum(builtin);
}
#ifdef __cplusplus
}
#endif

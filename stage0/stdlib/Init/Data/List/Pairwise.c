...
// Imports: public import Init.Data.List.Sublist public import Init.Data.List.Attach
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_Pairwise(uint8_t builtin, lean_object* w) {
lean_object * res;

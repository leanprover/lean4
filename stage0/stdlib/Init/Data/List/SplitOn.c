...
// Imports: public import Init.Data.List.SplitOn.Basic public import Init.Data.List.SplitOn.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_List_SplitOn(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_List_SplitOn(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_List_SplitOn(uint8_t builtin) {
lean_object * res;

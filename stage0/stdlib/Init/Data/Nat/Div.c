...
// Imports: public import Init.Data.Nat.Div.Basic public import Init.Data.Nat.Div.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Nat_Div(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Nat_Div(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_Nat_Div(uint8_t builtin) {
lean_object * res;

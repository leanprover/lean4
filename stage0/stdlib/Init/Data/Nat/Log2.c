...
// Imports: public import Init.Grind.Tactics import Init.Data.Nat.Div.Basic import Init.NotationExtra import Init.WFTactics
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Nat_Log2(uint8_t builtin) {
lean_object * res;

...
// Module: Init.Data.Nat.Order
// Imports: public import Init.Data.Nat.Basic import Init.Data.Nat.MinMax public import Init.Data.Order.Classes import Init.Data.Order.Factories import Init.NotationExtra
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Nat_Order(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Nat_Order(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_Nat_Order(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_Nat_Order(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_Nat_Order(builtin);
}
#ifdef __cplusplus
}
#endif

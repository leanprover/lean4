...
// Imports: public import Init.Data.Nat.Power2.Basic public import Init.Data.Nat.Power2.Lemmas public import Init.Data.Nat.Power2.Bitwise
#include <lean/lean.h>
...
lean_object* runtime_initialize_Init_Data_Nat_Power2_Bitwise(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Nat_Power2(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Nat_Power2(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Init_Data_Nat_Power2_Bitwise(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Init_Data_Nat_Power2_Bitwise(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

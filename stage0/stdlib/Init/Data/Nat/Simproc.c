...
// Imports: public import Init.Data.Bool public import Init.Data.Nat.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Nat_Simproc(uint8_t builtin, lean_object* w) {
lean_object * res;

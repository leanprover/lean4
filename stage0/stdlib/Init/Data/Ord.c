...
lean_object* runtime_initialize_Init_Data_Ord_BitVec(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Ord_SInt(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Ord(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Ord(uint8_t builtin) {
lean_object * res;

...
// Imports: public import Init.Data.Order.Ord public import Init.Data.BitVec.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Ord_BitVec(uint8_t builtin, lean_object* w) {
lean_object * res;

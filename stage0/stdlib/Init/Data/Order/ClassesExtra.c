...
// Imports: public import Init.Data.Order.Classes public import Init.Data.Ord.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Order_ClassesExtra(uint8_t builtin, lean_object* w) {
lean_object * res;

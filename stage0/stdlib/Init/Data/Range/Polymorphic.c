...
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_Char(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_Nat(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_Int(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_BitVec(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_UInt(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_SInt(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_NatLemmas(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_IntLemmas(uint8_t builtin);
lean_object* runtime_initialize_Init_Data_Range_Polymorphic_GetElemTactic(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Range_Polymorphic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Range_Polymorphic(uint8_t builtin) {
lean_object * res;

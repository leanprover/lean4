...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Slice_InternalLemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Slice_InternalLemmas(uint8_t builtin) {
lean_object * res;

...
// Imports: Init.Data.Slice.Operations Init.Data.Iterators.Lemmas.Consumers
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Slice_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Imports: public import Init.Data.Slice.Operations import all Init.Data.Slice.Operations import Init.Data.Iterators.Lemmas.Consumers public import Init.Data.List.Control public import Init.Data.Iterators.Consumers.Collect import Init.Data.Slice.InternalLemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Slice_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Slice_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_Slice_Lemmas(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_Slice_Lemmas(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_Slice_Lemmas(builtin);
}
#ifdef __cplusplus
}
#endif

...
lean_object* runtime_initialize_Init_Data_String_Iterator(uint8_t builtin);
...
lean_object* runtime_initialize_Init_Data_String_Stream(uint8_t builtin);
...
lean_object* runtime_initialize_Init_Data_String_Legacy(uint8_t builtin);
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_String(uint8_t builtin) {
lean_object * res;

...
x_5 = lean_obj_once(&l_Std_Iter_toStringList___redArg___closed__0, &l_Std_Iter_toStringList___redArg___closed__0_once, _init_l_Std_Iter_toStringList___redArg___closed__0);
...
x_7 = lean_obj_once(&l_Std_Iter_toStringList___redArg___closed__0, &l_Std_Iter_toStringList___redArg___closed__0_once, _init_l_Std_Iter_toStringList___redArg___closed__0);
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_String_Iter(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_String_Iter(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_String_Iter(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_String_Iter(builtin);
}
#ifdef __cplusplus
}
#endif

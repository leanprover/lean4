...
// Imports: Init.Data.ToString.Basic Init.Data.ToString.Macro Init.Data.ToString.Name
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_ToString(uint8_t builtin, lean_object* w) {
lean_object * res;

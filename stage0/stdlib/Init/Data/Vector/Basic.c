...
lean_dec_ref_known(v_this_1764_, 2);
...
lean_dec_ref_known(v_this_1795_, 2);
...
lean_dec_ref_known(v_fst_2366_, 1);
return v_val_2367_;
}
}
}
...
lean_dec_ref_known(v_fst_2426_, 1);
return v_val_2427_;
}
}
}
...
lean_dec_ref_known(v_fst_3178_, 1);

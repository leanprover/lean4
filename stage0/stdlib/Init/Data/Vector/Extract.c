...
// Imports: public import Init.Data.Vector.Lemmas public import Init.Data.Array.Extract
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Data_Vector_Extract(uint8_t builtin, lean_object* w) {
lean_object * res;

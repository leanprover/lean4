...
// Imports: public import Init.Data.Array.FinRange public import Init.Data.Vector.OfFn
#include <lean/lean.h>
...
extern "C" {
#endif
static lean_object* l_Vector_finRange___closed__0;
...
static lean_object* _init_l_Vector_finRange___closed__0() {
_start:
{
lean_object* x_1; 
x_1 = lean_alloc_closure((void*)(l_Vector_finRange___lam__0___boxed), 1, 0);
return x_1;
}
}
...
x_2 = l_Vector_finRange___closed__0;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
l_Vector_finRange___closed__0 = _init_l_Vector_finRange___closed__0();
lean_mark_persistent(l_Vector_finRange___closed__0);

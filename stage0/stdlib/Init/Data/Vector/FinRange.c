...
LEAN_EXPORT lean_object* l_Vector_finRange___lam__0(lean_object* v_i_1_){
_start:
{
lean_inc(v_i_1_);
return v_i_1_;
...
LEAN_EXPORT lean_object* l_Vector_finRange___lam__0___boxed(lean_object* v_i_2_){
_start:
{
lean_object* v_res_3_; 
v_res_3_ = l_Vector_finRange___lam__0(v_i_2_);
lean_dec(v_i_2_);
return v_res_3_;
}
}
LEAN_EXPORT lean_object* l_Vector_finRange(lean_object* v_n_5_){
_start:
{
lean_object* v___f_6_; lean_object* v___x_7_; 
v___f_6_ = ((lean_object*)(l_Vector_finRange___closed__0));
...
lean_object* runtime_initialize_Init_Data_Vector_OfFn(uint8_t builtin);
lean_object* runtime_initialize_Init_Omega(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Vector_FinRange(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Vector_FinRange(uint8_t builtin) {
lean_object * res;

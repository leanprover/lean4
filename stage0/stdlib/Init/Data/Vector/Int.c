...
// Module: Init.Data.Vector.Int
// Imports: public import Init.Data.Vector.Basic import Init.Data.Array.Int import Init.Data.Int.Lemmas import Init.Data.Vector.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Data_Vector_Int(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = runtime_initialize_Init_Data_Array_Int(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
LEAN_EXPORT lean_object* meta_initialize_Init_Data_Vector_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Data_Vector_Int(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Data_Vector_Int(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Data_Vector_Int(builtin);
}
#ifdef __cplusplus
}
#endif

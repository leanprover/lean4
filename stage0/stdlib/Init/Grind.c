...
lean_object* runtime_initialize_Init_Grind_Cases(uint8_t builtin);
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Init_Grind_Homo(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Init_Grind_Homo(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

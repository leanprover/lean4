...
// Module: Init.Grind.Homo.Fin
// Imports: import Init.Grind.Attr public import Init.Data.Fin.Lemmas public import Init.Data.Fin.Bitwise
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Homo_Fin(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Homo_Fin(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Homo_Fin(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Grind_Homo_Fin(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Grind_Homo_Fin(builtin);
}
#ifdef __cplusplus
}
#endif

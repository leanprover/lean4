...
// Module: Init.Grind.Homo.Int
// Imports: import Init.Grind.Attr public import Init.Data.Int.Lemmas public import Init.Data.Int.Order public import Init.Data.Int.LemmasAux public import Init.Data.Int.Pow public import Init.Data.Int.Bitwise.Lemmas public import Init.Data.Int.DivMod.Bootstrap public import Init.Data.Int.DivMod.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Homo_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Homo_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Homo_Int(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Grind_Homo_Int(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Grind_Homo_Int(builtin);
}
#ifdef __cplusplus
}
#endif

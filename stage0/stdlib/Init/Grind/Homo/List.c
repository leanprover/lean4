...
// Module: Init.Grind.Homo.List
// Imports: import Init.Grind.Attr public import Init.Data.List.Lemmas public import Init.Data.List.TakeDrop public import Init.Data.List.Nat.TakeDrop public import Init.Data.List.Nat.InsertIdx public import Init.Data.List.Nat.Modify public import Init.Data.List.Erase public import Init.Data.List.Zip
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Homo_List(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Homo_List(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Homo_List(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Grind_Homo_List(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Grind_Homo_List(builtin);
}
#ifdef __cplusplus
}
#endif

...
// Module: Init.Grind.Homo.Nat
// Imports: import Init.Grind.Attr public import Init.Data.Nat.Lemmas public import Init.Data.Nat.Bitwise.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Homo_Nat(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Homo_Nat(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Homo_Nat(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Grind_Homo_Nat(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Grind_Homo_Nat(builtin);
}
#ifdef __cplusplus
}
#endif

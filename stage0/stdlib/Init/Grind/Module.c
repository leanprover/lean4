...
// Imports: Init.Grind.Module.Basic Init.Grind.Module.Int
#include <lean/lean.h>
...
lean_object* initialize_Init_Grind_Module_Int(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_Init_Grind_Module_Int(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

...
// Imports: public import Init.Grind.Ordered.Ring public import Init.GrindInstances.Ring.Int import Init.Omega
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Ordered_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Ordered_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ordered_Int(uint8_t builtin) {
lean_object * res;

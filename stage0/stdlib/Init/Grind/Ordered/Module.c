...
// Imports: Init.Data.Int.Order Init.Grind.Module.Basic Init.Grind.Ordered.PartialOrder
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ordered_Module(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Imports: public import Init.Data.Int.Order public import Init.Data.Order.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ordered_Order(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Init.Grind.Ordered.Ring
// Imports: public import Init.Grind.Ring.Basic public import Init.Grind.Ordered.Module import Init.Data.Nat.Lemmas import Init.Grind.Ordered.Order import Init.Omega import Init.RCases
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Ordered_Ring(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Ordered_Ring(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ordered_Ring(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Init_Grind_Ordered_Ring(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Init_Grind_Ordered_Ring(builtin);
}
#ifdef __cplusplus
}
#endif

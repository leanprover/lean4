...
// Imports: public import Init.Grind.Ring.Basic public import Init.Grind.Ordered.Module
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ordered_Ring(uint8_t builtin, lean_object* w) {
lean_object * res;

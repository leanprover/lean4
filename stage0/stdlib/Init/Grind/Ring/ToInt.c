...
// Imports: public import Init.Grind.Ring.Basic import Init.Conv import Init.Data.Int.Pow
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Grind_Ring_ToInt(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Grind_Ring_ToInt(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ring_ToInt(uint8_t builtin) {
lean_object * res;

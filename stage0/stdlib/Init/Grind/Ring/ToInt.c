...
// Imports: public import Init.Grind.Ring.Basic public import Init.Grind.ToInt
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Init_Grind_Ring_ToInt(uint8_t builtin, lean_object* w) {
lean_object * res;

...
LEAN_EXPORT lean_object* runtime_initialize_Init_GrindInstances_Nat(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_GrindInstances_Nat(uint8_t builtin) {
lean_object * res;

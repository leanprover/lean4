...
// Module: Init.Lean.Elab.Basic
// Imports: Init.Control.Reader Init.Lean.Meta Init.Lean.Parser.Module
...
lean_object* initialize_Init_Lean_Elab_Basic(lean_object* w) {
lean_object * res;

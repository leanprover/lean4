...
{
uint8_t x_55; 
x_55 = lean_ctor_get_uint8(x_35, sizeof(void*)*1);
if (x_55 == 0)
{
uint8_t x_56; 
x_56 = lean_ctor_get_uint8(x_35, sizeof(void*)*1 + 1);
lean_dec(x_35);
x_36 = x_56;
goto block_54;
}
...
x_41 = lean_array_fget(x_8, x_16);
x_42 = l_Lean_Expr_Inhabited___closed__1;
x_43 = lean_array_fset(x_8, x_16, x_42);
lean_inc(x_9);
x_44 = l_Lean_Meta_reduceAux___main(x_1, x_2, x_3, x_41, x_9, x_10);
...
lean_inc(x_46);
lean_dec(x_44);
x_47 = lean_array_fset(x_43, x_16, x_45);
lean_dec(x_16);
x_7 = x_14;
x_8 = x_47;
x_10 = x_46;

...
lean_inc(x_26);
lean_dec(x_15);
x_29 = l_List_reverse___rarg(x_26);
x_30 = lean_alloc_ctor(0, 3, 0);
...
lean_inc(x_31);
lean_dec(x_13);
x_33 = l_Lean_Expr_getAppFn___main(x_4);
lean_dec(x_4);
...
lean_inc(x_35);
x_36 = l_Lean_Meta_SynthInstance_inferTCGoalsLRAttr;
x_37 = l_Lean_TagAttribute_hasTag(x_36, x_35, x_34);
lean_dec(x_34);
lean_dec(x_35);

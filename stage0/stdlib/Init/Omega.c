...
lean_object* runtime_initialize_Init_Omega_LinearCombo(uint8_t builtin);
lean_object* runtime_initialize_Init_Omega_Constraint(uint8_t builtin);
lean_object* runtime_initialize_Init_Omega_Logic(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Init_Omega(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Init_Omega(uint8_t builtin) {
lean_object * res;

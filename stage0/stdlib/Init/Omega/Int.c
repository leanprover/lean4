...
v___x_22_ = l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___redArg(v_n_19_, v_h__1_20_, v_h__2_21_);
return v___x_22_;
}
}
LEAN_EXPORT lean_object* l___private_Init_Omega_Int_0__Int_neg_match__1_splitter___boxed(lean_object* v_motive_23_, lean_object* v_n_24_, lean_object* v_h__1_25_, lean_object* v_h__2_26_){
_start:
{
lean_object* v_res_27_; 
v_res_27_ = l___private_Init_Omega_Int_0__Int_neg_match__1_splitter(v_motive_23_, v_n_24_, v_h__1_25_, v_h__2_26_);
lean_dec(v_n_24_);
return v_res_27_;
}
}

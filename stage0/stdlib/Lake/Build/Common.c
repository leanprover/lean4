...
{
lean_object* x_5; lean_object* x_6; uint64_t x_7; uint64_t x_8; uint8_t x_9; 
...
lean_ctor_set(x_62, 0, x_61);
x_63 = l_Lake_CacheMap_insertCore(x_51, x_62, x_56);
...
x_190 = l_Lake_CacheMap_insertCore(x_178, x_189, x_183);
x_191 = lean_st_ref_set(x_180, x_190);
lean_dec(x_180);
x_14 = x_184;
x_15 = x_182;
x_16 = x_181;
...
{
uint8_t x_30; 
x_30 = lean_nat_dec_le(x_29, x_25);
if (x_30 == 0)
{
lean_dec(x_25);
lean_inc(x_29);

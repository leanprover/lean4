...
v___x_289_ = lean_st_ref_put(v_registeredJobs_278_, v___x_288_);
...
v___x_408_ = lean_nat_add(v___y_406_, v___y_407_);
lean_dec(v___y_407_);
lean_dec(v___y_406_);
...
lean_ctor_set(v___x_388_, 3, v___y_405_);
...
lean_ctor_set(v_reuseFailAlloc_413_, 3, v___y_405_);

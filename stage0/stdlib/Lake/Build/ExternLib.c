...
v___x_463_ = lean_st_ref_put(v_registeredJobs_450_, v___x_462_);
...
v___x_683_ = lean_st_ref_put(v_registeredJobs_670_, v___x_682_);
...
v___x_803_ = lean_nat_add(v___y_801_, v___y_802_);
lean_dec(v___y_802_);
lean_dec(v___y_801_);
...
lean_ctor_set(v___x_783_, 3, v___y_800_);
...
lean_ctor_set(v_reuseFailAlloc_808_, 3, v___y_800_);

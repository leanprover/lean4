...
lean_inc(x_519);
x_520 = l_Lake_joinRelative(x_517, x_519);
lean_dec(x_519);
x_521 = lean_ctor_get(x_518, 8);
lean_inc(x_521);
x_522 = l_Lake_joinRelative(x_520, x_521);
lean_dec(x_521);
x_523 = l_Lake_nameToSharedLib(x_516);
x_524 = l_Lake_joinRelative(x_522, x_523);
lean_dec(x_523);

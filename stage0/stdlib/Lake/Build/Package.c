...
// Imports: Lake.Util.Name Lake.Config.FacetConfig Lake.Build.Job.Monad Lake.Build.Infos Lake.Util.Git Lake.Util.Url Lake.Util.Proc Lake.Build.Actions Lake.Build.Common Lake.Build.Targets Lake.Build.Topological Lake.Build.Job.Register Lake.Reservoir
#include <lean/lean.h>
...
x_26 = lean_apply_7(x_2, x_25, x_3, x_4, x_5, x_6, x_19, x_21);
return x_26;
}
block_37:
{
...
lean_inc_ref(x_20);
x_31 = l_Lake_GitRepo_findTag_x3f(x_30, x_20, x_25);
x_32 = lean_ctor_get(x_31, 0);
lean_inc(x_32);
...
x_45 = 1;
x_46 = l_Lake_untar(x_3, x_42, x_45, x_41, x_40);
...
x_161 = 1;
x_162 = l_Lake_untar(x_3, x_158, x_161, x_157, x_156);

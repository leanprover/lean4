...
LEAN_EXPORT lean_object* runtime_initialize_Lake_Build_Target(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lake_Build_Target(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lake_Build_Target(uint8_t builtin) {
lean_object * res;

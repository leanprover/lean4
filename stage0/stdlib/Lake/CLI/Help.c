...
{
lean_object* x_1; 
x_1 = lean_mk_string_from_bytes("Run the workspace's test script or executable\n\nUSAGE:\n  lake test [-- <args>...]\n\nLooks for a script or executable tagged `@[test_runner]` in the workspace's\nroot package and executes it with `args`. ", 200);
return x_1;
}
}
...
x_22 = l_Lake_helpScript___closed__2;
...
{
lean_object* x_37; 
x_37 = l_Lake_helpTranslateConfig;
return x_37;
}
}
else

...
lean_inc(x_61);
lean_dec_ref(x_59);
x_62 = l_Lean_instToJsonModuleSetup_toJson(x_61);
...
x_150 = l_Lean_instToJsonModuleSetup_toJson(x_149);
...
lean_inc(x_205);
lean_dec_ref(x_203);
x_206 = l_Lean_instToJsonModuleSetup_toJson(x_205);
...
x_284 = l_Lean_instToJsonModuleSetup_toJson(x_283);

...
lean_inc(x_174);
lean_dec(x_172);
x_175 = l_Lean_Kernel_Environment_isDiagnosticsEnabled(x_174);
lean_dec(x_174);
if (x_175 == 0)
{
uint8_t x_254; 
...
x_184 = l_Lean_Kernel_Environment_enableDiag(x_181, x_183);
...
x_215 = l_Lean_Kernel_Environment_enableDiag(x_207, x_214);

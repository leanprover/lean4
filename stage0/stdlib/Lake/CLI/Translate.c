...
lean_dec(x_122);
x_123 = l_Lean_Kernel_enableDiag(x_121, x_58);
...
lean_inc(x_126);
lean_dec(x_118);
x_134 = l_Lean_Kernel_enableDiag(x_126, x_58);
...
x_157 = l_Lake_Package_mkConfigString___closed__38;

...
{
lean_object* v_a_168_; lean_object* v___x_169_; lean_object* v___x_170_; lean_object* v___x_171_; lean_object* v___x_172_; lean_object* v___x_173_; lean_object* v___x_174_; lean_object* v___x_175_; lean_object* v___x_176_; lean_object* v___x_177_; lean_object* v___x_178_; lean_object* v___x_179_; lean_object* v___x_180_; lean_object* v___x_181_; lean_object* v___x_182_; lean_object* v___x_183_; lean_object* v___x_184_; lean_object* v___x_185_; lean_object* v___x_186_; lean_object* v_env_187_; lean_object* v___x_188_; lean_object* v___x_189_; lean_object* v___x_190_; lean_object* v___x_191_; lean_object* v___x_192_; lean_object* v___x_193_; lean_object* v___x_194_; uint8_t v___x_195_; lean_object* v_fileName_197_; lean_object* v_fileMap_198_; lean_object* v_currNamespace_199_; lean_object* v_openDecls_200_; lean_object* v_initHeartbeats_201_; lean_object* v_maxHeartbeats_202_; lean_object* v_quotContext_203_; lean_object* v_currMacroScope_204_; lean_object* v_cancelTk_x3f_205_; lean_object* v_inheritedTraceOptions_206_; lean_object* v_currRecDepth_207_; lean_object* v_ref_208_; uint8_t v_suppressElabErrors_209_; lean_object* v___y_210_; uint8_t v___y_245_; uint8_t v___x_265_; 
...
v___x_190_ = lean_obj_once(&l_Lake_Package_mkConfigString___closed__20, &l_Lake_Package_mkConfigString___closed__20_once, _init_l_Lake_Package_mkConfigString___closed__20);
...
v___x_265_ = l_Lean_Kernel_isDiagnosticsEnabled(v_env_187_);
...
v_currNamespace_199_ = v___x_176_;
v_openDecls_200_ = v___x_177_;
v_initHeartbeats_201_ = v___x_172_;
v_maxHeartbeats_202_ = v___x_190_;
v_quotContext_203_ = v___x_176_;
v_currMacroScope_204_ = v___x_173_;
v_cancelTk_x3f_205_ = v___x_191_;
v_inheritedTraceOptions_206_ = v___x_185_;
v_currRecDepth_207_ = v___x_169_;
v_ref_208_ = v___x_192_;
v_suppressElabErrors_209_ = v___x_162_;
v___y_210_ = v___x_183_;
goto v___jp_196_;
}
else
{
v___y_245_ = v___x_195_;
goto v___jp_244_;
}
}
else
{
v___y_245_ = v___x_265_;
goto v___jp_244_;
}
v___jp_196_:
{
...
lean_ctor_set(v___x_212_, 4, v_currNamespace_199_);
lean_ctor_set(v___x_212_, 5, v_openDecls_200_);
lean_ctor_set(v___x_212_, 6, v_initHeartbeats_201_);
lean_ctor_set(v___x_212_, 7, v_maxHeartbeats_202_);
lean_ctor_set(v___x_212_, 8, v_quotContext_203_);
lean_ctor_set(v___x_212_, 9, v_currMacroScope_204_);
lean_ctor_set(v___x_212_, 10, v_cancelTk_x3f_205_);
lean_ctor_set(v___x_212_, 11, v_inheritedTraceOptions_206_);
lean_inc(v_ref_208_);
v___x_213_ = lean_alloc_ctor(0, 3, 2);
lean_ctor_set(v___x_213_, 0, v___x_212_);
lean_ctor_set(v___x_213_, 1, v_currRecDepth_207_);
lean_ctor_set(v___x_213_, 2, v_ref_208_);
lean_ctor_set_uint8(v___x_213_, sizeof(void*)*3, v___x_195_);
lean_ctor_set_uint8(v___x_213_, sizeof(void*)*3 + 1, v_suppressElabErrors_209_);
v___x_214_ = l_Lean_PrettyPrinter_ppModule(v___x_194_, v___x_213_, v___y_210_);
lean_dec(v___y_210_);
lean_dec_ref_known(v___x_213_, 3);
if (lean_obj_tag(v___x_214_) == 0)
{
lean_object* v_a_215_; lean_object* v___x_216_; lean_object* v___x_217_; lean_object* v___x_218_; lean_object* v___x_219_; lean_object* v___x_220_; lean_object* v___x_221_; lean_object* v_str_222_; lean_object* v_startInclusive_223_; lean_object* v_endExclusive_224_; lean_object* v___x_225_; lean_object* v___x_226_; lean_object* v___x_227_; lean_object* v___x_228_; 
v_a_215_ = lean_ctor_get(v___x_214_, 0);
lean_inc(v_a_215_);
lean_dec_ref_known(v___x_214_, 1);
v___x_216_ = lean_st_ref_get(v___x_183_);
lean_dec(v___x_183_);
lean_dec(v___x_216_);
v___x_217_ = l_Std_Format_defWidth;
v___x_218_ = l_Std_Format_pretty(v_a_215_, v___x_217_, v___x_169_, v___x_169_);
v___x_219_ = lean_string_utf8_byte_size(v___x_218_);
v___x_220_ = lean_alloc_ctor(0, 3, 0);
lean_ctor_set(v___x_220_, 0, v___x_218_);
lean_ctor_set(v___x_220_, 1, v___x_169_);
lean_ctor_set(v___x_220_, 2, v___x_219_);
v___x_221_ = l_String_Slice_trimAscii(v___x_220_);
v_str_222_ = lean_ctor_get(v___x_221_, 0);
lean_inc_ref(v_str_222_);
v_startInclusive_223_ = lean_ctor_get(v___x_221_, 1);
lean_inc(v_startInclusive_223_);
v_endExclusive_224_ = lean_ctor_get(v___x_221_, 2);
lean_inc(v_endExclusive_224_);
lean_dec_ref(v___x_221_);
v___x_225_ = lean_string_utf8_extract_fast(v_str_222_, v_startInclusive_223_, v_endExclusive_224_);
lean_dec(v_endExclusive_224_);
lean_dec(v_startInclusive_223_);
lean_dec_ref(v_str_222_);
v___x_226_ = ((lean_object*)(l_Lake_Package_mkConfigString___closed__23));
v___x_227_ = lean_string_append(v___x_225_, v___x_226_);
v___x_228_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_228_, 0, v___x_227_);
lean_ctor_set(v___x_228_, 1, v_a_147_);
return v___x_228_;
}
else
{
...
{
lean_object* v_msg_230_; lean_object* v___x_231_; lean_object* v___x_232_; 
v_msg_230_ = lean_ctor_get(v_a_229_, 1);
lean_inc_ref(v_msg_230_);
lean_dec_ref_known(v_a_229_, 2);
v___x_231_ = l_Lean_MessageData_toString(v_msg_230_);
v___x_232_ = lean_mk_io_user_error(v___x_231_);
v_a_150_ = v___x_232_;
goto v___jp_149_;
}
else
{
lean_object* v_id_233_; lean_object* v___x_234_; 
v_id_233_ = lean_ctor_get(v_a_229_, 0);
lean_inc(v_id_233_);
lean_dec_ref_known(v_a_229_, 2);
v___x_234_ = l_Lean_InternalExceptionId_getName(v_id_233_);
...
v___x_236_ = ((lean_object*)(l_Lake_Package_mkConfigString___closed__24));
v___x_237_ = l_Lean_Name_toString(v_a_235_, v___x_163_);
...
lean_dec_ref_known(v___x_234_, 1);
v___x_239_ = ((lean_object*)(l_Lake_Package_mkConfigString___closed__25));
v___x_240_ = l_Nat_reprFast(v_id_233_);
v___x_241_ = lean_string_append(v___x_239_, v___x_240_);
lean_dec_ref(v___x_240_);
v___x_242_ = ((lean_object*)(l_Lake_Package_mkConfigString___closed__26));
...
v_unused_264_ = lean_ctor_get(v___x_246_, 5);
...
v___x_258_ = l_Lean_Kernel_enableDiag(v_env_247_, v___x_195_);
if (v_isShared_257_ == 0)
{
lean_ctor_set(v___x_256_, 5, v___x_170_);
...
lean_ctor_set(v_reuseFailAlloc_262_, 1, v_nextMacroScope_248_);
lean_ctor_set(v_reuseFailAlloc_262_, 2, v_ngen_249_);
lean_ctor_set(v_reuseFailAlloc_262_, 3, v_auxDeclNGen_250_);
lean_ctor_set(v_reuseFailAlloc_262_, 4, v_traceState_251_);
lean_ctor_set(v_reuseFailAlloc_262_, 5, v___x_170_);
lean_ctor_set(v_reuseFailAlloc_262_, 6, v_messages_252_);
lean_ctor_set(v_reuseFailAlloc_262_, 7, v_infoState_253_);
lean_ctor_set(v_reuseFailAlloc_262_, 8, v_snapshotTasks_254_);
...
v___x_261_ = lean_st_ref_put(v___x_183_, v___x_260_);
lean_inc(v___x_183_);
v_fileName_197_ = v___x_188_;
v_fileMap_198_ = v___x_189_;
v_currNamespace_199_ = v___x_176_;
...
{
lean_object* v_a_266_; lean_object* v___x_267_; uint8_t v___x_268_; lean_object* v___x_269_; lean_object* v___x_270_; lean_object* v___x_271_; lean_object* v___x_272_; 
lean_dec_ref(v_pkg_145_);
v_a_266_ = lean_ctor_get(v___x_167_, 0);
lean_inc(v_a_266_);
lean_dec_ref_known(v___x_167_, 1);
v___x_267_ = lean_io_error_to_string(v_a_266_);
v___x_268_ = 3;
v___x_269_ = lean_alloc_ctor(0, 1, 1);
lean_ctor_set(v___x_269_, 0, v___x_267_);
lean_ctor_set_uint8(v___x_269_, sizeof(void*)*1, v___x_268_);
v___x_270_ = lean_array_get_size(v_a_147_);
v___x_271_ = lean_array_push(v_a_147_, v___x_269_);
...
v___x_273_ = lean_obj_once(&l_Lake_Package_mkConfigString___closed__28, &l_Lake_Package_mkConfigString___closed__28_once, _init_l_Lake_Package_mkConfigString___closed__28);
v___x_274_ = l_Lake_Package_mkTomlConfig(v_pkg_145_, v___x_273_);
v___x_275_ = l_Lake_Toml_ppTable(v___x_274_);
lean_dec_ref(v___x_274_);
v___x_276_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_276_, 0, v___x_275_);
lean_ctor_set(v___x_276_, 1, v_a_147_);
return v___x_276_;
}
v___jp_149_:
{
...
LEAN_EXPORT lean_object* l_Lake_Package_mkConfigString___boxed(lean_object* v_pkg_277_, lean_object* v_lang_278_, lean_object* v_a_279_, lean_object* v_a_280_){
_start:
{
uint8_t v_lang_boxed_281_; lean_object* v_res_282_; 
v_lang_boxed_281_ = lean_unbox(v_lang_278_);
v_res_282_ = l_Lake_Package_mkConfigString(v_pkg_277_, v_lang_boxed_281_, v_a_279_);
return v_res_282_;
}
}

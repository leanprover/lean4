...
lean_ctor_set(x_22, 11, x_8);
lean_ctor_set(x_22, 12, x_17);
lean_ctor_set(x_22, 13, x_12);
lean_ctor_set(x_22, 14, x_15);
lean_ctor_set(x_22, 15, x_20);
lean_ctor_set_uint8(x_22, sizeof(void*)*16, x_9);

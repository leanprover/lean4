...
lean_ctor_set(v___x_129_, 2, v___y_103_);
...
v___x_153_ = l_Lean_FileMap_toPosition(v___y_140_, v___y_144_);
lean_dec(v___y_144_);
...
v_ref_182_ = l_Lean_replaceRef(v_ref_95_, v___y_176_);

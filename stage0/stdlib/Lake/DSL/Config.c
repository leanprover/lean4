...
v___x_455_ = l_Nat_reprFast(v___y_448_);
...
v___x_467_ = l_Lean_Elab_Term_withMacroExpansion___at___00__private_Lake_DSL_Config_0__Lake_DSL_elabNameConst_spec__0___redArg(v_stx_436_, v___x_462_, v___x_466_, v___y_451_, v___y_446_, v___y_449_, v___y_452_, v___y_447_, v___y_450_);
return v___x_467_;
}
v___jp_472_:
{

...
lean_dec_ref_known(v___x_214_, 6);
return v___x_216_;
}
else
{
...
lean_dec_ref_known(v_mod_x3f_175_, 1);
...
lean_dec_ref_known(v___x_333_, 6);
...
lean_dec(v_ref_494_);
v_val_496_ = lean_ctor_get(v___y_483_, 0);
lean_inc(v_val_496_);
...
lean_dec_ref_known(v___x_495_, 6);

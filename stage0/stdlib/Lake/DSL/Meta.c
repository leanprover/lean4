...
v___x_799_ = l_Lean_FileMap_toPosition(v___y_788_, v___y_787_);
lean_dec(v___y_787_);
...
v___x_818_ = l_Lean_Syntax_getTailPos_x3f(v___y_814_, v___y_813_);
lean_dec(v___y_814_);
...
v___y_835_ = v_ref_846_;
v___y_836_ = v_fileMap_844_;
v___y_837_ = v_fileName_843_;

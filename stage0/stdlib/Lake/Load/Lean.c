...
lean_ctor_set(x_147, 13, x_145);
lean_ctor_set(x_147, 14, x_144);
lean_ctor_set(x_147, 15, x_138);
...
x_171 = lean_mk_empty_array_with_capacity(x_169);
x_172 = lean_box(0);

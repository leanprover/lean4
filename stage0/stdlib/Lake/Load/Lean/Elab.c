...
v___x_2287_ = l_Lake_importConfigFile___lam__0(v___x_2282_, v___x_2123_, v___y_2286_);
...
v_options_2289_ = lean_ctor_get(v___y_2285_, 4);
...
v___y_2285_ = v_a_2343_;
v___y_2286_ = v_h_2310_;
goto v___jp_2283_;
}
else
{

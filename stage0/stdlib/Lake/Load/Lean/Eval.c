...
lean_ctor_set(v___x_1394_, 4, v___y_1384_);
lean_ctor_set(v___x_1394_, 5, v___y_1386_);
lean_ctor_set(v___x_1394_, 6, v___y_1383_);
lean_ctor_set(v___x_1394_, 7, v___y_1389_);
lean_ctor_set(v___x_1394_, 8, v___y_1385_);
lean_ctor_set(v___x_1394_, 9, v___y_1388_);
lean_ctor_set(v___x_1394_, 10, v___y_1382_);
if (v_isShared_1380_ == 0)
{
lean_ctor_set(v___x_1379_, 1, v___y_1387_);
...
lean_ctor_set(v_reuseFailAlloc_1397_, 1, v___y_1387_);
...
v___x_1402_ = lean_array_get_size(v___y_1387_);
v___x_1403_ = lean_array_push(v___y_1387_, v___x_1401_);
if (v_isShared_1380_ == 0)
{
...
lean_inc_ref(v___x_1409_);
v___x_1452_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lake_LakefileConfig_loadFromEnv_spec__15(v_a_1368_, v___y_1440_, v___x_1409_, v_sz_1451_, v___x_1374_, v___x_1450_, v_a_1448_);

...
lean_ctor_set(v___x_1397_, 8, v___y_1385_);
lean_ctor_set(v___x_1397_, 9, v___y_1388_);
...
v___x_1459_ = lean_nat_dec_lt(v___y_1447_, v___x_1458_);
if (v___x_1459_ == 0)
{
uint8_t v___x_1460_; 

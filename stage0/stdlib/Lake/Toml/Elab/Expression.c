...
lean_ctor_set(v___x_1651_, 2, v___y_1627_);
...
v___x_1674_ = l_Lean_FileMap_toPosition(v___y_1666_, v___y_1663_);
lean_dec(v___y_1663_);
v___x_1675_ = l_Lean_FileMap_toPosition(v___y_1666_, v___y_1667_);

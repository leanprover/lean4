...
lean_object* runtime_initialize_Lake_Util_Cli(uint8_t builtin);
...
lean_object* runtime_initialize_Lake_Util_Lock(uint8_t builtin);
lean_object* runtime_initialize_Lake_Util_Log(uint8_t builtin);
lean_object* runtime_initialize_Lake_Util_MainM(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Lake_Util(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lake_Util(uint8_t builtin) {
lean_object * res;

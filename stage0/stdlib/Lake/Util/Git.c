...
v___x_107_ = lean_string_utf8_extract_fast(v_str_104_, v_startInclusive_105_, v_endExclusive_106_);
...
v___x_676_ = lean_string_utf8_extract_fast(v_str_670_, v_startInclusive_671_, v_endExclusive_672_);

...
v___x_987_ = lean_string_utf8_extract(v_str_984_, v_startInclusive_985_, v_endExclusive_986_);
...
v___x_1042_ = lean_string_utf8_extract(v_str_1039_, v_startInclusive_1040_, v_endExclusive_1041_);

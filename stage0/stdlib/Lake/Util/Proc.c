...
v___x_434_ = lean_string_utf8_extract_fast(v_str_431_, v_startInclusive_432_, v_endExclusive_433_);
...
v___x_471_ = lean_string_utf8_extract_fast(v_str_468_, v_startInclusive_469_, v_endExclusive_470_);

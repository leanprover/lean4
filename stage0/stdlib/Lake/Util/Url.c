...
v___x_626_ = lean_string_utf8_extract(v_str_623_, v_startInclusive_624_, v_endExclusive_625_);
...
v___x_737_ = lean_string_utf8_extract(v_str_734_, v_startInclusive_735_, v_endExclusive_736_);

...
v_stdout_607_ = lean_ctor_get(v___y_596_, 0);
...
lean_dec(v_val_599_);
lean_dec(v___y_595_);
v_stdout_619_ = lean_ctor_get(v___y_596_, 0);
...
v___x_639_ = l_Lake_JsonObject_getJson_x3f(v___y_633_, v___x_638_);
lean_dec(v___y_633_);

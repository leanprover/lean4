...
v_stdout_599_ = lean_ctor_get(v___y_587_, 0);
...
v___x_608_ = lean_array_push(v___y_588_, v___x_607_);
...
lean_dec(v_val_591_);
lean_dec(v___y_589_);
v_stdout_611_ = lean_ctor_get(v___y_587_, 0);
...
lean_ctor_set(v___x_621_, 1, v___y_588_);
return v___x_621_;
}
}
}

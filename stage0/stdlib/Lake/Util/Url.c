...
v_stdout_607_ = lean_ctor_get(v___y_594_, 0);
...
lean_dec(v_val_599_);
lean_dec(v___y_596_);
v_stdout_619_ = lean_ctor_get(v___y_594_, 0);
...
lean_ctor_set(v___x_621_, 1, v___y_597_);

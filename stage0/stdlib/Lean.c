...
lean_object* runtime_initialize_Lean_PostprocessTraces(uint8_t builtin);
lean_object* runtime_initialize_Lean_Cadical(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Lean_Cadical(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
lean_object* initialize_Lean_PostprocessTraces(uint8_t builtin);
lean_object* initialize_Lean_Cadical(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_PostprocessTraces(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Cadical(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

...
lean_object* x_17; 
lean_dec_ref(x_11);
x_17 = l_Lean_setEnv___at___00Lean_registerParametricAttribute_spec__4___redArg(x_13, x_14);
lean_dec(x_14);
return x_17;
}
else

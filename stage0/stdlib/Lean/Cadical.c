...
// Module: Lean.Cadical
// Imports: public import Lean.Cadical.Internal public import Lean.Cadical.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Cadical(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Cadical(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lean_Cadical(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Lean_Cadical(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Lean_Cadical(builtin);
}
#ifdef __cplusplus
}
#endif

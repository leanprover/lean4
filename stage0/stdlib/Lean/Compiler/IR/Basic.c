...
{
uint8_t v___x_3678_; 
v___x_3678_ = lean_nat_dec_eq(v_offset_3666_, v_offset_3672_);
lean_dec(v_offset_3672_);
lean_dec(v_offset_3666_);
if (v___x_3678_ == 0)
{

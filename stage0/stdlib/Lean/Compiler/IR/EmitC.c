...
lean_inc(x_94);
x_96 = l___private_Init_Data_Nat_Control_0__Nat_forM_loop___at___00Lean_IR_EmitC_emitDeclAux_spec__1___redArg(x_93, x_94, x_94, x_90);
lean_dec(x_94);
lean_dec_ref(x_93);
...
x_108 = lean_string_append(x_103, x_106);
lean_dec_ref(x_106);

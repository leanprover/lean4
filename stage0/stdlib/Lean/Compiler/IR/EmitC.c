...
x_30 = l___private_Init_Data_Option_Basic_0__beqOption____x40_Init_Data_Option_Basic___hyg_812____at_Lean_IR_IRType_beq___spec__1(x_28, x_29);
lean_dec(x_28);
if (x_30 == 0)
{
...
{
lean_object* x_1; 
x_1 = lean_mk_string("lean_mk_string_from_bytes(");
return x_1;
}
}

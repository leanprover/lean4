...
lean_inc(x_14);
x_18 = l___private_Init_Data_Nat_Control_0__Nat_forM_loop___at___Lean_IR_EmitC_emitFnDeclAux_spec__0___redArg(x_13, x_14, x_14, x_15);
lean_dec(x_14);
lean_dec_ref(x_13);

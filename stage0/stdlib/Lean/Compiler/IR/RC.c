...
{
uint8_t x_20; 
x_20 = l___private_Lean_Compiler_IR_RC_0__Lean_IR_ExplicitRC_isFirstOcc(x_2, x_13);
if (x_20 == 0)
{
lean_dec(x_17);
lean_dec(x_16);
...
LEAN_EXPORT lean_object* initialize_Lean_Compiler_IR_RC(lean_object* w) {
lean_object * res;

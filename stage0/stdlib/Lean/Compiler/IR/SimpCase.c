...
x_10 = l_Std_Range_forIn_x27_loop___at___private_Lean_Compiler_IR_SimpCase_0__Lean_IR_maxOccs___spec__1(x_1, x_8, x_9, x_7, lean_box(0), lean_box(0));
lean_dec(x_8);

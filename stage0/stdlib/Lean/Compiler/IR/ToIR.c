...
lean_dec_ref_known(v_value_947_, 2);
...
lean_dec_ref_known(v_value_947_, 1);
...
lean_dec_ref_known(v_c_1242_, 2);
...
lean_dec_ref_known(v_c_1242_, 1);
...
lean_dec_ref_known(v_c_1242_, 4);

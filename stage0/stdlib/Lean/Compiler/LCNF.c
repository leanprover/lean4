...
lean_object* runtime_initialize_Lean_Compiler_LCNF_SpecInfo(uint8_t builtin);
...
lean_object* runtime_initialize_Lean_Compiler_LCNF_Probing(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Compiler_LCNF(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Compiler_LCNF(uint8_t builtin) {
lean_object * res;

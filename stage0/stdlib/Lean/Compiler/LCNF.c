...
lean_object* runtime_initialize_Lean_Compiler_LCNF_LLVMBindings(uint8_t builtin);
lean_object* runtime_initialize_Lean_Compiler_LCNF_EmitLLVM(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Lean_Compiler_LCNF_EmitLLVM(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
lean_object* initialize_Lean_Compiler_LCNF_LLVMBindings(uint8_t builtin);
lean_object* initialize_Lean_Compiler_LCNF_EmitLLVM(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Compiler_LCNF_LLVMBindings(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Compiler_LCNF_EmitLLVM(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

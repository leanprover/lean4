...
{
uint8_t v___x_713_; 
v___x_713_ = l_Lean_Compiler_LCNF_AlphaEqv_eqvFVar(v___y_709_, v___y_711_, v___y_712_);
lean_dec(v___y_711_);
lean_dec(v___y_709_);
if (v___x_713_ == 0)
{
...
if (v_c_u2082_732_ == 0)
{
v___y_716_ = v_k_u2081_729_;
v___y_717_ = v_fvarId_u2081_725_;
v___y_718_ = v_p_u2081_728_;
v___y_719_ = v_k_u2082_734_;

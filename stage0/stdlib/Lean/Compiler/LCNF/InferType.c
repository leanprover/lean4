...
if (lean_is_scalar(x_256)) {
 x_311 = lean_alloc_ctor(6, 2, 0);
} else {
 x_311 = x_256;
 lean_ctor_set_tag(x_311, 6);
}
...
if (lean_is_scalar(x_320)) {
 x_325 = lean_alloc_ctor(6, 2, 0);
} else {
 x_325 = x_320;
 lean_ctor_set_tag(x_325, 6);
}
...
if (lean_is_scalar(x_400)) {
 x_418 = lean_alloc_ctor(6, 2, 0);
} else {
 x_418 = x_400;
 lean_ctor_set_tag(x_418, 6);
}
...
if (lean_is_scalar(x_400)) {
 x_455 = lean_alloc_ctor(6, 2, 0);
} else {
 x_455 = x_400;
 lean_ctor_set_tag(x_455, 6);
}
...
if (lean_is_scalar(x_364)) {
 x_477 = lean_alloc_ctor(6, 2, 0);
} else {
 x_477 = x_364;
 lean_ctor_set_tag(x_477, 6);
}

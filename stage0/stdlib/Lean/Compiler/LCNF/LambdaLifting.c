...
v___x_491_ = l_Lean_Compiler_LCNF_cacheAuxDecl___redArg(v___y_484_, v_a_489_, v___y_485_, v___y_486_);
...
lean_inc_ref(v_a_489_);
v___x_497_ = l_Lean_Compiler_LCNF_Decl_save(v___y_484_, v_a_489_, v___y_482_, v___y_488_, v___y_485_, v___y_486_);
...
v___x_519_ = l_Lean_Compiler_LCNF_eraseDecl(v___y_484_, v_a_489_, v___y_482_, v___y_488_, v___y_485_, v___y_486_);

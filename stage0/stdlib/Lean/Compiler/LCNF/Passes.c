...
x_1 = lean_obj_once(&l_Lean_Compiler_LCNF_builtinPassManager___closed__78, &l_Lean_Compiler_LCNF_builtinPassManager___closed__78_once, _init_l_Lean_Compiler_LCNF_builtinPassManager___closed__78);

...
v___x_226_ = l_Array_mapFinIdxM_map___at___00__private_Lean_Compiler_LCNF_PushProj_0__Lean_Compiler_LCNF_Cases_pushProjs_go_spec__2___redArg(v_altsUsed_201_, v___y_223_, v_b_216_, v_alts_200_, v___x_224_, v___x_210_, v___x_225_, v___y_219_, v___y_221_, v___y_220_, v___y_222_);
lean_dec_ref(v_alts_200_);

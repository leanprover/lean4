...
lean_inc_ref(v_params_1211_);
v___x_1252_ = l___private_Lean_Compiler_LCNF_Simp_JpCases_0__Lean_Compiler_LCNF_Simp_mkJmpArgsAtJp(v_params_1211_, v___y_1245_, v___y_1246_, v___y_1247_);
...
lean_ctor_set(v___x_1240_, 0, v___y_1249_);
...
lean_ctor_set(v_reuseFailAlloc_1261_, 0, v___y_1249_);

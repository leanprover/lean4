...
v_fvarId_1251_ = lean_ctor_get(v___y_1247_, 0);
lean_inc(v_fvarId_1251_);
lean_dec_ref(v___y_1247_);
lean_inc_ref(v_params_1211_);
v___x_1252_ = l___private_Lean_Compiler_LCNF_Simp_JpCases_0__Lean_Compiler_LCNF_Simp_mkJmpArgsAtJp(v_params_1211_, v___y_1246_, v___y_1248_, v___y_1249_);

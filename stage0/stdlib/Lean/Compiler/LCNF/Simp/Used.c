...
lean_dec_ref_known(v_arg_176_, 1);
...
lean_dec_ref_known(v_code_375_, 2);
...
lean_dec_ref_known(v_code_375_, 1);
...
lean_dec_ref_known(v_decl_656_, 1);
...
lean_dec_ref_known(v_decl_667_, 1);

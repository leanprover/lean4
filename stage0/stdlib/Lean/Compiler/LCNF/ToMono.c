...
lean_del_object(v___x_964_);
lean_dec(v_declName_961_);
v___x_1007_ = l_Lean_Compiler_LCNF_argsToMonoRedArg(v_args_962_, v___y_995_, v___y_1001_, v___y_996_, v___y_1002_, v___y_1000_, v___y_1003_, v___y_999_);
lean_dec(v___y_999_);

...
if (builtin) {res = l_Lean_Compiler_initFn____x40_Lean_Compiler_Specialize___hyg_31_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
...
if (builtin) {res = l_Lean_Compiler_initFn____x40_Lean_Compiler_Specialize___hyg_333_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

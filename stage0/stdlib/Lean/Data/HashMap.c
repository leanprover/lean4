...
extern "C" {
#endif
LEAN_EXPORT size_t l___private_Lean_Data_HashMap_0__Lean_HashMapImp_mkIdx(lean_object*, uint64_t, lean_object*);
...
lean_dec(x_2);
x_5 = (size_t)(x_4) & (lean_unbox(x_1) - 1);
...
lean_dec(x_6);
x_8 = (size_t)(x_7) & (lean_unbox(x_5) - 1);
...
lean_dec(x_10);
lean_inc(x_9);
x_12 = (size_t)(x_11) & (lean_unbox(x_9) - 1);
...
lean_dec(x_36);
lean_inc(x_35);
x_38 = (size_t)(x_37) & (lean_unbox(x_35) - 1);
...
lean_dec(x_27);
lean_inc(x_26);
x_29 = (size_t)(x_28) & (lean_unbox(x_26) - 1);

...
lean_dec_ref_known(v_node_354_, 1);
...
lean_dec_ref_known(v_node_354_, 2);
...
lean_dec_ref_known(v_node_365_, 1);
...
lean_dec_ref_known(v_node_365_, 2);
...
lean_inc(v_a_543_);
lean_dec_ref_known(v_____do__lift_542_, 1);

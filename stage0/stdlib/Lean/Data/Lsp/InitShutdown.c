...
v_a_1249_ = lean_ctor_get(v___y_1246_, 0);
v_isSharedCheck_1256_ = !lean_is_exclusive(v___y_1246_);
if (v_isSharedCheck_1256_ == 0)
{
v___x_1251_ = v___y_1246_;

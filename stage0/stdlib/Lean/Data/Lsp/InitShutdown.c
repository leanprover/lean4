...
lean_ctor_set(v___x_1249_, 3, v___y_1243_);
lean_ctor_set(v___x_1249_, 4, v_a_1238_);
lean_ctor_set(v___x_1249_, 5, v___y_1248_);
lean_ctor_set_uint8(v___x_1249_, sizeof(void*)*6, v___y_1246_);

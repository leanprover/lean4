...
v___x_1560_ = lean_nat_add(v___y_1557_, v___y_1559_);
...
lean_ctor_set(v___x_1540_, 3, v___y_1558_);
...
lean_ctor_set(v_reuseFailAlloc_1565_, 3, v___y_1558_);

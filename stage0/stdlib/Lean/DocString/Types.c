...
lean_ctor_set(v___x_1598_, 0, v___y_1603_);
...
lean_ctor_set(v_reuseFailAlloc_1614_, 0, v___y_1603_);
...
lean_ctor_set(v___x_1607_, 1, v___y_1602_);
...
lean_ctor_set(v___x_1610_, 0, v___y_1601_);

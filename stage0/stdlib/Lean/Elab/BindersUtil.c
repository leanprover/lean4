...
lean_inc(v_a_232_);
lean_dec_ref_known(v___y_230_, 2);
v_a_225_ = v_a_231_;
v_a_226_ = v_a_232_;
goto v___jp_224_;
}
...
v___x_379_ = l_Array_append___redArg(v___y_373_, v___y_378_);
lean_dec_ref(v___y_378_);
lean_inc(v___y_370_);
lean_inc(v___y_372_);
v___x_380_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_380_, 0, v___y_372_);
...
v___y_385_ = v___y_434_;
v___y_386_ = v_gen_435_;
...
lean_inc_ref_n(v___y_328_, 3);
v___x_334_ = l_Array_append___redArg(v___y_328_, v___y_333_);
lean_dec_ref(v___y_333_);
lean_inc_n(v___y_325_, 3);
lean_inc_n(v___y_327_, 5);
v___x_335_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_335_, 0, v___y_327_);
lean_ctor_set(v___x_335_, 1, v___y_325_);
lean_ctor_set(v___x_335_, 2, v___x_334_);
v___x_336_ = l_Array_append___redArg(v___y_328_, v___y_332_);
lean_dec_ref(v___y_332_);
v___x_337_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_337_, 0, v___y_327_);
lean_ctor_set(v___x_337_, 1, v___y_325_);
...
lean_ctor_set(v___x_339_, 0, v___y_327_);
lean_ctor_set(v___x_339_, 1, v___x_338_);
v___x_340_ = l_Array_append___redArg(v___y_328_, v___y_331_);
lean_dec_ref(v___y_331_);
v___x_341_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_341_, 0, v___y_327_);
lean_ctor_set(v___x_341_, 1, v___y_325_);
lean_ctor_set(v___x_341_, 2, v___x_340_);
lean_inc(v___y_330_);
v___x_342_ = l_Lean_Syntax_node1(v___y_327_, v___y_330_, v___x_341_);
v___x_343_ = l_Lean_Syntax_node7(v___y_327_, v___x_321_, v___y_324_, v___y_323_, v___y_329_, v___x_335_, v___x_337_, v___x_339_, v___x_342_);
v___x_344_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_344_, 0, v___x_343_);
v___x_345_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_345_, 0, v___x_344_);
lean_ctor_set(v___x_345_, 1, v___y_326_);
return v___x_345_;
}
}
else
...
v___y_471_ = v___x_519_;
v___y_472_ = v_motive_487_;
v___y_473_ = v___x_520_;
v___y_474_ = v___x_518_;
v___y_475_ = v_val_511_;
...
lean_inc_ref_n(v___y_300_, 3);
v___x_308_ = l_Array_append___redArg(v___y_300_, v___y_307_);
lean_dec_ref(v___y_307_);
lean_inc_n(v___y_299_, 3);
lean_inc_n(v___y_305_, 5);
v___x_309_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_309_, 0, v___y_305_);
lean_ctor_set(v___x_309_, 1, v___y_299_);
lean_ctor_set(v___x_309_, 2, v___x_308_);
v___x_310_ = l_Array_append___redArg(v___y_300_, v___y_298_);
lean_dec_ref(v___y_298_);
v___x_311_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_311_, 0, v___y_305_);
lean_ctor_set(v___x_311_, 1, v___y_299_);
...
lean_ctor_set(v___x_313_, 0, v___y_305_);
lean_ctor_set(v___x_313_, 1, v___x_312_);
v___x_314_ = l_Array_append___redArg(v___y_300_, v___y_303_);
lean_dec_ref(v___y_303_);
v___x_315_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_315_, 0, v___y_305_);
lean_ctor_set(v___x_315_, 1, v___y_299_);
lean_ctor_set(v___x_315_, 2, v___x_314_);
lean_inc(v___y_302_);
v___x_316_ = l_Lean_Syntax_node1(v___y_305_, v___y_302_, v___x_315_);
v___x_317_ = l_Lean_Syntax_node6(v___y_305_, v___x_296_, v___y_301_, v___y_306_, v___x_309_, v___x_311_, v___x_313_, v___x_316_);
v___x_318_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_318_, 0, v___x_317_);
v___x_319_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_319_, 0, v___x_318_);
lean_ctor_set(v___x_319_, 1, v___y_304_);
return v___x_319_;
}
}
}
...
v___x_674_ = l_Array_append___redArg(v___y_669_, v___y_673_);
lean_dec_ref(v___y_673_);
lean_inc_n(v___y_672_, 3);
lean_inc_n(v___y_664_, 5);
v___x_675_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_675_, 0, v___y_664_);
lean_ctor_set(v___x_675_, 1, v___y_672_);
lean_ctor_set(v___x_675_, 2, v___x_674_);
v___x_676_ = l_Array_append___redArg(v___y_669_, v___y_668_);
lean_dec_ref(v___y_668_);
v___x_677_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_677_, 0, v___y_664_);
lean_ctor_set(v___x_677_, 1, v___y_672_);
...
v___x_680_ = l_Array_append___redArg(v___y_669_, v___y_667_);
...
lean_inc(v___y_671_);
v___x_682_ = l_Lean_Syntax_node1(v___y_664_, v___y_671_, v___x_681_);
v___x_683_ = l_Lean_Syntax_node6(v___y_664_, v___x_662_, v___y_670_, v___y_666_, v___x_675_, v___x_677_, v___x_679_, v___x_682_);
v___x_684_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_684_, 0, v___x_683_);
lean_ctor_set(v___x_684_, 1, v___y_665_);
return v___x_684_;
}
v___jp_685_:
{
...
v___x_696_ = l_Array_append___redArg(v___y_690_, v___y_695_);
lean_dec_ref(v___y_695_);
lean_inc(v___y_694_);
lean_inc(v___y_686_);
v___x_697_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_697_, 0, v___y_686_);
lean_ctor_set(v___x_697_, 1, v___y_694_);
lean_ctor_set(v___x_697_, 2, v___x_696_);
if (lean_obj_tag(v___y_693_) == 1)
{
lean_object* v_val_698_; lean_object* v___x_699_; 
v_val_698_ = lean_ctor_get(v___y_693_, 0);
lean_inc(v_val_698_);
lean_dec_ref_known(v___y_693_, 1);

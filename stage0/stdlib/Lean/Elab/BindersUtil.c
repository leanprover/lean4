...
v___x_362_ = l_Array_append___redArg(v___y_356_, v___y_361_);
lean_dec_ref(v___y_361_);
lean_inc(v___y_359_);
lean_inc(v___y_353_);
v___x_363_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_363_, 0, v___y_353_);
lean_ctor_set(v___x_363_, 1, v___y_359_);
...
v___x_379_ = l_Array_append___redArg(v___y_372_, v___y_378_);
lean_dec_ref(v___y_378_);
lean_inc(v___y_375_);
lean_inc(v___y_370_);
v___x_380_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_380_, 0, v___y_370_);
lean_ctor_set(v___x_380_, 1, v___y_375_);
lean_ctor_set(v___x_380_, 2, v___x_379_);
if (lean_obj_tag(v___y_376_) == 1)
{
lean_object* v_val_381_; lean_object* v___x_382_; 
v_val_381_ = lean_ctor_get(v___y_376_, 0);
lean_inc(v_val_381_);
...
v___x_336_ = l_Array_append___redArg(v___y_328_, v___y_327_);
lean_dec_ref(v___y_327_);
v___x_337_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_337_, 0, v___y_324_);
lean_ctor_set(v___x_337_, 1, v___y_331_);
...
v___x_340_ = l_Array_append___redArg(v___y_328_, v___y_323_);
lean_dec_ref(v___y_323_);
v___x_341_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_341_, 0, v___y_324_);
lean_ctor_set(v___x_341_, 1, v___y_331_);
lean_ctor_set(v___x_341_, 2, v___x_340_);
lean_inc(v___y_332_);
v___x_342_ = l_Lean_Syntax_node1(v___y_324_, v___y_332_, v___x_341_);
v___x_343_ = l_Lean_Syntax_node7(v___y_324_, v___x_321_, v___y_330_, v___y_325_, v___y_326_, v___x_335_, v___x_337_, v___x_339_, v___x_342_);
v___x_344_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_344_, 0, v___x_343_);
v___x_345_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_345_, 0, v___x_344_);
lean_ctor_set(v___x_345_, 1, v___y_329_);
return v___x_345_;
}
}
else
...
v___x_480_ = l_Array_append___redArg(v___y_471_, v___y_479_);
lean_dec_ref(v___y_479_);
lean_inc(v___y_470_);
lean_inc(v___y_475_);
v___x_481_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_481_, 0, v___y_475_);
lean_ctor_set(v___x_481_, 1, v___y_470_);
lean_ctor_set(v___x_481_, 2, v___x_480_);
if (lean_obj_tag(v___y_476_) == 1)
{
lean_object* v_val_482_; lean_object* v___x_483_; 
v_val_482_ = lean_ctor_get(v___y_476_, 0);
lean_inc(v_val_482_);
lean_dec_ref(v___y_476_);
v___x_483_ = l_Array_mkArray1___redArg(v_val_482_);
v___y_298_ = v___y_470_;
v___y_299_ = v___y_471_;
v___y_300_ = v___x_481_;
v___y_301_ = v___y_472_;
v___y_302_ = v___y_473_;
v___y_303_ = v___y_474_;
v___y_304_ = v___y_475_;
v___y_305_ = v___y_477_;
v___y_306_ = v___y_478_;
...
v___x_308_ = l_Array_append___redArg(v___y_299_, v___y_307_);
lean_dec_ref(v___y_307_);
lean_inc_n(v___y_298_, 3);
lean_inc_n(v___y_304_, 5);
...
v___x_310_ = l_Array_append___redArg(v___y_299_, v___y_306_);
lean_dec_ref(v___y_306_);
v___x_311_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_311_, 0, v___y_304_);
lean_ctor_set(v___x_311_, 1, v___y_298_);
...
v___x_314_ = l_Array_append___redArg(v___y_299_, v___y_301_);
...
lean_inc(v___y_302_);
v___x_316_ = l_Lean_Syntax_node1(v___y_304_, v___y_302_, v___x_315_);
v___x_317_ = l_Lean_Syntax_node6(v___y_304_, v___x_296_, v___y_305_, v___y_300_, v___x_309_, v___x_311_, v___x_313_, v___x_316_);
v___x_318_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_318_, 0, v___x_317_);
v___x_319_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_319_, 0, v___x_318_);
lean_ctor_set(v___x_319_, 1, v___y_303_);
return v___x_319_;
}
}
}
...
v___x_680_ = l_Array_append___redArg(v___y_665_, v___y_666_);
lean_dec_ref(v___y_666_);
v___x_681_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_681_, 0, v___y_672_);
lean_ctor_set(v___x_681_, 1, v___y_669_);
lean_ctor_set(v___x_681_, 2, v___x_680_);
lean_inc(v___y_671_);
v___x_682_ = l_Lean_Syntax_node1(v___y_672_, v___y_671_, v___x_681_);
v___x_683_ = l_Lean_Syntax_node6(v___y_672_, v___x_662_, v___y_664_, v___y_668_, v___x_675_, v___x_677_, v___x_679_, v___x_682_);
...
lean_ctor_set(v___x_697_, 1, v___y_690_);
lean_ctor_set(v___x_697_, 2, v___x_696_);
if (lean_obj_tag(v___y_694_) == 1)
{
lean_object* v_val_698_; lean_object* v___x_699_; 
v_val_698_ = lean_ctor_get(v___y_694_, 0);
lean_inc(v_val_698_);
...
v___y_686_ = v___x_721_;
v___y_687_ = v___x_723_;
v___y_688_ = v_alts_719_;
v___y_689_ = v___y_705_;
v___y_690_ = v___x_722_;
v___y_691_ = v___x_717_;
v___y_692_ = v___x_708_;
v___y_693_ = v___x_720_;
v___y_694_ = v_motive_703_;

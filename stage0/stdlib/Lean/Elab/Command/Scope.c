...
// Imports: public import Lean.Data.Options public import Lean.Parser.Term
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Lean_Elab_Command_Scope(uint8_t builtin, lean_object* w) {
lean_object * res;

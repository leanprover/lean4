...
_start:
{
uint8_t v___x_4689__boxed_441_; size_t v_i_boxed_442_; size_t v_stop_boxed_443_; lean_object* v_res_444_; 
v___x_4689__boxed_441_ = lean_unbox(v___x_436_);
v_i_boxed_442_ = lean_unbox_usize(v_i_438_);
lean_dec(v_i_438_);
v_stop_boxed_443_ = lean_unbox_usize(v_stop_439_);
lean_dec(v_stop_439_);
v_res_444_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_ConfigEval_mkEvalConfigItemView_spec__2(v___x_4689__boxed_441_, v_as_437_, v_i_boxed_442_, v_stop_boxed_443_, v_b_440_);
...
v___jp_807_:
{
lean_object* v_binders_818_; lean_object* v___x_819_; 
v_binders_818_ = l_Lean_Syntax_getArgs(v___y_814_);
lean_dec(v___y_814_);
v___x_819_ = l_Lean_Elab_ConfigEval_mkEvalConfigItemView(v_entries_x3f_815_, v___y_816_, v___y_817_);
...
v___x_821_ = l_Lean_Elab_ConfigEval_defEvalConfigItem(v___y_810_, v___y_813_, v___y_809_, v___y_812_, v___y_811_, v___y_808_, v_binders_818_, v_a_820_, v___y_816_, v___y_817_);
return v___x_821_;
}
else
{
lean_object* v_a_822_; lean_object* v___x_824_; uint8_t v_isShared_825_; uint8_t v_isSharedCheck_829_; 
lean_dec_ref(v_binders_818_);
lean_dec(v___y_813_);
lean_dec(v___y_812_);
lean_dec(v___y_811_);
lean_dec(v___y_810_);
...
v___x_1440_ = l_Array_append___redArg(v___y_1430_, v___y_1439_);
lean_dec_ref(v___y_1439_);
lean_inc_n(v___y_1419_, 18);
lean_inc_n(v___y_1412_, 77);
v___x_1441_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1441_, 0, v___y_1412_);
lean_ctor_set(v___x_1441_, 1, v___y_1419_);
lean_ctor_set(v___x_1441_, 2, v___x_1440_);
lean_inc_n(v___y_1435_, 22);
v___x_1442_ = l_Lean_Syntax_node7(v___y_1412_, v___y_1429_, v___y_1413_, v___y_1435_, v___x_1441_, v___y_1435_, v___y_1435_, v___y_1435_, v___y_1435_);
...
lean_ctor_set(v___x_1449_, 1, v___y_1419_);
...
v___x_1457_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00__private_Lean_Elab_ConfigEval_Builtins_0__Lean_Elab_ConfigEval_mkElabConfigCmd_spec__1(v___y_1421_, v___y_1415_, v_binders_1395_);
...
v___x_1462_ = l_Array_append___redArg(v___y_1430_, v___x_1461_);
...
lean_ctor_set(v___x_1464_, 1, v___y_1438_);
v___x_1465_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___y_1417_);
...
v___x_1476_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1419_, v___x_1467_, v___x_1475_);
...
v___x_1478_ = l_Lean_Syntax_node5(v___y_1412_, v___x_1463_, v___x_1464_, v___x_1465_, v___x_1476_, v___y_1435_, v___x_1477_);
v___x_1479_ = lean_array_push(v___x_1462_, v___x_1478_);
v___x_1480_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___y_1423_);
lean_inc_n(v_type_1394_, 2);
v___x_1481_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1419_, v___x_1467_, v_type_1394_);
...
v___x_1493_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1492_, v___y_1435_);
v___x_1494_ = ((lean_object*)(l___private_Lean_Elab_ConfigEval_Builtins_0__Lean_Elab_ConfigEval_mkElabConfigCmd___closed__24));
v___x_1495_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1494_, v___y_1435_);
v___x_1496_ = l_Lean_Syntax_node6(v___y_1412_, v___x_1491_, v___x_1487_, v___y_1435_, v___x_1493_, v___x_1495_, v___y_1435_, v___x_1489_);
...
v___x_1499_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1498_);
...
v___x_1502_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___y_1406_);
...
v___x_1505_ = l_Lean_addMacroScope(v___y_1427_, v___x_1504_, v___y_1416_);
v___x_1506_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1506_, 0, v___x_1504_);
lean_ctor_set(v___x_1506_, 1, v___y_1437_);
...
lean_ctor_set(v___x_1508_, 1, v___y_1431_);
...
v___x_1511_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1419_, v___x_1467_, v___x_1510_);
v___x_1512_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1482_, v___x_1483_, v_logExceptionsDefault_1388_);
v___x_1513_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1512_);
...
lean_ctor_set(v___x_1516_, 1, v___y_1419_);
...
v___x_1518_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v_type_1394_);
lean_inc(v___x_1518_);
lean_inc_n(v___y_1434_, 4);
v___x_1519_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1434_, v_monad_1386_, v___x_1518_);
v___x_1520_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1517_, v___x_1467_, v___x_1519_);
v___x_1521_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1520_);
...
v___x_1534_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1533_, v___y_1435_);
...
lean_ctor_set(v___x_1538_, 1, v___y_1422_);
lean_ctor_set(v___x_1538_, 2, v___y_1409_);
lean_ctor_set(v___x_1538_, 3, v___y_1431_);
v___x_1539_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1537_, v___x_1538_);
lean_inc_ref_n(v___y_1424_, 5);
v___x_1540_ = l_String_toRawSubstring_x27(v___y_1424_);
v___x_1541_ = l_Lean_Name_mkStr1(v___y_1424_);
v___x_1542_ = l_Lean_addMacroScope(v___y_1427_, v___x_1541_, v___y_1416_);
lean_inc_ref_n(v___y_1407_, 2);
lean_inc_ref_n(v___y_1436_, 2);
v___x_1543_ = l_Lean_Name_mkStr4(v___x_1401_, v___y_1436_, v___y_1407_, v___y_1424_);
lean_inc(v___x_1543_);
v___x_1544_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1544_, 0, v___x_1543_);
lean_ctor_set(v___x_1544_, 1, v___y_1437_);
v___x_1545_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_1545_, 0, v___x_1543_);
v___x_1546_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1546_, 0, v___x_1545_);
lean_ctor_set(v___x_1546_, 1, v___y_1431_);
...
v___x_1549_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1434_, v___x_1548_, v___x_1518_);
v___x_1550_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1517_, v___x_1467_, v___x_1549_);
v___x_1551_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1550_);
...
v___x_1555_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1552_, v___x_1554_, v___y_1433_);
v___x_1556_ = l_Array_append___redArg(v___y_1430_, v___y_1432_);
lean_dec_ref(v___y_1432_);
v___x_1557_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1557_, 0, v___y_1412_);
lean_ctor_set(v___x_1557_, 1, v___y_1419_);
lean_ctor_set(v___x_1557_, 2, v___x_1556_);
v___x_1558_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1434_, v___x_1555_, v___x_1557_);
v___x_1559_ = l_Lean_Syntax_node5(v___y_1412_, v___x_1536_, v___x_1539_, v___y_1435_, v___x_1551_, v___x_1483_, v___x_1558_);
v___x_1560_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1535_, v___x_1559_);
lean_inc(v___x_1534_);
lean_inc_ref(v___x_1532_);
v___x_1561_ = l_Lean_Syntax_node4(v___y_1412_, v___x_1530_, v___x_1532_, v___y_1435_, v___x_1534_, v___x_1560_);
v___x_1562_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1529_, v___x_1561_, v___y_1435_);
lean_inc_ref(v___y_1428_);
v___x_1563_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_1563_, 0, v___y_1412_);
lean_ctor_set(v___x_1563_, 1, v___y_1428_);
lean_ctor_set(v___x_1563_, 2, v___y_1420_);
lean_ctor_set(v___x_1563_, 3, v___y_1431_);
...
v___x_1567_ = l_Lean_Name_mkStr2(v___y_1424_, v___x_1566_);
v___x_1568_ = l_Lean_addMacroScope(v___y_1427_, v___x_1567_, v___y_1416_);
v___x_1569_ = l_Lean_Name_mkStr5(v___x_1401_, v___y_1436_, v___y_1407_, v___y_1424_, v___x_1566_);
v___x_1570_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1570_, 0, v___x_1569_);
lean_ctor_set(v___x_1570_, 1, v___y_1437_);
v___x_1571_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1571_, 0, v___x_1570_);
lean_ctor_set(v___x_1571_, 1, v___y_1431_);
...
v___x_1575_ = l_Lean_addMacroScope(v___y_1427_, v___x_1574_, v___y_1416_);
...
lean_ctor_set(v___x_1576_, 3, v___y_1431_);
...
v___x_1579_ = l_Lean_addMacroScope(v___y_1427_, v___x_1578_, v___y_1416_);
...
lean_ctor_set(v___x_1581_, 1, v___y_1437_);
v___x_1582_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_1582_, 0, v___x_1581_);
lean_ctor_set(v___x_1582_, 1, v___y_1431_);
...
v___x_1588_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1587_);
v___x_1589_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1434_, v___x_1583_, v___x_1588_);
v___x_1590_ = l_Lean_Syntax_node5(v___y_1412_, v___y_1425_, v___x_1464_, v___x_1576_, v___x_1483_, v___x_1589_, v___x_1477_);
v___x_1591_ = l_Lean_Syntax_node1(v___y_1412_, v___y_1419_, v___x_1590_);
v___x_1592_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1434_, v___x_1572_, v___x_1591_);
v___x_1593_ = l_Lean_Syntax_node5(v___y_1412_, v___x_1536_, v___x_1564_, v___y_1435_, v___y_1435_, v___x_1483_, v___x_1592_);
v___x_1594_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1535_, v___x_1593_);
v___x_1595_ = l_Lean_Syntax_node4(v___y_1412_, v___x_1530_, v___x_1532_, v___y_1435_, v___x_1534_, v___x_1594_);
v___x_1596_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1529_, v___x_1595_, v___y_1435_);
v___x_1597_ = ((lean_object*)(l___private_Lean_Elab_ConfigEval_Builtins_0__Lean_Elab_ConfigEval_mkElabConfigCmd___closed__67));
v___x_1598_ = l_Lean_Syntax_node1(v___y_1412_, v___x_1597_, v___y_1418_);
v___x_1599_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1529_, v___x_1598_, v___y_1435_);
v___x_1600_ = l_Lean_Syntax_node3(v___y_1412_, v___y_1419_, v___x_1562_, v___x_1596_, v___x_1599_);
...
v___x_1604_ = l_Lean_Syntax_node2(v___y_1412_, v___x_1603_, v___y_1435_, v___y_1435_);
v___x_1605_ = l_Lean_Syntax_node4(v___y_1412_, v___x_1524_, v___x_1483_, v___x_1602_, v___x_1604_, v___y_1435_);
v___x_1606_ = l_Lean_Syntax_node5(v___y_1412_, v___x_1444_, v___x_1446_, v___x_1454_, v___x_1522_, v___x_1605_, v___y_1435_);
v___x_1607_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1414_, v___x_1442_, v___x_1606_);
v___x_1608_ = l_Lean_Syntax_node2(v___y_1412_, v___y_1419_, v___y_1426_, v___x_1607_);
...
v___y_1418_ = v___y_1625_;
v___y_1419_ = v___y_1624_;
...
v___y_1432_ = v___y_1639_;
v___y_1433_ = v___y_1638_;
v___y_1434_ = v___y_1640_;
v___y_1435_ = v___y_1641_;
v___y_1436_ = v___y_1642_;
...
lean_ctor_set(v___x_1691_, 1, v___y_1664_);
...
v___x_1694_ = lean_array_push(v___x_1693_, v___y_1685_);
v___x_1695_ = lean_array_push(v___x_1694_, v___y_1676_);
v___x_1696_ = lean_array_push(v___x_1695_, v___y_1680_);
v___x_1697_ = lean_array_push(v___x_1696_, v___y_1675_);
lean_inc(v___y_1683_);
v___x_1698_ = lean_array_push(v___x_1697_, v___y_1683_);
v___x_1699_ = lean_array_push(v___x_1698_, v___y_1670_);
v___x_1700_ = lean_array_push(v___x_1699_, v___y_1674_);
...
lean_ctor_set(v___x_1703_, 1, v___y_1666_);
...
v___y_1632_ = v___x_1703_;
v___y_1633_ = v___y_1677_;
v___y_1634_ = v___y_1678_;
v___y_1635_ = v___x_1707_;
v___y_1636_ = v___y_1679_;
v___y_1637_ = v___y_1681_;
v___y_1638_ = v___y_1683_;
v___y_1639_ = v___y_1682_;
...
v___y_1662_ = v_currMacroScope_1723_;
v___y_1663_ = v___x_1725_;
v___y_1664_ = v___x_1739_;
v___y_1665_ = v_a_1764_;
v___y_1666_ = v___x_1782_;
v___y_1667_ = v___x_1750_;
v___y_1668_ = v_sz_1801_;
v___y_1669_ = v___x_1740_;
v___y_1670_ = v___x_1805_;
v___y_1671_ = v___x_1731_;
v___y_1672_ = v___x_1726_;
v___y_1673_ = v___x_1744_;
v___y_1674_ = v___x_1807_;
v___y_1675_ = v___x_1800_;
v___y_1676_ = v___x_1791_;
v___y_1677_ = v_quotContext_1722_;
v___y_1678_ = v___x_1748_;
v___y_1679_ = v___x_1736_;
v___y_1680_ = v___x_1798_;
v___y_1681_ = v___x_1783_;
v___y_1682_ = v_a_1712_;
v___y_1683_ = v_fnName_1772_;
v___y_1684_ = v___x_1729_;
v___y_1685_ = v___x_1784_;
v___y_1686_ = v___x_1734_;
v___y_1687_ = v___x_1736_;
v___y_1688_ = v___x_1745_;

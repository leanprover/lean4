...
x_92 = l_Lean_throwError___at___00Lean_Elab_throwAlreadyDeclaredUniverseLevel___at___00Lean_Elab_expandDeclId_spec__1_spec__1___redArg(x_91, x_80, x_76, x_75, x_72, x_77, x_74);
lean_dec(x_74);
lean_dec_ref(x_77);
lean_dec(x_72);
lean_dec_ref(x_75);

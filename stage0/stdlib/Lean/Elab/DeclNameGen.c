...
_start:
{
uint8_t v_binderInfo_18864__boxed_647_; lean_object* v_res_648_; 
v_binderInfo_18864__boxed_647_ = lean_unbox(v_binderInfo_638_);
v_res_648_ = l___private_Lean_Elab_DeclNameGen_0__Lean_Elab_Command_NameGen_winnowExpr_visit___lam__0(v_body_636_, v_binderName_637_, v_binderInfo_18864__boxed_647_, v_binderType_639_, v_arg_640_, v___y_641_, v___y_642_, v___y_643_, v___y_644_, v___y_645_);
lean_dec(v___y_645_);

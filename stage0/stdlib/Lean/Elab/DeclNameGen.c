...
{
lean_dec_ref_known(v_entry_2685_, 1);
return v___x_2741_;
}
}
v___jp_2742_:
...
lean_dec(v_expandedMacroDecls_3056_);
...
lean_dec_ref_known(v_a_3103_, 2);
...
lean_inc(v_a_3134_);
lean_dec_ref_known(v___y_3133_, 1);
...
lean_inc(v_a_3445_);
lean_dec_ref_known(v_r_3427_, 1);

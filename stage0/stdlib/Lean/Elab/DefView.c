...
{
lean_dec_ref_known(v_entry_819_, 1);
return v___x_865_;
}
}
v___jp_866_:
...
lean_dec_ref_known(v_val_1064_, 0);
return v_v_1065_;
}
else
{
...
lean_dec_ref_known(v___x_1196_, 10);
return v___x_1197_;
}
else
{
...
lean_dec_ref_known(v_as_1232_, 2);
...
lean_dec_ref_known(v_a_1374_, 2);
...
v___y_1455_ = v_fst_1513_;
v___y_1456_ = v___x_1533_;
v___y_1457_ = v___x_1524_;
...
v___x_1488_ = l_Lean_Name_mkStr4(v___y_1483_, v___y_1479_, v___x_1486_, v___x_1487_);
...
v_docString_x3f_1460_ = lean_ctor_get(v___y_1456_, 1);
...
lean_ctor_set(v___x_1470_, 2, v___y_1456_);
lean_ctor_set(v___x_1470_, 3, v_declId_1459_);
lean_ctor_set(v___x_1470_, 4, v___y_1455_);

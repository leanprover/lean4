...
lean_object* runtime_initialize_Lean_Elab_Deriving_Inhabited(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_Nonempty(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_TypeName(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_BEq(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_DecEq(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_Repr(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_FromToJson(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_SizeOf(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_Hashable(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_Ord(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_ToExpr(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_ReflBEq(uint8_t builtin);
lean_object* runtime_initialize_Lean_Elab_Deriving_LawfulBEq(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Lean_Elab_Deriving(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Elab_Deriving(uint8_t builtin) {
lean_object * res;

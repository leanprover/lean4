...
_start:
{
uint8_t v_____do__lift_1654__boxed_850_; lean_object* v_res_851_; 
v_____do__lift_1654__boxed_850_ = lean_unbox(v_____do__lift_846_);
v_res_851_ = l___private_Lean_Elab_Deriving_LawfulBEq_0__Lean_Elab_Deriving_LawfulBEq_mkLawfulBEqInstanceHandler___lam__0(v_____do__lift_1654__boxed_850_, v___y_847_, v___y_848_);
lean_dec(v___y_848_);

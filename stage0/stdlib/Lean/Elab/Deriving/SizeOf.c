...
_start:
{
uint8_t v_____do__lift_1784__boxed_37_; lean_object* v_res_38_; 
v_____do__lift_1784__boxed_37_ = lean_unbox(v_____do__lift_33_);
v_res_38_ = l_Lean_Elab_Deriving_SizeOf_mkSizeOfHandler___lam__0(v_____do__lift_1784__boxed_37_, v___y_34_, v___y_35_);
lean_dec(v___y_35_);

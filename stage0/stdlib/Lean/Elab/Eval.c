...
_start:
{
uint8_t v___x_3599__boxed_163_; uint8_t v_safety_boxed_164_; lean_object* v_res_165_; 
v___x_3599__boxed_163_ = lean_unbox(v___x_152_);
v_safety_boxed_164_ = lean_unbox(v_safety_155_);
v_res_165_ = l_Lean_Elab_Term_evalTerm___redArg___lam__0(v_value_150_, v___x_151_, v___x_3599__boxed_163_, v___x_153_, v_type_154_, v_safety_boxed_164_, v___y_156_, v___y_157_, v___y_158_, v___y_159_, v___y_160_, v___y_161_);
lean_dec(v___y_161_);
...
_start:
{
lean_object* v___x_177_; lean_object* v_nextMacroScope_178_; lean_object* v_ngen_179_; lean_object* v_auxDeclNGen_180_; lean_object* v_traceState_181_; lean_object* v_recordedDeps_182_; lean_object* v_messages_183_; lean_object* v_infoState_184_; lean_object* v_snapshotTasks_185_; lean_object* v___x_187_; uint8_t v_isShared_188_; uint8_t v_isSharedCheck_211_; 
...
v_recordedDeps_182_ = lean_ctor_get(v___x_177_, 6);
v_messages_183_ = lean_ctor_get(v___x_177_, 7);
v_infoState_184_ = lean_ctor_get(v___x_177_, 8);
v_snapshotTasks_185_ = lean_ctor_get(v___x_177_, 9);
...
lean_ctor_set(v_reuseFailAlloc_210_, 6, v_recordedDeps_182_);
lean_ctor_set(v_reuseFailAlloc_210_, 7, v_messages_183_);
lean_ctor_set(v_reuseFailAlloc_210_, 8, v_infoState_184_);
lean_ctor_set(v_reuseFailAlloc_210_, 9, v_snapshotTasks_185_);
...
v___x_192_ = lean_st_ref_put(v___y_175_, v___x_191_);
...
v___x_202_ = lean_obj_once(&l_Lean_setEnv___at___00Lean_withEnv___at___00Lean_Elab_Term_evalTerm_spec__2_spec__2___redArg___closed__3, &l_Lean_setEnv___at___00Lean_withEnv___at___00Lean_Elab_Term_evalTerm_spec__2_spec__2___redArg___closed__3_once, _init_l_Lean_setEnv___at___00Lean_withEnv___at___00Lean_Elab_Term_evalTerm_spec__2_spec__2___redArg___closed__3);
if (v_isShared_200_ == 0)
{
lean_ctor_set(v___x_199_, 1, v___x_202_);
...
lean_ctor_set(v_reuseFailAlloc_207_, 1, v___x_202_);
...
v___x_205_ = lean_st_ref_put(v___y_174_, v___x_204_);
...
_start:
{
lean_object* v___x_274_; uint8_t v___x_275_; lean_object* v___x_276_; lean_object* v___x_277_; lean_object* v___x_278_; lean_object* v___f_279_; lean_object* v___x_280_; lean_object* v_env_281_; lean_object* v___x_282_; lean_object* v___x_283_; 
lean_inc_ref(v_type_264_);
v___x_274_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_274_, 0, v_type_264_);
v___x_275_ = 1;
v___x_276_ = lean_box(0);
v___x_277_ = lean_box(v___x_275_);
v___x_278_ = lean_box(v_safety_266_);
v___f_279_ = lean_alloc_closure((void*)(l_Lean_Elab_Term_evalTerm___redArg___lam__0___boxed), 13, 6);
lean_closure_set(v___f_279_, 0, v_value_265_);
lean_closure_set(v___f_279_, 1, v___x_274_);
lean_closure_set(v___f_279_, 2, v___x_277_);
lean_closure_set(v___f_279_, 3, v___x_276_);
lean_closure_set(v___f_279_, 4, v_type_264_);
lean_closure_set(v___f_279_, 5, v___x_278_);
v___x_280_ = lean_st_ref_get(v_a_272_);
v_env_281_ = lean_ctor_get(v___x_280_, 0);
lean_inc_ref(v_env_281_);
lean_dec(v___x_280_);
v___x_282_ = l_Lean_Environment_unlockAsync(v_env_281_);
v___x_283_ = l_Lean_withEnv___at___00Lean_Elab_Term_evalTerm_spec__2___redArg(v___x_282_, v___f_279_, v_a_267_, v_a_268_, v_a_269_, v_a_270_, v_a_271_, v_a_272_);
return v___x_283_;
}
}

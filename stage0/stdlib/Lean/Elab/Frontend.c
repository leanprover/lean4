...
lean_ctor_set_uint8(x_22, sizeof(void*)*6 + 4, x_11);
...
x_114 = lean_box(0);
x_115 = l_Lean_profileitIOUnsafe___redArg(x_112, x_109, x_113, x_114);
lean_dec_ref(x_109);

...
lean_dec_ref(x_57);
lean_inc_ref(x_54);
x_59 = l_Lean_Language_SnapshotTree_getAll(x_54);
...
lean_inc(x_66);
lean_dec_ref(x_64);
x_67 = l_Lean_Firefox_toJsonProfile____x40_Lean_Util_Profiler___hyg_4964_(x_65);
...
lean_dec_ref(x_80);
x_84 = l_Lean_Server_ModuleRefs_toLspModuleRefs(x_83, x_79);
...
x_90 = l_Lean_Server_toJsonIlean____x40_Lean_Server_References___hyg_1586_(x_89);
x_91 = l_Lean_Json_compress(x_90);
x_92 = l_IO_FS_writeFile(x_77, x_91, x_86);
lean_dec_ref(x_91);
...
x_122 = lean_box(0);
x_123 = l_Lean_profileitIOUnsafe___redArg(x_120, x_116, x_121, x_122, x_118);
lean_dec(x_116);

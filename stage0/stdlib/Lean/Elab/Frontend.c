...
x_132 = lean_nat_dec_lt(x_126, x_131);
lean_dec(x_126);
if (x_132 == 0)
{
lean_dec(x_131);
...
x_147 = lean_box(0);
x_148 = l_Lean_profileitIOUnsafe___redArg(x_145, x_142, x_146, x_147, x_143);
lean_dec(x_142);

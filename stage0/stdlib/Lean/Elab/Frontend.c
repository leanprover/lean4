...
lean_inc(x_205);
lean_inc_ref(x_48);
x_206 = lean_alloc_closure((void*)(l_Lean_Elab_runFrontend___lam__4), 2, 1);
lean_closure_set(x_206, 0, x_48);
x_207 = l_Lean_Language_SnapshotTask_map___redArg(x_203, x_206, x_204, x_205, x_30);
lean_ctor_set(x_47, 0, x_207);
x_183 = x_47;
goto block_199;
}
else
...
lean_inc(x_211);
lean_inc_ref(x_48);
x_212 = lean_alloc_closure((void*)(l_Lean_Elab_runFrontend___lam__4), 2, 1);
lean_closure_set(x_212, 0, x_48);
x_213 = l_Lean_Language_SnapshotTask_map___redArg(x_209, x_212, x_210, x_211, x_30);
...
lean_dec(x_110);
x_115 = l_Array_foldlMUnsafe_fold___at___Lean_Elab_runFrontend_spec__5(x_108, x_113, x_114, x_109);
lean_dec_ref(x_108);
x_80 = x_107;
x_81 = x_106;
x_82 = x_104;
...
{
lean_object* x_139; 
x_139 = l_Lean_Language_SnapshotTree_runAndReport(x_137, x_35, x_8, x_138, x_42);
lean_dec(x_138);
...
x_143 = l_Lean_Language_Lean_waitForFinalCmdState_x3f(x_41);
...
lean_dec(x_145);
lean_inc(x_136);
x_148 = l_List_get_x21Internal___redArg(x_49, x_147, x_136);
lean_dec(x_147);
if (x_11 == 0)
{
...
lean_dec(x_148);
lean_inc_ref(x_146);
x_152 = l_Lean_Environment_displayStats(x_146, x_142);
...
lean_inc(x_159);
lean_dec(x_139);
x_161 = l_Lean_Language_Lean_waitForFinalCmdState_x3f(x_41);
...
lean_dec(x_164);
lean_inc(x_136);
x_167 = l_List_get_x21Internal___redArg(x_49, x_166, x_136);
lean_dec(x_166);
if (x_11 == 0)
{
...
lean_dec(x_167);
lean_inc_ref(x_165);
x_171 = l_Lean_Environment_displayStats(x_165, x_160);
...
lean_inc(x_185);
x_186 = l_Lean_Language_SnapshotTask_map___redArg(x_45, x_48, x_184, x_185, x_30);
x_187 = l_Lean_Elab_runFrontend___lam__4___closed__0;
x_188 = lean_array_push(x_187, x_186);
x_189 = l_Lean_Language_Lean_pushOpt___redArg(x_183, x_188);
...
lean_dec(x_193);
x_198 = l_Array_foldlMUnsafe_fold___at___Lean_Elab_runFrontend_spec__6(x_9, x_196, x_197, x_191);
x_136 = x_192;
x_137 = x_190;
x_138 = x_198;
goto block_182;

...
lean_ctor_set(v___x_3018_, 3, v___y_2995_);
...
v___x_3042_ = l_Lean_FileMap_toPosition(v___y_3031_, v___y_3030_);
...
v_ref_3071_ = l_Lean_replaceRef(v_ref_2984_, v___y_3067_);

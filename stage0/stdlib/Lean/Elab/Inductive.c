...
lean_inc(x_12);
lean_inc(x_8);
x_18 = l_Lean_addDecl___at_Lean_Elab_Term_evalExpr___spec__3(x_15, x_8, x_9, x_10, x_11, x_12, x_13, x_17);
if (lean_obj_tag(x_18) == 0)
{
lean_object* x_19; lean_object* x_20; 
x_19 = lean_ctor_get(x_18, 1);
...
x_55 = lean_alloc_closure((void*)(l_Lean_Elab_Command_elabInductiveViews___lambda__2___boxed), 12, 4);
...
if (builtin) {res = l_Lean_Elab_Command_initFn____x40_Lean_Elab_Inductive___hyg_4179_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

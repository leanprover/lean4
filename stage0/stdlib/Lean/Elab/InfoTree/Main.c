...
lean_dec_ref_known(v_a_1194_, 2);
...
lean_dec_ref_known(v_ctx_2754_, 1);
...
lean_dec_ref_known(v_tree_2795_, 2);
...
lean_dec_ref_known(v_info_3794_, 1);
...
lean_dec_ref_known(v_a_x3f_3851_, 1);

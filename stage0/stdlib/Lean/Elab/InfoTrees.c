...
lean_ctor_set(v___x_129_, 1, v___y_96_);
...
lean_ctor_set_uint8(v___x_130_, sizeof(void*)*5, v___y_98_);
...
v___x_192_ = l_Lean_Syntax_getTailPos_x3f(v___y_190_, v___y_189_);
lean_dec(v___y_190_);

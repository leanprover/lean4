...
v___x_1774_ = l___private_Lean_Elab_MacroArgUtil_0__Lean_Elab_Command_expandMacroArg_mkAntiquotNode(v_stx_1746_, v_id_1745_, v___y_1760_, v___y_1762_);

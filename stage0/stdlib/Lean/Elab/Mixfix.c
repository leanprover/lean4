...
lean_ctor_set(v___x_450_, 0, v___y_432_);
lean_ctor_set(v___x_450_, 1, v___y_433_);
...
lean_inc_ref_n(v___y_479_, 2);
v___x_483_ = l_Array_append___redArg(v___y_479_, v___y_482_);
lean_dec_ref(v___y_482_);
lean_inc_n(v___y_468_, 3);
lean_inc_n(v___y_466_, 7);
v___x_484_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_484_, 0, v___y_466_);
lean_ctor_set(v___x_484_, 1, v___y_468_);
lean_ctor_set(v___x_484_, 2, v___x_483_);
v___x_485_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_485_, 0, v___y_466_);
lean_ctor_set(v___x_485_, 1, v___y_468_);
lean_ctor_set(v___x_485_, 2, v___y_479_);
lean_inc(v___y_465_);
v___x_486_ = l_Lean_Syntax_node1(v___y_466_, v___y_465_, v___x_485_);
lean_inc_ref(v___y_467_);
v___x_487_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_487_, 0, v___y_466_);
lean_ctor_set(v___x_487_, 1, v___y_467_);
v___x_488_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__25));
v___x_489_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_489_, 0, v___y_466_);
lean_ctor_set(v___x_489_, 1, v___x_488_);
lean_inc(v___y_480_);
v___x_490_ = l_Lean_Syntax_node2(v___y_466_, v___y_480_, v___x_489_, v___y_481_);
v___x_491_ = l_Lean_Syntax_node1(v___y_466_, v___y_468_, v___x_490_);
...
lean_ctor_set(v___x_525_, 0, v___y_507_);
lean_ctor_set(v___x_525_, 1, v___y_509_);
...
v_val_526_ = lean_ctor_get(v___y_510_, 0);
lean_inc(v_val_526_);
...
lean_ctor_set(v___x_530_, 0, v___y_507_);
...
lean_ctor_set(v___x_532_, 0, v___y_507_);
lean_ctor_set(v___x_532_, 1, v___y_509_);
...
lean_ctor_set(v___x_534_, 0, v___y_507_);
lean_ctor_set(v___x_534_, 1, v___x_533_);
v___x_535_ = l_Lean_Syntax_node3(v___y_507_, v___x_528_, v___x_530_, v___x_532_, v___x_534_);
...
uint8_t v___x_581_; 
lean_inc(v___x_579_);
v___x_581_ = l_Lean_Syntax_matchesNull(v___x_579_, v___y_566_);
if (v___x_581_ == 0)
{
...
v___x_608_ = l_Array_append___redArg(v___y_592_, v___y_607_);
...
v_val_610_ = lean_ctor_get(v___y_591_, 0);
lean_inc(v_val_610_);
...
lean_inc_ref_n(v___y_626_, 2);
v___x_642_ = l_Array_append___redArg(v___y_626_, v___y_641_);
lean_dec_ref(v___y_641_);
lean_inc_n(v___y_634_, 3);
lean_inc_n(v___y_639_, 7);
v___x_643_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_643_, 0, v___y_639_);
lean_ctor_set(v___x_643_, 1, v___y_634_);
lean_ctor_set(v___x_643_, 2, v___x_642_);
v___x_644_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_644_, 0, v___y_639_);
lean_ctor_set(v___x_644_, 1, v___y_634_);
lean_ctor_set(v___x_644_, 2, v___y_626_);
lean_inc(v___y_625_);
v___x_645_ = l_Lean_Syntax_node1(v___y_639_, v___y_625_, v___x_644_);
lean_inc_ref(v___y_631_);
v___x_646_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_646_, 0, v___y_639_);
lean_ctor_set(v___x_646_, 1, v___y_631_);
...
lean_inc(v___y_640_);
v___x_649_ = l_Lean_Syntax_node2(v___y_639_, v___y_640_, v___x_648_, v___y_636_);
v___x_650_ = l_Lean_Syntax_node1(v___y_639_, v___y_634_, v___x_649_);
if (lean_obj_tag(v___y_624_) == 1)
{
...
v_val_651_ = lean_ctor_get(v___y_624_, 0);
lean_inc(v_val_651_);
...
lean_inc_n(v___y_639_, 5);
v___x_654_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_654_, 0, v___y_639_);
...
v___x_661_ = l_Lean_Syntax_node5(v___y_639_, v___x_652_, v___x_654_, v___x_656_, v___x_658_, v_val_651_, v___x_660_);
v___x_662_ = l_Array_mkArray1___redArg(v___x_661_);
v___y_591_ = v___y_627_;
v___y_592_ = v___y_626_;
v___y_593_ = v___y_628_;
v___y_594_ = v___y_629_;
v___y_595_ = v___y_630_;
v___y_596_ = v___x_650_;
...
v___x_683_ = l_Array_append___redArg(v___y_667_, v___y_682_);
lean_dec_ref(v___y_682_);
lean_inc(v___y_675_);
lean_inc(v___y_680_);
v___x_684_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_684_, 0, v___y_680_);
lean_ctor_set(v___x_684_, 1, v___y_675_);
lean_ctor_set(v___x_684_, 2, v___x_683_);
if (lean_obj_tag(v___y_671_) == 1)
{
...
v_val_685_ = lean_ctor_get(v___y_671_, 0);
lean_inc(v_val_685_);
...
lean_inc_n(v___y_680_, 4);
v___x_689_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_689_, 0, v___y_680_);
lean_ctor_set(v___x_689_, 1, v___x_688_);
lean_inc_ref(v___y_667_);
v___x_690_ = l_Array_append___redArg(v___y_667_, v_val_685_);
lean_dec(v_val_685_);
lean_inc(v___y_675_);
v___x_691_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_691_, 0, v___y_680_);
lean_ctor_set(v___x_691_, 1, v___y_675_);
...
lean_ctor_set(v___x_693_, 0, v___y_680_);
lean_ctor_set(v___x_693_, 1, v___x_692_);
v___x_694_ = l_Lean_Syntax_node3(v___y_680_, v___x_687_, v___x_689_, v___x_691_, v___x_693_);
...
lean_dec(v_stx_152_);
v___x_716_ = l_Lean_SourceInfo_fromRef(v_ref_711_, v___y_702_);
...
uint8_t v___x_740_; 
lean_inc(v___x_738_);
v___x_740_ = l_Lean_Syntax_matchesNull(v___x_738_, v___y_725_);
if (v___x_740_ == 0)
{
...
v_prio_746_ = l_Lean_Syntax_getArg(v___x_742_, v___y_730_);
lean_dec(v___x_742_);
v___x_747_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_747_, 0, v_prio_746_);
v___y_698_ = v_name_734_;
...
v___x_770_ = l_Array_append___redArg(v___y_752_, v___y_769_);
lean_dec_ref(v___y_769_);
lean_inc(v___y_751_);
lean_inc(v___y_758_);
v___x_771_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_771_, 0, v___y_758_);
lean_ctor_set(v___x_771_, 1, v___y_751_);
lean_ctor_set(v___x_771_, 2, v___x_770_);
if (lean_obj_tag(v___y_753_) == 1)
{
...
v_val_772_ = lean_ctor_get(v___y_753_, 0);
lean_inc(v_val_772_);
...
lean_ctor_set(v___x_775_, 0, v___y_758_);
...
lean_ctor_set(v___x_779_, 0, v___y_758_);
...
v___x_782_ = l_Lean_Syntax_node5(v___y_758_, v___x_773_, v___x_775_, v___x_777_, v___x_779_, v_val_772_, v___x_781_);
...
v___y_270_ = v___y_765_;
v___y_271_ = v___y_767_;
...
lean_ctor_set(v___x_807_, 2, v___y_789_);
lean_inc(v___y_786_);
v___x_808_ = l_Lean_Syntax_node1(v___y_794_, v___y_786_, v___x_807_);
lean_inc_ref(v___y_802_);
v___x_809_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_809_, 0, v___y_794_);
lean_ctor_set(v___x_809_, 1, v___y_802_);
...
lean_inc(v___y_793_);
v___x_812_ = l_Lean_Syntax_node2(v___y_794_, v___y_793_, v___x_811_, v___y_790_);
v___x_813_ = l_Lean_Syntax_node1(v___y_794_, v___y_788_, v___x_812_);
...
lean_ctor_set(v___x_848_, 1, v___y_830_);
...
v_val_849_ = lean_ctor_get(v___y_835_, 0);
lean_inc(v_val_849_);
...
v___x_851_ = l_Lean_Name_mkStr4(v___x_155_, v___x_156_, v___y_839_, v___x_850_);
...
lean_ctor_set(v___x_855_, 1, v___y_830_);
...
lean_dec(v_stx_152_);
v___x_884_ = lean_nat_add(v_a_875_, v___y_862_);
lean_dec(v_a_875_);
...
if (lean_obj_tag(v___y_868_) == 1)
{
lean_object* v_val_893_; lean_object* v___x_894_; 
v_val_893_ = lean_ctor_get(v___y_868_, 0);
lean_inc(v_val_893_);
...
v___y_833_ = v_prio_871_;
v___y_834_ = v___x_883_;
v___y_835_ = v___y_867_;
v___y_836_ = v___y_869_;
v___y_837_ = v___x_888_;
v___y_838_ = v___x_890_;
v___y_839_ = v___y_870_;
v___y_840_ = v_currMacroScope_878_;
...
uint8_t v___x_921_; 
lean_inc(v___x_919_);
v___x_921_ = l_Lean_Syntax_matchesNull(v___x_919_, v___y_906_);
if (v___x_921_ == 0)
{
...
v_prio_927_ = l_Lean_Syntax_getArg(v___x_923_, v___y_911_);
lean_dec(v___x_923_);
...
v___y_866_ = v_name_915_;
v___y_867_ = v___y_910_;
v___y_868_ = v___y_913_;
...
v___x_951_ = l_Array_append___redArg(v___y_949_, v___y_950_);
lean_dec_ref(v___y_950_);
lean_inc(v___y_932_);
lean_inc(v___y_936_);
v___x_952_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_952_, 0, v___y_936_);
lean_ctor_set(v___x_952_, 1, v___y_932_);
lean_ctor_set(v___x_952_, 2, v___x_951_);
if (lean_obj_tag(v___y_946_) == 1)
{
...
v_val_953_ = lean_ctor_get(v___y_946_, 0);
lean_inc(v_val_953_);
lean_dec_ref_known(v___y_946_, 1);
...
v___x_986_ = l_Array_append___redArg(v___y_984_, v___y_985_);
lean_dec_ref(v___y_985_);
lean_inc_n(v___y_967_, 3);
lean_inc_n(v___y_972_, 7);
v___x_987_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_987_, 0, v___y_972_);
lean_ctor_set(v___x_987_, 1, v___y_967_);
...
lean_ctor_set(v___x_988_, 2, v___y_984_);
lean_inc(v___y_968_);
v___x_989_ = l_Lean_Syntax_node1(v___y_972_, v___y_968_, v___x_988_);
...
lean_ctor_set(v___x_992_, 0, v___y_972_);
lean_ctor_set(v___x_992_, 1, v___x_991_);
lean_inc_ref(v___x_992_);
lean_inc(v___y_975_);
v___x_993_ = l_Lean_Syntax_node2(v___y_972_, v___y_975_, v___x_992_, v___y_969_);
v___x_994_ = l_Lean_Syntax_node1(v___y_972_, v___y_967_, v___x_993_);
if (lean_obj_tag(v___y_977_) == 1)
{
...
v_val_995_ = lean_ctor_get(v___y_977_, 0);
lean_inc(v_val_995_);
...
lean_ctor_set(v___x_1000_, 0, v___y_972_);
...
v_val_1030_ = lean_ctor_get(v___y_1015_, 0);
...
lean_ctor_set(v___x_1034_, 0, v___y_1014_);
lean_ctor_set(v___x_1034_, 1, v___x_1033_);
lean_inc_ref(v___y_1026_);
v___x_1035_ = l_Array_append___redArg(v___y_1026_, v_val_1030_);
lean_dec(v_val_1030_);
lean_inc(v___y_1009_);
v___x_1036_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1036_, 0, v___y_1014_);
lean_ctor_set(v___x_1036_, 1, v___y_1009_);
...
lean_ctor_set(v___x_1038_, 0, v___y_1014_);
lean_ctor_set(v___x_1038_, 1, v___x_1037_);
v___x_1039_ = l_Lean_Syntax_node3(v___y_1014_, v___x_1032_, v___x_1034_, v___x_1036_, v___x_1038_);
...
v___x_1055_ = l_Lean_evalPrec(v___y_1047_, v___y_1053_, v___y_1054_);
...
v___y_1020_ = v_currMacroScope_1059_;
v___y_1021_ = v___x_1070_;
v___y_1022_ = v___x_1062_;
v___y_1023_ = v___x_1068_;
v___y_1024_ = v_prio_1052_;
v___y_1025_ = v___x_1071_;
v___y_1026_ = v___x_1073_;
...
v___x_1102_ = l_Lean_Syntax_matchesNull(v___x_1100_, v___y_1087_);
if (v___x_1102_ == 0)
{
...
v___x_1132_ = l_Array_append___redArg(v___y_1125_, v___y_1131_);
lean_dec_ref(v___y_1131_);
lean_inc(v___y_1122_);
lean_inc(v___y_1128_);
v___x_1133_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1133_, 0, v___y_1128_);
...
v___x_1144_ = l_Lean_Syntax_node5(v___y_1128_, v___x_1135_, v___x_1137_, v___x_1139_, v___x_1141_, v_val_1134_, v___x_1143_);
...
v___y_387_ = v___y_1130_;
v___y_388_ = v___y_1129_;
...
v___x_1167_ = l_Array_append___redArg(v___y_1162_, v___y_1166_);
lean_dec_ref(v___y_1166_);
lean_inc_n(v___y_1159_, 3);
lean_inc_n(v___y_1164_, 7);
v___x_1168_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1168_, 0, v___y_1164_);
lean_ctor_set(v___x_1168_, 1, v___y_1159_);
lean_ctor_set(v___x_1168_, 2, v___x_1167_);
v___x_1169_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1169_, 0, v___y_1164_);
lean_ctor_set(v___x_1169_, 1, v___y_1159_);
lean_ctor_set(v___x_1169_, 2, v___y_1162_);
lean_inc(v___y_1148_);
v___x_1170_ = l_Lean_Syntax_node1(v___y_1164_, v___y_1148_, v___x_1169_);
lean_inc_ref(v___y_1153_);
v___x_1171_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_1171_, 0, v___y_1164_);
lean_ctor_set(v___x_1171_, 1, v___y_1153_);
v___x_1172_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__25));
v___x_1173_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_1173_, 0, v___y_1164_);
lean_ctor_set(v___x_1173_, 1, v___x_1172_);
lean_inc_ref(v___x_1173_);
lean_inc(v___y_1157_);
v___x_1174_ = l_Lean_Syntax_node2(v___y_1164_, v___y_1157_, v___x_1173_, v___y_1150_);
v___x_1175_ = l_Lean_Syntax_node1(v___y_1164_, v___y_1159_, v___x_1174_);
...
lean_ctor_set(v___x_1185_, 0, v___y_1164_);
lean_ctor_set(v___x_1185_, 1, v___x_1184_);
v___x_1186_ = l_Lean_Syntax_node5(v___y_1164_, v___x_1177_, v___x_1179_, v___x_1181_, v___x_1183_, v_val_1176_, v___x_1185_);
v___x_1187_ = l_Array_mkArray1___redArg(v___x_1186_);
v___y_1112_ = v___x_1170_;
v___y_1113_ = v___x_1173_;
v___y_1114_ = v___y_1149_;
v___y_1115_ = v___y_1151_;
v___y_1116_ = v___y_1152_;
v___y_1117_ = v___y_1154_;
v___y_1118_ = v___y_1155_;
v___y_1119_ = v___y_1156_;
v___y_1120_ = v___y_1157_;
v___y_1121_ = v___y_1158_;
v___y_1122_ = v___y_1159_;
v___y_1123_ = v___x_1175_;
v___y_1124_ = v___y_1161_;
v___y_1125_ = v___y_1162_;
v___y_1126_ = v___y_1163_;
v___y_1127_ = v___x_1171_;
...
v_val_1211_ = lean_ctor_get(v___y_1198_, 0);
...
lean_inc_n(v___y_1206_, 4);
v___x_1215_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_1215_, 0, v___y_1206_);
lean_ctor_set(v___x_1215_, 1, v___x_1214_);
lean_inc_ref(v___y_1204_);
v___x_1216_ = l_Array_append___redArg(v___y_1204_, v_val_1211_);
lean_dec(v_val_1211_);
lean_inc(v___y_1201_);
v___x_1217_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_1217_, 0, v___y_1206_);
lean_ctor_set(v___x_1217_, 1, v___y_1201_);
...
lean_ctor_set(v___x_1219_, 0, v___y_1206_);
lean_ctor_set(v___x_1219_, 1, v___x_1218_);
v___x_1220_ = l_Lean_Syntax_node3(v___y_1206_, v___x_1213_, v___x_1215_, v___x_1217_, v___x_1219_);
...
if (lean_obj_tag(v___y_1229_) == 1)
{
lean_object* v_val_1255_; lean_object* v___x_1256_; 
v_val_1255_ = lean_ctor_get(v___y_1229_, 0);
...
v___y_1191_ = v___x_1242_;
v___y_1192_ = v___y_1227_;
v___y_1193_ = v___x_1244_;
v___y_1194_ = v_prio_1232_;
v___y_1195_ = v___x_1251_;
v___y_1196_ = v___x_1252_;
v___y_1197_ = v_a_1237_;
v___y_1198_ = v___y_1228_;
v___y_1199_ = v___y_1230_;
v___y_1200_ = v___y_1231_;
v___y_1201_ = v___x_1253_;
v___y_1202_ = v_currMacroScope_1239_;
v___y_1203_ = v___y_1224_;
v___y_1204_ = v___x_1254_;
v___y_1205_ = v___x_1248_;
v___y_1206_ = v___x_1250_;
v___y_1207_ = v_quotContext_1238_;
...
v___x_1282_ = l_Lean_Syntax_matchesNull(v___x_1280_, v___y_1268_);
if (v___x_1282_ == 0)
{
...
v___y_566_ = v___y_1292_;
v___y_567_ = v___x_1300_;
v___y_568_ = v___x_1315_;
v___y_569_ = v_attrs_x3f_1294_;
v___y_570_ = v___x_1321_;
v___y_571_ = v___x_1306_;
...
v___y_725_ = v___y_1292_;
v___y_726_ = v___x_1300_;
v___y_727_ = v___x_1342_;
v___y_728_ = v_attrs_x3f_1294_;
v___y_729_ = v___x_1313_;
v___y_730_ = v___x_1306_;
...
v___y_1271_ = v_attrs_x3f_1294_;
v___y_1272_ = v___x_1306_;
...
lean_inc_n(v___y_159_, 3);
lean_inc_n(v___y_158_, 7);
v___x_176_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_176_, 0, v___y_158_);
lean_ctor_set(v___x_176_, 1, v___y_159_);
...
lean_inc(v___y_169_);
lean_inc(v___y_160_);
v___x_180_ = l_Lean_addMacroScope(v___y_160_, v___x_179_, v___y_169_);
v___x_181_ = lean_box(0);
v___x_182_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_182_, 0, v___y_158_);
...
v___x_183_ = l_Lean_Syntax_node2(v___y_158_, v___x_177_, v___x_182_, v___y_168_);
v___x_184_ = l_Lean_Syntax_node2(v___y_158_, v___y_159_, v___x_183_, v___y_164_);
v___x_185_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__8));
v___x_186_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_186_, 0, v___y_158_);
...
v___x_189_ = l_Lean_Syntax_node1(v___y_158_, v___y_159_, v___x_182_);
v___x_190_ = l_Lean_Syntax_node2(v___y_158_, v___x_188_, v___y_170_, v___x_189_);
...
v___x_194_ = lean_array_push(v___x_193_, v___y_171_);
v___x_195_ = lean_array_push(v___x_194_, v___y_173_);
v___x_196_ = lean_array_push(v___x_195_, v___y_163_);
v___x_197_ = lean_array_push(v___x_196_, v___y_168_);
v___x_198_ = lean_array_push(v___x_197_, v___y_162_);
...
v___x_223_ = l_Array_append___redArg(v___y_206_, v___y_222_);
lean_dec_ref(v___y_222_);
lean_inc_n(v___y_215_, 3);
lean_inc_n(v___y_219_, 7);
v___x_224_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_224_, 0, v___y_219_);
lean_ctor_set(v___x_224_, 1, v___y_215_);
...
lean_inc(v___y_216_);
lean_inc(v___y_207_);
v___x_228_ = l_Lean_addMacroScope(v___y_207_, v___x_227_, v___y_216_);
...
v___x_231_ = l_Lean_Syntax_node2(v___y_219_, v___x_225_, v___x_230_, v___y_211_);
v___x_232_ = l_Lean_Syntax_node2(v___y_219_, v___y_215_, v___y_208_, v___x_231_);
v___x_233_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__8));
v___x_234_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_234_, 0, v___y_219_);
lean_ctor_set(v___x_234_, 1, v___x_233_);
v___x_235_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__9));
lean_inc_ref(v___y_213_);
v___x_236_ = l_Lean_Name_mkStr4(v___x_155_, v___x_156_, v___y_213_, v___x_235_);
v___x_237_ = l_Lean_Syntax_node1(v___y_219_, v___y_215_, v___x_230_);
v___x_238_ = l_Lean_Syntax_node2(v___y_219_, v___x_236_, v___y_210_, v___x_237_);
...
v___x_245_ = lean_array_push(v___x_244_, v___y_211_);
v___x_246_ = lean_array_push(v___x_245_, v___y_209_);
...
lean_ctor_set(v___x_251_, 0, v___y_219_);
lean_ctor_set(v___x_251_, 1, v___y_218_);
lean_ctor_set(v___x_251_, 2, v___x_250_);
v___x_252_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_252_, 0, v___x_251_);
lean_ctor_set(v___x_252_, 1, v___y_217_);
return v___x_252_;
}
v___jp_253_:
{
...
v___x_274_ = l_Array_append___redArg(v___y_256_, v___y_273_);
lean_dec_ref(v___y_273_);
lean_inc_n(v___y_255_, 4);
lean_inc_n(v___y_262_, 11);
v___x_275_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_275_, 0, v___y_262_);
lean_ctor_set(v___x_275_, 1, v___y_255_);
...
v___x_279_ = l_Lean_addMacroScope(v___y_254_, v___x_278_, v___y_268_);
...
lean_inc(v___y_260_);
v___x_282_ = l_Lean_Syntax_node2(v___y_262_, v___y_260_, v___y_258_, v___y_269_);
v___x_283_ = l_Lean_Syntax_node1(v___y_262_, v___y_255_, v___x_282_);
lean_inc_ref(v___x_281_);
v___x_284_ = l_Lean_Syntax_node2(v___y_262_, v___x_276_, v___x_281_, v___x_283_);
...
v___x_287_ = l_Lean_addMacroScope(v___y_254_, v___x_286_, v___y_268_);
v___x_288_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_288_, 0, v___y_262_);
...
v___x_289_ = l_Lean_Syntax_node2(v___y_262_, v___x_276_, v___x_288_, v___y_259_);
v___x_290_ = l_Lean_Syntax_node3(v___y_262_, v___y_255_, v___x_284_, v___y_272_, v___x_289_);
v___x_291_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__8));
v___x_292_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_292_, 0, v___y_262_);
...
v___x_295_ = l_Lean_Syntax_node2(v___y_262_, v___y_255_, v___x_281_, v___x_288_);
v___x_296_ = l_Lean_Syntax_node2(v___y_262_, v___x_294_, v___y_257_, v___x_295_);
v___x_297_ = lean_unsigned_to_nat(10u);
v___x_298_ = lean_mk_empty_array_with_capacity(v___x_297_);
v___x_299_ = lean_array_push(v___x_298_, v___y_270_);
v___x_300_ = lean_array_push(v___x_299_, v___y_266_);
v___x_301_ = lean_array_push(v___x_300_, v___y_267_);
v___x_302_ = lean_array_push(v___x_301_, v___y_264_);
...
lean_ctor_set(v___x_309_, 0, v___y_262_);
...
v___x_332_ = l_Array_append___redArg(v___y_330_, v___y_331_);
lean_dec_ref(v___y_331_);
lean_inc_n(v___y_313_, 4);
lean_inc_n(v___y_317_, 11);
v___x_333_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_333_, 0, v___y_317_);
lean_ctor_set(v___x_333_, 1, v___y_313_);
...
v___x_337_ = l_Lean_addMacroScope(v___y_324_, v___x_336_, v___y_325_);
v___x_338_ = lean_box(0);
v___x_339_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_339_, 0, v___y_317_);
lean_ctor_set(v___x_339_, 1, v___x_335_);
lean_ctor_set(v___x_339_, 2, v___x_337_);
lean_ctor_set(v___x_339_, 3, v___x_338_);
lean_inc(v___y_323_);
v___x_340_ = l_Lean_Syntax_node2(v___y_317_, v___y_323_, v___y_312_, v___y_326_);
v___x_341_ = l_Lean_Syntax_node1(v___y_317_, v___y_313_, v___x_340_);
lean_inc(v___x_341_);
lean_inc_ref(v___x_339_);
v___x_342_ = l_Lean_Syntax_node2(v___y_317_, v___x_334_, v___x_339_, v___x_341_);
...
v___x_345_ = l_Lean_addMacroScope(v___y_324_, v___x_344_, v___y_325_);
v___x_346_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_346_, 0, v___y_317_);
...
v___x_347_ = l_Lean_Syntax_node2(v___y_317_, v___x_334_, v___x_346_, v___x_341_);
v___x_348_ = l_Lean_Syntax_node3(v___y_317_, v___y_313_, v___x_342_, v___y_327_, v___x_347_);
...
v___x_352_ = l_Lean_Name_mkStr4(v___x_155_, v___x_156_, v___y_321_, v___x_351_);
v___x_353_ = l_Lean_Syntax_node2(v___y_317_, v___y_313_, v___x_339_, v___x_346_);
v___x_354_ = l_Lean_Syntax_node2(v___y_317_, v___x_352_, v___y_314_, v___x_353_);
...
v___x_358_ = lean_array_push(v___x_357_, v___y_329_);
v___x_359_ = lean_array_push(v___x_358_, v___y_316_);
v___x_360_ = lean_array_push(v___x_359_, v___y_319_);
v___x_361_ = lean_array_push(v___x_360_, v___y_318_);
v___x_362_ = lean_array_push(v___x_361_, v___y_320_);
...
lean_ctor_set(v___x_367_, 0, v___y_317_);
lean_ctor_set(v___x_367_, 1, v___y_328_);
lean_ctor_set(v___x_367_, 2, v___x_366_);
v___x_368_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_368_, 0, v___x_367_);
lean_ctor_set(v___x_368_, 1, v___y_315_);
return v___x_368_;
}
v___jp_369_:
{
...
lean_inc_n(v___y_380_, 4);
lean_inc_n(v___y_386_, 11);
v___x_391_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_391_, 0, v___y_386_);
lean_ctor_set(v___x_391_, 1, v___y_380_);
...
v___x_395_ = l_Lean_addMacroScope(v___y_388_, v___x_394_, v___y_382_);
v___x_396_ = lean_box(0);
v___x_397_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_397_, 0, v___y_386_);
...
v___x_398_ = l_Lean_Syntax_node2(v___y_386_, v___x_392_, v___x_397_, v___y_381_);
...
v___x_401_ = l_Lean_addMacroScope(v___y_388_, v___x_400_, v___y_382_);
v___x_402_ = lean_alloc_ctor(3, 4, 0);
lean_ctor_set(v___x_402_, 0, v___y_386_);
lean_ctor_set(v___x_402_, 1, v___x_399_);
lean_ctor_set(v___x_402_, 2, v___x_401_);
lean_ctor_set(v___x_402_, 3, v___x_396_);
lean_inc(v___y_378_);
v___x_403_ = l_Lean_Syntax_node2(v___y_386_, v___y_378_, v___y_371_, v___y_384_);
v___x_404_ = l_Lean_Syntax_node1(v___y_386_, v___y_380_, v___x_403_);
lean_inc_ref(v___x_402_);
v___x_405_ = l_Lean_Syntax_node2(v___y_386_, v___x_392_, v___x_402_, v___x_404_);
v___x_406_ = l_Lean_Syntax_node3(v___y_386_, v___y_380_, v___x_398_, v___y_372_, v___x_405_);
v___x_407_ = ((lean_object*)(l_Lean_Elab_Command_expandMixfix___lam__0___closed__8));
v___x_408_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_408_, 0, v___y_386_);
...
v___x_411_ = l_Lean_Syntax_node2(v___y_386_, v___y_380_, v___x_397_, v___x_402_);
v___x_412_ = l_Lean_Syntax_node2(v___y_386_, v___x_410_, v___y_373_, v___x_411_);
v___x_413_ = lean_unsigned_to_nat(10u);
v___x_414_ = lean_mk_empty_array_with_capacity(v___x_413_);
v___x_415_ = lean_array_push(v___x_414_, v___y_377_);
v___x_416_ = lean_array_push(v___x_415_, v___y_387_);
v___x_417_ = lean_array_push(v___x_416_, v___y_370_);
v___x_418_ = lean_array_push(v___x_417_, v___y_385_);
v___x_419_ = lean_array_push(v___x_418_, v___y_381_);
v___x_420_ = lean_array_push(v___x_419_, v___y_374_);
...
lean_ctor_set(v___x_425_, 0, v___y_386_);
lean_ctor_set(v___x_425_, 1, v___y_375_);
lean_ctor_set(v___x_425_, 2, v___x_424_);
v___x_426_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_426_, 0, v___x_425_);
lean_ctor_set(v___x_426_, 1, v___y_376_);
return v___x_426_;
}
}
}

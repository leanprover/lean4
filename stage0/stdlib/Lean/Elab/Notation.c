...
v___x_2540_ = l_Array_append___redArg(v___y_2527_, v___y_2539_);
lean_dec_ref(v___y_2539_);
lean_inc_n(v___y_2524_, 3);
lean_inc_n(v___y_2534_, 9);
v___x_2541_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2541_, 0, v___y_2534_);
lean_ctor_set(v___x_2541_, 1, v___y_2524_);
...
lean_ctor_set(v___x_2544_, 0, v___y_2534_);
...
lean_ctor_set(v___x_2546_, 0, v___y_2534_);
...
lean_ctor_set(v___x_2548_, 0, v___y_2534_);
...
lean_ctor_set(v___x_2553_, 0, v___y_2534_);
lean_ctor_set(v___x_2553_, 1, v___x_2552_);
v___x_2554_ = l_Lean_Syntax_node5(v___y_2534_, v___x_2542_, v___x_2544_, v___x_2546_, v___x_2548_, v___x_2551_, v___x_2553_);
v___x_2555_ = l_Lean_Syntax_node1(v___y_2534_, v___y_2524_, v___x_2554_);
v_sz_2556_ = lean_array_size(v___y_2535_);
v___x_2557_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabNotation_spec__3(v_sz_2556_, v___y_2532_, v___y_2535_);
v___x_2558_ = l_Array_append___redArg(v___y_2527_, v___x_2557_);
lean_dec_ref(v___x_2557_);
v___x_2559_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2559_, 0, v___y_2534_);
lean_ctor_set(v___x_2559_, 1, v___y_2524_);
...
v___x_2565_ = lean_array_push(v___x_2564_, v___y_2528_);
lean_inc(v___y_2520_);
v___x_2566_ = lean_array_push(v___x_2565_, v___y_2520_);
v___x_2567_ = lean_array_push(v___x_2566_, v___y_2526_);
...
v___x_2573_ = lean_array_push(v___x_2572_, v___y_2521_);
lean_inc(v___y_2522_);
v___x_2574_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2574_, 0, v___y_2534_);
lean_ctor_set(v___x_2574_, 1, v___y_2522_);
lean_ctor_set(v___x_2574_, 2, v___x_2573_);
v___x_2575_ = l_Lean_Elab_Command_elabSyntax(v___x_2574_, v___y_2525_, v___y_2530_);
...
v___y_2470_ = v___y_2532_;
v___y_2471_ = v___y_2533_;
v___y_2472_ = v_a_2576_;
...
v___x_2582_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabNotation_spec__8(v___y_2523_, v___y_2532_, v___x_2581_, v___x_2578_);
v___y_2463_ = v___y_2520_;
v___y_2464_ = v___y_2523_;
v___y_2465_ = v___x_2550_;
v___y_2466_ = v___y_2524_;
...
v___x_2584_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00Lean_Elab_Command_elabNotation_spec__8(v___y_2523_, v___y_2532_, v___x_2583_, v___x_2578_);
v___y_2463_ = v___y_2520_;
v___y_2464_ = v___y_2523_;
v___y_2465_ = v___x_2550_;
v___y_2466_ = v___y_2524_;
...
lean_ctor_set(v___x_2615_, 0, v___y_2608_);
lean_ctor_set(v___x_2615_, 1, v___y_2598_);
...
lean_ctor_set(v___x_2619_, 0, v___y_2608_);
...
lean_ctor_set(v___x_2621_, 0, v___y_2608_);
...
lean_ctor_set(v___x_2625_, 0, v___y_2608_);
lean_ctor_set(v___x_2625_, 1, v___x_2624_);
v___x_2626_ = l_Lean_Syntax_node5(v___y_2608_, v___x_2617_, v___x_2619_, v___x_2621_, v___x_2623_, v_val_2616_, v___x_2625_);
...
v___x_2650_ = l_Array_append___redArg(v___y_2636_, v___y_2649_);
lean_dec_ref(v___y_2649_);
lean_inc(v___y_2634_);
lean_inc_n(v___y_2643_, 2);
v___x_2651_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2651_, 0, v___y_2643_);
lean_ctor_set(v___x_2651_, 1, v___y_2634_);
lean_ctor_set(v___x_2651_, 2, v___x_2650_);
lean_inc_ref(v___y_2639_);
v___x_2652_ = lean_alloc_ctor(2, 2, 0);
lean_ctor_set(v___x_2652_, 0, v___y_2643_);
lean_ctor_set(v___x_2652_, 1, v___y_2639_);
...
v___x_2657_ = l_Lean_Syntax_node2(v___y_2643_, v___x_2654_, v___x_2656_, v_val_2653_);
...
v___y_2600_ = v___x_2652_;
v___y_2601_ = v___y_2637_;
v___y_2602_ = v___y_2636_;
...
v___x_2681_ = l_Array_append___redArg(v___y_2668_, v___y_2680_);
lean_dec_ref(v___y_2680_);
lean_inc(v___y_2665_);
lean_inc(v___y_2675_);
v___x_2682_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2682_, 0, v___y_2675_);
lean_ctor_set(v___x_2682_, 1, v___y_2665_);
...
v_val_2683_ = lean_ctor_get(v___y_2666_, 0);
...
lean_inc_ref(v___y_2668_);
v___x_2688_ = l_Array_append___redArg(v___y_2668_, v_val_2683_);
lean_dec(v_val_2683_);
lean_inc(v___y_2665_);
v___x_2689_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2689_, 0, v___y_2675_);
lean_ctor_set(v___x_2689_, 1, v___y_2665_);
...
lean_ctor_set(v___x_2691_, 0, v___y_2675_);
lean_ctor_set(v___x_2691_, 1, v___x_2690_);
v___x_2692_ = l_Lean_Syntax_node3(v___y_2675_, v___x_2685_, v___x_2687_, v___x_2689_, v___x_2691_);
...
v___y_2636_ = v___y_2668_;
v___y_2637_ = v___y_2669_;
...
if (lean_obj_tag(v___y_2698_) == 1)
{
lean_object* v_val_2716_; lean_object* v___x_2717_; 
v_val_2716_ = lean_ctor_get(v___y_2698_, 0);
...
v_attrs_x3f_2735_ = l_Lean_Elab_Command_addInheritDocDefault(v_rhs_2732_, v___y_2721_);
...
v___x_2800_ = l_Lean_Syntax_matchesNull(v___x_2798_, v___y_2788_);
if (v___x_2800_ == 0)
{
...
v___x_2822_ = l_Lean_Syntax_matchesNull(v___x_2820_, v___y_2812_);
if (v___x_2822_ == 0)
{
...
v___x_2847_ = l_Lean_Syntax_matchesNull(v___x_2845_, v___y_2832_);
if (v___x_2847_ == 0)
{
...
v_prec_x3f_2853_ = l_Lean_Syntax_getArg(v___x_2849_, v___y_2832_);
lean_dec(v___x_2849_);
v___x_2854_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2854_, 0, v_prec_x3f_2853_);
v___y_2810_ = v_attrKind_2838_;
v___y_2811_ = v_attrs_x3f_2834_;
...
v___y_2832_ = v___x_2860_;
v___y_2833_ = v_doc_x3f_2857_;
...
lean_closure_set(v___x_2384_, 0, v___y_2379_);
lean_closure_set(v___x_2384_, 1, v___y_2381_);
...
lean_inc_n(v___y_2414_, 4);
lean_inc_n(v___y_2417_, 15);
v___x_2422_ = lean_alloc_ctor(1, 3, 0);
lean_ctor_set(v___x_2422_, 0, v___y_2417_);
lean_ctor_set(v___x_2422_, 1, v___y_2414_);
lean_ctor_set(v___x_2422_, 2, v___y_2416_);
...
lean_inc_ref_n(v___y_2413_, 4);
v___x_2425_ = l_Lean_Name_mkStr4(v___x_2405_, v___x_2406_, v___y_2413_, v___x_2424_);
v___x_2426_ = ((lean_object*)(l_Lean_Elab_Command_mkUnexpander___closed__31));
v___x_2427_ = l_Lean_Name_mkStr4(v___x_2405_, v___x_2406_, v___y_2413_, v___x_2426_);
...
v___x_2431_ = l_Lean_Name_mkStr4(v___x_2405_, v___x_2406_, v___y_2413_, v___x_2430_);
...
v___x_2435_ = l_Lean_Syntax_node3(v___y_2417_, v___x_2431_, v___x_2433_, v___y_2412_, v___x_2434_);
v___x_2436_ = l_Lean_Syntax_node1(v___y_2417_, v___y_2414_, v___x_2435_);
v___x_2437_ = l_Lean_Syntax_node1(v___y_2417_, v___y_2414_, v___x_2436_);
...
v___x_2441_ = l_Lean_Name_mkStr4(v___x_2405_, v___x_2406_, v___y_2413_, v___x_2440_);
...
v___x_2444_ = l_Lean_Syntax_node3(v___y_2417_, v___x_2431_, v___x_2433_, v___y_2411_, v___x_2434_);
...
v___x_2447_ = l_Lean_Syntax_node1(v___y_2417_, v___y_2414_, v___x_2446_);
v___x_2448_ = l_Lean_Syntax_node1(v___y_2417_, v___x_2425_, v___x_2447_);
lean_inc_n(v___y_2410_, 2);
lean_inc_ref_n(v___x_2422_, 2);
v___x_2449_ = l_Lean_Syntax_node6(v___y_2417_, v___x_2421_, v___x_2422_, v___x_2422_, v___y_2410_, v___x_2423_, v___x_2422_, v___x_2448_);
v___x_2450_ = l_Lean_Elab_Command_isLocalAttrKind(v___y_2410_);
if (v___x_2450_ == 0)
{
lean_object* v___x_2451_; 
v___x_2451_ = l_Lean_Elab_Command_elabCommand(v___x_2449_, v___y_2415_, v___y_2419_);
if (lean_obj_tag(v___x_2451_) == 0)
{
lean_dec_ref_known(v___x_2451_, 1);
v___y_2379_ = v___y_2410_;
v___y_2380_ = v___y_2411_;
...
v___x_2453_ = lean_st_ref_get(v___y_2419_);
...
v___x_2461_ = l_Lean_Elab_Command_withScope___redArg(v___f_2459_, v___x_2460_, v___y_2415_, v___y_2419_);
...
v___x_2478_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_Elab_Command_elabNotation_spec__4(v_sz_2477_, v___y_2470_, v___y_2476_);
v___x_2479_ = l___private_Lean_Elab_Notation_0__Lean_Elab_Command_antiquote(v___x_2478_, v___y_2474_);
lean_dec_ref(v___x_2478_);
v_sz_2480_ = lean_array_size(v___y_2464_);
v___x_2481_ = lean_box_usize(v_sz_2480_);
v___x_2482_ = lean_box_usize(v___y_2470_);
...
v___x_2484_ = l_Lean_Elab_liftMacroM___at___00Lean_Elab_Command_elabNotation_spec__1___redArg(v___x_2483_, v___y_2467_, v___y_2469_);
...
lean_ctor_set(v___x_2486_, 1, v___y_2472_);
lean_ctor_set(v___x_2486_, 2, v_a_2485_);
v___x_2487_ = l_Lean_Elab_Command_getRef___redArg(v___y_2467_);
...
v___x_2489_ = l_Lean_SourceInfo_fromRef(v_a_2488_, v___y_2475_);
lean_dec(v_a_2488_);
v___x_2490_ = l_Lean_Elab_Command_getCurrMacroScope___redArg(v___y_2467_);
if (lean_obj_tag(v___x_2490_) == 0)
{
lean_object* v_quotContext_x3f_2491_; 
lean_dec_ref_known(v___x_2490_, 1);
v_quotContext_x3f_2491_ = lean_ctor_get(v___y_2467_, 5);
if (lean_obj_tag(v_quotContext_x3f_2491_) == 0)
{
lean_object* v___x_2492_; 
v___x_2492_ = l_Lean_getMainModule___at___00Lean_Elab_Command_elabNotation_spec__7___redArg(v___y_2469_);
lean_dec_ref(v___x_2492_);
v___y_2410_ = v___y_2463_;
v___y_2411_ = v___x_2479_;
v___y_2412_ = v___x_2486_;
v___y_2413_ = v___y_2471_;
v___y_2414_ = v___y_2466_;
v___y_2415_ = v___y_2467_;
v___y_2416_ = v___y_2468_;
v___y_2417_ = v___x_2489_;
v___y_2418_ = v___y_2473_;
v___y_2419_ = v___y_2469_;
goto v___jp_2409_;
}
else
{

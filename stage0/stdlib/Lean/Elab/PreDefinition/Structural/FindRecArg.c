...
v___x_4078_ = l_Lean_Elab_Structural_inductiveGroups(v___y_4077_, v___y_4074_, v___y_4076_, v___y_4075_, v___y_4073_);
if (lean_obj_tag(v___x_4078_) == 0)
{
lean_object* v_options_4079_; uint8_t v_hasTrace_4080_; 
v_options_4079_ = lean_ctor_get(v___y_4075_, 2);
...
lean_inc(v_a_4082_);
lean_dec_ref_known(v___x_4078_, 1);
v_inheritedTraceOptions_4083_ = lean_ctor_get(v___y_4075_, 13);
...
v___x_4092_ = l_Lean_addTrace___at___00Lean_Elab_Structural_getRecArgInfos_spec__0(v___x_4071_, v___x_4091_, v___y_4074_, v___y_4076_, v___y_4075_, v___y_4073_);

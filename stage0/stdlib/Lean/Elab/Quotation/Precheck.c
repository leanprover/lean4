...
v___x_540_ = l_Lean_Syntax_getTailPos_x3f(v___y_533_, v___y_537_);
lean_dec(v___y_533_);
...
v_ref_550_ = l_Lean_replaceRef(v_ref_461_, v___y_548_);
v___x_551_ = l_Lean_Syntax_getPos_x3f(v_ref_550_, v___y_546_);

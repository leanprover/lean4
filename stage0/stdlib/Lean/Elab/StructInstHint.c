...
lean_dec(v___y_612_);
lean_dec(v___y_610_);
v_val_622_ = lean_ctor_get(v___y_611_, 0);
lean_inc(v_val_622_);
...
v___y_652_ = v_numFields_724_;
v___y_653_ = v___x_732_;

...
lean_inc(v_val_621_);
lean_dec_ref_known(v___y_612_, 1);
v___y_581_ = v___y_610_;
v___y_582_ = v___y_611_;
v___y_583_ = v___x_620_;
v___y_584_ = v___y_614_;
...
v_val_643_ = lean_ctor_get(v___y_636_, 0);
lean_inc_ref(v___y_638_);
lean_inc(v_val_643_);
v___x_644_ = lean_apply_1(v___y_638_, v_val_643_);
v___x_645_ = lean_nat_sub(v___y_635_, v___x_644_);
lean_dec(v___x_644_);
...
{
uint8_t v___x_699_; 
v___x_699_ = lean_nat_dec_le(v___y_682_, v___y_685_);
if (v___x_699_ == 0)
{
lean_dec(v___y_682_);
...
v___y_707_ = v_hasWith_723_;
v___y_708_ = v_numFields_724_;

...
// Module: Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Expr
// Imports: Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Basic Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Const Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Var Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Not Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.ShiftLeft Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.ShiftRight Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Add Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.ZeroExtend Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Append Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Replicate Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Extract Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.RotateLeft Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.RotateRight Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.SignExtend Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Impl.Expr Lean.Elab.Tactic.BVDecide.Bitblast.BVExpr.Circuit.Lemmas.Operations.Mul
#include <lean/lean.h>
...
extern "C" {
#endif
LEAN_EXPORT lean_object* l___private_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Expr_0__Lean_Elab_Tactic_BVDecide_BVExpr_bitblast_go_match__5_splitter___rarg(lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*, lean_object*);
LEAN_EXPORT lean_object* l___private_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Expr_0__Lean_Elab_Tactic_BVDecide_BVExpr_bitblast_go_match__5_splitter(lean_object*);
...
lean_inc(x_19);
lean_dec(x_2);
x_20 = lean_apply_3(x_5, x_1, x_18, x_19);
return x_20;
}
case 3:
{
...
lean_inc(x_24);
lean_dec(x_2);
x_25 = lean_apply_4(x_11, x_21, x_22, x_23, x_24);
return x_25;
}
case 4:
{
...
LEAN_EXPORT lean_object* l___private_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Expr_0__Lean_Elab_Tactic_BVDecide_BVExpr_bitblast_go_match__5_splitter(lean_object* x_1) {
_start:
{
lean_object* x_2; 
x_2 = lean_alloc_closure((void*)(l___private_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Expr_0__Lean_Elab_Tactic_BVDecide_BVExpr_bitblast_go_match__5_splitter___rarg), 13, 0);
return x_2;
}
}
lean_object* initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Basic(uint8_t builtin, lean_object*);
lean_object* initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Const(uint8_t builtin, lean_object*);
lean_object* initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Var(uint8_t builtin, lean_object*);
...
lean_object* initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Expr(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Expr(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Const(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Lemmas_Var(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Elab_Tactic_BVDecide_Bitblast_BVExpr_Circuit_Impl_Expr(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

...
lean_inc(x_32);
lean_dec_ref(x_31);
x_33 = l___private_Lean_Elab_Tactic_BVDecide_Frontend_BVDecide_ReifiedLemmas_0__Lean_Elab_Tactic_BVDecide_Frontend_addCondLemmas_mkCondTrueLemma___redArg___closed__10;
lean_inc(x_24);
lean_inc_ref(x_16);
...
lean_inc(x_67);
lean_dec_ref(x_66);
x_68 = l___private_Lean_Elab_Tactic_BVDecide_Frontend_BVDecide_ReifiedLemmas_0__Lean_Elab_Tactic_BVDecide_Frontend_addCondLemmas_mkCondTrueLemma___redArg___closed__10;
lean_inc(x_24);
lean_inc_ref(x_16);

...
lean_dec_ref_known(v_action_470_, 2);
...
lean_dec_ref_known(v_action_470_, 3);
...
lean_dec_ref_known(v_action_470_, 5);
...
lean_dec_ref_known(v_action_470_, 1);
...
lean_dec_ref_known(v_data_943_, 3);
...
lean_inc(v_a_1686_);
lean_dec_ref_known(v_r_1660_, 1);

...
// Module: Lean.Elab.Tactic.BVDecide.LRAT.Internal.Formula.Class
// Imports: Lean.Elab.Tactic.BVDecide.LRAT.Internal.Entails Lean.Elab.Tactic.BVDecide.LRAT.Internal.Clause
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Lean_Elab_Tactic_BVDecide_LRAT_Internal_Formula_Class(uint8_t builtin, lean_object* w) {
lean_object * res;

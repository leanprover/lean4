...
lean_dec(v___x_715_);
v___x_717_ = l_Lean_Elab_Tactic_withLocation(v___x_716_, v___y_705_, v___y_707_, v___f_702_, v___y_712_, v___y_711_, v___y_710_, v___y_713_, v___y_704_, v___y_709_, v___y_706_, v___y_708_);
lean_dec(v___x_716_);
return v___x_717_;
}
}

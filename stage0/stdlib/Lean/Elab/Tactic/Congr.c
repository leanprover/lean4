...
v___x_118_ = l_Lean_Elab_Tactic_withMainContext___redArg(v___f_117_, v___y_107_, v___y_109_, v___y_111_, v___y_112_, v___y_113_, v___y_108_, v___y_114_, v___y_110_);
return v___x_118_;
}
}
}

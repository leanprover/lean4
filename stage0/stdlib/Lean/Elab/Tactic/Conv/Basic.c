...
res = l___regBuiltin_Lean_Elab_Tactic_Conv_evalConvTactic(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
res = l___regBuiltin_Lean_Elab_Tactic_Conv_evalConvTactic_declRange(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

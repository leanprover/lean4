...
lean_inc_ref_n(v___y_130_, 2);
v___x_141_ = l_Lean_FileMap_toPosition(v___y_130_, v___y_131_);
lean_dec(v___y_131_);
v___x_142_ = l_Lean_FileMap_toPosition(v___y_130_, v___y_134_);
lean_dec(v___y_134_);

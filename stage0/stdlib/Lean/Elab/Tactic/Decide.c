...
lean_inc_ref(v_inheritedTraceOptions_1570_);
...
if (v___x_2482_ == 0)
{
lean_inc_ref(v_inheritedTraceOptions_2445_);
...
lean_inc_ref(v_fileMap_2433_);
lean_inc_ref(v_fileName_2432_);

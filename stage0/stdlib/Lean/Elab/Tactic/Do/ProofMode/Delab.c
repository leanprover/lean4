...
v___x_384_ = l_Lean_addMacroScope(v_quotContext_377_, v___x_362_, v_currMacroScope_378_);
...
v_ref_416_ = lean_ctor_get(v___y_337_, 2);
...
v_ref_445_ = lean_ctor_get(v___y_337_, 2);
...
v_ref_615_ = lean_ctor_get(v_a_566_, 2);

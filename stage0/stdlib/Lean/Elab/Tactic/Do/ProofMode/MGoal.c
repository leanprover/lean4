...
v___x_873_ = l_Lean_FileMap_toPosition(v___y_864_, v___y_865_);
lean_dec(v___y_865_);
v___x_874_ = l_Lean_FileMap_toPosition(v___y_864_, v___y_866_);
lean_dec(v___y_866_);

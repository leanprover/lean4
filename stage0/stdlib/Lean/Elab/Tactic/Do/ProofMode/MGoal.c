...
lean_ctor_set(v___x_832_, 1, v___y_812_);
v___x_833_ = lean_alloc_ctor(0, 5, 3);
lean_ctor_set(v___x_833_, 0, v___y_811_);
lean_ctor_set(v___x_833_, 1, v___y_809_);
lean_ctor_set(v___x_833_, 2, v___y_810_);
lean_ctor_set(v___x_833_, 3, v___y_807_);
...
v___x_857_ = l_Lean_FileMap_toPosition(v___y_848_, v___y_847_);
lean_dec(v___y_847_);
...
v___x_876_ = l_Lean_Syntax_getTailPos_x3f(v___y_870_, v___y_874_);
lean_dec(v___y_870_);

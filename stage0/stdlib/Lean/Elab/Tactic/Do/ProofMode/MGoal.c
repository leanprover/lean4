...
lean_ctor_set(v___x_849_, 0, v___y_827_);
lean_ctor_set(v___x_849_, 1, v___y_823_);
lean_ctor_set(v___x_849_, 2, v___y_826_);
lean_ctor_set(v___x_849_, 3, v___y_829_);
lean_ctor_set(v___x_849_, 4, v___x_848_);
lean_ctor_set_uint8(v___x_849_, sizeof(void*)*5, v___y_824_);
...
lean_inc_ref_n(v___y_861_, 2);
v___x_873_ = l_Lean_FileMap_toPosition(v___y_861_, v___y_863_);
lean_dec(v___y_863_);
v___x_874_ = l_Lean_FileMap_toPosition(v___y_861_, v___y_866_);
lean_dec(v___y_866_);
...
v___x_892_ = l_Lean_Syntax_getTailPos_x3f(v___y_890_, v___y_885_);
lean_dec(v___y_890_);

...
lean_dec_ref_known(v_a_2792_, 1);
...
lean_dec_ref_known(v___x_2904_, 14);
return v___x_2905_;
}
}
...
lean_dec_ref_known(v___x_3398_, 7);
...
lean_dec_ref_known(v___x_3528_, 7);
...
lean_dec_ref_known(v_userName_x3f_3837_, 1);
v___x_3925_ = 1;
...
lean_inc(v_a_4130_);
lean_dec_ref_known(v_r_4104_, 1);

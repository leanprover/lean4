...
v___y_132_ = v___x_170_;
v___y_133_ = v___x_166_;
...
v___x_140_ = l_Lean_MVarId_applyConst(v_g_52_, v___x_139_, v___y_132_, v___y_135_, v___y_134_, v___y_131_, v___y_130_);
...
lean_ctor_set(v___x_150_, 0, v___y_136_);
return v___x_150_;
}
}
}

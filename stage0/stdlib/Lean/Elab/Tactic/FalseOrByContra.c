...
lean_dec_ref_known(v___x_268_, 7);
...
lean_dec_ref_known(v___x_172_, 0);
lean_dec(v_g_54_);
...
lean_dec_ref_known(v_val_102_, 2);
v___x_109_ = 0;
...
v___x_142_ = l_Lean_MVarId_applyConst(v_g_54_, v___x_141_, v___y_133_, v___y_138_, v___y_136_, v___y_134_, v___y_137_);
...
lean_ctor_set(v___x_152_, 0, v___y_132_);
return v___x_152_;
}
}
}

...
lean_ctor_set(v___x_677_, 2, v___y_652_);
...
v___x_701_ = l_Lean_FileMap_toPosition(v___y_692_, v___y_690_);
lean_dec(v___y_690_);
...
v___x_720_ = l_Lean_Syntax_getTailPos_x3f(v___y_715_, v___y_714_);
lean_dec(v___y_715_);

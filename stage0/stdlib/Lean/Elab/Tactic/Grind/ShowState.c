...
v___x_397_ = l_Lean_FileMap_toPosition(v___y_387_, v___y_388_);
lean_dec(v___y_388_);
...
v___x_416_ = l_Lean_Syntax_getTailPos_x3f(v___y_413_, v___y_414_);
lean_dec(v___y_413_);

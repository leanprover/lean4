...
lean_ctor_set(v___x_373_, 3, v___y_352_);
lean_ctor_set(v___x_373_, 4, v___x_372_);
lean_ctor_set_uint8(v___x_373_, sizeof(void*)*5, v___y_349_);
lean_ctor_set_uint8(v___x_373_, sizeof(void*)*5 + 1, v___y_348_);
...
v___x_397_ = l_Lean_FileMap_toPosition(v___y_389_, v___y_387_);
lean_dec(v___y_387_);
...
v___x_416_ = l_Lean_Syntax_getTailPos_x3f(v___y_409_, v___y_412_);
lean_dec(v___y_409_);

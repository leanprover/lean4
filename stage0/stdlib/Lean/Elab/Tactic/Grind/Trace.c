...
v___x_630_ = l_Lean_Elab_Tactic_Grind_withConfigItems___redArg(v_val_613_, v___f_629_, v___y_625_, v___y_626_, v___y_623_, v___y_622_, v___y_621_, v___y_624_, v___y_620_, v___y_619_);
lean_dec(v_val_613_);
return v___x_630_;
}
v___jp_631_:

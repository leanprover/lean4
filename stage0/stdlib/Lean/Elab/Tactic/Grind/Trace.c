...
v___x_610_ = l_Lean_Elab_Tactic_Grind_withConfigItems___redArg(v_val_593_, v___f_609_, v___y_606_, v___y_600_, v___y_601_, v___y_603_, v___y_604_, v___y_602_, v___y_599_, v___y_605_);
lean_dec(v_val_593_);
return v___x_610_;
}
v___jp_611_:

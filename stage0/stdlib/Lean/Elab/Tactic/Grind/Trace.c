...
{
lean_ctor_set(v___x_199_, 0, v___y_178_);
...
lean_ctor_set(v_reuseFailAlloc_221_, 0, v___y_178_);
...
v___x_865_ = l_Lean_Elab_Tactic_Grind_withConfigItems___redArg(v_val_848_, v___f_864_, v___y_861_, v___y_858_, v___y_860_, v___y_856_, v___y_859_, v___y_857_, v___y_855_, v___y_854_);
return v___x_865_;
}
v___jp_866_:
{

...
v_id_816_ = lean_ctor_get(v___y_812_, 0);
v_isSharedCheck_829_ = !lean_is_exclusive(v___y_812_);
if (v_isSharedCheck_829_ == 0)
{
lean_object* v_unused_830_; 
v_unused_830_ = lean_ctor_get(v___y_812_, 1);
lean_dec(v_unused_830_);
v___x_818_ = v___y_812_;
...
{
uint8_t v___x_820_; 
v___x_820_ = l_Lean_instBEqInternalExceptionId_beq(v___y_814_, v_id_816_);
lean_dec(v_id_816_);
if (v___x_820_ == 0)
{
...
v___x_827_ = l_Lean_throwError___at___00Lean_Elab_ConfigEval_evalExprWithElab___at___00__private_Lean_Elab_Tactic_Impossible_0__Lean_Elab_Tactic_elabImpossibleConfig_evalConfigItem_spec__0_spec__1___redArg(v___x_826_, v___y_811_, v___y_806_, v___y_813_, v___y_810_, v___y_808_, v___y_807_);
lean_dec_ref(v___y_808_);
return v___x_827_;
}
}
...
v___x_1854_ = l_Lean_addDecl(v___y_1836_, v___x_1830_, v___x_1853_, v___y_1850_);
...
v___x_1901_ = lean_st_ref_put(v___y_1883_, v___x_1900_);

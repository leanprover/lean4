...
{
uint8_t v___x_820_; 
v___x_820_ = l_Lean_instBEqInternalExceptionId_beq(v___y_807_, v_id_816_);
lean_dec(v_id_816_);
if (v___x_820_ == 0)
{
...
v___x_827_ = l_Lean_throwError___at___00Lean_Elab_ConfigEval_evalExprWithElab___at___00__private_Lean_Elab_Tactic_Impossible_0__Lean_Elab_Tactic_elabImpossibleConfig_evalConfigItem_spec__0_spec__1___redArg(v___x_826_, v___y_809_, v___y_806_, v___y_812_, v___y_814_, v___y_811_, v___y_813_);
lean_dec_ref(v___y_811_);
return v___x_827_;
}
}
...
v___x_1901_ = lean_st_ref_set(v___y_1879_, v___x_1900_);

...
lean_object* l_List_mapTR_loop___at_Lean_Meta_substCore___spec__7(lean_object*, lean_object*);
...
x_10 = lean_box(0);
x_11 = l_List_mapTR_loop___at_Lean_Meta_substCore___spec__7(x_3, x_10);
...
res = l___regBuiltin_Lean_Elab_Tactic_evalInjection_declRange(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
res = l___regBuiltin_Lean_Elab_Tactic_evalInjections_declRange(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

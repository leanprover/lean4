...
{
lean_dec_ref_known(v_entry_808_, 1);
return v___x_864_;
}
}
v___jp_865_:
...
lean_dec_ref_known(v___x_1140_, 14);
return v___x_1141_;
}
}
...
lean_dec(v_expandedMacroDecls_1206_);
...
lean_inc(v_a_1471_);
lean_dec_ref_known(v_r_1445_, 1);

...
x_47 = l___private_Lean_Elab_Tactic_Match_1__mkAuxiliaryMatchTermAux___lambda__1___closed__5;
lean_inc(x_46);
...
lean_inc(x_59);
lean_dec(x_3);
x_61 = l___private_Lean_Elab_Tactic_Match_1__mkAuxiliaryMatchTermAux___lambda__1___closed__5;
lean_inc(x_59);

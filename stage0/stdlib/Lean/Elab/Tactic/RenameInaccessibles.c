...
lean_ctor_set(v___x_996_, 1, v___y_973_);
...
lean_ctor_set_uint8(v___x_996_, sizeof(void*)*5 + 1, v___y_971_);
...
v___x_1039_ = l_Lean_Syntax_getTailPos_x3f(v___y_1034_, v___y_1037_);

...
_start:
{
uint8_t v___x_5519__boxed_492_; lean_object* v_res_493_; 
v___x_5519__boxed_492_ = lean_unbox(v___x_482_);
v_res_493_ = l___private_Lean_Elab_Tactic_Unfold_0__Lean_Elab_Tactic_evalUnfold_go___lam__2(v_declNameId_479_, v___x_480_, v_loc_481_, v___x_5519__boxed_492_, v___y_483_, v___y_484_, v___y_485_, v___y_486_, v___y_487_, v___y_488_, v___y_489_, v___y_490_);
lean_dec(v___y_490_);
lean_dec(v___y_488_);

...
if (builtin) {res = l_Lean_EnvExtensionInterfaceUnsafe_initFn____x40_Lean_Environment___hyg_1071_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
...
if (builtin) {res = l_Lean_initFn____x40_Lean_Environment___hyg_2066_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
...
if (builtin) {res = l_Lean_initFn____x40_Lean_Environment___hyg_4643_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

...
// Module: Lean.ErrorExplanations.DependsOnNoncomputable
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_DependsOnNoncomputable(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Lean.ErrorExplanations.InductiveParamMissing
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_InductiveParamMissing(uint8_t builtin, lean_object* w) {
lean_object * res;

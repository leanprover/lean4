...
// Module: Lean.ErrorExplanations.InferBinderTypeFailed
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_InferBinderTypeFailed(uint8_t builtin, lean_object* w) {
lean_object * res;

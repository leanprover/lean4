...
// Module: Lean.ErrorExplanations.InferDefTypeFailed
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_InferDefTypeFailed(uint8_t builtin, lean_object* w) {
lean_object * res;

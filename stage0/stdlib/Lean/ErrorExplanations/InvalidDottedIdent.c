...
// Module: Lean.ErrorExplanations.InvalidDottedIdent
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_InvalidDottedIdent(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Lean.ErrorExplanations.ProjNonPropFromProp
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_ProjNonPropFromProp(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Lean.ErrorExplanations.PropRecLargeElim
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_PropRecLargeElim(uint8_t builtin, lean_object* w) {
lean_object * res;

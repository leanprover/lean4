...
// Module: Lean.ErrorExplanations.RedundantMatchAlt
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_RedundantMatchAlt(uint8_t builtin, lean_object* w) {
lean_object * res;

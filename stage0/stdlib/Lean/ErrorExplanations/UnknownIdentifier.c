...
// Module: Lean.ErrorExplanations.UnknownIdentifier
...
LEAN_EXPORT lean_object* initialize_Lean_ErrorExplanations_UnknownIdentifier(uint8_t builtin, lean_object* w) {
lean_object * res;

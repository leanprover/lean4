...
// Module: Lean.Fmt.Util
// Imports: public import Lean.Fmt.Util.Basic public import Lean.Fmt.Util.Module public import Lean.Fmt.Util.RangeTree
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Fmt_Util(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Fmt_Util(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lean_Fmt_Util(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Lean_Fmt_Util(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Lean_Fmt_Util(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Lean_Fmt_Util(builtin);
}
#ifdef __cplusplus
}
#endif

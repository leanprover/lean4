...
v_sz_1638_ = lean_array_size(v___y_1631_);
v___x_1639_ = ((size_t)0ULL);
lean_inc(v___y_1624_);
lean_inc(v___y_1626_);
v___x_1640_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_throwUnknownNameWithSuggestions_spec__2(v___y_1630_, v___y_1627_, v___y_1626_, v___y_1624_, v_sz_1638_, v___x_1639_, v___y_1631_);
...
v___y_1656_ = v_currNamespace_1680_;

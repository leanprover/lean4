...
v___x_1640_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_throwUnknownNameWithSuggestions_spec__2(v___y_1631_, v___y_1628_, v___y_1626_, v___y_1630_, v_sz_1638_, v___x_1639_, v___y_1624_);
lean_dec(v___y_1631_);
lean_inc(v___y_1625_);
v___x_1641_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_1641_, 0, v___y_1625_);
v___x_1642_ = lean_box(0);
v___x_1643_ = l_Lean_MessageData_hint(v___x_1637_, v___x_1640_, v___x_1641_, v___x_1642_, v___y_1629_, v_a_1598_, v_a_1599_);

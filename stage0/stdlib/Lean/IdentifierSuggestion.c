...
v_sz_1638_ = lean_array_size(v___y_1630_);
v___x_1639_ = ((size_t)0ULL);
lean_inc(v___y_1625_);
lean_inc(v___y_1626_);
v___x_1640_ = l___private_Init_Data_Array_Basic_0__Array_mapMUnsafe_map___at___00Lean_throwUnknownNameWithSuggestions_spec__2(v___y_1627_, v___y_1629_, v___y_1626_, v___y_1625_, v_sz_1638_, v___x_1639_, v___y_1630_);
lean_dec(v___y_1627_);
lean_inc(v___y_1631_);
v___x_1641_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_1641_, 0, v___y_1631_);
...
v___y_1658_ = v_currNamespace_1680_;
v___y_1659_ = v___y_1673_;
v___y_1660_ = v_env_1679_;

...
LEAN_EXPORT lean_object* l_Lean_initFn____x40_Lean_ImportingFlag___hyg_26_(lean_object*);
...
LEAN_EXPORT lean_object* l_Lean_initFn____x40_Lean_ImportingFlag___hyg_26_(lean_object* x_1) {
_start:
{
uint8_t x_2; lean_object* x_3; lean_object* x_4; uint8_t x_5; 
x_2 = 0;
...
lean_dec_ref(res);
}if (builtin) {res = l_Lean_initFn____x40_Lean_ImportingFlag___hyg_26_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

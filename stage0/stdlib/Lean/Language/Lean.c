...
_start:
{
uint8_t v_val_35340__boxed_1317_; uint8_t v___x_35345__boxed_1318_; lean_object* v_res_1319_; 
v_val_35340__boxed_1317_ = lean_unbox(v_val_1306_);
v___x_35345__boxed_1318_ = lean_unbox(v___x_1311_);
v_res_1319_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__4(v___x_1304_, v___x_1305_, v_val_35340__boxed_1317_, v_val_1307_, v_val_1308_, v___x_1309_, v___x_1310_, v___x_35345__boxed_1318_, v_a_1312_, v_pos_1313_, v___x_1314_, v_infoSt_1315_);
...
_start:
{
uint8_t v_val_35572__boxed_1487_; lean_object* v_res_1488_; 
v_val_35572__boxed_1487_ = lean_unbox(v_val_1483_);
v_res_1488_ = l_Lean_PersistentArray_forInAux___at___00Lean_PersistentArray_forIn___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__4_spec__4(v_init_1479_, v___x_1480_, v___x_1481_, v___x_1482_, v_val_35572__boxed_1487_, v_n_1484_, v_b_1485_);
...
_start:
{
uint8_t v_val_35757__boxed_1602_; lean_object* v_res_1603_; 
v_val_35757__boxed_1602_ = lean_unbox(v_val_1598_);
v_res_1603_ = l_Lean_PersistentArray_forIn___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__4(v___x_1595_, v___x_1596_, v___x_1597_, v_val_35757__boxed_1602_, v_t_1599_, v_init_1600_);
...
v___x_1661_ = l_Lean_Core_getMaxHeartbeats(v_opts_1627_);
...
v___x_1717_ = l_Lean_Kernel_isDiagnosticsEnabled(v_env_1660_);
lean_dec_ref(v_env_1660_);
if (v___x_1664_ == 0)
{
if (v___x_1717_ == 0)
{
v___y_1697_ = v___x_1635_;
goto v___jp_1696_;
}
else
{
v___y_1697_ = v___x_1664_;
goto v___jp_1696_;
}
}
else
{
v___y_1697_ = v___x_1717_;
goto v___jp_1696_;
}
v___jp_1665_:
{
...
v___x_1682_ = lean_alloc_ctor(0, 12, 0);
...
lean_ctor_set(v___x_1682_, 4, v_currNamespace_1668_);
lean_ctor_set(v___x_1682_, 5, v_openDecls_1669_);
lean_ctor_set(v___x_1682_, 6, v_initHeartbeats_1670_);
lean_ctor_set(v___x_1682_, 7, v_maxHeartbeats_1671_);
lean_ctor_set(v___x_1682_, 8, v_quotContext_1672_);
lean_ctor_set(v___x_1682_, 9, v_currMacroScope_1673_);
lean_ctor_set(v___x_1682_, 10, v_cancelTk_x3f_1674_);
lean_ctor_set(v___x_1682_, 11, v_inheritedTraceOptions_1675_);
lean_inc(v_ref_1677_);
v___x_1683_ = lean_alloc_ctor(0, 3, 2);
lean_ctor_set(v___x_1683_, 0, v___x_1682_);
lean_ctor_set(v___x_1683_, 1, v_currRecDepth_1676_);
lean_ctor_set(v___x_1683_, 2, v_ref_1677_);
lean_ctor_set_uint8(v___x_1683_, sizeof(void*)*3, v___x_1664_);
lean_ctor_set_uint8(v___x_1683_, sizeof(void*)*3 + 1, v_suppressElabErrors_1678_);
v___x_1684_ = l_Lean_Language_SnapshotTree_trace(v___x_1628_, v___x_1683_, v___y_1679_);
lean_dec(v___y_1679_);
lean_dec_ref_known(v___x_1683_, 3);
if (lean_obj_tag(v___x_1684_) == 0)
{
lean_object* v___x_1685_; lean_object* v_traceState_1686_; lean_object* v_traces_1687_; lean_object* v___x_1688_; lean_object* v___x_1689_; lean_object* v___x_1690_; lean_object* v___x_1691_; lean_object* v___x_1692_; lean_object* v___x_1693_; 
lean_dec_ref_known(v___x_1684_, 1);
lean_dec_ref(v___x_1633_);
v___x_1685_ = lean_st_ref_get(v___x_1654_);
...
v___x_1689_ = l_Lean_PersistentArray_forIn___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__4(v_fileMap_1659_, v_pos_1629_, v_fileName_1658_, v_val_1630_, v_traces_1687_, v___x_1688_);
lean_dec_ref(v_traces_1687_);
v___x_1690_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v___x_1689_);
v___x_1691_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_1691_, 0, v___x_1631_);
lean_ctor_set(v___x_1691_, 1, v___x_1690_);
lean_ctor_set(v___x_1691_, 2, v___x_1632_);
lean_ctor_set(v___x_1691_, 3, v___x_1624_);
lean_ctor_set_uint8(v___x_1691_, sizeof(void*)*4, v_val_1630_);
v___x_1692_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_1692_, 0, v___x_1691_);
lean_ctor_set(v___x_1692_, 1, v___x_1652_);
...
lean_ctor_set(v___x_1694_, 0, v___x_1633_);
lean_ctor_set(v___x_1694_, 1, v___x_1652_);
v___x_1695_ = lean_task_pure(v___x_1694_);
return v___x_1695_;
}
}
v___jp_1696_:
...
if (v___y_1697_ == 0)
{
lean_object* v___x_1698_; lean_object* v_env_1699_; lean_object* v_nextMacroScope_1700_; lean_object* v_ngen_1701_; lean_object* v_auxDeclNGen_1702_; lean_object* v_traceState_1703_; lean_object* v_messages_1704_; lean_object* v_infoState_1705_; lean_object* v_snapshotTasks_1706_; lean_object* v___x_1708_; uint8_t v_isShared_1709_; uint8_t v_isSharedCheck_1715_; 
v___x_1698_ = lean_st_ref_take(v___x_1654_);
...
v_unused_1716_ = lean_ctor_get(v___x_1698_, 5);
...
v___x_1710_ = l_Lean_Kernel_enableDiag(v_env_1699_, v___x_1664_);
if (v_isShared_1709_ == 0)
{
lean_ctor_set(v___x_1708_, 5, v___x_1645_);
...
lean_ctor_set(v_reuseFailAlloc_1714_, 1, v_nextMacroScope_1700_);
lean_ctor_set(v_reuseFailAlloc_1714_, 2, v_ngen_1701_);
lean_ctor_set(v_reuseFailAlloc_1714_, 3, v_auxDeclNGen_1702_);
lean_ctor_set(v_reuseFailAlloc_1714_, 4, v_traceState_1703_);
lean_ctor_set(v_reuseFailAlloc_1714_, 5, v___x_1645_);
lean_ctor_set(v_reuseFailAlloc_1714_, 6, v_messages_1704_);
lean_ctor_set(v_reuseFailAlloc_1714_, 7, v_infoState_1705_);
lean_ctor_set(v_reuseFailAlloc_1714_, 8, v_snapshotTasks_1706_);
...
v___x_1713_ = lean_st_ref_put(v___x_1654_, v___x_1712_);
...
v_currNamespace_1668_ = v___x_1618_;
v_openDecls_1669_ = v___x_1642_;
v_initHeartbeats_1670_ = v___x_1620_;
v_maxHeartbeats_1671_ = v___x_1661_;
v_quotContext_1672_ = v___x_1618_;
v_currMacroScope_1673_ = v___x_1638_;
v_cancelTk_x3f_1674_ = v___x_1634_;
v_inheritedTraceOptions_1675_ = v___x_1655_;
v_currRecDepth_1676_ = v___x_1620_;
v_ref_1677_ = v___x_1662_;
v_suppressElabErrors_1678_ = v_val_1630_;
...
lean_object* v___x_1718_ = _args[0];
lean_object* v___x_1719_ = _args[1];
lean_object* v___x_1720_ = _args[2];
lean_object* v___x_1721_ = _args[3];
lean_object* v___x_1722_ = _args[4];
lean_object* v_env_1723_ = _args[5];
lean_object* v___x_1724_ = _args[6];
lean_object* v___x_1725_ = _args[7];
lean_object* v_a_1726_ = _args[8];
lean_object* v_opts_1727_ = _args[9];
lean_object* v___x_1728_ = _args[10];
lean_object* v_pos_1729_ = _args[11];
lean_object* v_val_1730_ = _args[12];
lean_object* v___x_1731_ = _args[13];
lean_object* v___x_1732_ = _args[14];
lean_object* v___x_1733_ = _args[15];
lean_object* v___x_1734_ = _args[16];
lean_object* v___x_1735_ = _args[17];
lean_object* v_x_1736_ = _args[18];
lean_object* v___y_1737_ = _args[19];
_start:
{
size_t v___x_35818__boxed_1738_; uint8_t v___x_35819__boxed_1739_; uint8_t v_val_35823__boxed_1740_; uint8_t v___x_35828__boxed_1741_; lean_object* v_res_1742_; 
v___x_35818__boxed_1738_ = lean_unbox_usize(v___x_1721_);
lean_dec(v___x_1721_);
v___x_35819__boxed_1739_ = lean_unbox(v___x_1722_);
v_val_35823__boxed_1740_ = lean_unbox(v_val_1730_);
v___x_35828__boxed_1741_ = lean_unbox(v___x_1735_);
v_res_1742_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3(v___x_1718_, v___x_1719_, v___x_1720_, v___x_35818__boxed_1738_, v___x_35819__boxed_1739_, v_env_1723_, v___x_1724_, v___x_1725_, v_a_1726_, v_opts_1727_, v___x_1728_, v_pos_1729_, v_val_35823__boxed_1740_, v___x_1731_, v___x_1732_, v___x_1733_, v___x_1734_, v___x_35828__boxed_1741_, v_x_1736_);
...
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__2(lean_object* v_a_1743_, lean_object* v___x_1744_, lean_object* v_parserState_1745_, lean_object* v_x_1746_){
_start:
{
lean_object* v_toProcessingContext_1747_; lean_object* v___x_1748_; lean_object* v___x_1749_; 
v_toProcessingContext_1747_ = lean_ctor_get(v_a_1743_, 0);
v___x_1748_ = l_Lean_MessageLog_empty;
lean_inc_ref(v_toProcessingContext_1747_);
v___x_1749_ = l_Lean_Parser_parseCommand(v_toProcessingContext_1747_, v___x_1744_, v_parserState_1745_, v___x_1748_);
return v___x_1749_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__2___boxed(lean_object* v_a_1750_, lean_object* v___x_1751_, lean_object* v_parserState_1752_, lean_object* v_x_1753_){
_start:
{
lean_object* v_res_1754_; 
v_res_1754_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__2(v_a_1750_, v___x_1751_, v_parserState_1752_, v_x_1753_);
lean_dec_ref(v_a_1750_);
return v_res_1754_;
}
}
LEAN_EXPORT lean_object* l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__6___redArg(lean_object* v_as_1756_, size_t v_i_1757_, size_t v_stop_1758_, lean_object* v_b_1759_){
_start:
{
uint8_t v___x_1761_; 
v___x_1761_ = lean_usize_dec_eq(v_i_1757_, v_stop_1758_);
if (v___x_1761_ == 0)
{
lean_object* v___f_1762_; lean_object* v___x_1763_; lean_object* v___x_1764_; size_t v___x_1765_; size_t v___x_1766_; 
v___f_1762_ = ((lean_object*)(l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__6___redArg___closed__0));
v___x_1763_ = lean_array_uget_borrowed(v_as_1756_, v_i_1757_);
lean_inc(v___x_1763_);
v___x_1764_ = l_Lean_Language_SnapshotTask_cancelRec___redArg(v___f_1762_, v___x_1763_);
...
lean_dec(v_i_1769_);
v_stop_boxed_1774_ = lean_unbox_usize(v_stop_1770_);
lean_dec(v_stop_1770_);
v_res_1775_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__6___redArg(v_as_1768_, v_i_boxed_1773_, v_stop_boxed_1774_, v_b_1771_);
lean_dec_ref(v_as_1768_);
return v_res_1775_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__0___boxed(lean_object* v_oldResult_1776_, lean_object* v_cmds_1777_, lean_object* v_stx_1778_, lean_object* v_newParserState_1779_, lean_object* v_val_1780_, lean_object* v_sync_1781_, lean_object* v_val_1782_, lean_object* v_a_1783_, lean_object* v_oldNext_1784_, lean_object* v___y_1785_){
_start:
{
uint8_t v_sync_boxed_1786_; lean_object* v_res_1787_; 
v_sync_boxed_1786_ = lean_unbox(v_sync_1781_);
v_res_1787_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__0(v_oldResult_1776_, v_cmds_1777_, v_stx_1778_, v_newParserState_1779_, v_val_1780_, v_sync_boxed_1786_, v_val_1782_, v_a_1783_, v_oldNext_1784_);
lean_dec_ref(v_a_1783_);
return v_res_1787_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__1(lean_object* v_val_1788_, lean_object* v_cmds_1789_, lean_object* v_stx_1790_, lean_object* v_newParserState_1791_, lean_object* v_val_1792_, uint8_t v_sync_1793_, lean_object* v_val_1794_, lean_object* v_a_1795_, lean_object* v_oldResult_1796_){
_start:
{
lean_object* v_task_1798_; lean_object* v___x_1799_; lean_object* v___f_1800_; lean_object* v___x_1801_; uint8_t v___x_1802_; lean_object* v___x_1803_; 
v_task_1798_ = lean_ctor_get(v_val_1788_, 3);
lean_inc_ref(v_task_1798_);
lean_dec_ref(v_val_1788_);
v___x_1799_ = lean_box(v_sync_1793_);
lean_inc_ref(v_a_1795_);
v___f_1800_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__0___boxed), 10, 8);
lean_closure_set(v___f_1800_, 0, v_oldResult_1796_);
lean_closure_set(v___f_1800_, 1, v_cmds_1789_);
lean_closure_set(v___f_1800_, 2, v_stx_1790_);
lean_closure_set(v___f_1800_, 3, v_newParserState_1791_);
lean_closure_set(v___f_1800_, 4, v_val_1792_);
lean_closure_set(v___f_1800_, 5, v___x_1799_);
lean_closure_set(v___f_1800_, 6, v_val_1794_);
lean_closure_set(v___f_1800_, 7, v_a_1795_);
v___x_1801_ = lean_unsigned_to_nat(0u);
v___x_1802_ = 1;
v___x_1803_ = l_BaseIO_chainTask___redArg(v_task_1798_, v___f_1800_, v___x_1801_, v___x_1802_);
return v___x_1803_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__1___boxed(lean_object* v_val_1804_, lean_object* v_cmds_1805_, lean_object* v_stx_1806_, lean_object* v_newParserState_1807_, lean_object* v_val_1808_, lean_object* v_sync_1809_, lean_object* v_val_1810_, lean_object* v_a_1811_, lean_object* v_oldResult_1812_, lean_object* v___y_1813_){
_start:
{
uint8_t v_sync_boxed_1814_; lean_object* v_res_1815_; 
v_sync_boxed_1814_ = lean_unbox(v_sync_1809_);
v_res_1815_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__1(v_val_1804_, v_cmds_1805_, v_stx_1806_, v_newParserState_1807_, v_val_1808_, v_sync_boxed_1814_, v_val_1810_, v_a_1811_, v_oldResult_1812_);
...
v___x_1823_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__1));
v___x_1824_ = ((lean_object*)(l_Lean_Options_set___at___00Lean_Language_Lean_setOption_spec__0___closed__1));
v___x_1825_ = l_Lean_Name_append(v___x_1824_, v___x_1823_);
return v___x_1825_;
}
}
...
v___x_1826_ = l_Lean_PersistentHashMap_mkEmptyEntriesArray(lean_box(0), lean_box(0));
return v___x_1826_;
}
}
...
v___x_1827_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__3, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__3_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__3);
v___x_1828_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_1828_, 0, v___x_1827_);
return v___x_1828_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5(lean_object* v___x_1830_, lean_object* v_val_1831_, lean_object* v_cmds_1832_, lean_object* v_fst_1833_, lean_object* v_fst_1834_, uint8_t v_val_1835_, lean_object* v_a_1836_, lean_object* v_snd_1837_, lean_object* v___x_1838_, uint8_t v___x_1839_, lean_object* v_fst_1840_, lean_object* v_val_1841_, lean_object* v_val_1842_, lean_object* v_val_1843_, lean_object* v_snd_1844_, lean_object* v_prom_1845_, lean_object* v___x_1846_, lean_object* v___f_1847_, lean_object* v___f_1848_, lean_object* v___f_1849_, lean_object* v_pos_1850_, lean_object* v_cmdState_1851_, lean_object* v___x_1852_, lean_object* v_opts_1853_, lean_object* v___x_1854_, lean_object* v_old_x3f_1855_, lean_object* v_parseCancelTk_1856_, lean_object* v_next_x3f_1857_){
_start:
{
lean_object* v___y_1860_; lean_object* v___y_1861_; lean_object* v___y_1862_; lean_object* v___y_1863_; lean_object* v_snapshotTasks_1864_; lean_object* v___y_1865_; lean_object* v_traceTask_1866_; lean_object* v___y_1877_; lean_object* v___y_1878_; lean_object* v___y_1879_; lean_object* v___y_1880_; lean_object* v___y_1881_; lean_object* v___y_1882_; lean_object* v___y_1888_; lean_object* v___y_1889_; lean_object* v___y_1890_; lean_object* v___y_1891_; lean_object* v___y_1892_; size_t v___y_1893_; lean_object* v___y_1894_; lean_object* v___y_1895_; lean_object* v___y_1896_; lean_object* v___y_1897_; lean_object* v___y_1898_; lean_object* v___y_1899_; lean_object* v___y_1900_; lean_object* v___y_1901_; lean_object* v___y_1902_; lean_object* v___y_1903_; lean_object* v___y_1904_; lean_object* v_env_1905_; lean_object* v_messages_1906_; lean_object* v_scopes_1907_; lean_object* v_infoState_1908_; lean_object* v_traceState_1909_; lean_object* v_snapshotTasks_1910_; lean_object* v___y_1911_; lean_object* v___y_1912_; lean_object* v___y_1913_; lean_object* v___y_1914_; lean_object* v___y_1915_; lean_object* v_reportedCmdState_1916_; lean_object* v___y_1951_; lean_object* v___y_1952_; lean_object* v___y_1953_; lean_object* v___y_1954_; size_t v___y_1955_; lean_object* v___y_1956_; lean_object* v___y_1957_; lean_object* v___y_1958_; lean_object* v___y_1959_; lean_object* v___y_1960_; lean_object* v___y_1961_; lean_object* v___y_1962_; lean_object* v___y_1963_; lean_object* v___y_1964_; lean_object* v___y_1965_; lean_object* v___y_1966_; lean_object* v___y_1967_; lean_object* v___y_1968_; lean_object* v___y_1969_; lean_object* v___y_1970_; lean_object* v___y_1971_; lean_object* v___y_1972_; lean_object* v_reportedCmdState_1973_; lean_object* v___y_1981_; lean_object* v___y_1982_; lean_object* v___y_1983_; lean_object* v___y_1984_; size_t v___y_1985_; lean_object* v___y_1986_; lean_object* v___y_1987_; lean_object* v___y_1988_; lean_object* v___y_1989_; lean_object* v___y_1990_; lean_object* v___y_1991_; size_t v___y_1992_; lean_object* v___y_1993_; lean_object* v___y_1994_; lean_object* v___y_1995_; lean_object* v___y_1996_; lean_object* v___y_1997_; lean_object* v___y_1998_; lean_object* v___y_1999_; lean_object* v___y_2000_; lean_object* v___y_2001_; lean_object* v___y_2002_; lean_object* v___y_2003_; lean_object* v___y_2004_; lean_object* v___y_2037_; 
if (lean_obj_tag(v_next_x3f_1857_) == 0)
{
lean_object* v___x_2090_; 
lean_dec_ref(v_parseCancelTk_1856_);
...
{
lean_object* v_toProcessingContext_2091_; lean_object* v_val_2092_; lean_object* v_pos_2093_; lean_object* v_endPos_2094_; lean_object* v___x_2095_; lean_object* v___x_2096_; lean_object* v___x_2097_; lean_object* v___x_2098_; lean_object* v___x_2099_; lean_object* v___x_2100_; lean_object* v___x_2101_; 
v_toProcessingContext_2091_ = lean_ctor_get(v_a_1836_, 0);
v_val_2092_ = lean_ctor_get(v_next_x3f_1857_, 0);
v_pos_2093_ = lean_ctor_get(v_fst_1834_, 0);
v_endPos_2094_ = lean_ctor_get(v_toProcessingContext_2091_, 3);
v___x_2095_ = lean_box(0);
lean_inc(v_endPos_2094_);
lean_inc(v_pos_2093_);
v___x_2096_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2096_, 0, v_pos_2093_);
lean_ctor_set(v___x_2096_, 1, v_endPos_2094_);
v___x_2097_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2097_, 0, v___x_2096_);
v___x_2098_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2098_, 0, v_parseCancelTk_1856_);
v___x_2099_ = l_IO_Promise_result_x21___redArg(v_val_2092_);
...
lean_ctor_set(v___x_1867_, 0, v___y_1862_);
lean_ctor_set(v___x_1867_, 1, v___x_1830_);
lean_ctor_set(v___x_1867_, 2, v___y_1861_);
lean_ctor_set(v___x_1867_, 3, v_traceTask_1866_);
v___x_1868_ = lean_array_push(v_snapshotTasks_1864_, v___x_1867_);
v___x_1869_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_1869_, 0, v___y_1860_);
lean_ctor_set(v___x_1869_, 1, v___x_1868_);
v___x_1870_ = lean_io_promise_resolve(v___x_1869_, v_val_1831_);
if (lean_obj_tag(v_next_x3f_1857_) == 1)
{
lean_object* v_val_1871_; lean_object* v___x_1872_; lean_object* v___x_1873_; lean_object* v___x_1874_; 
v_val_1871_ = lean_ctor_get(v_next_x3f_1857_, 0);
lean_inc(v_val_1871_);
lean_dec_ref_known(v_next_x3f_1857_, 1);
v___x_1872_ = lean_box(0);
v___x_1873_ = lean_array_push(v_cmds_1832_, v_fst_1833_);
v___x_1874_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(v___x_1872_, v_fst_1834_, v___y_1863_, v_val_1871_, v_val_1835_, v___y_1865_, v___x_1873_, v_a_1836_);
return v___x_1874_;
}
else
{
...
lean_dec(v_next_x3f_1857_);
lean_dec_ref(v_fst_1834_);
lean_dec(v_fst_1833_);
lean_dec_ref(v_cmds_1832_);
...
v___x_1884_ = lean_mk_empty_array_with_capacity(v___y_1881_);
lean_dec(v___y_1881_);
lean_inc_ref(v___y_1877_);
v___x_1885_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_1885_, 0, v___y_1877_);
...
v_snapshotTasks_1864_ = v_snapshotTasks_1883_;
v___y_1865_ = v___y_1882_;
v_traceTask_1866_ = v___x_1886_;
goto v___jp_1859_;
}
v___jp_1887_:
{
lean_object* v___x_1917_; lean_object* v___x_1918_; lean_object* v___x_1919_; lean_object* v___x_1920_; lean_object* v___x_1921_; lean_object* v___x_1922_; lean_object* v___x_1923_; lean_object* v___x_1924_; lean_object* v___x_1925_; lean_object* v_opts_1926_; uint8_t v_hasTrace_1927_; 
v___x_1917_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_messages_1906_);
v___x_1918_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_1918_, 0, v___y_1914_);
lean_ctor_set(v___x_1918_, 1, v___x_1917_);
lean_ctor_set(v___x_1918_, 2, v___y_1903_);
lean_ctor_set(v___x_1918_, 3, v_traceState_1909_);
lean_ctor_set_uint8(v___x_1918_, sizeof(void*)*4, v_val_1835_);
v___x_1919_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_1919_, 0, v___x_1918_);
lean_ctor_set(v___x_1919_, 1, v_reportedCmdState_1916_);
v___x_1920_ = lean_io_promise_resolve(v___x_1919_, v_val_1842_);
v___x_1921_ = l_Lean_Elab_InfoState_substituteLazy(v_infoState_1908_);
lean_inc(v___y_1913_);
v___x_1922_ = l_BaseIO_chainTask___redArg(v___x_1921_, v___y_1911_, v___y_1913_, v___x_1839_);
v___x_1923_ = l_Lean_inheritedTraceOptions;
v___x_1924_ = lean_st_ref_get(v___x_1923_);
v___x_1925_ = l_List_head_x21___redArg(v___x_1846_, v_scopes_1907_);
lean_dec(v_scopes_1907_);
lean_dec_ref(v___x_1846_);
v_opts_1926_ = lean_ctor_get(v___x_1925_, 1);
lean_inc_ref(v_opts_1926_);
lean_dec(v___x_1925_);
v_hasTrace_1927_ = lean_ctor_get_uint8(v_opts_1926_, sizeof(void*)*1);
...
lean_dec_ref(v_snapshotTasks_1910_);
...
v___x_1928_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2);
v___x_1929_ = l___private_Lean_Util_Trace_0__Lean_checkTraceOption_go(v___x_1924_, v_opts_1926_, v___x_1928_);
lean_dec(v___x_1924_);
if (v___x_1929_ == 0)
{
lean_dec_ref(v_opts_1926_);
...
v___x_1930_ = lean_task_map(v___f_1847_, v___y_1896_, v___y_1913_, v___x_1839_);
...
lean_ctor_set(v___x_1931_, 1, v___y_1901_);
lean_ctor_set(v___x_1931_, 2, v___y_1897_);
lean_ctor_set(v___x_1931_, 3, v___x_1930_);
v___x_1932_ = lean_task_map(v___f_1848_, v___y_1912_, v___y_1913_, v___x_1839_);
v___x_1933_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_1933_, 0, v___y_1899_);
lean_ctor_set(v___x_1933_, 1, v___y_1901_);
lean_ctor_set(v___x_1933_, 2, v___y_1897_);
lean_ctor_set(v___x_1933_, 3, v___x_1932_);
v___x_1934_ = lean_task_map(v___f_1849_, v___y_1915_, v___y_1913_, v___x_1839_);
v___x_1935_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_1935_, 0, v___y_1899_);
lean_ctor_set(v___x_1935_, 1, v___y_1901_);
lean_ctor_set(v___x_1935_, 2, v___y_1897_);
...
v___x_1940_ = lean_array_push(v___x_1939_, v___x_1935_);
v___x_1941_ = l_Array_append___redArg(v___x_1940_, v_snapshotTasks_1910_);
lean_inc_ref(v___y_1902_);
v___x_1942_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_1942_, 0, v___y_1902_);
lean_ctor_set(v___x_1942_, 1, v___x_1941_);
lean_inc_ref(v___x_1942_);
v___x_1943_ = l_Lean_Language_SnapshotTree_waitAll(v___x_1942_);
v___x_1944_ = lean_box_usize(v___y_1893_);
v___x_1945_ = lean_box(v___x_1839_);
v___x_1946_ = lean_box(v_val_1835_);
v___x_1947_ = lean_box(v___x_1929_);
lean_inc_ref(v_a_1836_);
lean_inc_ref(v___y_1892_);
v___f_1948_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___boxed), 20, 18);
lean_closure_set(v___f_1948_, 0, v___x_1838_);
lean_closure_set(v___f_1948_, 1, v___y_1890_);
lean_closure_set(v___f_1948_, 2, v___y_1895_);
lean_closure_set(v___f_1948_, 3, v___x_1944_);
lean_closure_set(v___f_1948_, 4, v___x_1945_);
lean_closure_set(v___f_1948_, 5, v_env_1905_);
lean_closure_set(v___f_1948_, 6, v___y_1892_);
lean_closure_set(v___f_1948_, 7, v___x_1923_);
lean_closure_set(v___f_1948_, 8, v_a_1836_);
lean_closure_set(v___f_1948_, 9, v_opts_1926_);
lean_closure_set(v___f_1948_, 10, v___x_1942_);
lean_closure_set(v___f_1948_, 11, v_pos_1850_);
lean_closure_set(v___f_1948_, 12, v___x_1946_);
lean_closure_set(v___f_1948_, 13, v___y_1889_);
lean_closure_set(v___f_1948_, 14, v___y_1888_);
lean_closure_set(v___f_1948_, 15, v___y_1891_);
lean_closure_set(v___f_1948_, 16, v___y_1894_);
lean_closure_set(v___f_1948_, 17, v___x_1947_);
v___x_1949_ = lean_io_bind_task(v___x_1943_, v___f_1948_, v___y_1913_, v_val_1835_);
v___y_1860_ = v___y_1902_;
v___y_1861_ = v___y_1897_;
v___y_1862_ = v___y_1898_;
v___y_1863_ = v___y_1904_;
v_snapshotTasks_1864_ = v_snapshotTasks_1910_;
v___y_1865_ = v___y_1900_;
v_traceTask_1866_ = v___x_1949_;
goto v___jp_1859_;
}
}
}
v___jp_1950_:
{
lean_object* v_env_1974_; lean_object* v_messages_1975_; lean_object* v_scopes_1976_; lean_object* v_infoState_1977_; lean_object* v_traceState_1978_; lean_object* v_snapshotTasks_1979_; 
v_env_1974_ = lean_ctor_get(v___y_1967_, 0);
lean_inc_ref(v_env_1974_);
v_messages_1975_ = lean_ctor_get(v___y_1967_, 1);
lean_inc_ref(v_messages_1975_);
v_scopes_1976_ = lean_ctor_get(v___y_1967_, 2);
lean_inc(v_scopes_1976_);
v_infoState_1977_ = lean_ctor_get(v___y_1967_, 8);
lean_inc_ref(v_infoState_1977_);
v_traceState_1978_ = lean_ctor_get(v___y_1967_, 9);
lean_inc_ref(v_traceState_1978_);
v_snapshotTasks_1979_ = lean_ctor_get(v___y_1967_, 10);
lean_inc_ref(v_snapshotTasks_1979_);
...
v_env_1905_ = v_env_1974_;
v_messages_1906_ = v_messages_1975_;
v_scopes_1907_ = v_scopes_1976_;
v_infoState_1908_ = v_infoState_1977_;
v_traceState_1909_ = v_traceState_1978_;
v_snapshotTasks_1910_ = v_snapshotTasks_1979_;
v___y_1911_ = v___y_1968_;
v___y_1912_ = v___y_1969_;
v___y_1913_ = v___y_1970_;
v___y_1914_ = v___y_1971_;
v___y_1915_ = v___y_1972_;
v_reportedCmdState_1916_ = v_reportedCmdState_1973_;
goto v___jp_1887_;
}
v___jp_1980_:
{
lean_object* v___x_2005_; lean_object* v___x_2006_; lean_object* v___x_2007_; lean_object* v___x_2008_; lean_object* v___f_2009_; uint8_t v___x_2010_; 
v___x_2005_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2005_, 0, v___y_2004_);
lean_ctor_set(v___x_2005_, 1, v_val_1841_);
lean_inc_ref(v___y_1994_);
lean_inc_n(v_pos_1850_, 2);
lean_inc_ref(v_cmds_1832_);
lean_inc(v_fst_1833_);
v___x_2006_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab(v_fst_1833_, v_cmds_1832_, v_cmdState_1851_, v_pos_1850_, v___x_2005_, v___y_1994_, v_a_1836_);
v___x_2007_ = lean_box(v_val_1835_);
v___x_2008_ = lean_box(v___x_1839_);
lean_inc_ref(v_a_1836_);
...
v___f_2009_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__4___boxed), 13, 11);
lean_closure_set(v___f_2009_, 0, v___y_1982_);
lean_closure_set(v___f_2009_, 1, v___y_1986_);
lean_closure_set(v___f_2009_, 2, v___x_2007_);
lean_closure_set(v___f_2009_, 3, v_val_1843_);
lean_closure_set(v___f_2009_, 4, v___x_2006_);
lean_closure_set(v___f_2009_, 5, v___x_1846_);
lean_closure_set(v___f_2009_, 6, v___y_1988_);
lean_closure_set(v___f_2009_, 7, v___x_2008_);
lean_closure_set(v___f_2009_, 8, v_a_1836_);
lean_closure_set(v___f_2009_, 9, v_pos_1850_);
lean_closure_set(v___f_2009_, 10, v___x_1852_);
v___x_2010_ = l_Lean_Option_get___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__1(v_opts_1853_, v___x_1854_);
if (v___x_2010_ == 0)
{
...
v___y_1968_ = v___f_2009_;
v___y_1969_ = v___y_1999_;
v___y_1970_ = v___y_2000_;
v___y_1971_ = v___y_2002_;
v___y_1972_ = v___y_2003_;
v_reportedCmdState_1973_ = v___x_2006_;
goto v___jp_1950_;
}
else
{
uint8_t v___x_2011_; 
lean_inc(v_fst_1833_);
v___x_2011_ = l_Lean_Parser_isTerminalCommand(v_fst_1833_);
if (v___x_2011_ == 0)
{
if (v___x_2010_ == 0)
{
...
{
lean_object* v_env_2012_; lean_object* v_messages_2013_; lean_object* v_scopes_2014_; lean_object* v_infoState_2015_; lean_object* v_traceState_2016_; lean_object* v_snapshotTasks_2017_; lean_object* v___x_2018_; lean_object* v___x_2019_; lean_object* v___x_2020_; lean_object* v___x_2021_; lean_object* v___x_2022_; lean_object* v___x_2023_; lean_object* v___x_2024_; lean_object* v___x_2025_; lean_object* v___x_2026_; lean_object* v___x_2027_; lean_object* v___x_2028_; lean_object* v___x_2029_; lean_object* v___x_2030_; lean_object* v___x_2031_; lean_object* v___x_2032_; lean_object* v___x_2033_; lean_object* v___x_2034_; lean_object* v___x_2035_; 
v_env_2012_ = lean_ctor_get(v___x_2006_, 0);
lean_inc_ref_n(v_env_2012_, 2);
v_messages_2013_ = lean_ctor_get(v___x_2006_, 1);
lean_inc_ref(v_messages_2013_);
v_scopes_2014_ = lean_ctor_get(v___x_2006_, 2);
lean_inc(v_scopes_2014_);
v_infoState_2015_ = lean_ctor_get(v___x_2006_, 8);
lean_inc_ref(v_infoState_2015_);
v_traceState_2016_ = lean_ctor_get(v___x_2006_, 9);
lean_inc_ref(v_traceState_2016_);
v_snapshotTasks_2017_ = lean_ctor_get(v___x_2006_, 10);
lean_inc_ref(v_snapshotTasks_2017_);
v___x_2018_ = lean_mk_empty_array_with_capacity(v___y_1998_);
lean_dec(v___y_1998_);
lean_inc_ref(v___x_2018_);
v___x_2019_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_2019_, 0, v___x_2018_);
lean_inc_n(v___y_2000_, 3);
...
lean_ctor_set(v___x_2020_, 2, v___y_2000_);
lean_ctor_set(v___x_2020_, 3, v___y_2000_);
lean_ctor_set_usize(v___x_2020_, 4, v___y_1992_);
v___x_2021_ = l_Lean_NameSet_empty;
...
v___x_2023_ = ((lean_object*)(l_Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10___closed__0));
v___x_2024_ = l_Lean_Options_empty;
v___x_2025_ = lean_box(0);
v___x_2026_ = lean_mk_empty_array_with_capacity(v___y_2000_);
lean_inc_ref_n(v___x_2026_, 3);
lean_inc_n(v___x_1838_, 2);
v___x_2027_ = lean_alloc_ctor(0, 10, 3);
lean_ctor_set(v___x_2027_, 0, v___x_2023_);
lean_ctor_set(v___x_2027_, 1, v___x_2024_);
lean_ctor_set(v___x_2027_, 2, v___x_1838_);
lean_ctor_set(v___x_2027_, 3, v___x_2025_);
lean_ctor_set(v___x_2027_, 4, v___x_2025_);
lean_ctor_set(v___x_2027_, 5, v___x_2026_);
lean_ctor_set(v___x_2027_, 6, v___x_2026_);
lean_ctor_set(v___x_2027_, 7, v___x_2025_);
lean_ctor_set(v___x_2027_, 8, v___x_2025_);
lean_ctor_set(v___x_2027_, 9, v___x_2025_);
lean_ctor_set_uint8(v___x_2027_, sizeof(void*)*10, v_val_1835_);
lean_ctor_set_uint8(v___x_2027_, sizeof(void*)*10 + 1, v_val_1835_);
lean_ctor_set_uint8(v___x_2027_, sizeof(void*)*10 + 2, v_val_1835_);
v___x_2028_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_2028_, 0, v___x_2027_);
lean_ctor_set(v___x_2028_, 1, v___x_2025_);
v___x_2029_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0);
v___x_2030_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__3));
v___x_2031_ = l_Lean_DeclNameGenerator_ofPrefix(v___x_1838_);
v___x_2032_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4);
v___x_2033_ = lean_alloc_ctor(0, 3, 1);
lean_ctor_set(v___x_2033_, 0, v___x_2032_);
lean_ctor_set(v___x_2033_, 1, v___x_2032_);
lean_ctor_set(v___x_2033_, 2, v___x_2020_);
lean_ctor_set_uint8(v___x_2033_, sizeof(void*)*3, v___x_1839_);
v___x_2034_ = lean_box(0);
lean_inc_ref(v___y_2001_);
v___x_2035_ = lean_alloc_ctor(0, 13, 0);
lean_ctor_set(v___x_2035_, 0, v_env_2012_);
lean_ctor_set(v___x_2035_, 1, v___x_2022_);
lean_ctor_set(v___x_2035_, 2, v___x_2028_);
lean_ctor_set(v___x_2035_, 3, v___x_2021_);
lean_ctor_set(v___x_2035_, 4, v___x_2029_);
lean_ctor_set(v___x_2035_, 5, v___y_2000_);
lean_ctor_set(v___x_2035_, 6, v___x_2030_);
lean_ctor_set(v___x_2035_, 7, v___x_2031_);
lean_ctor_set(v___x_2035_, 8, v___x_2033_);
lean_ctor_set(v___x_2035_, 9, v___y_2001_);
lean_ctor_set(v___x_2035_, 10, v___x_2026_);
lean_ctor_set(v___x_2035_, 11, v___x_2034_);
lean_ctor_set(v___x_2035_, 12, v___x_2026_);
v___y_1888_ = v___y_1981_;
v___y_1889_ = v___y_1982_;
v___y_1890_ = v___y_1983_;
v___y_1891_ = v___y_1984_;
v___y_1892_ = v___y_1986_;
...
v___y_1903_ = v___y_1997_;
v___y_1904_ = v___x_2006_;
v_env_1905_ = v_env_2012_;
v_messages_1906_ = v_messages_2013_;
v_scopes_1907_ = v_scopes_2014_;
v_infoState_1908_ = v_infoState_2015_;
v_traceState_1909_ = v_traceState_2016_;
v_snapshotTasks_1910_ = v_snapshotTasks_2017_;
v___y_1911_ = v___f_2009_;
v___y_1912_ = v___y_1999_;
v___y_1913_ = v___y_2000_;
v___y_1914_ = v___y_2002_;
v___y_1915_ = v___y_2003_;
v_reportedCmdState_1916_ = v___x_2035_;
goto v___jp_1887_;
}
}
else
...
v___jp_2036_:
{
lean_object* v___x_2038_; lean_object* v___x_2039_; lean_object* v___x_2040_; lean_object* v___x_2041_; lean_object* v___x_2042_; lean_object* v___x_2043_; lean_object* v___x_2044_; lean_object* v___x_2045_; lean_object* v___x_2046_; lean_object* v___x_2047_; lean_object* v___x_2048_; lean_object* v___x_2049_; lean_object* v___x_2050_; lean_object* v___x_2051_; lean_object* v___x_2052_; lean_object* v___x_2053_; lean_object* v___x_2054_; lean_object* v___x_2055_; lean_object* v___x_2056_; lean_object* v___x_2057_; lean_object* v___x_2058_; size_t v___x_2059_; lean_object* v___x_2060_; lean_object* v___x_2061_; lean_object* v___x_2062_; lean_object* v___x_2063_; lean_object* v___x_2064_; lean_object* v___x_2065_; lean_object* v___x_2066_; lean_object* v___x_2067_; lean_object* v___x_2068_; lean_object* v___x_2069_; lean_object* v___x_2070_; lean_object* v___x_2071_; lean_object* v___x_2072_; lean_object* v___x_2073_; lean_object* v___x_2074_; lean_object* v___x_2075_; lean_object* v___x_2076_; lean_object* v___x_2077_; 
v___x_2038_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_snd_1837_);
v___x_2039_ = l_IO_CancelToken_new();
v___x_2040_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__0));
lean_inc(v___x_1838_);
v___x_2041_ = l_Lean_Name_str___override(v___x_1838_, v___x_2040_);
v___x_2042_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__2));
v___x_2043_ = l_Lean_Name_str___override(v___x_2041_, v___x_2042_);
v___x_2044_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__4));
v___x_2045_ = l_Lean_Name_str___override(v___x_2043_, v___x_2044_);
v___x_2046_ = l_Lean_Name_str___override(v___x_2045_, v___x_2042_);
v___x_2047_ = lean_unsigned_to_nat(0u);
v___x_2048_ = l_Lean_Name_num___override(v___x_2046_, v___x_2047_);
v___x_2049_ = l_Lean_Name_str___override(v___x_2048_, v___x_2042_);
v___x_2050_ = l_Lean_Name_str___override(v___x_2049_, v___x_2044_);
v___x_2051_ = l_Lean_Name_str___override(v___x_2050_, v___x_2042_);
v___x_2052_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab___closed__0));
v___x_2053_ = l_Lean_Name_str___override(v___x_2051_, v___x_2052_);
v___x_2054_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__5));
v___x_2055_ = l_Lean_Name_str___override(v___x_2053_, v___x_2054_);
v___x_2056_ = l_Lean_Name_toString(v___x_2055_, v___x_1839_);
v___x_2057_ = lean_box(0);
v___x_2058_ = lean_unsigned_to_nat(32u);
v___x_2059_ = ((size_t)5ULL);
v___x_2060_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
lean_inc_ref_n(v___x_2056_, 2);
v___x_2061_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2061_, 0, v___x_2056_);
lean_ctor_set(v___x_2061_, 1, v___x_2038_);
lean_ctor_set(v___x_2061_, 2, v___x_2057_);
lean_ctor_set(v___x_2061_, 3, v___x_2060_);
lean_ctor_set_uint8(v___x_2061_, sizeof(void*)*4, v_val_1835_);
v___x_2062_ = l_Lean_Language_Snapshot_Diagnostics_empty;
v___x_2063_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2063_, 0, v___x_2056_);
lean_ctor_set(v___x_2063_, 1, v___x_2062_);
lean_ctor_set(v___x_2063_, 2, v___x_2057_);
lean_ctor_set(v___x_2063_, 3, v___x_2060_);
lean_ctor_set_uint8(v___x_2063_, sizeof(void*)*4, v_val_1835_);
lean_inc(v_fst_1840_);
v___x_2064_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2064_, 0, v_fst_1840_);
v___x_2065_ = l_Lean_Language_SnapshotTask_defaultReportingRange(v___x_2064_);
lean_inc_ref(v___x_2039_);
v___x_2066_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2066_, 0, v___x_2039_);
v___x_2067_ = l_IO_Promise_result_x21___redArg(v_val_1841_);
lean_inc_ref(v___x_2067_);
lean_inc(v___x_2065_);
lean_inc_ref_n(v___x_2064_, 3);
...
v___x_2069_ = l_IO_Promise_result_x21___redArg(v_val_1842_);
...
lean_ctor_set(v___x_2070_, 2, v___x_2057_);
lean_ctor_set(v___x_2070_, 3, v___x_2069_);
v___x_2071_ = l_IO_Promise_result_x21___redArg(v_val_1843_);
lean_inc_ref(v___x_2071_);
v___x_2072_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2072_, 0, v___x_2064_);
lean_ctor_set(v___x_2072_, 1, v___x_1830_);
lean_ctor_set(v___x_2072_, 2, v___x_2057_);
lean_ctor_set(v___x_2072_, 3, v___x_2071_);
v___x_2073_ = l_IO_Promise_result_x21___redArg(v_val_1831_);
v___x_2074_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2074_, 0, v___x_2057_);
lean_ctor_set(v___x_2074_, 1, v___x_1830_);
lean_ctor_set(v___x_2074_, 2, v___x_2057_);
lean_ctor_set(v___x_2074_, 3, v___x_2073_);
lean_inc_ref(v___x_2063_);
v___x_2075_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2075_, 0, v___x_2063_);
lean_ctor_set(v___x_2075_, 1, v___x_2068_);
lean_ctor_set(v___x_2075_, 2, v___x_2070_);
lean_ctor_set(v___x_2075_, 3, v___x_2072_);
lean_ctor_set(v___x_2075_, 4, v___x_2074_);
v___x_2076_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2076_, 0, v___x_2061_);
lean_ctor_set(v___x_2076_, 1, v_fst_1840_);
lean_ctor_set(v___x_2076_, 2, v_snd_1844_);
lean_ctor_set(v___x_2076_, 3, v___x_2075_);
lean_ctor_set(v___x_2076_, 4, v___y_2037_);
v___x_2077_ = lean_io_promise_resolve(v___x_2076_, v_prom_1845_);
if (lean_obj_tag(v_old_x3f_1855_) == 0)
{
lean_inc_ref(v___x_2063_);
lean_inc_ref(v___x_2056_);
v___y_1981_ = v___x_2057_;
v___y_1982_ = v___x_2056_;
v___y_1983_ = v___x_2058_;
v___y_1984_ = v___x_2063_;
v___y_1985_ = v___x_2059_;
v___y_1986_ = v___x_2060_;
v___y_1987_ = v___x_2057_;
v___y_1988_ = v___x_2047_;
v___y_1989_ = v___x_2067_;
v___y_1990_ = v___x_2057_;
v___y_1991_ = v___x_2057_;
v___y_1992_ = v___x_2059_;
v___y_1993_ = v___x_2064_;
v___y_1994_ = v___x_2039_;
v___y_1995_ = v___x_2065_;
v___y_1996_ = v___x_2063_;
v___y_1997_ = v___x_2057_;
v___y_1998_ = v___x_2058_;
v___y_1999_ = v___x_2069_;
v___y_2000_ = v___x_2047_;
v___y_2001_ = v___x_2060_;
v___y_2002_ = v___x_2056_;
v___y_2003_ = v___x_2071_;
...
v_val_2078_ = lean_ctor_get(v_old_x3f_1855_, 0);
v_isSharedCheck_2089_ = !lean_is_exclusive(v_old_x3f_1855_);
if (v_isSharedCheck_2089_ == 0)
{
v___x_2080_ = v_old_x3f_1855_;
...
v_resetjp_2079_:
{
lean_object* v_elabSnap_2082_; lean_object* v_stx_2083_; lean_object* v_elabSnap_2084_; lean_object* v___x_2085_; lean_object* v___x_2087_; 
v_elabSnap_2082_ = lean_ctor_get(v_val_2078_, 3);
lean_inc_ref(v_elabSnap_2082_);
v_stx_2083_ = lean_ctor_get(v_val_2078_, 1);
lean_inc(v_stx_2083_);
lean_dec(v_val_2078_);
v_elabSnap_2084_ = lean_ctor_get(v_elabSnap_2082_, 1);
lean_inc_ref(v_elabSnap_2084_);
lean_dec_ref(v_elabSnap_2082_);
v___x_2085_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2085_, 0, v_stx_2083_);
lean_ctor_set(v___x_2085_, 1, v_elabSnap_2084_);
...
v___x_2102_ = l_Lean_Language_instInhabitedDynamicSnapshot;
v___x_2103_ = l_Lean_Language_instInhabitedSnapshotTask_default___redArg(v___x_2102_);
return v___x_2103_;
}
}
...
v___x_2104_ = l_Lean_Language_instInhabitedSnapshotTree_default;
v___x_2105_ = l_Lean_Language_instInhabitedSnapshotTask_default___redArg(v___x_2104_);
return v___x_2105_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__8(lean_object* v_cmds_2106_, lean_object* v_fst_2107_, lean_object* v_fst_2108_, uint8_t v_val_2109_, lean_object* v_a_2110_, lean_object* v_snd_2111_, lean_object* v___x_2112_, uint8_t v___x_2113_, lean_object* v_prom_2114_, lean_object* v___x_2115_, lean_object* v___f_2116_, lean_object* v___f_2117_, lean_object* v___f_2118_, lean_object* v_pos_2119_, lean_object* v_cmdState_2120_, lean_object* v___x_2121_, lean_object* v_opts_2122_, lean_object* v_old_x3f_2123_, lean_object* v_parseCancelTk_2124_){
_start:
{
lean_object* v___x_2126_; lean_object* v___x_2127_; lean_object* v___x_2128_; lean_object* v___x_2129_; lean_object* v___y_2131_; lean_object* v___y_2132_; lean_object* v___y_2133_; lean_object* v___y_2134_; lean_object* v_snapshotTasks_2135_; lean_object* v___y_2136_; lean_object* v___y_2137_; lean_object* v___y_2138_; lean_object* v_traceTask_2139_; lean_object* v___y_2150_; lean_object* v___y_2151_; lean_object* v___y_2152_; lean_object* v___y_2153_; lean_object* v___y_2154_; lean_object* v___y_2155_; lean_object* v___y_2156_; lean_object* v___y_2157_; lean_object* v___y_2163_; size_t v___y_2164_; lean_object* v___y_2165_; lean_object* v___y_2166_; lean_object* v___y_2167_; lean_object* v___y_2168_; lean_object* v___y_2169_; lean_object* v___y_2170_; lean_object* v___y_2171_; lean_object* v___y_2172_; lean_object* v___y_2173_; lean_object* v___y_2174_; lean_object* v___y_2175_; lean_object* v___y_2176_; lean_object* v___y_2177_; lean_object* v_env_2178_; lean_object* v_messages_2179_; lean_object* v_scopes_2180_; lean_object* v_infoState_2181_; lean_object* v_traceState_2182_; lean_object* v_snapshotTasks_2183_; lean_object* v___y_2184_; lean_object* v___y_2185_; lean_object* v___y_2186_; lean_object* v___y_2187_; lean_object* v___y_2188_; lean_object* v___y_2189_; lean_object* v___y_2190_; lean_object* v___y_2191_; lean_object* v___y_2192_; lean_object* v_reportedCmdState_2193_; lean_object* v___y_2228_; size_t v___y_2229_; lean_object* v___y_2230_; lean_object* v___y_2231_; lean_object* v___y_2232_; lean_object* v___y_2233_; lean_object* v___y_2234_; lean_object* v___y_2235_; lean_object* v___y_2236_; lean_object* v___y_2237_; lean_object* v___y_2238_; lean_object* v___y_2239_; lean_object* v___y_2240_; lean_object* v___y_2241_; lean_object* v___y_2242_; lean_object* v___y_2243_; lean_object* v___y_2244_; lean_object* v___y_2245_; lean_object* v___y_2246_; lean_object* v___y_2247_; lean_object* v___y_2248_; lean_object* v___y_2249_; lean_object* v___y_2250_; lean_object* v___y_2251_; lean_object* v_reportedCmdState_2252_; lean_object* v___x_2259_; lean_object* v___y_2261_; size_t v___y_2262_; lean_object* v___y_2263_; lean_object* v___y_2264_; lean_object* v___y_2265_; lean_object* v___y_2266_; lean_object* v___y_2267_; lean_object* v___y_2268_; lean_object* v___y_2269_; lean_object* v___y_2270_; lean_object* v___y_2271_; lean_object* v___y_2272_; lean_object* v___y_2273_; lean_object* v___y_2274_; lean_object* v___y_2275_; lean_object* v___y_2276_; lean_object* v___y_2277_; lean_object* v___y_2278_; lean_object* v___y_2279_; lean_object* v___y_2280_; lean_object* v___y_2281_; size_t v___y_2282_; lean_object* v___y_2283_; lean_object* v___y_2284_; lean_object* v___y_2285_; lean_object* v___y_2286_; lean_object* v___y_2319_; lean_object* v___y_2320_; lean_object* v___y_2321_; lean_object* v___y_2322_; lean_object* v___y_2323_; lean_object* v___y_2378_; lean_object* v___y_2379_; lean_object* v___y_2380_; lean_object* v_fst_2397_; lean_object* v_snd_2398_; uint8_t v___x_2410_; 
v___x_2126_ = lean_io_promise_new();
v___x_2127_ = lean_io_promise_new();
v___x_2128_ = lean_io_promise_new();
v___x_2129_ = lean_io_promise_new();
v___x_2259_ = l_Lean_internal_cmdlineSnapshots;
v___x_2410_ = l_Lean_Option_get___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__1(v_opts_2122_, v___x_2259_);
if (v___x_2410_ == 0)
{
lean_inc_ref(v_fst_2108_);
lean_inc(v_fst_2107_);
v_fst_2397_ = v_fst_2107_;
v_snd_2398_ = v_fst_2108_;
goto v___jp_2396_;
}
else
{
uint8_t v___x_2411_; 
lean_inc(v_fst_2107_);
v___x_2411_ = l_Lean_Parser_isTerminalCommand(v_fst_2107_);
if (v___x_2411_ == 0)
{
if (v___x_2410_ == 0)
{
...
v___x_2413_ = l_Lean_Parser_instInhabitedModuleParserState_default;
v_fst_2397_ = v___x_2412_;
v_snd_2398_ = v___x_2413_;
goto v___jp_2396_;
}
}
else
...
lean_ctor_set(v___x_2140_, 1, v___y_2136_);
lean_ctor_set(v___x_2140_, 2, v___y_2137_);
lean_ctor_set(v___x_2140_, 3, v_traceTask_2139_);
v___x_2141_ = lean_array_push(v_snapshotTasks_2135_, v___x_2140_);
v___x_2142_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2142_, 0, v___y_2131_);
lean_ctor_set(v___x_2142_, 1, v___x_2141_);
v___x_2143_ = lean_io_promise_resolve(v___x_2142_, v___x_2129_);
lean_dec(v___x_2129_);
if (lean_obj_tag(v___y_2138_) == 1)
{
lean_object* v_val_2144_; lean_object* v___x_2145_; lean_object* v___x_2146_; lean_object* v___x_2147_; 
v_val_2144_ = lean_ctor_get(v___y_2138_, 0);
lean_inc(v_val_2144_);
lean_dec_ref_known(v___y_2138_, 1);
v___x_2145_ = lean_box(0);
v___x_2146_ = lean_array_push(v_cmds_2106_, v_fst_2107_);
v___x_2147_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(v___x_2145_, v_fst_2108_, v___y_2134_, v_val_2144_, v_val_2109_, v___y_2132_, v___x_2146_, v_a_2110_);
return v___x_2147_;
}
else
{
...
v___jp_2149_:
{
lean_object* v_snapshotTasks_2158_; lean_object* v___x_2159_; lean_object* v___x_2160_; lean_object* v___x_2161_; 
v_snapshotTasks_2158_ = lean_ctor_get(v___y_2154_, 10);
lean_inc_ref(v_snapshotTasks_2158_);
v___x_2159_ = lean_mk_empty_array_with_capacity(v___y_2152_);
lean_dec(v___y_2152_);
lean_inc_ref(v___y_2150_);
v___x_2160_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2160_, 0, v___y_2150_);
lean_ctor_set(v___x_2160_, 1, v___x_2159_);
v___x_2161_ = lean_task_pure(v___x_2160_);
v___y_2131_ = v___y_2150_;
v___y_2132_ = v___y_2151_;
v___y_2133_ = v___y_2153_;
v___y_2134_ = v___y_2154_;
v_snapshotTasks_2135_ = v_snapshotTasks_2158_;
v___y_2136_ = v___y_2155_;
v___y_2137_ = v___y_2156_;
v___y_2138_ = v___y_2157_;
v_traceTask_2139_ = v___x_2161_;
goto v___jp_2130_;
}
v___jp_2162_:
{
lean_object* v___x_2194_; lean_object* v___x_2195_; lean_object* v___x_2196_; lean_object* v___x_2197_; lean_object* v___x_2198_; lean_object* v___x_2199_; lean_object* v___x_2200_; lean_object* v___x_2201_; lean_object* v___x_2202_; lean_object* v_opts_2203_; uint8_t v_hasTrace_2204_; 
v___x_2194_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_messages_2179_);
v___x_2195_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2195_, 0, v___y_2184_);
lean_ctor_set(v___x_2195_, 1, v___x_2194_);
lean_ctor_set(v___x_2195_, 2, v___y_2174_);
lean_ctor_set(v___x_2195_, 3, v_traceState_2182_);
lean_ctor_set_uint8(v___x_2195_, sizeof(void*)*4, v_val_2109_);
v___x_2196_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2196_, 0, v___x_2195_);
lean_ctor_set(v___x_2196_, 1, v_reportedCmdState_2193_);
v___x_2197_ = lean_io_promise_resolve(v___x_2196_, v___x_2127_);
lean_dec(v___x_2127_);
v___x_2198_ = l_Lean_Elab_InfoState_substituteLazy(v_infoState_2181_);
lean_inc(v___y_2175_);
v___x_2199_ = l_BaseIO_chainTask___redArg(v___x_2198_, v___y_2171_, v___y_2175_, v___x_2113_);
v___x_2200_ = l_Lean_inheritedTraceOptions;
v___x_2201_ = lean_st_ref_get(v___x_2200_);
v___x_2202_ = l_List_head_x21___redArg(v___x_2115_, v_scopes_2180_);
lean_dec(v_scopes_2180_);
lean_dec_ref(v___x_2115_);
v_opts_2203_ = lean_ctor_get(v___x_2202_, 1);
lean_inc_ref(v_opts_2203_);
lean_dec(v___x_2202_);
v_hasTrace_2204_ = lean_ctor_get_uint8(v_opts_2203_, sizeof(void*)*1);
...
lean_dec_ref(v_snapshotTasks_2183_);
...
v___x_2205_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__2);
v___x_2206_ = l___private_Lean_Util_Trace_0__Lean_checkTraceOption_go(v___x_2201_, v_opts_2203_, v___x_2205_);
lean_dec(v___x_2201_);
if (v___x_2206_ == 0)
{
lean_dec_ref(v_opts_2203_);
...
v___x_2207_ = lean_task_map(v___f_2116_, v___y_2173_, v___y_2175_, v___x_2113_);
lean_inc_n(v___y_2192_, 3);
lean_inc_n(v___y_2188_, 2);
lean_inc_n(v___y_2190_, 2);
v___x_2208_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2208_, 0, v___y_2190_);
lean_ctor_set(v___x_2208_, 1, v___y_2188_);
lean_ctor_set(v___x_2208_, 2, v___y_2192_);
lean_ctor_set(v___x_2208_, 3, v___x_2207_);
v___x_2209_ = lean_task_map(v___f_2117_, v___y_2186_, v___y_2175_, v___x_2113_);
v___x_2210_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2210_, 0, v___y_2190_);
lean_ctor_set(v___x_2210_, 1, v___y_2188_);
lean_ctor_set(v___x_2210_, 2, v___y_2192_);
lean_ctor_set(v___x_2210_, 3, v___x_2209_);
v___x_2211_ = lean_task_map(v___f_2118_, v___y_2187_, v___y_2175_, v___x_2113_);
v___x_2212_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2212_, 0, v___y_2190_);
lean_ctor_set(v___x_2212_, 1, v___y_2188_);
lean_ctor_set(v___x_2212_, 2, v___y_2192_);
...
v___x_2215_ = lean_array_push(v___x_2214_, v___x_2208_);
v___x_2216_ = lean_array_push(v___x_2215_, v___x_2210_);
v___x_2217_ = lean_array_push(v___x_2216_, v___x_2212_);
v___x_2218_ = l_Array_append___redArg(v___x_2217_, v_snapshotTasks_2183_);
lean_inc_ref(v___y_2172_);
v___x_2219_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2219_, 0, v___y_2172_);
lean_ctor_set(v___x_2219_, 1, v___x_2218_);
lean_inc_ref(v___x_2219_);
v___x_2220_ = l_Lean_Language_SnapshotTree_waitAll(v___x_2219_);
v___x_2221_ = lean_box_usize(v___y_2164_);
v___x_2222_ = lean_box(v___x_2113_);
v___x_2223_ = lean_box(v_val_2109_);
v___x_2224_ = lean_box(v___x_2206_);
lean_inc_ref(v_a_2110_);
lean_inc_ref(v___y_2170_);
v___f_2225_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___boxed), 20, 18);
lean_closure_set(v___f_2225_, 0, v___x_2112_);
lean_closure_set(v___f_2225_, 1, v___y_2167_);
lean_closure_set(v___f_2225_, 2, v___y_2166_);
lean_closure_set(v___f_2225_, 3, v___x_2221_);
lean_closure_set(v___f_2225_, 4, v___x_2222_);
lean_closure_set(v___f_2225_, 5, v_env_2178_);
lean_closure_set(v___f_2225_, 6, v___y_2170_);
lean_closure_set(v___f_2225_, 7, v___x_2200_);
lean_closure_set(v___f_2225_, 8, v_a_2110_);
lean_closure_set(v___f_2225_, 9, v_opts_2203_);
lean_closure_set(v___f_2225_, 10, v___x_2219_);
lean_closure_set(v___f_2225_, 11, v_pos_2119_);
lean_closure_set(v___f_2225_, 12, v___x_2223_);
lean_closure_set(v___f_2225_, 13, v___y_2169_);
lean_closure_set(v___f_2225_, 14, v___y_2163_);
lean_closure_set(v___f_2225_, 15, v___y_2165_);
lean_closure_set(v___f_2225_, 16, v___y_2168_);
lean_closure_set(v___f_2225_, 17, v___x_2224_);
v___x_2226_ = lean_io_bind_task(v___x_2220_, v___f_2225_, v___y_2175_, v_val_2109_);
v___y_2131_ = v___y_2172_;
v___y_2132_ = v___y_2189_;
v___y_2133_ = v___y_2176_;
v___y_2134_ = v___y_2177_;
v_snapshotTasks_2135_ = v_snapshotTasks_2183_;
v___y_2136_ = v___y_2191_;
v___y_2137_ = v___y_2192_;
v___y_2138_ = v___y_2185_;
v_traceTask_2139_ = v___x_2226_;
goto v___jp_2130_;
}
}
}
v___jp_2227_:
{
lean_object* v_env_2253_; lean_object* v_messages_2254_; lean_object* v_scopes_2255_; lean_object* v_infoState_2256_; lean_object* v_traceState_2257_; lean_object* v_snapshotTasks_2258_; 
v_env_2253_ = lean_ctor_get(v___y_2242_, 0);
lean_inc_ref(v_env_2253_);
v_messages_2254_ = lean_ctor_get(v___y_2242_, 1);
lean_inc_ref(v_messages_2254_);
v_scopes_2255_ = lean_ctor_get(v___y_2242_, 2);
lean_inc(v_scopes_2255_);
v_infoState_2256_ = lean_ctor_get(v___y_2242_, 8);
lean_inc_ref(v_infoState_2256_);
v_traceState_2257_ = lean_ctor_get(v___y_2242_, 9);
lean_inc_ref(v_traceState_2257_);
v_snapshotTasks_2258_ = lean_ctor_get(v___y_2242_, 10);
lean_inc_ref(v_snapshotTasks_2258_);
...
v_env_2178_ = v_env_2253_;
v_messages_2179_ = v_messages_2254_;
v_scopes_2180_ = v_scopes_2255_;
v_infoState_2181_ = v_infoState_2256_;
v_traceState_2182_ = v_traceState_2257_;
v_snapshotTasks_2183_ = v_snapshotTasks_2258_;
...
v___y_2192_ = v___y_2251_;
v_reportedCmdState_2193_ = v_reportedCmdState_2252_;
goto v___jp_2162_;
}
v___jp_2260_:
{
lean_object* v___x_2287_; lean_object* v___x_2288_; lean_object* v___x_2289_; lean_object* v___x_2290_; lean_object* v___f_2291_; uint8_t v___x_2292_; 
v___x_2287_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2287_, 0, v___y_2286_);
lean_ctor_set(v___x_2287_, 1, v___x_2126_);
lean_inc_ref(v___y_2280_);
lean_inc_n(v_pos_2119_, 2);
lean_inc_ref(v_cmds_2106_);
lean_inc(v_fst_2107_);
v___x_2288_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab(v_fst_2107_, v_cmds_2106_, v_cmdState_2120_, v_pos_2119_, v___x_2287_, v___y_2280_, v_a_2110_);
v___x_2289_ = lean_box(v_val_2109_);
v___x_2290_ = lean_box(v___x_2113_);
lean_inc_ref(v_a_2110_);
...
v___f_2291_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__4___boxed), 13, 11);
lean_closure_set(v___f_2291_, 0, v___y_2267_);
lean_closure_set(v___f_2291_, 1, v___y_2268_);
lean_closure_set(v___f_2291_, 2, v___x_2289_);
lean_closure_set(v___f_2291_, 3, v___x_2128_);
lean_closure_set(v___f_2291_, 4, v___x_2288_);
lean_closure_set(v___f_2291_, 5, v___x_2115_);
lean_closure_set(v___f_2291_, 6, v___y_2264_);
lean_closure_set(v___f_2291_, 7, v___x_2290_);
lean_closure_set(v___f_2291_, 8, v_a_2110_);
lean_closure_set(v___f_2291_, 9, v_pos_2119_);
lean_closure_set(v___f_2291_, 10, v___x_2121_);
v___x_2292_ = l_Lean_Option_get___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__1(v_opts_2122_, v___x_2259_);
if (v___x_2292_ == 0)
{
...
v___y_2251_ = v___y_2285_;
v_reportedCmdState_2252_ = v___x_2288_;
goto v___jp_2227_;
}
else
{
uint8_t v___x_2293_; 
lean_inc(v_fst_2107_);
v___x_2293_ = l_Lean_Parser_isTerminalCommand(v_fst_2107_);
if (v___x_2293_ == 0)
{
if (v___x_2292_ == 0)
{
...
lean_inc_ref(v_snapshotTasks_2299_);
v___x_2300_ = lean_mk_empty_array_with_capacity(v___y_2276_);
lean_dec(v___y_2276_);
lean_inc_ref(v___x_2300_);
v___x_2301_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_2301_, 0, v___x_2300_);
lean_inc_n(v___y_2272_, 3);
...
lean_ctor_set(v___x_2302_, 2, v___y_2272_);
lean_ctor_set(v___x_2302_, 3, v___y_2272_);
lean_ctor_set_usize(v___x_2302_, 4, v___y_2282_);
v___x_2303_ = l_Lean_NameSet_empty;
lean_inc_ref_n(v___x_2302_, 2);
v___x_2304_ = lean_alloc_ctor(0, 3, 0);
lean_ctor_set(v___x_2304_, 0, v___x_2302_);
lean_ctor_set(v___x_2304_, 1, v___x_2302_);
lean_ctor_set(v___x_2304_, 2, v___x_2303_);
v___x_2305_ = ((lean_object*)(l_Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10___closed__0));
v___x_2306_ = l_Lean_Options_empty;
v___x_2307_ = lean_box(0);
v___x_2308_ = lean_mk_empty_array_with_capacity(v___y_2272_);
lean_inc_ref_n(v___x_2308_, 3);
lean_inc_n(v___x_2112_, 2);
v___x_2309_ = lean_alloc_ctor(0, 10, 3);
lean_ctor_set(v___x_2309_, 0, v___x_2305_);
lean_ctor_set(v___x_2309_, 1, v___x_2306_);
lean_ctor_set(v___x_2309_, 2, v___x_2112_);
lean_ctor_set(v___x_2309_, 3, v___x_2307_);
lean_ctor_set(v___x_2309_, 4, v___x_2307_);
lean_ctor_set(v___x_2309_, 5, v___x_2308_);
lean_ctor_set(v___x_2309_, 6, v___x_2308_);
lean_ctor_set(v___x_2309_, 7, v___x_2307_);
lean_ctor_set(v___x_2309_, 8, v___x_2307_);
lean_ctor_set(v___x_2309_, 9, v___x_2307_);
lean_ctor_set_uint8(v___x_2309_, sizeof(void*)*10, v_val_2109_);
lean_ctor_set_uint8(v___x_2309_, sizeof(void*)*10 + 1, v_val_2109_);
lean_ctor_set_uint8(v___x_2309_, sizeof(void*)*10 + 2, v_val_2109_);
v___x_2310_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_2310_, 0, v___x_2309_);
lean_ctor_set(v___x_2310_, 1, v___x_2307_);
v___x_2311_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__0);
v___x_2312_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__3___closed__3));
v___x_2313_ = l_Lean_DeclNameGenerator_ofPrefix(v___x_2112_);
v___x_2314_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__4);
v___x_2315_ = lean_alloc_ctor(0, 3, 1);
lean_ctor_set(v___x_2315_, 0, v___x_2314_);
lean_ctor_set(v___x_2315_, 1, v___x_2314_);
lean_ctor_set(v___x_2315_, 2, v___x_2302_);
lean_ctor_set_uint8(v___x_2315_, sizeof(void*)*3, v___x_2113_);
v___x_2316_ = lean_box(0);
lean_inc_ref(v___y_2283_);
v___x_2317_ = lean_alloc_ctor(0, 13, 0);
lean_ctor_set(v___x_2317_, 0, v_env_2294_);
lean_ctor_set(v___x_2317_, 1, v___x_2304_);
lean_ctor_set(v___x_2317_, 2, v___x_2310_);
lean_ctor_set(v___x_2317_, 3, v___x_2303_);
lean_ctor_set(v___x_2317_, 4, v___x_2311_);
lean_ctor_set(v___x_2317_, 5, v___y_2272_);
lean_ctor_set(v___x_2317_, 6, v___x_2312_);
lean_ctor_set(v___x_2317_, 7, v___x_2313_);
lean_ctor_set(v___x_2317_, 8, v___x_2315_);
lean_ctor_set(v___x_2317_, 9, v___y_2283_);
lean_ctor_set(v___x_2317_, 10, v___x_2308_);
lean_ctor_set(v___x_2317_, 11, v___x_2316_);
lean_ctor_set(v___x_2317_, 12, v___x_2308_);
...
v___y_2171_ = v___f_2291_;
v___y_2172_ = v___y_2269_;
v___y_2173_ = v___y_2270_;
v___y_2174_ = v___y_2271_;
v___y_2175_ = v___y_2272_;
v___y_2176_ = v___y_2273_;
v___y_2177_ = v___x_2288_;
v_env_2178_ = v_env_2294_;
v_messages_2179_ = v_messages_2295_;
v_scopes_2180_ = v_scopes_2296_;
v_infoState_2181_ = v_infoState_2297_;
v_traceState_2182_ = v_traceState_2298_;
v_snapshotTasks_2183_ = v_snapshotTasks_2299_;
v___y_2184_ = v___y_2274_;
v___y_2185_ = v___y_2275_;
v___y_2186_ = v___y_2277_;
v___y_2187_ = v___y_2278_;
v___y_2188_ = v___y_2279_;
v___y_2189_ = v___y_2280_;
v___y_2190_ = v___y_2281_;
v___y_2191_ = v___y_2284_;
v___y_2192_ = v___y_2285_;
v_reportedCmdState_2193_ = v___x_2317_;
goto v___jp_2162_;
}
}
else
...
v___jp_2318_:
{
lean_object* v___x_2324_; lean_object* v___x_2325_; lean_object* v___x_2326_; lean_object* v___x_2327_; lean_object* v___x_2328_; lean_object* v___x_2329_; lean_object* v___x_2330_; lean_object* v___x_2331_; lean_object* v___x_2332_; lean_object* v___x_2333_; lean_object* v___x_2334_; lean_object* v___x_2335_; lean_object* v___x_2336_; lean_object* v___x_2337_; lean_object* v___x_2338_; lean_object* v___x_2339_; lean_object* v___x_2340_; lean_object* v___x_2341_; lean_object* v___x_2342_; lean_object* v___x_2343_; lean_object* v___x_2344_; lean_object* v___x_2345_; size_t v___x_2346_; lean_object* v___x_2347_; lean_object* v___x_2348_; lean_object* v___x_2349_; lean_object* v___x_2350_; lean_object* v___x_2351_; lean_object* v___x_2352_; lean_object* v___x_2353_; lean_object* v___x_2354_; lean_object* v___x_2355_; lean_object* v___x_2356_; lean_object* v___x_2357_; lean_object* v___x_2358_; lean_object* v___x_2359_; lean_object* v___x_2360_; lean_object* v___x_2361_; lean_object* v___x_2362_; lean_object* v___x_2363_; lean_object* v___x_2364_; 
v___x_2324_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_snd_2111_);
v___x_2325_ = l_IO_CancelToken_new();
v___x_2326_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__0));
lean_inc(v___x_2112_);
v___x_2327_ = l_Lean_Name_str___override(v___x_2112_, v___x_2326_);
v___x_2328_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__2));
v___x_2329_ = l_Lean_Name_str___override(v___x_2327_, v___x_2328_);
v___x_2330_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__4));
v___x_2331_ = l_Lean_Name_str___override(v___x_2329_, v___x_2330_);
v___x_2332_ = l_Lean_Name_str___override(v___x_2331_, v___x_2328_);
v___x_2333_ = lean_unsigned_to_nat(0u);
v___x_2334_ = l_Lean_Name_num___override(v___x_2332_, v___x_2333_);
v___x_2335_ = l_Lean_Name_str___override(v___x_2334_, v___x_2328_);
v___x_2336_ = l_Lean_Name_str___override(v___x_2335_, v___x_2330_);
v___x_2337_ = l_Lean_Name_str___override(v___x_2336_, v___x_2328_);
v___x_2338_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab___closed__0));
v___x_2339_ = l_Lean_Name_str___override(v___x_2337_, v___x_2338_);
v___x_2340_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__5));
v___x_2341_ = l_Lean_Name_str___override(v___x_2339_, v___x_2340_);
v___x_2342_ = l_Lean_Name_toString(v___x_2341_, v___x_2113_);
...
v___x_2347_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
lean_inc_ref_n(v___x_2342_, 2);
v___x_2348_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2348_, 0, v___x_2342_);
lean_ctor_set(v___x_2348_, 1, v___x_2324_);
lean_ctor_set(v___x_2348_, 2, v___x_2343_);
lean_ctor_set(v___x_2348_, 3, v___x_2347_);
lean_ctor_set_uint8(v___x_2348_, sizeof(void*)*4, v_val_2109_);
v___x_2349_ = l_Lean_Language_Snapshot_Diagnostics_empty;
v___x_2350_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2350_, 0, v___x_2342_);
lean_ctor_set(v___x_2350_, 1, v___x_2349_);
lean_ctor_set(v___x_2350_, 2, v___x_2343_);
lean_ctor_set(v___x_2350_, 3, v___x_2347_);
lean_ctor_set_uint8(v___x_2350_, sizeof(void*)*4, v_val_2109_);
lean_inc(v___y_2319_);
v___x_2351_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2351_, 0, v___y_2319_);
v___x_2352_ = l_Lean_Language_SnapshotTask_defaultReportingRange(v___x_2351_);
lean_inc_ref(v___x_2325_);
v___x_2353_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2353_, 0, v___x_2325_);
v___x_2354_ = l_IO_Promise_result_x21___redArg(v___x_2126_);
lean_inc_ref(v___x_2354_);
lean_inc(v___x_2352_);
lean_inc_ref_n(v___x_2351_, 3);
v___x_2355_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2355_, 0, v___x_2351_);
lean_ctor_set(v___x_2355_, 1, v___x_2352_);
lean_ctor_set(v___x_2355_, 2, v___x_2353_);
lean_ctor_set(v___x_2355_, 3, v___x_2354_);
v___x_2356_ = l_IO_Promise_result_x21___redArg(v___x_2127_);
lean_inc_ref(v___x_2356_);
lean_inc_n(v___y_2320_, 3);
v___x_2357_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2357_, 0, v___x_2351_);
lean_ctor_set(v___x_2357_, 1, v___y_2320_);
lean_ctor_set(v___x_2357_, 2, v___x_2343_);
lean_ctor_set(v___x_2357_, 3, v___x_2356_);
v___x_2358_ = l_IO_Promise_result_x21___redArg(v___x_2128_);
lean_inc_ref(v___x_2358_);
v___x_2359_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2359_, 0, v___x_2351_);
lean_ctor_set(v___x_2359_, 1, v___y_2320_);
lean_ctor_set(v___x_2359_, 2, v___x_2343_);
lean_ctor_set(v___x_2359_, 3, v___x_2358_);
v___x_2360_ = l_IO_Promise_result_x21___redArg(v___x_2129_);
v___x_2361_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2361_, 0, v___x_2343_);
lean_ctor_set(v___x_2361_, 1, v___y_2320_);
lean_ctor_set(v___x_2361_, 2, v___x_2343_);
lean_ctor_set(v___x_2361_, 3, v___x_2360_);
lean_inc_ref(v___x_2350_);
v___x_2362_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2362_, 0, v___x_2350_);
lean_ctor_set(v___x_2362_, 1, v___x_2355_);
lean_ctor_set(v___x_2362_, 2, v___x_2357_);
lean_ctor_set(v___x_2362_, 3, v___x_2359_);
lean_ctor_set(v___x_2362_, 4, v___x_2361_);
v___x_2363_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2363_, 0, v___x_2348_);
lean_ctor_set(v___x_2363_, 1, v___y_2319_);
lean_ctor_set(v___x_2363_, 2, v___y_2322_);
lean_ctor_set(v___x_2363_, 3, v___x_2362_);
lean_ctor_set(v___x_2363_, 4, v___y_2323_);
v___x_2364_ = lean_io_promise_resolve(v___x_2363_, v_prom_2114_);
if (lean_obj_tag(v_old_x3f_2123_) == 0)
{
lean_inc_ref(v___x_2342_);
lean_inc_ref(v___x_2350_);
v___y_2261_ = v___x_2343_;
v___y_2262_ = v___x_2346_;
v___y_2263_ = v___x_2350_;
v___y_2264_ = v___x_2333_;
v___y_2265_ = v___x_2344_;
v___y_2266_ = v___x_2343_;
v___y_2267_ = v___x_2342_;
v___y_2268_ = v___x_2347_;
v___y_2269_ = v___x_2350_;
v___y_2270_ = v___x_2354_;
v___y_2271_ = v___x_2343_;
v___y_2272_ = v___x_2333_;
v___y_2273_ = v___x_2343_;
v___y_2274_ = v___x_2342_;
v___y_2275_ = v___y_2321_;
v___y_2276_ = v___x_2344_;
v___y_2277_ = v___x_2356_;
v___y_2278_ = v___x_2358_;
v___y_2279_ = v___x_2352_;
v___y_2280_ = v___x_2325_;
v___y_2281_ = v___x_2351_;
v___y_2282_ = v___x_2346_;
v___y_2283_ = v___x_2347_;
v___y_2284_ = v___y_2320_;
v___y_2285_ = v___x_2343_;
v___y_2286_ = v___x_2343_;
goto v___jp_2260_;
}
else
{
lean_object* v_val_2365_; lean_object* v___x_2367_; uint8_t v_isShared_2368_; uint8_t v_isSharedCheck_2376_; 
v_val_2365_ = lean_ctor_get(v_old_x3f_2123_, 0);
v_isSharedCheck_2376_ = !lean_is_exclusive(v_old_x3f_2123_);
if (v_isSharedCheck_2376_ == 0)
{
v___x_2367_ = v_old_x3f_2123_;
...
v_resetjp_2366_:
{
lean_object* v_elabSnap_2369_; lean_object* v_stx_2370_; lean_object* v_elabSnap_2371_; lean_object* v___x_2372_; lean_object* v___x_2374_; 
v_elabSnap_2369_ = lean_ctor_get(v_val_2365_, 3);
lean_inc_ref(v_elabSnap_2369_);
v_stx_2370_ = lean_ctor_get(v_val_2365_, 1);
lean_inc(v_stx_2370_);
lean_dec(v_val_2365_);
v_elabSnap_2371_ = lean_ctor_get(v_elabSnap_2369_, 1);
lean_inc_ref(v_elabSnap_2371_);
lean_dec_ref(v_elabSnap_2369_);
v___x_2372_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2372_, 0, v_stx_2370_);
lean_ctor_set(v___x_2372_, 1, v_elabSnap_2371_);
...
v___x_2381_ = l_Lean_Language_SnapshotTask_ReportingRange_ofOptionInheriting(v___y_2380_);
lean_inc(v_fst_2107_);
v___x_2382_ = l_Lean_Parser_isTerminalCommand(v_fst_2107_);
if (v___x_2382_ == 0)
{
lean_object* v___x_2383_; lean_object* v_toProcessingContext_2384_; lean_object* v_pos_2385_; lean_object* v_endPos_2386_; lean_object* v___x_2387_; lean_object* v___x_2388_; lean_object* v___x_2389_; lean_object* v___x_2390_; lean_object* v___x_2391_; lean_object* v___x_2392_; lean_object* v___x_2393_; lean_object* v___x_2394_; 
v___x_2383_ = lean_io_promise_new();
v_toProcessingContext_2384_ = lean_ctor_get(v_a_2110_, 0);
v_pos_2385_ = lean_ctor_get(v_fst_2108_, 0);
v_endPos_2386_ = lean_ctor_get(v_toProcessingContext_2384_, 3);
lean_inc(v___x_2383_);
v___x_2387_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2387_, 0, v___x_2383_);
v___x_2388_ = lean_box(0);
lean_inc(v_endPos_2386_);
lean_inc(v_pos_2385_);
v___x_2389_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2389_, 0, v_pos_2385_);
lean_ctor_set(v___x_2389_, 1, v_endPos_2386_);
v___x_2390_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2390_, 0, v___x_2389_);
v___x_2391_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2391_, 0, v_parseCancelTk_2124_);
v___x_2392_ = l_IO_Promise_result_x21___redArg(v___x_2383_);
lean_dec(v___x_2383_);
v___x_2393_ = lean_alloc_ctor(0, 4, 0);
...
v___y_2319_ = v___y_2378_;
v___y_2320_ = v___x_2381_;
v___y_2321_ = v___x_2387_;
v___y_2322_ = v___y_2379_;
v___y_2323_ = v___x_2394_;
goto v___jp_2318_;
}
else
{
lean_object* v___x_2395_; 
lean_dec_ref(v_parseCancelTk_2124_);
v___x_2395_ = lean_box(0);
v___y_2319_ = v___y_2378_;
v___y_2320_ = v___x_2381_;
v___y_2321_ = v___x_2395_;
v___y_2322_ = v___y_2379_;
v___y_2323_ = v___x_2395_;
goto v___jp_2318_;
}
}
v___jp_2396_:
...
lean_inc(v_fst_2107_);
v___x_2399_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_getNiceCommandStartPos_x3f(v_fst_2107_);
if (lean_obj_tag(v___x_2399_) == 0)
{
lean_object* v___x_2400_; 
v___x_2400_ = lean_box(0);
v___y_2378_ = v_fst_2397_;
v___y_2379_ = v_snd_2398_;
v___y_2380_ = v___x_2400_;
goto v___jp_2377_;
}
else
{
lean_object* v_val_2401_; lean_object* v___x_2403_; uint8_t v_isShared_2404_; uint8_t v_isSharedCheck_2409_; 
...
lean_ctor_set(v___x_2405_, 0, v_val_2401_);
lean_ctor_set(v___x_2405_, 1, v_val_2401_);
...
lean_object* v_cmds_2414_ = _args[0];
lean_object* v_fst_2415_ = _args[1];
lean_object* v_fst_2416_ = _args[2];
lean_object* v_val_2417_ = _args[3];
lean_object* v_a_2418_ = _args[4];
lean_object* v_snd_2419_ = _args[5];
lean_object* v___x_2420_ = _args[6];
lean_object* v___x_2421_ = _args[7];
lean_object* v_prom_2422_ = _args[8];
lean_object* v___x_2423_ = _args[9];
lean_object* v___f_2424_ = _args[10];
lean_object* v___f_2425_ = _args[11];
lean_object* v___f_2426_ = _args[12];
lean_object* v_pos_2427_ = _args[13];
lean_object* v_cmdState_2428_ = _args[14];
lean_object* v___x_2429_ = _args[15];
lean_object* v_opts_2430_ = _args[16];
lean_object* v_old_x3f_2431_ = _args[17];
lean_object* v_parseCancelTk_2432_ = _args[18];
lean_object* v___y_2433_ = _args[19];
_start:
{
uint8_t v_val_36460__boxed_2434_; uint8_t v___x_36463__boxed_2435_; lean_object* v_res_2436_; 
v_val_36460__boxed_2434_ = lean_unbox(v_val_2417_);
v___x_36463__boxed_2435_ = lean_unbox(v___x_2421_);
v_res_2436_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__8(v_cmds_2414_, v_fst_2415_, v_fst_2416_, v_val_36460__boxed_2434_, v_a_2418_, v_snd_2419_, v___x_2420_, v___x_36463__boxed_2435_, v_prom_2422_, v___x_2423_, v___f_2424_, v___f_2425_, v___f_2426_, v_pos_2427_, v_cmdState_2428_, v___x_2429_, v_opts_2430_, v_old_x3f_2431_, v_parseCancelTk_2432_);
lean_dec_ref(v_opts_2430_);
lean_dec(v_prom_2422_);
lean_dec_ref(v_a_2418_);
return v_res_2436_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(lean_object* v_old_x3f_2439_, lean_object* v_parserState_2440_, lean_object* v_cmdState_2441_, lean_object* v_prom_2442_, uint8_t v_sync_2443_, lean_object* v_parseCancelTk_2444_, lean_object* v_cmds_2445_, lean_object* v_a_2446_){
_start:
{
lean_object* v___y_2451_; lean_object* v_toSnapshot_2453_; lean_object* v_stx_2454_; lean_object* v_parserState_2455_; lean_object* v_elabSnap_2456_; lean_object* v_val_2457_; lean_object* v_newParserState_2458_; lean_object* v___f_2489_; lean_object* v___f_2490_; lean_object* v___f_2491_; lean_object* v___x_2492_; lean_object* v___x_2493_; lean_object* v___y_2495_; lean_object* v___y_2496_; lean_object* v___y_2497_; lean_object* v___y_2498_; uint8_t v___y_2499_; lean_object* v___y_2500_; lean_object* v___y_2501_; uint8_t v___y_2502_; lean_object* v___y_2503_; lean_object* v___y_2504_; lean_object* v___y_2505_; lean_object* v___y_2506_; lean_object* v___y_2507_; lean_object* v___y_2508_; lean_object* v___y_2509_; lean_object* v___y_2510_; lean_object* v___y_2511_; lean_object* v___y_2520_; lean_object* v___y_2521_; lean_object* v___y_2522_; lean_object* v___y_2523_; uint8_t v___y_2524_; uint8_t v___y_2525_; lean_object* v___y_2526_; lean_object* v___y_2527_; lean_object* v___y_2528_; lean_object* v___y_2529_; lean_object* v___y_2530_; lean_object* v___y_2531_; lean_object* v___y_2532_; lean_object* v___y_2533_; lean_object* v_fst_2534_; lean_object* v_snd_2535_; lean_object* v___y_2548_; uint8_t v___y_2549_; lean_object* v___y_2550_; lean_object* v___y_2584_; uint8_t v___y_2585_; lean_object* v___y_2586_; lean_object* v___y_2587_; lean_object* v___y_2589_; lean_object* v___y_2590_; lean_object* v___y_2591_; lean_object* v___y_2592_; lean_object* v___y_2593_; lean_object* v___y_2594_; lean_object* v___y_2595_; lean_object* v___y_2596_; lean_object* v___y_2597_; lean_object* v___y_2598_; lean_object* v___x_2629_; 
v___f_2489_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__0));
v___f_2490_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__1));
v___f_2491_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__2));
v___x_2492_ = l_Lean_Elab_Command_instInhabitedScope_default;
v___x_2493_ = l_Lean_Elab_instInhabitedInfoTree_default;
v___x_2629_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__5));
if (lean_obj_tag(v_old_x3f_2439_) == 1)
{
lean_object* v_val_2662_; lean_object* v_nextCmdSnap_x3f_2663_; 
v_val_2662_ = lean_ctor_get(v_old_x3f_2439_, 0);
...
{
lean_object* v_toSnapshot_2664_; lean_object* v_stx_2665_; lean_object* v_parserState_2666_; lean_object* v_elabSnap_2667_; lean_object* v_val_2668_; lean_object* v___x_2669_; 
v_toSnapshot_2664_ = lean_ctor_get(v_val_2662_, 0);
v_stx_2665_ = lean_ctor_get(v_val_2662_, 1);
v_parserState_2666_ = lean_ctor_get(v_val_2662_, 2);
v_elabSnap_2667_ = lean_ctor_get(v_val_2662_, 3);
v_val_2668_ = lean_ctor_get(v_nextCmdSnap_x3f_2663_, 0);
lean_inc(v_val_2668_);
v___x_2669_ = l_Lean_Language_SnapshotTask_get_x3f___redArg(v_val_2668_);
if (lean_obj_tag(v___x_2669_) == 1)
{
lean_object* v_val_2670_; lean_object* v_nextCmdSnap_x3f_2671_; 
v_val_2670_ = lean_ctor_get(v___x_2669_, 0);
lean_inc(v_val_2670_);
lean_dec_ref_known(v___x_2669_, 1);
v_nextCmdSnap_x3f_2671_ = lean_ctor_get(v_val_2670_, 4);
lean_inc(v_nextCmdSnap_x3f_2671_);
...
v_val_2672_ = lean_ctor_get(v_nextCmdSnap_x3f_2671_, 0);
lean_inc(v_val_2672_);
lean_dec_ref_known(v_nextCmdSnap_x3f_2671_, 1);
v___x_2673_ = l_Lean_Language_SnapshotTask_get_x3f___redArg(v_val_2672_);
if (lean_obj_tag(v___x_2673_) == 1)
{
lean_object* v_val_2674_; lean_object* v_parserState_2675_; lean_object* v_pos_2676_; uint8_t v___x_2677_; 
v_val_2674_ = lean_ctor_get(v___x_2673_, 0);
lean_inc(v_val_2674_);
lean_dec_ref_known(v___x_2673_, 1);
v_parserState_2675_ = lean_ctor_get(v_val_2674_, 2);
lean_inc_ref(v_parserState_2675_);
lean_dec(v_val_2674_);
v_pos_2676_ = lean_ctor_get(v_parserState_2675_, 0);
lean_inc(v_pos_2676_);
lean_dec_ref(v_parserState_2675_);
v___x_2677_ = l_Lean_Language_Lean_isBeforeEditPos(v_pos_2676_, v_a_2446_);
lean_dec(v_pos_2676_);
if (v___x_2677_ == 0)
{
goto v___jp_2630_;
}
...
lean_inc_ref_n(v_parserState_2666_, 2);
lean_inc(v_stx_2665_);
lean_inc_ref(v_toSnapshot_2664_);
lean_dec_ref_known(v_old_x3f_2439_, 1);
lean_dec_ref(v_parseCancelTk_2444_);
lean_dec_ref(v_cmdState_2441_);
lean_dec_ref(v_parserState_2440_);
v_toSnapshot_2453_ = v_toSnapshot_2664_;
v_stx_2454_ = v_stx_2665_;
v_parserState_2455_ = v_parserState_2666_;
v_elabSnap_2456_ = v_elabSnap_2667_;
v_val_2457_ = v_val_2668_;
v_newParserState_2458_ = v_parserState_2666_;
goto v___jp_2452_;
}
}
else
...
v___jp_2452_:
{
lean_object* v___x_2459_; lean_object* v___x_2460_; lean_object* v_resultSnap_2461_; lean_object* v_task_2462_; lean_object* v___x_2464_; uint8_t v_isShared_2465_; uint8_t v_isSharedCheck_2485_; 
v___x_2459_ = lean_io_promise_new();
v___x_2460_ = l_IO_CancelToken_new();
v_resultSnap_2461_ = lean_ctor_get(v_elabSnap_2456_, 2);
lean_inc_ref(v_resultSnap_2461_);
v_task_2462_ = lean_ctor_get(v_resultSnap_2461_, 3);
v_isSharedCheck_2485_ = !lean_is_exclusive(v_resultSnap_2461_);
if (v_isSharedCheck_2485_ == 0)
{
lean_object* v_unused_2486_; lean_object* v_unused_2487_; lean_object* v_unused_2488_; 
v_unused_2486_ = lean_ctor_get(v_resultSnap_2461_, 2);
lean_dec(v_unused_2486_);
v_unused_2487_ = lean_ctor_get(v_resultSnap_2461_, 1);
lean_dec(v_unused_2487_);
v_unused_2488_ = lean_ctor_get(v_resultSnap_2461_, 0);
lean_dec(v_unused_2488_);
v___x_2464_ = v_resultSnap_2461_;
v_isShared_2465_ = v_isSharedCheck_2485_;
goto v_resetjp_2463_;
}
else
{
lean_inc(v_task_2462_);
lean_dec(v_resultSnap_2461_);
...
v_resetjp_2463_:
{
lean_object* v___x_2466_; lean_object* v___f_2467_; lean_object* v___x_2468_; uint8_t v___x_2469_; lean_object* v___x_2470_; lean_object* v_toProcessingContext_2471_; lean_object* v_pos_2472_; lean_object* v_endPos_2473_; lean_object* v___x_2474_; lean_object* v___x_2475_; lean_object* v___x_2476_; lean_object* v___x_2477_; lean_object* v___x_2478_; lean_object* v___x_2480_; 
v___x_2466_ = lean_box(v_sync_2443_);
lean_inc_ref(v_a_2446_);
lean_inc_ref(v___x_2460_);
lean_inc(v___x_2459_);
lean_inc_ref(v_newParserState_2458_);
lean_inc(v_stx_2454_);
v___f_2467_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__1___boxed), 10, 8);
lean_closure_set(v___f_2467_, 0, v_val_2457_);
lean_closure_set(v___f_2467_, 1, v_cmds_2445_);
lean_closure_set(v___f_2467_, 2, v_stx_2454_);
lean_closure_set(v___f_2467_, 3, v_newParserState_2458_);
lean_closure_set(v___f_2467_, 4, v___x_2459_);
lean_closure_set(v___f_2467_, 5, v___x_2466_);
lean_closure_set(v___f_2467_, 6, v___x_2460_);
lean_closure_set(v___f_2467_, 7, v_a_2446_);
v___x_2468_ = lean_unsigned_to_nat(0u);
v___x_2469_ = 1;
v___x_2470_ = l_BaseIO_chainTask___redArg(v_task_2462_, v___f_2467_, v___x_2468_, v___x_2469_);
v_toProcessingContext_2471_ = lean_ctor_get(v_a_2446_, 0);
v_pos_2472_ = lean_ctor_get(v_newParserState_2458_, 0);
lean_inc(v_pos_2472_);
lean_dec_ref(v_newParserState_2458_);
v_endPos_2473_ = lean_ctor_get(v_toProcessingContext_2471_, 3);
v___x_2474_ = lean_box(0);
lean_inc(v_endPos_2473_);
v___x_2475_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2475_, 0, v_pos_2472_);
lean_ctor_set(v___x_2475_, 1, v_endPos_2473_);
v___x_2476_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2476_, 0, v___x_2475_);
v___x_2477_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2477_, 0, v___x_2460_);
v___x_2478_ = l_IO_Promise_result_x21___redArg(v___x_2459_);
lean_dec(v___x_2459_);
if (v_isShared_2465_ == 0)
{
lean_ctor_set(v___x_2464_, 3, v___x_2478_);
lean_ctor_set(v___x_2464_, 2, v___x_2477_);
lean_ctor_set(v___x_2464_, 1, v___x_2476_);
...
lean_ctor_set(v_reuseFailAlloc_2484_, 1, v___x_2476_);
lean_ctor_set(v_reuseFailAlloc_2484_, 2, v___x_2477_);
lean_ctor_set(v_reuseFailAlloc_2484_, 3, v___x_2478_);
...
lean_ctor_set(v___x_2482_, 0, v_toSnapshot_2453_);
lean_ctor_set(v___x_2482_, 1, v_stx_2454_);
lean_ctor_set(v___x_2482_, 2, v_parserState_2455_);
lean_ctor_set(v___x_2482_, 3, v_elabSnap_2456_);
lean_ctor_set(v___x_2482_, 4, v___x_2481_);
v___x_2483_ = lean_io_promise_resolve(v___x_2482_, v_prom_2442_);
lean_dec(v_prom_2442_);
return v___x_2483_;
}
}
}
...
v___x_2513_ = l_Lean_Parser_isTerminalCommand(v___y_2506_);
if (v___x_2513_ == 0)
{
...
v___x_2516_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5(v___x_2512_, v___y_2504_, v_cmds_2445_, v___y_2496_, v___y_2495_, v___y_2502_, v_a_2446_, v___y_2503_, v___y_2508_, v___y_2499_, v___y_2500_, v___y_2510_, v___y_2505_, v___y_2497_, v___y_2501_, v_prom_2442_, v___x_2492_, v___f_2491_, v___f_2490_, v___f_2489_, v___y_2509_, v_cmdState_2441_, v___x_2493_, v___y_2498_, v___y_2507_, v_old_x3f_2439_, v_parseCancelTk_2444_, v___x_2515_);
...
v___x_2518_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5(v___x_2512_, v___y_2504_, v_cmds_2445_, v___y_2496_, v___y_2495_, v___y_2502_, v_a_2446_, v___y_2503_, v___y_2508_, v___y_2499_, v___y_2500_, v___y_2510_, v___y_2505_, v___y_2497_, v___y_2501_, v_prom_2442_, v___x_2492_, v___f_2491_, v___f_2490_, v___f_2489_, v___y_2509_, v_cmdState_2441_, v___x_2493_, v___y_2498_, v___y_2507_, v_old_x3f_2439_, v_parseCancelTk_2444_, v___x_2517_);
lean_dec_ref(v___y_2498_);
lean_dec(v_prom_2442_);
lean_dec(v___y_2505_);
lean_dec(v___y_2504_);
v___y_2451_ = v___x_2518_;
goto v___jp_2450_;
}
}
v___jp_2519_:
...
v___y_2500_ = v_fst_2534_;
v___y_2501_ = v_snd_2535_;
...
v___x_2551_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__0));
v___x_2552_ = l_Lean_Name_str___override(v___y_2550_, v___x_2551_);
v___x_2553_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__2));
v___x_2554_ = l_Lean_Name_str___override(v___x_2552_, v___x_2553_);
v___x_2555_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__4));
v___x_2556_ = l_Lean_Name_str___override(v___x_2554_, v___x_2555_);
v___x_2557_ = l_Lean_Name_str___override(v___x_2556_, v___x_2553_);
v___x_2558_ = lean_unsigned_to_nat(0u);
v___x_2559_ = l_Lean_Name_num___override(v___x_2557_, v___x_2558_);
v___x_2560_ = l_Lean_Name_str___override(v___x_2559_, v___x_2553_);
v___x_2561_ = l_Lean_Name_str___override(v___x_2560_, v___x_2555_);
v___x_2562_ = l_Lean_Name_str___override(v___x_2561_, v___x_2553_);
v___x_2563_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab___closed__0));
v___x_2564_ = l_Lean_Name_str___override(v___x_2562_, v___x_2563_);
v___x_2565_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5___closed__5));
v___x_2566_ = l_Lean_Name_str___override(v___x_2564_, v___x_2565_);
v___x_2567_ = l_Lean_Name_toString(v___x_2566_, v___y_2549_);
v___x_2568_ = l_Lean_Language_Snapshot_Diagnostics_empty;
v___x_2569_ = lean_box(0);
v___x_2570_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
v___x_2571_ = 0;
v___x_2572_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2572_, 0, v___x_2567_);
lean_ctor_set(v___x_2572_, 1, v___x_2568_);
lean_ctor_set(v___x_2572_, 2, v___x_2569_);
lean_ctor_set(v___x_2572_, 3, v___x_2570_);
lean_ctor_set_uint8(v___x_2572_, sizeof(void*)*4, v___x_2571_);
v___x_2573_ = lean_box(0);
v___x_2574_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3);
lean_inc_ref_n(v___x_2572_, 3);
v___x_2575_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2575_, 0, v___x_2572_);
lean_ctor_set(v___x_2575_, 1, v_cmdState_2441_);
v___x_2576_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_2569_, v___x_2575_);
v___x_2577_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_2569_, v___x_2572_);
v___x_2578_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4);
v___x_2579_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2579_, 0, v___x_2572_);
lean_ctor_set(v___x_2579_, 1, v___x_2574_);
lean_ctor_set(v___x_2579_, 2, v___x_2576_);
lean_ctor_set(v___x_2579_, 3, v___x_2577_);
lean_ctor_set(v___x_2579_, 4, v___x_2578_);
v___x_2580_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_2580_, 0, v___x_2572_);
lean_ctor_set(v___x_2580_, 1, v___x_2573_);
lean_ctor_set(v___x_2580_, 2, v___y_2548_);
lean_ctor_set(v___x_2580_, 3, v___x_2579_);
lean_ctor_set(v___x_2580_, 4, v___x_2569_);
v___x_2581_ = lean_io_promise_resolve(v___x_2580_, v_prom_2442_);
lean_dec(v_prom_2442_);
...
v___jp_2588_:
{
uint8_t v___x_2599_; uint8_t v___x_2600_; 
v___x_2599_ = l_IO_CancelToken_isSet(v_parseCancelTk_2444_);
v___x_2600_ = 1;
if (v___x_2599_ == 0)
{
...
if (v_sync_2443_ == 0)
{
lean_object* v___x_2601_; lean_object* v___x_2602_; lean_object* v___x_2603_; lean_object* v___x_2604_; lean_object* v___x_2605_; uint8_t v___x_2606_; 
...
v___x_2605_ = l_Lean_internal_cmdlineSnapshots;
v___x_2606_ = l_Lean_Option_get___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__1(v___y_2597_, v___x_2605_);
lean_dec_ref(v___y_2597_);
if (v___x_2606_ == 0)
{
lean_inc(v___y_2596_);
v___y_2520_ = v___y_2589_;
v___y_2521_ = v___y_2590_;
v___y_2522_ = v___x_2603_;
v___y_2523_ = v___y_2591_;
v___y_2524_ = v___x_2600_;
v___y_2525_ = v___x_2599_;
v___y_2526_ = v___y_2594_;
v___y_2527_ = v___x_2604_;
v___y_2528_ = v___x_2602_;
v___y_2529_ = v___x_2605_;
v___y_2530_ = v___y_2593_;
v___y_2531_ = v___y_2592_;
v___y_2532_ = v___x_2601_;
v___y_2533_ = v___y_2596_;
v_fst_2534_ = v___y_2596_;
v_snd_2535_ = v___y_2595_;
goto v___jp_2519_;
}
else
{
uint8_t v___x_2607_; 
lean_inc(v___y_2596_);
v___x_2607_ = l_Lean_Parser_isTerminalCommand(v___y_2596_);
if (v___x_2607_ == 0)
{
if (v___x_2606_ == 0)
{
...
v___x_2609_ = l_Lean_Parser_instInhabitedModuleParserState_default;
v___y_2520_ = v___y_2589_;
v___y_2521_ = v___y_2590_;
v___y_2522_ = v___x_2603_;
v___y_2523_ = v___y_2591_;
...
v___y_2532_ = v___x_2601_;
v___y_2533_ = v___y_2596_;
v_fst_2534_ = v___x_2608_;
v_snd_2535_ = v___x_2609_;
goto v___jp_2519_;
}
}
else
...
{
lean_object* v___x_2610_; lean_object* v___x_2611_; lean_object* v___f_2612_; lean_object* v___x_2613_; lean_object* v___x_2614_; 
lean_dec_ref(v___y_2597_);
lean_dec(v___y_2596_);
lean_dec_ref(v___y_2595_);
v___x_2610_ = lean_box(v___x_2599_);
v___x_2611_ = lean_box(v___x_2600_);
lean_inc_ref(v_a_2446_);
v___f_2612_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__8___boxed), 20, 19);
lean_closure_set(v___f_2612_, 0, v_cmds_2445_);
lean_closure_set(v___f_2612_, 1, v___y_2590_);
lean_closure_set(v___f_2612_, 2, v___y_2589_);
lean_closure_set(v___f_2612_, 3, v___x_2610_);
lean_closure_set(v___f_2612_, 4, v_a_2446_);
lean_closure_set(v___f_2612_, 5, v___y_2594_);
lean_closure_set(v___f_2612_, 6, v___y_2593_);
lean_closure_set(v___f_2612_, 7, v___x_2611_);
lean_closure_set(v___f_2612_, 8, v_prom_2442_);
lean_closure_set(v___f_2612_, 9, v___x_2492_);
lean_closure_set(v___f_2612_, 10, v___f_2491_);
lean_closure_set(v___f_2612_, 11, v___f_2490_);
lean_closure_set(v___f_2612_, 12, v___f_2489_);
lean_closure_set(v___f_2612_, 13, v___y_2592_);
lean_closure_set(v___f_2612_, 14, v_cmdState_2441_);
lean_closure_set(v___f_2612_, 15, v___x_2493_);
lean_closure_set(v___f_2612_, 16, v___y_2591_);
lean_closure_set(v___f_2612_, 17, v_old_x3f_2439_);
lean_closure_set(v___f_2612_, 18, v_parseCancelTk_2444_);
v___x_2613_ = lean_unsigned_to_nat(0u);
v___x_2614_ = lean_io_as_task(v___f_2612_, v___x_2613_);
...
lean_dec_ref(v_cmds_2445_);
lean_dec_ref(v_parseCancelTk_2444_);
if (lean_obj_tag(v_old_x3f_2439_) == 1)
{
lean_object* v_val_2615_; lean_object* v___x_2616_; lean_object* v_children_2617_; lean_object* v___x_2618_; lean_object* v___x_2619_; uint8_t v___x_2620_; 
v_val_2615_ = lean_ctor_get(v_old_x3f_2439_, 0);
lean_inc(v_val_2615_);
lean_dec_ref_known(v_old_x3f_2439_, 1);
v___x_2616_ = l_Lean_Language_toSnapshotTree___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__5(v_val_2615_);
v_children_2617_ = lean_ctor_get(v___x_2616_, 1);
lean_inc_ref(v_children_2617_);
lean_dec_ref(v___x_2616_);
v___x_2618_ = lean_unsigned_to_nat(0u);
v___x_2619_ = lean_array_get_size(v_children_2617_);
v___x_2620_ = lean_nat_dec_lt(v___x_2618_, v___x_2619_);
if (v___x_2620_ == 0)
{
lean_dec_ref(v_children_2617_);
v___y_2548_ = v___y_2595_;
v___y_2549_ = v___x_2600_;
v___y_2550_ = v___y_2598_;
goto v___jp_2547_;
}
else
{
...
v___x_2622_ = lean_nat_dec_le(v___x_2619_, v___x_2619_);
if (v___x_2622_ == 0)
{
if (v___x_2620_ == 0)
{
...
v___x_2624_ = lean_usize_of_nat(v___x_2619_);
v___x_2625_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__6___redArg(v_children_2617_, v___x_2623_, v___x_2624_, v___x_2621_);
lean_dec_ref(v_children_2617_);
...
v___x_2627_ = lean_usize_of_nat(v___x_2619_);
v___x_2628_ = l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd_spec__6___redArg(v_children_2617_, v___x_2626_, v___x_2627_, v___x_2621_);
lean_dec_ref(v_children_2617_);
v___y_2584_ = v___y_2595_;
v___y_2585_ = v___x_2600_;
v___y_2586_ = v___y_2598_;
v___y_2587_ = v___x_2628_;
goto v___jp_2583_;
}
}
}
...
v_env_2631_ = lean_ctor_get(v_cmdState_2441_, 0);
v_scopes_2632_ = lean_ctor_get(v_cmdState_2441_, 2);
v___x_2633_ = l_List_head_x21___redArg(v___x_2492_, v_scopes_2632_);
...
lean_inc_ref(v_parserState_2440_);
lean_inc_ref(v_a_2446_);
...
lean_closure_set(v___f_2638_, 0, v_a_2446_);
lean_closure_set(v___f_2638_, 1, v___x_2637_);
lean_closure_set(v___f_2638_, 2, v_parserState_2440_);
v___x_2639_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__6));
...
v_val_2643_ = lean_ctor_get(v_old_x3f_2439_, 0);
...
v_pos_2647_ = lean_ctor_get(v_parserState_2440_, 0);
...
lean_inc(v_fst_2645_);
v___y_2589_ = v_fst_2645_;
v___y_2590_ = v_fst_2644_;
v___y_2591_ = v_opts_2634_;
v___y_2592_ = v_pos_2647_;
v___y_2593_ = v___x_2640_;
v___y_2594_ = v_snd_2646_;
v___y_2595_ = v_fst_2645_;
v___y_2596_ = v_fst_2644_;
v___y_2597_ = v_opts_2634_;
...
v___x_2655_ = l_Lean_Language_SnapshotTask_cancelRec___redArg(v___x_2629_, v_val_2654_);
lean_inc_ref(v_opts_2634_);
lean_inc(v_fst_2644_);
lean_inc(v_fst_2645_);
v___y_2589_ = v_fst_2645_;
...
v_val_2656_ = lean_ctor_get(v_nextCmdSnap_x3f_2652_, 0);
lean_inc(v_val_2656_);
lean_dec_ref_known(v_nextCmdSnap_x3f_2652_, 1);
v_toSnapshot_2453_ = v_toSnapshot_2648_;
v_stx_2454_ = v_stx_2649_;
v_parserState_2455_ = v_parserState_2650_;
v_elabSnap_2456_ = v_elabSnap_2651_;
v_val_2457_ = v_val_2656_;
v_newParserState_2458_ = v_fst_2645_;
goto v___jp_2452_;
}
else
{
...
lean_dec_ref(v_cmds_2445_);
v___x_2657_ = lean_io_promise_resolve(v_val_2643_, v_prom_2442_);
lean_dec(v_prom_2442_);
return v___x_2657_;
}
}
...
{
lean_object* v_fst_2658_; lean_object* v_fst_2659_; lean_object* v_snd_2660_; lean_object* v_pos_2661_; 
v_fst_2658_ = lean_ctor_get(v___x_2641_, 0);
lean_inc_n(v_fst_2658_, 2);
lean_dec(v___x_2641_);
v_fst_2659_ = lean_ctor_get(v_snd_2642_, 0);
lean_inc_n(v_fst_2659_, 2);
v_snd_2660_ = lean_ctor_get(v_snd_2642_, 1);
lean_inc(v_snd_2660_);
lean_dec(v_snd_2642_);
v_pos_2661_ = lean_ctor_get(v_parserState_2440_, 0);
lean_inc(v_pos_2661_);
lean_dec_ref(v_parserState_2440_);
lean_inc_ref(v_opts_2634_);
v___y_2589_ = v_fst_2659_;
v___y_2590_ = v_fst_2658_;
v___y_2591_ = v_opts_2634_;
v___y_2592_ = v_pos_2661_;
v___y_2593_ = v___x_2640_;
v___y_2594_ = v_snd_2660_;
v___y_2595_ = v_fst_2659_;
v___y_2596_ = v_fst_2658_;
v___y_2597_ = v_opts_2634_;
v___y_2598_ = v___x_2640_;
goto v___jp_2588_;
}
...
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__0(lean_object* v_oldResult_2678_, lean_object* v_cmds_2679_, lean_object* v_stx_2680_, lean_object* v_newParserState_2681_, lean_object* v_val_2682_, uint8_t v_sync_2683_, lean_object* v_val_2684_, lean_object* v_a_2685_, lean_object* v_oldNext_2686_){
_start:
{
lean_object* v_cmdState_2688_; lean_object* v___x_2689_; lean_object* v___x_2690_; lean_object* v___x_2691_; 
v_cmdState_2688_ = lean_ctor_get(v_oldResult_2678_, 1);
lean_inc_ref(v_cmdState_2688_);
lean_dec_ref(v_oldResult_2678_);
v___x_2689_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2689_, 0, v_oldNext_2686_);
v___x_2690_ = lean_array_push(v_cmds_2679_, v_stx_2680_);
v___x_2691_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(v___x_2689_, v_newParserState_2681_, v_cmdState_2688_, v_val_2682_, v_sync_2683_, v_val_2684_, v___x_2690_, v_a_2685_);
return v___x_2691_;
}
}
...
lean_object* v___x_2692_ = _args[0];
lean_object* v_val_2693_ = _args[1];
lean_object* v_cmds_2694_ = _args[2];
lean_object* v_fst_2695_ = _args[3];
lean_object* v_fst_2696_ = _args[4];
lean_object* v_val_2697_ = _args[5];
lean_object* v_a_2698_ = _args[6];
lean_object* v_snd_2699_ = _args[7];
lean_object* v___x_2700_ = _args[8];
lean_object* v___x_2701_ = _args[9];
lean_object* v_fst_2702_ = _args[10];
lean_object* v_val_2703_ = _args[11];
lean_object* v_val_2704_ = _args[12];
lean_object* v_val_2705_ = _args[13];
lean_object* v_snd_2706_ = _args[14];
lean_object* v_prom_2707_ = _args[15];
lean_object* v___x_2708_ = _args[16];
lean_object* v___f_2709_ = _args[17];
lean_object* v___f_2710_ = _args[18];
lean_object* v___f_2711_ = _args[19];
lean_object* v_pos_2712_ = _args[20];
lean_object* v_cmdState_2713_ = _args[21];
lean_object* v___x_2714_ = _args[22];
lean_object* v_opts_2715_ = _args[23];
lean_object* v___x_2716_ = _args[24];
lean_object* v_old_x3f_2717_ = _args[25];
lean_object* v_parseCancelTk_2718_ = _args[26];
lean_object* v_next_x3f_2719_ = _args[27];
lean_object* v___y_2720_ = _args[28];
_start:
{
uint8_t v_val_36242__boxed_2721_; uint8_t v___x_36245__boxed_2722_; lean_object* v_res_2723_; 
v_val_36242__boxed_2721_ = lean_unbox(v_val_2697_);
v___x_36245__boxed_2722_ = lean_unbox(v___x_2701_);
v_res_2723_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___lam__5(v___x_2692_, v_val_2693_, v_cmds_2694_, v_fst_2695_, v_fst_2696_, v_val_36242__boxed_2721_, v_a_2698_, v_snd_2699_, v___x_2700_, v___x_36245__boxed_2722_, v_fst_2702_, v_val_2703_, v_val_2704_, v_val_2705_, v_snd_2706_, v_prom_2707_, v___x_2708_, v___f_2709_, v___f_2710_, v___f_2711_, v_pos_2712_, v_cmdState_2713_, v___x_2714_, v_opts_2715_, v___x_2716_, v_old_x3f_2717_, v_parseCancelTk_2718_, v_next_x3f_2719_);
lean_dec_ref(v___x_2716_);
lean_dec_ref(v_opts_2715_);
lean_dec(v_prom_2707_);
...
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1(lean_object* v_setupImports_2820_, lean_object* v_stx_2821_, lean_object* v_origStx_2822_, lean_object* v_toProcessingContext_2823_, lean_object* v___x_2824_, lean_object* v_fileMap_2825_, lean_object* v_parserState_2826_, lean_object* v_a_2827_, lean_object* v___x_2828_, lean_object* v___x_2829_, lean_object* v___x_2830_, lean_object* v___y_2831_){
_start:
{
lean_object* v_toProcessingContext_2833_; lean_object* v___x_2834_; 
v_toProcessingContext_2833_ = lean_ctor_get(v___y_2831_, 0);
lean_inc_ref(v_toProcessingContext_2833_);
lean_inc(v_stx_2821_);
v___x_2834_ = lean_apply_3(v_setupImports_2820_, v_stx_2821_, v_toProcessingContext_2833_, lean_box(0));
if (lean_obj_tag(v___x_2834_) == 0)
{
lean_object* v_a_2835_; lean_object* v___x_2837_; uint8_t v_isShared_2838_; uint8_t v_isSharedCheck_3048_; 
v_a_2835_ = lean_ctor_get(v___x_2834_, 0);
v_isSharedCheck_3048_ = !lean_is_exclusive(v___x_2834_);
if (v_isSharedCheck_3048_ == 0)
{
v___x_2837_ = v___x_2834_;
v_isShared_2838_ = v_isSharedCheck_3048_;
...
v_a_2839_ = lean_ctor_get(v_a_2835_, 0);
lean_inc(v_a_2839_);
lean_dec_ref_known(v_a_2835_, 1);
if (v_isShared_2838_ == 0)
{
lean_ctor_set(v___x_2837_, 0, v_a_2839_);
...
{
lean_object* v_a_2843_; lean_object* v___x_2845_; uint8_t v_isShared_2846_; uint8_t v_isSharedCheck_3047_; 
v_a_2843_ = lean_ctor_get(v_a_2835_, 0);
v_isSharedCheck_3047_ = !lean_is_exclusive(v_a_2835_);
if (v_isSharedCheck_3047_ == 0)
{
v___x_2845_ = v_a_2835_;
v_isShared_2846_ = v_isSharedCheck_3047_;
...
v_resetjp_2844_:
{
lean_object* v___x_2847_; lean_object* v_mainModuleName_2848_; lean_object* v_package_x3f_2849_; uint8_t v_isModule_2850_; lean_object* v_imports_2851_; lean_object* v_opts_2852_; uint32_t v_trustLevel_2853_; lean_object* v_importArts_2854_; lean_object* v_plugins_2855_; lean_object* v___x_2856_; lean_object* v___x_2857_; uint8_t v___x_2858_; lean_object* v___x_2860_; 
v___x_2847_ = lean_io_mono_nanos_now();
v_mainModuleName_2848_ = lean_ctor_get(v_a_2843_, 0);
lean_inc(v_mainModuleName_2848_);
v_package_x3f_2849_ = lean_ctor_get(v_a_2843_, 1);
lean_inc(v_package_x3f_2849_);
v_isModule_2850_ = lean_ctor_get_uint8(v_a_2843_, sizeof(void*)*6 + 4);
v_imports_2851_ = lean_ctor_get(v_a_2843_, 2);
lean_inc_ref(v_imports_2851_);
v_opts_2852_ = lean_ctor_get(v_a_2843_, 3);
lean_inc_ref(v_opts_2852_);
v_trustLevel_2853_ = lean_ctor_get_uint32(v_a_2843_, sizeof(void*)*6);
v_importArts_2854_ = lean_ctor_get(v_a_2843_, 4);
lean_inc(v_importArts_2854_);
v_plugins_2855_ = lean_ctor_get(v_a_2843_, 5);
lean_inc_ref(v_plugins_2855_);
lean_dec(v_a_2843_);
v___x_2856_ = l_Lean_Elab_HeaderSyntax_startPos(v_stx_2821_);
v___x_2857_ = l_Lean_MessageLog_empty;
v___x_2858_ = 1;
lean_inc(v_stx_2821_);
if (v_isShared_2846_ == 0)
{
lean_ctor_set(v___x_2845_, 0, v_stx_2821_);
v___x_2860_ = v___x_2845_;
...
lean_ctor_set(v_reuseFailAlloc_3046_, 0, v_stx_2821_);
v___x_2860_ = v_reuseFailAlloc_3046_;
goto v_reusejp_2859_;
}
v_reusejp_2859_:
{
...
lean_ctor_set(v___x_2861_, 0, v_origStx_2822_);
lean_inc_ref(v___x_2860_);
lean_inc_ref(v_opts_2852_);
v___x_2862_ = l_Lean_Elab_processHeaderCore(v___x_2856_, v_imports_2851_, v_isModule_2850_, v_opts_2852_, v___x_2857_, v_toProcessingContext_2823_, v_trustLevel_2853_, v_plugins_2855_, v___x_2858_, v_mainModuleName_2848_, v_package_x3f_2849_, v_importArts_2854_, v___x_2860_, v___x_2861_);
if (lean_obj_tag(v___x_2862_) == 0)
{
lean_object* v_a_2863_; lean_object* v___x_2865_; uint8_t v_isShared_2866_; uint8_t v_isSharedCheck_3037_; 
v_a_2863_ = lean_ctor_get(v___x_2862_, 0);
v_isSharedCheck_3037_ = !lean_is_exclusive(v___x_2862_);
if (v_isSharedCheck_3037_ == 0)
{
v___x_2865_ = v___x_2862_;
v_isShared_2866_ = v_isSharedCheck_3037_;
...
v_resetjp_2864_:
{
lean_object* v_fst_2867_; lean_object* v_snd_2868_; lean_object* v___x_2870_; uint8_t v_isShared_2871_; uint8_t v_isSharedCheck_3036_; 
v_fst_2867_ = lean_ctor_get(v_a_2863_, 0);
v_snd_2868_ = lean_ctor_get(v_a_2863_, 1);
v_isSharedCheck_3036_ = !lean_is_exclusive(v_a_2863_);
if (v_isSharedCheck_3036_ == 0)
{
v___x_2870_ = v_a_2863_;
v_isShared_2871_ = v_isSharedCheck_3036_;
...
v_resetjp_2869_:
{
lean_object* v___x_2872_; lean_object* v___x_2873_; uint8_t v___x_2874_; lean_object* v___y_2876_; lean_object* v___y_2877_; lean_object* v___y_2878_; lean_object* v___y_2879_; lean_object* v___y_2880_; lean_object* v___y_2881_; lean_object* v_traceState_2890_; 
v___x_2872_ = lean_io_mono_nanos_now();
lean_inc(v_snd_2868_);
v___x_2873_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_snd_2868_);
v___x_2874_ = l_Lean_MessageLog_hasErrors(v_snd_2868_);
if (v___x_2874_ == 0)
{
double v___x_2984_; double v___x_2985_; double v___x_2986_; double v___x_2987_; double v___x_2988_; lean_object* v___x_3005_; lean_object* v___x_3006_; 
lean_del_object(v___x_2837_);
lean_dec_ref(v___x_2830_);
v___x_2984_ = lean_float_of_nat(v___x_2847_);
v___x_2985_ = lean_float_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__6, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__6_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__6);
v___x_2986_ = lean_float_div(v___x_2984_, v___x_2985_);
v___x_2987_ = lean_float_of_nat(v___x_2872_);
v___x_2988_ = lean_float_div(v___x_2987_, v___x_2985_);
v___x_3005_ = l_Lean_trace_profiler_output;
v___x_3006_ = l_Lean_Option_get_x3f___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader_spec__1(v_opts_2852_, v___x_3005_);
if (lean_obj_tag(v___x_3006_) == 0)
{
lean_object* v___x_3007_; uint8_t v___x_3008_; 
v___x_3007_ = l_Lean_trace_profiler_serve;
v___x_3008_ = l_Lean_Option_get___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__1(v_opts_2852_, v___x_3007_);
if (v___x_3008_ == 0)
{
lean_object* v___x_3009_; 
v___x_3009_ = l_Lean_instInhabitedTraceState_default;
v_traceState_2890_ = v___x_3009_;
goto v___jp_2889_;
}
else
{
...
v___jp_2989_:
{
uint64_t v___x_2990_; lean_object* v___x_2991_; lean_object* v___x_2992_; lean_object* v___x_2993_; lean_object* v___x_2994_; lean_object* v___x_2995_; lean_object* v___x_2996_; lean_object* v___x_2997_; lean_object* v___x_2998_; lean_object* v___x_2999_; lean_object* v___x_3000_; lean_object* v___x_3001_; lean_object* v___x_3002_; lean_object* v___x_3003_; lean_object* v___x_3004_; 
v___x_2990_ = 0ULL;
v___x_2991_ = lean_box(0);
v___x_2992_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__8));
v___x_2993_ = lean_box(0);
v___x_2994_ = ((lean_object*)(l_Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10___closed__0));
...
lean_ctor_set_float(v___x_2995_, sizeof(void*)*3, v___x_2986_);
lean_ctor_set_float(v___x_2995_, sizeof(void*)*3 + 8, v___x_2988_);
lean_ctor_set_uint8(v___x_2995_, sizeof(void*)*3 + 16, v___x_2858_);
v___x_2996_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__11, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__11_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__11);
v___x_2997_ = lean_mk_empty_array_with_capacity(v___x_2824_);
...
v___x_3002_ = lean_array_push(v___x_3001_, v___x_2999_);
v___x_3003_ = l_Lean_Array_toPArray_x27___redArg(v___x_3002_);
lean_dec_ref(v___x_3002_);
v___x_3004_ = lean_alloc_ctor(0, 1, 8);
lean_ctor_set(v___x_3004_, 0, v___x_3003_);
lean_ctor_set_uint64(v___x_3004_, sizeof(void*)*1, v___x_2990_);
v_traceState_2890_ = v___x_3004_;
goto v___jp_2889_;
}
}
else
...
lean_dec_ref(v_opts_2852_);
lean_dec(v___x_2847_);
lean_dec(v___x_2828_);
lean_dec_ref(v_parserState_2826_);
lean_dec_ref(v_fileMap_2825_);
lean_dec(v_stx_2821_);
v___x_3010_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__2));
v___x_3011_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__4));
v___x_3012_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__6));
lean_inc_n(v___x_2824_, 2);
v___x_3013_ = l_Lean_Name_num___override(v___x_3012_, v___x_2824_);
v___x_3014_ = l_Lean_Name_str___override(v___x_3013_, v___x_3010_);
v___x_3015_ = l_Lean_Name_str___override(v___x_3014_, v___x_3011_);
v___x_3016_ = l_Lean_Name_str___override(v___x_3015_, v___x_3010_);
v___x_3017_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab___closed__0));
v___x_3018_ = l_Lean_Name_str___override(v___x_3016_, v___x_3017_);
v___x_3019_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__5));
v___x_3020_ = l_Lean_Name_str___override(v___x_3018_, v___x_3019_);
v___x_3021_ = l_Lean_Name_toString(v___x_3020_, v___x_2858_);
...
lean_ctor_set(v___x_3028_, 2, v___x_2824_);
lean_ctor_set(v___x_3028_, 3, v___x_2824_);
...
v___x_3030_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3030_, 0, v___x_3021_);
lean_ctor_set(v___x_3030_, 1, v___x_2873_);
lean_ctor_set(v___x_3030_, 2, v___x_3022_);
lean_ctor_set(v___x_3030_, 3, v___x_3029_);
lean_ctor_set_uint8(v___x_3030_, sizeof(void*)*4, v___x_2874_);
v___x_3031_ = l_Lean_Language_instInhabitedSnapshotTask_default___redArg(v___x_2830_);
v___x_3032_ = lean_alloc_ctor(0, 3, 0);
lean_ctor_set(v___x_3032_, 0, v___x_3030_);
lean_ctor_set(v___x_3032_, 1, v___x_3031_);
lean_ctor_set(v___x_3032_, 2, v___x_3022_);
if (v_isShared_2838_ == 0)
{
lean_ctor_set(v___x_2837_, 0, v___x_3032_);
v___x_3034_ = v___x_2837_;
...
lean_ctor_set(v___x_2882_, 0, v___y_2881_);
v___x_2883_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2883_, 0, v___y_2876_);
lean_ctor_set(v___x_2883_, 1, v___x_2873_);
lean_ctor_set(v___x_2883_, 2, v___x_2882_);
lean_ctor_set(v___x_2883_, 3, v___y_2877_);
lean_ctor_set_uint8(v___x_2883_, sizeof(void*)*4, v___x_2874_);
v___x_2884_ = l_Lean_Language_SnapshotTask_finished___redArg(v___y_2879_, v___x_2883_);
v___x_2885_ = lean_alloc_ctor(0, 3, 0);
lean_ctor_set(v___x_2885_, 0, v___y_2880_);
lean_ctor_set(v___x_2885_, 1, v___x_2884_);
lean_ctor_set(v___x_2885_, 2, v___y_2878_);
if (v_isShared_2866_ == 0)
{
lean_ctor_set(v___x_2865_, 0, v___x_2885_);
...
v___x_2891_ = l_Lean_Language_Lean_reparseOptions(v_opts_2852_);
if (lean_obj_tag(v___x_2891_) == 0)
{
lean_object* v_a_2892_; lean_object* v___x_2893_; lean_object* v___x_2894_; lean_object* v___x_2895_; lean_object* v___x_2896_; lean_object* v___x_2897_; lean_object* v_env_2898_; lean_object* v_messages_2899_; lean_object* v_scopes_2900_; lean_object* v_usedQuotCtxts_2901_; lean_object* v_nextMacroScope_2902_; lean_object* v_maxRecDepth_2903_; lean_object* v_ngen_2904_; lean_object* v_auxDeclNGen_2905_; lean_object* v_snapshotTasks_2906_; lean_object* v_prevLinterStates_2907_; lean_object* v_codeQualityEntryTasks_2908_; lean_object* v___x_2910_; uint8_t v_isShared_2911_; uint8_t v_isSharedCheck_2973_; 
v_a_2892_ = lean_ctor_get(v___x_2891_, 0);
lean_inc(v_a_2892_);
lean_dec_ref_known(v___x_2891_, 1);
v___x_2893_ = lean_obj_once(&l_Lean_addMessageContextPartial___at___00Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10_spec__11___redArg___closed__1, &l_Lean_addMessageContextPartial___at___00Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10_spec__11___redArg___closed__1_once, _init_l_Lean_addMessageContextPartial___at___00Lean_logAt___at___00Lean_logErrorAt___at___00Lean_Elab_logException___at___00Lean_Elab_withLogging___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab_spec__2_spec__2_spec__4_spec__10_spec__11___redArg___closed__1);
lean_inc_n(v___x_2824_, 4);
v___x_2894_ = lean_alloc_ctor(0, 11, 0);
lean_ctor_set(v___x_2894_, 0, v___x_2824_);
lean_ctor_set(v___x_2894_, 1, v___x_2824_);
lean_ctor_set(v___x_2894_, 2, v___x_2824_);
lean_ctor_set(v___x_2894_, 3, v___x_2824_);
lean_ctor_set(v___x_2894_, 4, v___x_2893_);
lean_ctor_set(v___x_2894_, 5, v___x_2893_);
lean_ctor_set(v___x_2894_, 6, v___x_2893_);
lean_ctor_set(v___x_2894_, 7, v___x_2893_);
lean_ctor_set(v___x_2894_, 8, v___x_2893_);
lean_ctor_set(v___x_2894_, 9, v___x_2893_);
lean_ctor_set(v___x_2894_, 10, v___x_2893_);
v___x_2895_ = lean_io_promise_new();
v___x_2896_ = l_IO_CancelToken_new();
lean_inc(v_fst_2867_);
v___x_2897_ = l_Lean_Elab_Command_mkState(v_fst_2867_, v_snd_2868_, v_a_2892_);
v_env_2898_ = lean_ctor_get(v___x_2897_, 0);
v_messages_2899_ = lean_ctor_get(v___x_2897_, 1);
v_scopes_2900_ = lean_ctor_get(v___x_2897_, 2);
v_usedQuotCtxts_2901_ = lean_ctor_get(v___x_2897_, 3);
v_nextMacroScope_2902_ = lean_ctor_get(v___x_2897_, 4);
v_maxRecDepth_2903_ = lean_ctor_get(v___x_2897_, 5);
v_ngen_2904_ = lean_ctor_get(v___x_2897_, 6);
v_auxDeclNGen_2905_ = lean_ctor_get(v___x_2897_, 7);
v_snapshotTasks_2906_ = lean_ctor_get(v___x_2897_, 10);
v_prevLinterStates_2907_ = lean_ctor_get(v___x_2897_, 11);
v_codeQualityEntryTasks_2908_ = lean_ctor_get(v___x_2897_, 12);
v_isSharedCheck_2973_ = !lean_is_exclusive(v___x_2897_);
if (v_isSharedCheck_2973_ == 0)
{
lean_object* v_unused_2974_; lean_object* v_unused_2975_; 
v_unused_2974_ = lean_ctor_get(v___x_2897_, 9);
lean_dec(v_unused_2974_);
v_unused_2975_ = lean_ctor_get(v___x_2897_, 8);
lean_dec(v_unused_2975_);
v___x_2910_ = v___x_2897_;
v_isShared_2911_ = v_isSharedCheck_2973_;
...
lean_inc(v_nextMacroScope_2902_);
lean_inc(v_usedQuotCtxts_2901_);
lean_inc(v_scopes_2900_);
...
v_resetjp_2909_:
{
lean_object* v___x_2912_; lean_object* v___x_2913_; lean_object* v___x_2914_; lean_object* v___x_2915_; lean_object* v___x_2916_; lean_object* v___x_2917_; lean_object* v___x_2918_; lean_object* v___x_2919_; lean_object* v___x_2920_; lean_object* v___x_2922_; 
v___x_2912_ = lean_box(0);
v___x_2913_ = l_Lean_Options_empty;
v___x_2914_ = lean_box(0);
v___x_2915_ = lean_box(0);
v___x_2916_ = lean_unsigned_to_nat(1u);
v___x_2917_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__2));
v___x_2918_ = lean_alloc_ctor(0, 8, 0);
lean_ctor_set(v___x_2918_, 0, v_fst_2867_);
lean_ctor_set(v___x_2918_, 1, v___x_2912_);
lean_ctor_set(v___x_2918_, 2, v_fileMap_2825_);
lean_ctor_set(v___x_2918_, 3, v___x_2894_);
lean_ctor_set(v___x_2918_, 4, v___x_2913_);
lean_ctor_set(v___x_2918_, 5, v___x_2914_);
lean_ctor_set(v___x_2918_, 6, v___x_2915_);
lean_ctor_set(v___x_2918_, 7, v___x_2917_);
v___x_2919_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_2919_, 0, v___x_2918_);
v___x_2920_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__4));
lean_inc(v_stx_2821_);
if (v_isShared_2871_ == 0)
{
lean_ctor_set(v___x_2870_, 1, v_stx_2821_);
lean_ctor_set(v___x_2870_, 0, v___x_2920_);
...
lean_ctor_set(v_reuseFailAlloc_2972_, 1, v_stx_2821_);
v___x_2922_ = v_reuseFailAlloc_2972_;
goto v_reusejp_2921_;
}
v_reusejp_2921_:
{
...
v___x_2925_ = l_Lean_Syntax_getArg(v_stx_2821_, v___x_2924_);
lean_dec(v_stx_2821_);
v___x_2926_ = l_Lean_Syntax_getArgs(v___x_2925_);
lean_dec(v___x_2925_);
v___x_2927_ = lean_array_to_list(v___x_2926_);
v___x_2928_ = l_List_mapTR_loop___at___00__private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader_spec__0(v___x_2927_, v___x_2915_);
v___x_2929_ = l_Lean_List_toPArray_x27___redArg(v___x_2928_);
v___x_2930_ = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(v___x_2930_, 0, v___x_2923_);
lean_ctor_set(v___x_2930_, 1, v___x_2929_);
v___x_2931_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2931_, 0, v___x_2919_);
lean_ctor_set(v___x_2931_, 1, v___x_2930_);
v___x_2932_ = lean_mk_empty_array_with_capacity(v___x_2916_);
v___x_2933_ = lean_array_push(v___x_2932_, v___x_2931_);
v___x_2934_ = l_Lean_Array_toPArray_x27___redArg(v___x_2933_);
lean_dec_ref(v___x_2933_);
lean_inc_ref(v___x_2934_);
v___x_2935_ = lean_alloc_ctor(0, 3, 1);
lean_ctor_set(v___x_2935_, 0, v___x_2893_);
lean_ctor_set(v___x_2935_, 1, v___x_2893_);
lean_ctor_set(v___x_2935_, 2, v___x_2934_);
lean_ctor_set_uint8(v___x_2935_, sizeof(void*)*3, v___x_2858_);
if (v_isShared_2911_ == 0)
{
lean_ctor_set(v___x_2910_, 9, v_traceState_2890_);
lean_ctor_set(v___x_2910_, 8, v___x_2935_);
v___x_2937_ = v___x_2910_;
goto v_reusejp_2936_;
}
else
{
lean_object* v_reuseFailAlloc_2971_; 
v_reuseFailAlloc_2971_ = lean_alloc_ctor(0, 13, 0);
lean_ctor_set(v_reuseFailAlloc_2971_, 0, v_env_2898_);
lean_ctor_set(v_reuseFailAlloc_2971_, 1, v_messages_2899_);
lean_ctor_set(v_reuseFailAlloc_2971_, 2, v_scopes_2900_);
lean_ctor_set(v_reuseFailAlloc_2971_, 3, v_usedQuotCtxts_2901_);
lean_ctor_set(v_reuseFailAlloc_2971_, 4, v_nextMacroScope_2902_);
lean_ctor_set(v_reuseFailAlloc_2971_, 5, v_maxRecDepth_2903_);
lean_ctor_set(v_reuseFailAlloc_2971_, 6, v_ngen_2904_);
lean_ctor_set(v_reuseFailAlloc_2971_, 7, v_auxDeclNGen_2905_);
lean_ctor_set(v_reuseFailAlloc_2971_, 8, v___x_2935_);
lean_ctor_set(v_reuseFailAlloc_2971_, 9, v_traceState_2890_);
lean_ctor_set(v_reuseFailAlloc_2971_, 10, v_snapshotTasks_2906_);
lean_ctor_set(v_reuseFailAlloc_2971_, 11, v_prevLinterStates_2907_);
lean_ctor_set(v_reuseFailAlloc_2971_, 12, v_codeQualityEntryTasks_2908_);
v___x_2937_ = v_reuseFailAlloc_2971_;
goto v_reusejp_2936_;
}
v_reusejp_2936_:
{
lean_object* v___x_2938_; lean_object* v___x_2939_; lean_object* v___x_2940_; lean_object* v___x_2941_; lean_object* v___x_2942_; lean_object* v___x_2943_; lean_object* v___x_2944_; lean_object* v___x_2945_; lean_object* v___x_2946_; size_t v___x_2947_; lean_object* v___x_2948_; lean_object* v_size_2949_; lean_object* v___x_2950_; lean_object* v___x_2951_; lean_object* v___x_2952_; lean_object* v___x_2953_; lean_object* v___x_2954_; lean_object* v___x_2955_; lean_object* v___x_2956_; lean_object* v___x_2957_; lean_object* v___x_2958_; lean_object* v___x_2959_; uint64_t v___x_2960_; lean_object* v___x_2961_; lean_object* v___x_2962_; lean_object* v___x_2963_; lean_object* v___x_2964_; lean_object* v___x_2965_; lean_object* v___x_2966_; lean_object* v___x_2967_; uint8_t v___x_2968_; 
v___x_2938_ = lean_mk_empty_array_with_capacity(v___x_2824_);
lean_inc_ref(v___x_2896_);
lean_inc(v___x_2895_);
lean_inc_ref(v___x_2937_);
v___x_2939_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(v___x_2912_, v_parserState_2826_, v___x_2937_, v___x_2895_, v___x_2858_, v___x_2896_, v___x_2938_, v_a_2827_);
v___x_2940_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__2));
v___x_2941_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__4));
v___x_2942_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__6));
lean_inc_n(v___x_2824_, 3);
v___x_2943_ = l_Lean_Name_num___override(v___x_2942_, v___x_2824_);
v___x_2944_ = lean_unsigned_to_nat(32u);
v___x_2945_ = lean_mk_empty_array_with_capacity(v___x_2944_);
v___x_2946_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__14, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__14_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__14);
...
lean_ctor_set(v___x_2948_, 2, v___x_2824_);
lean_ctor_set(v___x_2948_, 3, v___x_2824_);
lean_ctor_set_usize(v___x_2948_, 4, v___x_2947_);
v_size_2949_ = lean_ctor_get(v___x_2934_, 2);
lean_inc(v_size_2949_);
v___x_2950_ = l_Lean_Name_str___override(v___x_2943_, v___x_2940_);
v___x_2951_ = l_Lean_Language_SnapshotTask_defaultReportingRange(v___x_2828_);
v___x_2952_ = l_Lean_Name_str___override(v___x_2950_, v___x_2941_);
v___x_2953_ = l_Lean_Name_str___override(v___x_2952_, v___x_2940_);
v___x_2954_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_doElab___closed__0));
v___x_2955_ = l_Lean_Name_str___override(v___x_2953_, v___x_2954_);
v___x_2956_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___closed__5));
v___x_2957_ = l_Lean_Name_str___override(v___x_2955_, v___x_2956_);
v___x_2958_ = l_Lean_Name_toString(v___x_2957_, v___x_2858_);
v___x_2959_ = l_Lean_Language_Snapshot_Diagnostics_empty;
v___x_2960_ = 0ULL;
v___x_2961_ = lean_alloc_ctor(0, 1, 8);
lean_ctor_set(v___x_2961_, 0, v___x_2948_);
lean_ctor_set_uint64(v___x_2961_, sizeof(void*)*1, v___x_2960_);
v___x_2962_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_2962_, 0, v___x_2896_);
v___x_2963_ = l_IO_Promise_result_x21___redArg(v___x_2895_);
lean_dec(v___x_2895_);
v___x_2964_ = lean_alloc_ctor(0, 4, 0);
lean_ctor_set(v___x_2964_, 0, v___x_2828_);
lean_ctor_set(v___x_2964_, 1, v___x_2951_);
lean_ctor_set(v___x_2964_, 2, v___x_2962_);
lean_ctor_set(v___x_2964_, 3, v___x_2963_);
v___x_2965_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_2965_, 0, v___x_2937_);
...
v___x_2967_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_2967_, 0, v___x_2958_);
lean_ctor_set(v___x_2967_, 1, v___x_2959_);
lean_ctor_set(v___x_2967_, 2, v___x_2912_);
lean_ctor_set(v___x_2967_, 3, v___x_2961_);
lean_ctor_set_uint8(v___x_2967_, sizeof(void*)*4, v___x_2874_);
v___x_2968_ = lean_nat_dec_lt(v___x_2824_, v_size_2949_);
lean_dec(v_size_2949_);
if (v___x_2968_ == 0)
{
lean_object* v___x_2969_; 
lean_dec_ref(v___x_2934_);
lean_dec(v___x_2824_);
v___x_2969_ = l_outOfBounds___redArg(v___x_2829_);
v___y_2876_ = v___x_2958_;
v___y_2877_ = v___x_2961_;
v___y_2878_ = v___x_2966_;
v___y_2879_ = v___x_2860_;
v___y_2880_ = v___x_2967_;
v___y_2881_ = v___x_2969_;
goto v___jp_2875_;
}
else
{
lean_object* v___x_2970_; 
v___x_2970_ = l_Lean_PersistentArray_get_x21___redArg(v___x_2829_, v___x_2934_, v___x_2824_);
lean_dec(v___x_2824_);
lean_dec_ref(v___x_2934_);
v___y_2876_ = v___x_2958_;
v___y_2877_ = v___x_2961_;
...
lean_dec(v___x_2824_);
lean_dec(v_stx_2821_);
v_a_2976_ = lean_ctor_get(v___x_2891_, 0);
v_isSharedCheck_2983_ = !lean_is_exclusive(v___x_2891_);
if (v_isSharedCheck_2983_ == 0)
{
v___x_2978_ = v___x_2891_;
...
lean_dec(v___x_2824_);
lean_dec(v_stx_2821_);
v_a_3038_ = lean_ctor_get(v___x_2862_, 0);
v_isSharedCheck_3045_ = !lean_is_exclusive(v___x_2862_);
if (v_isSharedCheck_3045_ == 0)
{
v___x_3040_ = v___x_2862_;
...
lean_dec(v_origStx_2822_);
lean_dec(v_stx_2821_);
v_a_3049_ = lean_ctor_get(v___x_2834_, 0);
v_isSharedCheck_3056_ = !lean_is_exclusive(v___x_2834_);
if (v_isSharedCheck_3056_ == 0)
{
v___x_3051_ = v___x_2834_;
...
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___boxed(lean_object* v_setupImports_3057_, lean_object* v_stx_3058_, lean_object* v_origStx_3059_, lean_object* v_toProcessingContext_3060_, lean_object* v___x_3061_, lean_object* v_fileMap_3062_, lean_object* v_parserState_3063_, lean_object* v_a_3064_, lean_object* v___x_3065_, lean_object* v___x_3066_, lean_object* v___x_3067_, lean_object* v___y_3068_, lean_object* v___y_3069_){
_start:
{
lean_object* v_res_3070_; 
v_res_3070_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1(v_setupImports_3057_, v_stx_3058_, v_origStx_3059_, v_toProcessingContext_3060_, v___x_3061_, v_fileMap_3062_, v_parserState_3063_, v_a_3064_, v___x_3065_, v___x_3066_, v___x_3067_, v___y_3068_);
...
_start:
{
lean_object* v___x_3071_; lean_object* v___f_3072_; 
v___x_3071_ = l_Lean_Language_instInhabitedSnapshotLeaf;
v___f_3072_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__0), 2, 1);
lean_closure_set(v___f_3072_, 0, v___x_3071_);
return v___f_3072_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader(lean_object* v_setupImports_3073_, lean_object* v_stx_3074_, lean_object* v_origStx_3075_, lean_object* v_parserState_3076_, lean_object* v_a_3077_){
_start:
{
lean_object* v_toProcessingContext_3079_; lean_object* v_fileMap_3080_; lean_object* v_endPos_3081_; lean_object* v___x_3082_; lean_object* v___f_3083_; lean_object* v___x_3084_; lean_object* v___x_3085_; lean_object* v___x_3086_; lean_object* v___f_3087_; lean_object* v___x_3088_; lean_object* v___x_3089_; lean_object* v___x_3090_; lean_object* v___x_3091_; 
v_toProcessingContext_3079_ = lean_ctor_get(v_a_3077_, 0);
v_fileMap_3080_ = lean_ctor_get(v_toProcessingContext_3079_, 2);
v_endPos_3081_ = lean_ctor_get(v_toProcessingContext_3079_, 3);
v___x_3082_ = l_Lean_Language_instInhabitedSnapshotLeaf;
v___f_3083_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___closed__0, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___closed__0_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___closed__0);
v___x_3084_ = l_Lean_Elab_instInhabitedInfoTree_default;
v___x_3085_ = lean_box(0);
v___x_3086_ = lean_unsigned_to_nat(0u);
lean_inc_ref_n(v_a_3077_, 2);
lean_inc_ref(v_fileMap_3080_);
lean_inc_ref(v_toProcessingContext_3079_);
v___f_3087_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___lam__1___boxed), 13, 11);
lean_closure_set(v___f_3087_, 0, v_setupImports_3073_);
lean_closure_set(v___f_3087_, 1, v_stx_3074_);
lean_closure_set(v___f_3087_, 2, v_origStx_3075_);
lean_closure_set(v___f_3087_, 3, v_toProcessingContext_3079_);
lean_closure_set(v___f_3087_, 4, v___x_3086_);
lean_closure_set(v___f_3087_, 5, v_fileMap_3080_);
lean_closure_set(v___f_3087_, 6, v_parserState_3076_);
lean_closure_set(v___f_3087_, 7, v_a_3077_);
lean_closure_set(v___f_3087_, 8, v___x_3085_);
lean_closure_set(v___f_3087_, 9, v___x_3084_);
lean_closure_set(v___f_3087_, 10, v___x_3082_);
lean_inc(v_endPos_3081_);
v___x_3088_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_3088_, 0, v___x_3086_);
lean_ctor_set(v___x_3088_, 1, v_endPos_3081_);
v___x_3089_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3089_, 0, v___x_3088_);
v___x_3090_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___boxed), 5, 4);
lean_closure_set(v___x_3090_, 0, lean_box(0));
lean_closure_set(v___x_3090_, 1, v___f_3083_);
lean_closure_set(v___x_3090_, 2, v___f_3087_);
lean_closure_set(v___x_3090_, 3, v_a_3077_);
v___x_3091_ = l_Lean_Language_SnapshotTask_ofIO___redArg(v___x_3085_, v___x_3085_, v___x_3089_, v___x_3090_);
return v___x_3091_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader___boxed(lean_object* v_setupImports_3092_, lean_object* v_stx_3093_, lean_object* v_origStx_3094_, lean_object* v_parserState_3095_, lean_object* v_a_3096_, lean_object* v_a_3097_){
_start:
{
lean_object* v_res_3098_; 
v_res_3098_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader(v_setupImports_3092_, v_stx_3093_, v_origStx_3094_, v_parserState_3095_, v_a_3096_);
...
v___x_3102_ = l_Lean_Language_SnapshotTask_defaultReportingRange(v___x_3101_);
return v___x_3102_;
}
}
...
v___x_3107_ = 1;
v___x_3108_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__3));
v___x_3109_ = l_Lean_Name_toString(v___x_3108_, v___x_3107_);
return v___x_3109_;
}
}
...
_start:
{
uint8_t v___x_3110_; lean_object* v___x_3111_; lean_object* v___x_3112_; lean_object* v___x_3113_; lean_object* v___x_3114_; lean_object* v___x_3115_; 
v___x_3110_ = 0;
v___x_3111_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
v___x_3112_ = lean_box(0);
v___x_3113_ = l_Lean_Language_Snapshot_Diagnostics_empty;
...
v___x_3115_ = lean_alloc_ctor(0, 4, 1);
...
lean_ctor_set_uint8(v___x_3115_, sizeof(void*)*4, v___x_3110_);
return v___x_3115_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0(lean_object* v_newParserState_3116_, lean_object* v_cmdState_3117_, lean_object* v_a_3118_, lean_object* v_toSnapshot_3119_, lean_object* v_newStx_3120_, lean_object* v_oldCmd_3121_){
_start:
{
lean_object* v___x_3123_; lean_object* v___x_3124_; lean_object* v___x_3125_; uint8_t v___x_3126_; lean_object* v___x_3127_; lean_object* v___x_3128_; lean_object* v_diagnostics_3129_; lean_object* v___x_3131_; uint8_t v_isShared_3132_; uint8_t v_isSharedCheck_3151_; 
v___x_3123_ = lean_io_promise_new();
v___x_3124_ = l_IO_CancelToken_new();
v___x_3125_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3125_, 0, v_oldCmd_3121_);
v___x_3126_ = 1;
v___x_3127_ = ((lean_object*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__0));
lean_inc_ref(v___x_3124_);
lean_inc(v___x_3123_);
lean_inc_ref(v_cmdState_3117_);
v___x_3128_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd(v___x_3125_, v_newParserState_3116_, v_cmdState_3117_, v___x_3123_, v___x_3126_, v___x_3124_, v___x_3127_, v_a_3118_);
v_diagnostics_3129_ = lean_ctor_get(v_toSnapshot_3119_, 1);
v_isSharedCheck_3151_ = !lean_is_exclusive(v_toSnapshot_3119_);
if (v_isSharedCheck_3151_ == 0)
{
lean_object* v_unused_3152_; lean_object* v_unused_3153_; lean_object* v_unused_3154_; 
v_unused_3152_ = lean_ctor_get(v_toSnapshot_3119_, 3);
lean_dec(v_unused_3152_);
v_unused_3153_ = lean_ctor_get(v_toSnapshot_3119_, 2);
lean_dec(v_unused_3153_);
v_unused_3154_ = lean_ctor_get(v_toSnapshot_3119_, 0);
lean_dec(v_unused_3154_);
v___x_3131_ = v_toSnapshot_3119_;
v_isShared_3132_ = v_isSharedCheck_3151_;
goto v_resetjp_3130_;
}
else
{
lean_inc(v_diagnostics_3129_);
lean_dec(v_toSnapshot_3119_);
...
v_reuseFailAlloc_3150_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v_reuseFailAlloc_3150_, 0, v___x_3135_);
lean_ctor_set(v_reuseFailAlloc_3150_, 1, v_diagnostics_3129_);
lean_ctor_set(v_reuseFailAlloc_3150_, 2, v___x_3133_);
lean_ctor_set(v_reuseFailAlloc_3150_, 3, v___x_3136_);
...
lean_ctor_set_uint8(v___x_3146_, sizeof(void*)*4, v___x_3142_);
v___x_3147_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3144_, v___x_3146_);
v___x_3148_ = lean_alloc_ctor(0, 3, 0);
lean_ctor_set(v___x_3148_, 0, v___x_3143_);
lean_ctor_set(v___x_3148_, 1, v___x_3147_);
lean_ctor_set(v___x_3148_, 2, v___x_3141_);
v___x_3149_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3133_, v___x_3148_);
return v___x_3149_;
}
}
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___boxed(lean_object* v_newParserState_3155_, lean_object* v_cmdState_3156_, lean_object* v_a_3157_, lean_object* v_toSnapshot_3158_, lean_object* v_newStx_3159_, lean_object* v_oldCmd_3160_, lean_object* v___y_3161_){
_start:
{
lean_object* v_res_3162_; 
v_res_3162_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0(v_newParserState_3155_, v_cmdState_3156_, v_a_3157_, v_toSnapshot_3158_, v_newStx_3159_, v_oldCmd_3160_);
lean_dec_ref(v_a_3157_);
return v_res_3162_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__1(lean_object* v_newParserState_3163_, lean_object* v_a_3164_, lean_object* v_newStx_3165_, lean_object* v___x_3166_, lean_object* v_oldProcessed_3167_){
_start:
{
lean_object* v_result_x3f_3169_; 
v_result_x3f_3169_ = lean_ctor_get(v_oldProcessed_3167_, 2);
if (lean_obj_tag(v_result_x3f_3169_) == 1)
{
lean_object* v_val_3170_; lean_object* v_firstCmdSnap_3171_; lean_object* v_toSnapshot_3172_; lean_object* v_cmdState_3173_; lean_object* v_stx_x3f_3174_; lean_object* v___f_3175_; lean_object* v___x_3176_; uint8_t v___x_3177_; lean_object* v___x_3178_; 
v_val_3170_ = lean_ctor_get(v_result_x3f_3169_, 0);
lean_inc(v_val_3170_);
v_firstCmdSnap_3171_ = lean_ctor_get(v_val_3170_, 1);
lean_inc_ref(v_firstCmdSnap_3171_);
v_toSnapshot_3172_ = lean_ctor_get(v_oldProcessed_3167_, 0);
lean_inc_ref(v_toSnapshot_3172_);
lean_dec_ref(v_oldProcessed_3167_);
v_cmdState_3173_ = lean_ctor_get(v_val_3170_, 0);
lean_inc_ref(v_cmdState_3173_);
lean_dec(v_val_3170_);
v_stx_x3f_3174_ = lean_ctor_get(v_firstCmdSnap_3171_, 0);
lean_inc(v_stx_x3f_3174_);
lean_inc_ref(v_a_3164_);
v___f_3175_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___boxed), 7, 5);
lean_closure_set(v___f_3175_, 0, v_newParserState_3163_);
lean_closure_set(v___f_3175_, 1, v_cmdState_3173_);
lean_closure_set(v___f_3175_, 2, v_a_3164_);
lean_closure_set(v___f_3175_, 3, v_toSnapshot_3172_);
lean_closure_set(v___f_3175_, 4, v_newStx_3165_);
v___x_3176_ = lean_box(0);
v___x_3177_ = 1;
v___x_3178_ = l_Lean_Language_SnapshotTask_bindIO___redArg(v_firstCmdSnap_3171_, v___f_3175_, v_stx_x3f_3174_, v___x_3166_, v___x_3176_, v___x_3177_);
return v___x_3178_;
}
else
{
...
lean_dec_ref(v_newParserState_3163_);
v___x_3179_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3179_, 0, v_newStx_3165_);
v___x_3180_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3179_, v_oldProcessed_3167_);
return v___x_3180_;
}
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__1___boxed(lean_object* v_newParserState_3181_, lean_object* v_a_3182_, lean_object* v_newStx_3183_, lean_object* v___x_3184_, lean_object* v_oldProcessed_3185_, lean_object* v___y_3186_){
_start:
{
lean_object* v_res_3187_; 
v_res_3187_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__1(v_newParserState_3181_, v_a_3182_, v_newStx_3183_, v___x_3184_, v_oldProcessed_3185_);
...
_start:
{
uint8_t v___x_3188_; lean_object* v___x_3189_; lean_object* v___x_3190_; lean_object* v___x_3191_; lean_object* v___x_3192_; lean_object* v___x_3193_; 
v___x_3188_ = 0;
v___x_3189_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
v___x_3190_ = lean_box(0);
v___x_3191_ = l_Lean_Language_Snapshot_Diagnostics_empty;
v___x_3192_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4);
v___x_3193_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3193_, 0, v___x_3192_);
lean_ctor_set(v___x_3193_, 1, v___x_3191_);
lean_ctor_set(v___x_3193_, 2, v___x_3190_);
lean_ctor_set(v___x_3193_, 3, v___x_3189_);
lean_ctor_set_uint8(v___x_3193_, sizeof(void*)*4, v___x_3188_);
return v___x_3193_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2(lean_object* v_toProcessingContext_3194_, lean_object* v_a_3195_, lean_object* v_old_3196_, lean_object* v_newStx_3197_, lean_object* v_newParserState_3198_, lean_object* v___y_3199_){
_start:
{
lean_object* v_result_x3f_3201_; 
v_result_x3f_3201_ = lean_ctor_get(v_old_3196_, 4);
lean_inc(v_result_x3f_3201_);
if (lean_obj_tag(v_result_x3f_3201_) == 1)
{
lean_object* v_val_3202_; lean_object* v___x_3204_; uint8_t v_isShared_3205_; uint8_t v_isSharedCheck_3256_; 
v_val_3202_ = lean_ctor_get(v_result_x3f_3201_, 0);
v_isSharedCheck_3256_ = !lean_is_exclusive(v_result_x3f_3201_);
if (v_isSharedCheck_3256_ == 0)
{
v___x_3204_ = v_result_x3f_3201_;
v_isShared_3205_ = v_isSharedCheck_3256_;
goto v_resetjp_3203_;
}
else
{
lean_inc(v_val_3202_);
lean_dec(v_result_x3f_3201_);
...
v_resetjp_3203_:
{
lean_object* v_processedSnap_3206_; lean_object* v___x_3208_; uint8_t v_isShared_3209_; uint8_t v_isSharedCheck_3254_; 
v_processedSnap_3206_ = lean_ctor_get(v_val_3202_, 1);
v_isSharedCheck_3254_ = !lean_is_exclusive(v_val_3202_);
if (v_isSharedCheck_3254_ == 0)
{
lean_object* v_unused_3255_; 
v_unused_3255_ = lean_ctor_get(v_val_3202_, 0);
lean_dec(v_unused_3255_);
v___x_3208_ = v_val_3202_;
v_isShared_3209_ = v_isSharedCheck_3254_;
goto v_resetjp_3207_;
}
else
{
lean_inc(v_processedSnap_3206_);
...
v_resetjp_3207_:
{
lean_object* v_toSnapshot_3210_; lean_object* v___x_3212_; uint8_t v_isShared_3213_; uint8_t v_isSharedCheck_3249_; 
v_toSnapshot_3210_ = lean_ctor_get(v_old_3196_, 0);
v_isSharedCheck_3249_ = !lean_is_exclusive(v_old_3196_);
if (v_isSharedCheck_3249_ == 0)
{
lean_object* v_unused_3250_; lean_object* v_unused_3251_; lean_object* v_unused_3252_; lean_object* v_unused_3253_; 
v_unused_3250_ = lean_ctor_get(v_old_3196_, 4);
lean_dec(v_unused_3250_);
v_unused_3251_ = lean_ctor_get(v_old_3196_, 3);
lean_dec(v_unused_3251_);
v_unused_3252_ = lean_ctor_get(v_old_3196_, 2);
lean_dec(v_unused_3252_);
v_unused_3253_ = lean_ctor_get(v_old_3196_, 1);
lean_dec(v_unused_3253_);
v___x_3212_ = v_old_3196_;
v_isShared_3213_ = v_isSharedCheck_3249_;
goto v_resetjp_3211_;
}
else
{
lean_inc(v_toSnapshot_3210_);
lean_dec(v_old_3196_);
...
v_resetjp_3211_:
{
lean_object* v_pos_3214_; lean_object* v_endPos_3215_; lean_object* v_stx_x3f_3216_; lean_object* v___x_3217_; lean_object* v___x_3218_; lean_object* v___f_3219_; lean_object* v___x_3220_; uint8_t v___x_3221_; lean_object* v___x_3222_; lean_object* v_diagnostics_3223_; lean_object* v___x_3225_; uint8_t v_isShared_3226_; uint8_t v_isSharedCheck_3245_; 
v_pos_3214_ = lean_ctor_get(v_newParserState_3198_, 0);
v_endPos_3215_ = lean_ctor_get(v_toProcessingContext_3194_, 3);
v_stx_x3f_3216_ = lean_ctor_get(v_processedSnap_3206_, 0);
lean_inc(v_stx_x3f_3216_);
lean_inc(v_endPos_3215_);
lean_inc(v_pos_3214_);
v___x_3217_ = lean_alloc_ctor(0, 2, 0);
lean_ctor_set(v___x_3217_, 0, v_pos_3214_);
lean_ctor_set(v___x_3217_, 1, v_endPos_3215_);
v___x_3218_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3218_, 0, v___x_3217_);
lean_inc_ref(v___x_3218_);
lean_inc(v_newStx_3197_);
lean_inc_ref(v_a_3195_);
lean_inc_ref(v_newParserState_3198_);
v___f_3219_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__1___boxed), 6, 4);
lean_closure_set(v___f_3219_, 0, v_newParserState_3198_);
lean_closure_set(v___f_3219_, 1, v_a_3195_);
lean_closure_set(v___f_3219_, 2, v_newStx_3197_);
lean_closure_set(v___f_3219_, 3, v___x_3218_);
v___x_3220_ = lean_box(0);
v___x_3221_ = 1;
v___x_3222_ = l_Lean_Language_SnapshotTask_bindIO___redArg(v_processedSnap_3206_, v___f_3219_, v_stx_x3f_3216_, v___x_3218_, v___x_3220_, v___x_3221_);
v_diagnostics_3223_ = lean_ctor_get(v_toSnapshot_3210_, 1);
v_isSharedCheck_3245_ = !lean_is_exclusive(v_toSnapshot_3210_);
if (v_isSharedCheck_3245_ == 0)
{
lean_object* v_unused_3246_; lean_object* v_unused_3247_; lean_object* v_unused_3248_; 
v_unused_3246_ = lean_ctor_get(v_toSnapshot_3210_, 3);
lean_dec(v_unused_3246_);
v_unused_3247_ = lean_ctor_get(v_toSnapshot_3210_, 2);
lean_dec(v_unused_3247_);
v_unused_3248_ = lean_ctor_get(v_toSnapshot_3210_, 0);
lean_dec(v_unused_3248_);
v___x_3225_ = v_toSnapshot_3210_;
v_isShared_3226_ = v_isSharedCheck_3245_;
goto v_resetjp_3224_;
}
else
{
lean_inc(v_diagnostics_3223_);
lean_dec(v_toSnapshot_3210_);
...
v___x_3227_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4);
v___x_3228_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
if (v_isShared_3209_ == 0)
{
lean_ctor_set(v___x_3208_, 1, v___x_3222_);
lean_ctor_set(v___x_3208_, 0, v_newParserState_3198_);
v___x_3230_ = v___x_3208_;
...
lean_ctor_set(v_reuseFailAlloc_3244_, 0, v_newParserState_3198_);
lean_ctor_set(v_reuseFailAlloc_3244_, 1, v___x_3222_);
...
{
lean_ctor_set(v___x_3204_, 0, v___x_3230_);
...
lean_ctor_set(v_reuseFailAlloc_3243_, 0, v___x_3230_);
v___x_3232_ = v_reuseFailAlloc_3243_;
goto v_reusejp_3231_;
}
v_reusejp_3231_:
{
uint8_t v___x_3233_; lean_object* v___x_3234_; lean_object* v___x_3235_; lean_object* v___x_3237_; 
v___x_3233_ = 0;
v___x_3234_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2___closed__0, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2___closed__0_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2___closed__0);
lean_inc(v_newStx_3197_);
v___x_3235_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3235_, 0, v_newStx_3197_);
if (v_isShared_3226_ == 0)
{
lean_ctor_set(v___x_3225_, 3, v___x_3228_);
lean_ctor_set(v___x_3225_, 2, v___x_3220_);
...
v_reuseFailAlloc_3242_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v_reuseFailAlloc_3242_, 0, v___x_3227_);
lean_ctor_set(v_reuseFailAlloc_3242_, 1, v_diagnostics_3223_);
lean_ctor_set(v_reuseFailAlloc_3242_, 2, v___x_3220_);
lean_ctor_set(v_reuseFailAlloc_3242_, 3, v___x_3228_);
v___x_3237_ = v_reuseFailAlloc_3242_;
goto v_reusejp_3236_;
}
v_reusejp_3236_:
{
lean_object* v___x_3238_; lean_object* v___x_3240_; 
lean_ctor_set_uint8(v___x_3237_, sizeof(void*)*4, v___x_3233_);
v___x_3238_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3235_, v___x_3237_);
if (v_isShared_3213_ == 0)
{
lean_ctor_set(v___x_3212_, 4, v___x_3232_);
lean_ctor_set(v___x_3212_, 3, v_newStx_3197_);
lean_ctor_set(v___x_3212_, 2, v_toProcessingContext_3194_);
lean_ctor_set(v___x_3212_, 1, v___x_3238_);
lean_ctor_set(v___x_3212_, 0, v___x_3234_);
v___x_3240_ = v___x_3212_;
...
lean_ctor_set(v_reuseFailAlloc_3241_, 0, v___x_3234_);
lean_ctor_set(v_reuseFailAlloc_3241_, 1, v___x_3238_);
lean_ctor_set(v_reuseFailAlloc_3241_, 2, v_toProcessingContext_3194_);
lean_ctor_set(v_reuseFailAlloc_3241_, 3, v_newStx_3197_);
lean_ctor_set(v_reuseFailAlloc_3241_, 4, v___x_3232_);
...
{
lean_dec(v_result_x3f_3201_);
lean_dec_ref(v_newParserState_3198_);
lean_dec(v_newStx_3197_);
lean_dec_ref(v_toProcessingContext_3194_);
return v_old_3196_;
}
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2___boxed(lean_object* v_toProcessingContext_3257_, lean_object* v_a_3258_, lean_object* v_old_3259_, lean_object* v_newStx_3260_, lean_object* v_newParserState_3261_, lean_object* v___y_3262_, lean_object* v___y_3263_){
_start:
{
lean_object* v_res_3264_; 
v_res_3264_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2(v_toProcessingContext_3257_, v_a_3258_, v_old_3259_, v_newStx_3260_, v_newParserState_3261_, v___y_3262_);
lean_dec_ref(v___y_3262_);
lean_dec_ref(v_a_3258_);
return v_res_3264_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__3(lean_object* v_toProcessingContext_3265_, lean_object* v_setupImports_3266_, lean_object* v_old_x3f_3267_, lean_object* v___x_3268_, lean_object* v___f_3269_, lean_object* v___y_3270_){
_start:
{
lean_object* v___x_3272_; 
lean_inc_ref(v_toProcessingContext_3265_);
v___x_3272_ = l_Lean_Parser_parseHeader(v_toProcessingContext_3265_);
if (lean_obj_tag(v___x_3272_) == 0)
{
lean_object* v_a_3273_; lean_object* v___x_3275_; uint8_t v_isShared_3276_; uint8_t v_isSharedCheck_3341_; 
v_a_3273_ = lean_ctor_get(v___x_3272_, 0);
v_isSharedCheck_3341_ = !lean_is_exclusive(v___x_3272_);
if (v_isSharedCheck_3341_ == 0)
{
v___x_3275_ = v___x_3272_;
v_isShared_3276_ = v_isSharedCheck_3341_;
...
v_resetjp_3274_:
{
lean_object* v_snd_3277_; lean_object* v_fst_3278_; lean_object* v_fst_3279_; lean_object* v_snd_3280_; lean_object* v___x_3282_; uint8_t v_isShared_3283_; uint8_t v_isSharedCheck_3340_; 
v_snd_3277_ = lean_ctor_get(v_a_3273_, 1);
lean_inc(v_snd_3277_);
v_fst_3278_ = lean_ctor_get(v_a_3273_, 0);
lean_inc(v_fst_3278_);
lean_dec(v_a_3273_);
v_fst_3279_ = lean_ctor_get(v_snd_3277_, 0);
v_snd_3280_ = lean_ctor_get(v_snd_3277_, 1);
v_isSharedCheck_3340_ = !lean_is_exclusive(v_snd_3277_);
if (v_isSharedCheck_3340_ == 0)
{
v___x_3282_ = v_snd_3277_;
v_isShared_3283_ = v_isSharedCheck_3340_;
...
{
uint8_t v___x_3284_; 
v___x_3284_ = l_Lean_MessageLog_hasErrors(v_snd_3280_);
if (v___x_3284_ == 0)
{
lean_object* v___x_3285_; lean_object* v___y_3287_; 
lean_inc(v_fst_3278_);
v___x_3285_ = l_Lean_Syntax_unsetTrailing(v_fst_3278_);
if (lean_obj_tag(v_old_x3f_3267_) == 1)
{
lean_object* v_val_3308_; lean_object* v___x_3310_; uint8_t v_isShared_3311_; uint8_t v_isSharedCheck_3323_; 
v_val_3308_ = lean_ctor_get(v_old_x3f_3267_, 0);
v_isSharedCheck_3323_ = !lean_is_exclusive(v_old_x3f_3267_);
if (v_isSharedCheck_3323_ == 0)
{
v___x_3310_ = v_old_x3f_3267_;
...
v_resetjp_3309_:
{
lean_object* v_stx_3312_; lean_object* v_result_x3f_3313_; lean_object* v___x_3314_; uint8_t v___x_3315_; 
v_stx_3312_ = lean_ctor_get(v_val_3308_, 3);
v_result_x3f_3313_ = lean_ctor_get(v_val_3308_, 4);
lean_inc(v_stx_3312_);
v___x_3314_ = l_Lean_Syntax_unsetTrailing(v_stx_3312_);
lean_inc(v___x_3285_);
v___x_3315_ = l_Lean_Syntax_eqWithInfo(v___x_3285_, v___x_3314_);
if (v___x_3315_ == 0)
{
lean_inc(v_result_x3f_3313_);
lean_del_object(v___x_3310_);
lean_dec(v_val_3308_);
lean_dec_ref(v___f_3269_);
if (lean_obj_tag(v_result_x3f_3313_) == 0)
{
lean_dec_ref(v___x_3268_);
v___y_3287_ = v___y_3270_;
goto v___jp_3286_;
}
else
{
lean_object* v_val_3316_; lean_object* v_processedSnap_3317_; lean_object* v___x_3318_; 
v_val_3316_ = lean_ctor_get(v_result_x3f_3313_, 0);
lean_inc(v_val_3316_);
lean_dec_ref_known(v_result_x3f_3313_, 1);
v_processedSnap_3317_ = lean_ctor_get(v_val_3316_, 1);
lean_inc_ref(v_processedSnap_3317_);
lean_dec(v_val_3316_);
v___x_3318_ = l_Lean_Language_SnapshotTask_cancelRec___redArg(v___x_3268_, v_processedSnap_3317_);
v___y_3287_ = v___y_3270_;
goto v___jp_3286_;
}
}
...
lean_dec_ref(v___x_3268_);
lean_dec_ref(v_setupImports_3266_);
lean_dec_ref(v_toProcessingContext_3265_);
lean_inc_ref(v___y_3270_);
v___x_3319_ = lean_apply_5(v___f_3269_, v_val_3308_, v_fst_3278_, v_fst_3279_, v___y_3270_, lean_box(0));
...
v___jp_3286_:
{
lean_object* v___x_3288_; lean_object* v___x_3289_; lean_object* v___x_3290_; lean_object* v___x_3291_; lean_object* v___x_3292_; lean_object* v___x_3293_; lean_object* v___x_3294_; lean_object* v___x_3295_; lean_object* v___x_3297_; 
v___x_3288_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_snd_3280_);
lean_inc(v_fst_3279_);
lean_inc(v_fst_3278_);
v___x_3289_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_processHeader(v_setupImports_3266_, v___x_3285_, v_fst_3278_, v_fst_3279_, v___y_3287_);
v___x_3290_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4);
v___x_3291_ = l_Lean_Language_Snapshot_Diagnostics_empty;
...
v___x_3295_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
if (v_isShared_3283_ == 0)
{
lean_ctor_set(v___x_3282_, 1, v___x_3289_);
v___x_3297_ = v___x_3282_;
...
lean_ctor_set(v_reuseFailAlloc_3307_, 0, v_fst_3279_);
lean_ctor_set(v_reuseFailAlloc_3307_, 1, v___x_3289_);
v___x_3297_ = v_reuseFailAlloc_3307_;
goto v_reusejp_3296_;
}
v_reusejp_3296_:
{
lean_object* v___x_3298_; lean_object* v___x_3299_; lean_object* v___x_3300_; lean_object* v___x_3301_; lean_object* v___x_3302_; lean_object* v___x_3303_; lean_object* v___x_3305_; 
v___x_3298_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3298_, 0, v___x_3297_);
v___x_3299_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3299_, 0, v___x_3290_);
lean_ctor_set(v___x_3299_, 1, v___x_3291_);
lean_ctor_set(v___x_3299_, 2, v___x_3292_);
lean_ctor_set(v___x_3299_, 3, v___x_3295_);
lean_ctor_set_uint8(v___x_3299_, sizeof(void*)*4, v___x_3284_);
lean_inc(v_fst_3278_);
v___x_3300_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3300_, 0, v_fst_3278_);
v___x_3301_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3301_, 0, v___x_3290_);
lean_ctor_set(v___x_3301_, 1, v___x_3288_);
lean_ctor_set(v___x_3301_, 2, v___x_3292_);
lean_ctor_set(v___x_3301_, 3, v___x_3295_);
lean_ctor_set_uint8(v___x_3301_, sizeof(void*)*4, v___x_3284_);
v___x_3302_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3300_, v___x_3301_);
v___x_3303_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_3303_, 0, v___x_3299_);
lean_ctor_set(v___x_3303_, 1, v___x_3302_);
lean_ctor_set(v___x_3303_, 2, v_toProcessingContext_3265_);
lean_ctor_set(v___x_3303_, 3, v_fst_3278_);
lean_ctor_set(v___x_3303_, 4, v___x_3298_);
if (v_isShared_3276_ == 0)
{
lean_ctor_set(v___x_3275_, 0, v___x_3303_);
...
lean_dec(v_old_x3f_3267_);
lean_dec_ref(v_setupImports_3266_);
v___x_3324_ = l_Lean_Language_Snapshot_Diagnostics_ofMessageLog(v_snd_3280_);
v___x_3325_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__0___closed__4);
v___x_3326_ = l_Lean_Language_Snapshot_Diagnostics_empty;
...
v___x_3330_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg___closed__16);
v___x_3331_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3331_, 0, v___x_3325_);
lean_ctor_set(v___x_3331_, 1, v___x_3326_);
lean_ctor_set(v___x_3331_, 2, v___x_3327_);
lean_ctor_set(v___x_3331_, 3, v___x_3330_);
lean_ctor_set_uint8(v___x_3331_, sizeof(void*)*4, v___x_3284_);
lean_inc(v_fst_3278_);
v___x_3332_ = lean_alloc_ctor(1, 1, 0);
lean_ctor_set(v___x_3332_, 0, v_fst_3278_);
v___x_3333_ = 0;
v___x_3334_ = lean_alloc_ctor(0, 4, 1);
lean_ctor_set(v___x_3334_, 0, v___x_3325_);
lean_ctor_set(v___x_3334_, 1, v___x_3324_);
lean_ctor_set(v___x_3334_, 2, v___x_3327_);
lean_ctor_set(v___x_3334_, 3, v___x_3330_);
lean_ctor_set_uint8(v___x_3334_, sizeof(void*)*4, v___x_3333_);
v___x_3335_ = l_Lean_Language_SnapshotTask_finished___redArg(v___x_3332_, v___x_3334_);
v___x_3336_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_3336_, 0, v___x_3331_);
lean_ctor_set(v___x_3336_, 1, v___x_3335_);
lean_ctor_set(v___x_3336_, 2, v_toProcessingContext_3265_);
lean_ctor_set(v___x_3336_, 3, v_fst_3278_);
lean_ctor_set(v___x_3336_, 4, v___x_3327_);
if (v_isShared_3276_ == 0)
{
lean_ctor_set(v___x_3275_, 0, v___x_3336_);
...
lean_dec_ref(v_setupImports_3266_);
lean_dec_ref(v_toProcessingContext_3265_);
v_a_3342_ = lean_ctor_get(v___x_3272_, 0);
v_isSharedCheck_3349_ = !lean_is_exclusive(v___x_3272_);
if (v_isSharedCheck_3349_ == 0)
{
v___x_3344_ = v___x_3272_;
...
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__3___boxed(lean_object* v_toProcessingContext_3350_, lean_object* v_setupImports_3351_, lean_object* v_old_x3f_3352_, lean_object* v___x_3353_, lean_object* v___f_3354_, lean_object* v___y_3355_, lean_object* v___y_3356_){
_start:
{
lean_object* v_res_3357_; 
v_res_3357_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__3(v_toProcessingContext_3350_, v_setupImports_3351_, v_old_x3f_3352_, v___x_3353_, v___f_3354_, v___y_3355_);
lean_dec_ref(v___y_3355_);
return v_res_3357_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__4(lean_object* v___x_3358_, lean_object* v_toProcessingContext_3359_, lean_object* v_x_3360_){
_start:
{
lean_object* v___x_3361_; lean_object* v___x_3362_; lean_object* v___x_3363_; lean_object* v___x_3364_; 
v___x_3361_ = l_Lean_Language_instInhabitedSnapshotTask_default___redArg(v___x_3358_);
v___x_3362_ = lean_box(0);
v___x_3363_ = lean_box(0);
v___x_3364_ = lean_alloc_ctor(0, 5, 0);
lean_ctor_set(v___x_3364_, 0, v_x_3360_);
lean_ctor_set(v___x_3364_, 1, v___x_3361_);
lean_ctor_set(v___x_3364_, 2, v_toProcessingContext_3359_);
lean_ctor_set(v___x_3364_, 3, v___x_3362_);
lean_ctor_set(v___x_3364_, 4, v___x_3363_);
return v___x_3364_;
}
}
LEAN_EXPORT lean_object* l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader(lean_object* v_setupImports_3365_, lean_object* v_old_x3f_3366_, lean_object* v_a_3367_){
_start:
{
lean_object* v_toProcessingContext_3369_; lean_object* v___x_3370_; lean_object* v___x_3371_; lean_object* v___f_3372_; lean_object* v___f_3373_; lean_object* v___f_3374_; 
v_toProcessingContext_3369_ = lean_ctor_get(v_a_3367_, 0);
v___x_3370_ = l_Lean_Language_instInhabitedSnapshotLeaf;
v___x_3371_ = l_Lean_Language_Lean_instToSnapshotTreeHeaderProcessedSnapshot;
lean_inc_ref(v_a_3367_);
lean_inc_ref_n(v_toProcessingContext_3369_, 3);
...
lean_closure_set(v___f_3372_, 0, v_toProcessingContext_3369_);
lean_closure_set(v___f_3372_, 1, v_a_3367_);
lean_inc(v_old_x3f_3366_);
v___f_3373_ = lean_alloc_closure((void*)(l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__3___boxed), 7, 5);
lean_closure_set(v___f_3373_, 0, v_toProcessingContext_3369_);
lean_closure_set(v___f_3373_, 1, v_setupImports_3365_);
lean_closure_set(v___f_3373_, 2, v_old_x3f_3366_);
lean_closure_set(v___f_3373_, 3, v___x_3371_);
lean_closure_set(v___f_3373_, 4, v___f_3372_);
...
lean_closure_set(v___f_3374_, 0, v___x_3370_);
lean_closure_set(v___f_3374_, 1, v_toProcessingContext_3369_);
if (lean_obj_tag(v_old_x3f_3366_) == 1)
{
lean_object* v_val_3375_; lean_object* v_result_x3f_3376_; 
v_val_3375_ = lean_ctor_get(v_old_x3f_3366_, 0);
lean_inc(v_val_3375_);
lean_dec_ref_known(v_old_x3f_3366_, 1);
...
v___x_3387_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3387_;
}
else
{
...
v___x_3393_ = l_Lean_Language_Lean_isBeforeEditPos(v_pos_3392_, v_a_3367_);
...
lean_dec(v_stx_3377_);
lean_dec(v_val_3375_);
v___x_3394_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3394_;
}
else
{
...
lean_inc_ref(v_toProcessingContext_3369_);
v___x_3396_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseHeader___lam__2(v_toProcessingContext_3369_, v_a_3367_, v_val_3375_, v_stx_3377_, v_parserState_3395_, v_a_3367_);
return v___x_3396_;
}
}
else
...
lean_dec(v_stx_3377_);
lean_dec(v_val_3375_);
v___x_3397_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3397_;
}
}
}
...
lean_dec(v_stx_3377_);
lean_dec(v_val_3375_);
v___x_3398_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3398_;
}
}
else
...
lean_dec(v_stx_3377_);
lean_dec(v_val_3375_);
v___x_3399_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3399_;
}
}
else
...
lean_dec(v_stx_3377_);
lean_dec(v_val_3375_);
v___x_3400_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3400_;
}
}
else
...
lean_dec(v_val_3375_);
v___x_3401_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3401_;
}
}
else
...
lean_dec(v_old_x3f_3366_);
v___x_3402_ = l___private_Lean_Language_Lean_0__Lean_Language_Lean_withHeaderExceptions___redArg(v___f_3374_, v___f_3373_, v_a_3367_);
return v___x_3402_;
}
}
}
...
v___x_3543_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__3);
...
v___x_3546_ = lean_obj_once(&l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4, &l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4_once, _init_l___private_Lean_Language_Lean_0__Lean_Language_Lean_process_parseCmd___closed__4);

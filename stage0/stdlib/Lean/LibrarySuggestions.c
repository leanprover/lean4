...
lean_object* runtime_initialize_Lean_LibrarySuggestions_MePo(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_LibrarySuggestions(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_LibrarySuggestions(uint8_t builtin) {
lean_object * res;

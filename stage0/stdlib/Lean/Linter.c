...
// Module: Lean.Linter
// Imports: Lean.Linter.Util Lean.Linter.Builtin Lean.Linter.ConstructorAsVariable Lean.Linter.Deprecated Lean.Linter.UnusedVariables Lean.Linter.MissingDocs Lean.Linter.Omit Lean.Linter.List Lean.Linter.Sets Lean.Linter.UnusedSimpArgs
#include <lean/lean.h>
...
lean_object* initialize_Lean_Linter_Sets(uint8_t builtin, lean_object*);
lean_object* initialize_Lean_Linter_UnusedSimpArgs(uint8_t builtin, lean_object*);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Linter_Sets(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Linter_UnusedSimpArgs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

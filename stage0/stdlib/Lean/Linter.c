...
lean_object* runtime_initialize_Lean_Linter_WarnOnUnfold(uint8_t builtin);
...
lean_object* initialize_Lean_Linter_WarnOnUnfold(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Lean_Linter_WarnOnUnfold(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

...
lean_ctor_set(v___x_258_, 0, v___y_227_);
...
lean_ctor_set_uint8(v___x_258_, sizeof(void*)*5, v___y_229_);
...
v___y_227_ = v_fileName_292_;
v___y_228_ = v___y_288_;

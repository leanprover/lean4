...
lean_ctor_set(v___x_908_, 0, v___y_873_);
lean_ctor_set(v___x_908_, 1, v___y_876_);
lean_ctor_set(v___x_908_, 2, v___y_874_);
lean_ctor_set(v___x_908_, 3, v___y_878_);
...
v___x_1684_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_Linter_Extra_UnreachableTactic_unreachableTacticLinter_spec__6___redArg(v___y_1679_, v___y_1682_, v___y_1680_, v___y_1683_);
...
{
uint8_t v___x_1691_; 
v___x_1691_ = lean_nat_dec_le(v___y_1690_, v___y_1689_);
if (v___x_1691_ == 0)
{
lean_dec(v___y_1689_);
lean_inc(v___y_1690_);
v___y_1679_ = v___y_1686_;
v___y_1680_ = v___y_1690_;

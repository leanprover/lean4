...
lean_ctor_set(v___x_2109_, 0, v___y_2088_);
lean_ctor_set(v___x_2109_, 1, v___y_2089_);
lean_ctor_set(v___x_2109_, 2, v___y_2086_);
...
lean_ctor_set_uint8(v___x_2109_, sizeof(void*)*5 + 1, v___y_2085_);
...
lean_inc_ref_n(v___y_2123_, 2);
v___x_2133_ = l_Lean_FileMap_toPosition(v___y_2123_, v___y_2121_);
lean_dec(v___y_2121_);
v___x_2134_ = l_Lean_FileMap_toPosition(v___y_2123_, v___y_2126_);
...
v___x_2152_ = l_Lean_Syntax_getTailPos_x3f(v___y_2145_, v___y_2146_);
...
v_ref_2162_ = l_Lean_replaceRef(v_ref_2073_, v___y_2157_);

...
lean_ctor_set(v___x_366_, 1, v___y_333_);
...
lean_ctor_set_uint8(v___x_366_, sizeof(void*)*5 + 1, v___y_334_);
...
v___x_409_ = l_Lean_FileMap_toPosition(v_fileMap_401_, v___y_397_);
lean_dec(v___y_397_);

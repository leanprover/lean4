...
lean_ctor_set(v___x_912_, 0, v___y_896_);
lean_ctor_set(v___x_912_, 1, v___y_895_);
lean_ctor_set(v___x_912_, 2, v___y_899_);
lean_ctor_set(v___x_912_, 3, v___y_898_);
...
v___y_896_ = v_fileName_963_;
v___y_897_ = v_a_971_;
v___y_898_ = v___x_978_;

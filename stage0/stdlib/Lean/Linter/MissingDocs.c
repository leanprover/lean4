...
lean_dec_ref_known(v___x_2276_, 10);
return v___x_2277_;
}
else
{
...
lean_dec_ref_known(v___x_2385_, 3);
...
lean_dec_ref_known(v_found_4580_, 0);
if (v_v_4620_ == 0)
{
...
lean_inc(v_v_4653_);
lean_dec_ref_known(v_found_4580_, 1);
...
lean_dec_ref_known(v_val_4731_, 2);

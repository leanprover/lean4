...
lean_ctor_set(v___x_183_, 3, v___y_150_);
lean_ctor_set(v___x_183_, 4, v___x_182_);
lean_ctor_set_uint8(v___x_183_, sizeof(void*)*5, v___y_151_);
...
v___x_245_ = l_Lean_Syntax_getTailPos_x3f(v___y_241_, v___y_242_);
lean_dec(v___y_241_);

...
lean_ctor_set(v___x_167_, 3, v___y_151_);
lean_ctor_set(v___x_167_, 4, v___x_166_);
lean_ctor_set_uint8(v___x_167_, sizeof(void*)*5, v___y_150_);
lean_ctor_set_uint8(v___x_167_, sizeof(void*)*5 + 1, v___y_149_);

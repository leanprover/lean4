...
lean_ctor_set(v___x_583_, 2, v___y_551_);
lean_ctor_set(v___x_583_, 3, v___y_552_);
lean_ctor_set(v___x_583_, 4, v___x_582_);
lean_ctor_set_uint8(v___x_583_, sizeof(void*)*5, v___y_548_);

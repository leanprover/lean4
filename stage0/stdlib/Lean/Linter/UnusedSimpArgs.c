...
v___x_196_ = l_Lean_FileMap_toPosition(v___y_188_, v___y_183_);
lean_dec(v___y_183_);
...
v___x_215_ = l_Lean_Syntax_getTailPos_x3f(v___y_208_, v___y_211_);
lean_dec(v___y_208_);

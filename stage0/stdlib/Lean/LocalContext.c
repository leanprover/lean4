...
v___x_3777_ = l_Lean_LocalContext_setUserName(v_a_3761_, v___y_3776_, v___y_3773_);
v_i_3760_ = v_n_3771_;
...
v_fvarId_3855_ = lean_ctor_get(v___y_3853_, 1);

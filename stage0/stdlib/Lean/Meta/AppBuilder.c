...
LEAN_EXPORT lean_object* l_Lean_Meta_initFn____x40_Lean_Meta_AppBuilder___hyg_5445_(lean_object*);
...
LEAN_EXPORT lean_object* l_Lean_Meta_initFn____x40_Lean_Meta_AppBuilder___hyg_5445_(lean_object* x_1) {
_start:
{
...
res = l_Lean_Meta_initFn____x40_Lean_Meta_AppBuilder___hyg_5445_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

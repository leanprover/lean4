...
// Imports: Init Bootstrap.ShareCommon Lean.MetavarContext Lean.Environment Lean.Util.FoldConsts Lean.Meta.Basic Lean.Meta.Check
#include <lean/lean.h>
...
{
uint8_t x_475; 
x_475 = l___private_Lean_Expr_0__Lean_beqBinderInfo____x40_Lean_Expr___hyg_375_(x_463, x_463);
if (x_475 == 0)
{
...
{
uint8_t x_593; 
x_593 = l___private_Lean_Expr_0__Lean_beqBinderInfo____x40_Lean_Expr___hyg_375_(x_581, x_581);
if (x_593 == 0)
{

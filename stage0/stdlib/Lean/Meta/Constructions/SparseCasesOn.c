...
lean_closure_set(v___f_1838_, 0, v___y_1817_);
...
lean_closure_set(v___f_1838_, 8, v___y_1821_);
...
v___x_1866_ = l_Lean_EnvExtension_modifyState___redArg(v___y_1823_, v_env_1855_, v___y_1828_, v___y_1827_, v___y_1825_);

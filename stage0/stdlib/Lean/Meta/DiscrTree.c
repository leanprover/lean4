...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Meta_DiscrTree(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Meta_DiscrTree(uint8_t builtin) {
lean_object * res;

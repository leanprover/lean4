...
lean_ctor_set_uint8(x_34, sizeof(void*)*14, x_11);
...
lean_object* x_36; 
lean_dec_ref(x_35);
x_36 = l_Lean_evalConst___at___00Lean_Meta_evalExprCore_spec__4___redArg(x_13, x_1, x_15, x_12, x_34, x_30);
lean_dec(x_30);
lean_dec_ref(x_34);
lean_dec(x_12);
lean_dec_ref(x_15);

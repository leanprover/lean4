...
_start:
{
uint8_t v_binderInfo_117__boxed_47_; lean_object* v_res_48_; 
v_binderInfo_117__boxed_47_ = lean_unbox(v_binderInfo_44_);
v_res_48_ = l___private_Lean_Meta_ExprTraverse_0__Lean_Meta_traverseLambdaWithPos_visit___redArg___lam__1(v_inst_41_, v_inst_42_, v_binderName_43_, v_binderInfo_117__boxed_47_, v___f_45_, v_d_46_);
return v_res_48_;
}
}

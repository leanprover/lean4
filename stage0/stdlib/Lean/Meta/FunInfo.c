...
v___x_1583_ = lean_unsigned_to_nat(2619u);
...
v___x_1589_ = lean_unsigned_to_nat(2610u);
...
lean_dec_ref_known(v_snap_x3f_1634_, 1);
...
lean_inc(v_a_1640_);
lean_dec_ref_known(v_res_x3f_1633_, 1);
...
lean_dec_ref_known(v_fn_1955_, 2);

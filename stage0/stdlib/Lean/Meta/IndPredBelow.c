...
lean_inc(x_8);
lean_inc(x_7);
x_21 = l_Lean_commitWhen___at___private_Lean_Meta_Tactic_Contradiction_0__Lean_Meta_elimEmptyInductive___spec__3(x_20, x_7, x_8, x_9, x_10, x_11);
if (lean_obj_tag(x_21) == 0)
{
...
lean_inc(x_38);
lean_dec(x_36);
x_39 = l_List_lengthTRAux___rarg(x_25, x_29);

...
v_reusejp_105_:
{
lean_object* v___x_107_; lean_object* v___x_108_; lean_object* v___x_1765__overap_109_; lean_object* v___x_110_; 
v___x_107_ = lean_box(0);
v___x_108_ = l_instInhabitedOfMonad___redArg(v___x_106_, v___x_107_);
v___x_1765__overap_109_ = lean_panic_fn_borrowed(v___x_108_, v_msg_52_);
lean_dec(v___x_108_);
lean_inc(v___y_56_);
lean_inc_ref(v___y_55_);
lean_inc(v___y_54_);
lean_inc_ref(v___y_53_);
v___x_110_ = lean_apply_5(v___x_1765__overap_109_, v___y_53_, v___y_54_, v___y_55_, v___y_56_, lean_box(0));
return v___x_110_;
}
}
}

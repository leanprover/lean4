...
v___x_1898_ = l_Lean_Expr_app___override(v___y_1896_, v___y_1894_);
...
lean_ctor_set(v___x_2249_, 0, v___y_2242_);
lean_ctor_set(v___x_2249_, 1, v___y_2248_);
v___x_2250_ = lean_array_get_size(v_fvars_2231_);
v___x_2251_ = l___private_Init_Data_Nat_Control_0__Nat_foldRevM_loop___at___00__private_Lean_Meta_LetToHave_0__Lean_Meta_LetToHave_visitLambdaLet_finalize_spec__0___redArg(v_fvars_2231_, v___x_2250_, v___x_2249_, v___y_2241_, v___y_2246_, v___y_2245_, v___y_2243_, v___y_2247_, v___y_2244_);
lean_dec_ref(v_fvars_2231_);
return v___x_2251_;
}
v___jp_2252_:

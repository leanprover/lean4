...
_start:
{
uint8_t v___x_4448__boxed_407_; lean_object* v_res_408_; 
v___x_4448__boxed_407_ = lean_unbox(v___x_396_);
v_res_408_ = l___private_Lean_Meta_Match_AltTelescopes_0__Lean_Meta_Match_forallAltVarsTelescope_go___redArg___lam__0(v_a_391_, v_body_392_, v_ys_393_, v_args_394_, v_mask_395_, v___x_4448__boxed_407_, v_i_397_, v_altType_398_, v_altInfo_399_, v_k_400_, v_y_401_, v___y_402_, v___y_403_, v___y_404_, v___y_405_);
lean_dec(v___y_405_);

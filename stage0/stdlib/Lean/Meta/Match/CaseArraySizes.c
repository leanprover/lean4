...
lean_inc(x_12);
lean_dec(x_10);
x_13 = l_Lean_Lean_ToExpr___instance__3___lambda__1___closed__6;
lean_inc(x_5);
lean_inc(x_4);
lean_inc(x_3);
lean_inc(x_2);
...
x_64 = lean_alloc_closure((void*)(l_ReaderT_bind___at_Lean_Meta_Lean_Meta_Basic___instance__5___spec__2___rarg), 7, 2);

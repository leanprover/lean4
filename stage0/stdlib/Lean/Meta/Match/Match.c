...
res = l_Lean_Meta_Match_initFn____x40_Lean_Meta_Match_Match___hyg_9186_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
...
res = l_Lean_Meta_Match_initFn____x40_Lean_Meta_Match_Match___hyg_9212_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

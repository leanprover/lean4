...
v___x_511_ = lean_st_ref_take(v___y_504_);
...
v___x_523_ = lean_st_ref_set(v___y_504_, v___x_522_);
...
lean_inc(v___y_504_);
v___x_525_ = lean_apply_7(v___f_489_, v___x_524_, v___y_504_, v___y_509_, v___y_507_, v___y_506_, v___y_505_, lean_box(0));
return v___x_525_;
}
}
}

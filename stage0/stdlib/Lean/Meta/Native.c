...
v___x_553_ = lean_st_ref_take(v___y_547_);
...
v___x_565_ = l_Lean_Kernel_enableDiag(v_env_554_, v___y_549_);
...
v___x_568_ = lean_st_ref_set(v___y_547_, v___x_567_);

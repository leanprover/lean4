...
_start:
{
lean_object* v___x_20_; lean_object* v_env_21_; lean_object* v_nextMacroScope_22_; lean_object* v_ngen_23_; lean_object* v_auxDeclNGen_24_; lean_object* v_traceState_25_; lean_object* v_recordedDeps_26_; lean_object* v_messages_27_; lean_object* v_infoState_28_; lean_object* v_snapshotTasks_29_; lean_object* v___x_31_; uint8_t v_isShared_32_; uint8_t v_isSharedCheck_42_; 
...
v_recordedDeps_26_ = lean_ctor_get(v___x_20_, 6);
v_messages_27_ = lean_ctor_get(v___x_20_, 7);
v_infoState_28_ = lean_ctor_get(v___x_20_, 8);
v_snapshotTasks_29_ = lean_ctor_get(v___x_20_, 9);
...
v___x_34_ = l_Lean_Meta_recExt;
v___x_35_ = l_Lean_TagDeclarationExtension_tag(v___x_34_, v_env_21_, v_declName_17_);
v___x_36_ = lean_obj_once(&l_Lean_Meta_markAsRecursive___redArg___closed__2, &l_Lean_Meta_markAsRecursive___redArg___closed__2_once, _init_l_Lean_Meta_markAsRecursive___redArg___closed__2);
if (v_isShared_32_ == 0)
{
lean_ctor_set(v___x_31_, 5, v___x_36_);
lean_ctor_set(v___x_31_, 0, v___x_35_);
v___x_38_ = v___x_31_;
goto v_reusejp_37_;
}
else
...
lean_ctor_set(v_reuseFailAlloc_41_, 0, v___x_35_);
...
lean_ctor_set(v_reuseFailAlloc_41_, 5, v___x_36_);
lean_ctor_set(v_reuseFailAlloc_41_, 6, v_recordedDeps_26_);
lean_ctor_set(v_reuseFailAlloc_41_, 7, v_messages_27_);
lean_ctor_set(v_reuseFailAlloc_41_, 8, v_infoState_28_);
lean_ctor_set(v_reuseFailAlloc_41_, 9, v_snapshotTasks_29_);
...
v___x_39_ = lean_st_ref_put(v_a_18_, v___x_38_);

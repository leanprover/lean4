...
lean_dec_ref_known(v_key_853_, 2);
...
lean_inc(v_val_906_);
lean_dec_ref_known(v_val_903_, 1);
...
lean_dec_ref_known(v_val_1030_, 1);
v___y_1010_ = v___x_1019_;
v___y_1011_ = v_minIndex_1028_;

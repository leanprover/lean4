...
lean_dec_ref(v_e_u2082_140_);
lean_dec_ref(v_e_u2081_139_);
...
lean_dec_ref(v_k_u2082_186_);
lean_dec_ref(v_k_u2081_185_);
...
v___x_232_ = lean_array_get_borrowed(v___x_228_, v_es_227_, v_j_231_);
lean_dec(v_j_231_);

...
lean_dec_ref_known(v_key_531_, 2);
...
lean_inc(v_val_581_);
lean_dec_ref_known(v_____do__lift_578_, 1);
...
lean_inc(v_val_765_);
lean_dec_ref_known(v_fst_760_, 1);

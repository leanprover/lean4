...
lean_object* runtime_initialize_Lean_Meta_Sym_Simp_Debug(uint8_t builtin);
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Meta_Sym_Simp(uint8_t builtin) {
lean_object * res;

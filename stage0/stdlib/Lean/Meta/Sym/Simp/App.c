...
_start:
{
lean_object* v___x_834_; lean_object* v___x_984__overap_835_; lean_object* v___x_836_; 
...
v___x_984__overap_835_ = lean_panic_fn_borrowed(v___x_834_, v_msg_826_);
lean_inc(v___y_832_);
...
v___x_836_ = lean_apply_7(v___x_984__overap_835_, v___y_827_, v___y_828_, v___y_829_, v___y_830_, v___y_831_, v___y_832_, lean_box(0));
return v___x_836_;
}
}
...
lean_dec_ref_known(v_a_1077_, 3);
...
lean_dec_ref_known(v_fst_1044_, 2);
...
lean_dec_ref_known(v_a_1229_, 3);
...
if (v___x_1565_ == 0)
{
lean_dec_ref_known(v_result_1562_, 0);
...
lean_dec_ref_known(v_a_2249_, 2);
...
lean_dec_ref_known(v_a_2322_, 0);
...
lean_dec_ref_known(v_a_2332_, 3);

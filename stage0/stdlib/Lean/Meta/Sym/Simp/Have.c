...
uint8_t v___x_126_; 
lean_dec(v___y_124_);
v___x_126_ = lean_nat_dec_le(v___y_125_, v___y_123_);
if (v___x_126_ == 0)
{
...
v___x_128_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00__private_Lean_Meta_Sym_Simp_Have_0__Lean_Meta_Sym_Simp_collectFVarIdsAt_spec__2___redArg(v_fvarIdToPos_120_, v___y_122_, v___y_125_, v___y_123_);
lean_dec(v___y_123_);
return v___x_128_;
}
}

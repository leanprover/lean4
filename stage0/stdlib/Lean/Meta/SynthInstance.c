...
lean_inc(x_101);
lean_dec_ref(x_98);
x_102 = lean_nat_dec_eq(x_92, x_101);
lean_dec(x_101);
lean_dec(x_92);
if (x_102 == 0)
{
...
lean_inc(x_266);
lean_dec_ref(x_263);
x_267 = lean_nat_dec_eq(x_257, x_266);
lean_dec(x_266);
lean_dec(x_257);
if (x_267 == 0)
{

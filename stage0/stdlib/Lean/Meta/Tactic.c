...
lean_object* runtime_initialize_Lean_Meta_Tactic_ElimInfo(uint8_t builtin);
...
lean_object* runtime_initialize_Lean_Meta_Tactic_AC(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Meta_Tactic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Meta_Tactic(uint8_t builtin) {
lean_object * res;

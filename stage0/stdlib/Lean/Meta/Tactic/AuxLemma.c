...
v___x_413_ = l_Lean_addDecl(v___y_412_, v_forceExpose_351_, v___y_410_, v___y_407_);
...
lean_inc(v___y_409_);
lean_inc(v___y_408_);
v___x_414_ = l_Lean_inferDefEqAttr(v___y_408_, v___y_406_, v___y_409_, v___y_410_, v___y_407_);

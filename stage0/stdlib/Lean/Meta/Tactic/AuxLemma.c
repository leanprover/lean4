...
v___x_635_ = l_Lean_addDecl(v___y_634_, v_forceExpose_556_, v___y_628_, v___y_632_);
...
lean_inc(v___y_629_);
v___x_637_ = l_Lean_TagAttribute_setTag___at___00Lean_Meta_mkAuxLemma_spec__2(v___x_636_, v___y_629_, v___y_630_, v___y_631_, v___y_628_, v___y_632_);

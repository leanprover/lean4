...
// Module: Lean.Meta.Tactic.BVDecide.LRAT
// Imports: public import Lean.Meta.Tactic.BVDecide.LRAT.Trim public import Lean.Meta.Tactic.BVDecide.LRAT.Cert
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Meta_Tactic_BVDecide_LRAT(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Meta_Tactic_BVDecide_LRAT(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lean_Meta_Tactic_BVDecide_LRAT(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Lean_Meta_Tactic_BVDecide_LRAT(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Lean_Meta_Tactic_BVDecide_LRAT(builtin);
}
#ifdef __cplusplus
}
#endif

...
x_13 = l_Lean_RBNode_findCore___at_Lean_Meta_ToHide_isMarked___spec__1(x_2, x_10);
lean_dec(x_10);
...
x_12 = l_Lean_RBNode_findCore___at_Lean_Meta_ToHide_isMarked___spec__1(x_1, x_9);
lean_dec(x_9);
if (lean_obj_tag(x_12) == 0)
{
lean_dec(x_7);

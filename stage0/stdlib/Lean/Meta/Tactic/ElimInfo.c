...
lean_dec_ref_known(v_x_1756_, 2);
...
lean_dec_ref_known(v_x_1940_, 3);
lean_inc(v_f_1938_);
...
lean_dec_ref_known(v_x_2114_, 2);
...
lean_dec_ref_known(v___x_3253_, 14);
return v___x_3254_;
}
}
...
lean_dec_ref_known(v___x_3829_, 7);
...
lean_dec_ref_known(v___x_4042_, 7);

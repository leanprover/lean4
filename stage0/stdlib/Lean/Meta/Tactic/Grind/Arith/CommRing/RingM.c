...
{
lean_dec_ref_known(v_charInst_x3f_972_, 1);
goto v___jp_969_;
}
}
else
...
lean_dec_ref_known(v_noZeroDivInst_x3f_1050_, 1);
v___x_1056_ = 1;
...
lean_dec_ref_known(v_charInst_x3f_1101_, 1);
v___x_1107_ = 1;
...
lean_dec_ref_known(v_fieldInst_x3f_1201_, 1);
v___x_1207_ = 1;
...
lean_dec_ref_known(v_queue_1251_, 5);
v___x_1252_ = 0;
...
v___x_1331_ = lean_nat_add(v___y_1329_, v___y_1330_);
...
lean_ctor_set(v___x_1311_, 3, v___y_1328_);
...
lean_ctor_set(v_reuseFailAlloc_1336_, 3, v___y_1328_);
...
lean_ctor_set(v___x_1662_, 3, v___y_1656_);
...
lean_ctor_set(v_reuseFailAlloc_1666_, 3, v___y_1656_);
...
v___y_1655_ = v___x_1680_;
v___y_1656_ = v___x_1679_;

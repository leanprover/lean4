...
lean_dec_ref_known(v_mulFn_x3f_2184_, 1);
...
lean_dec_ref_known(v_addFn_x3f_2315_, 1);
...
lean_dec_ref_known(v_negFn_x3f_2514_, 1);
...
lean_dec_ref_known(v_powFn_x3f_2829_, 1);

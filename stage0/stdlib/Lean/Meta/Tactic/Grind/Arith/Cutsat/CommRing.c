...
v_res_257_ = l_Int_Internal_Linear_Poly_normCommRing_x3f___lam__0(v_a_152961__boxed_256_, v_s_255_);
return v_res_257_;
}
}
...
v___x_698_ = l_Lean_Meta_Sym_shareCommon___redArg(v_a_697_, v___y_679_);
return v___x_698_;
}
else
{
...
v___x_965_ = l_Lean_Meta_Sym_shareCommon___redArg(v_a_964_, v___y_939_);
return v___x_965_;
}
else
{

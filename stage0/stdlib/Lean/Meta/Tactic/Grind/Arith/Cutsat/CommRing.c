...
_start:
{
uint8_t v_a_128296__boxed_253_; lean_object* v_res_254_; 
v_a_128296__boxed_253_ = lean_unbox(v_a_251_);
v_res_254_ = l_Int_Internal_Linear_Poly_normCommRing_x3f___lam__0(v_a_128296__boxed_253_, v_s_252_);
return v_res_254_;
}
}

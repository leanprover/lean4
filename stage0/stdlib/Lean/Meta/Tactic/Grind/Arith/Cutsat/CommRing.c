...
lean_inc(v_val_813_);
lean_dec_ref_known(v_addFn_x3f_812_, 1);
...
lean_inc(v_val_955_);
lean_dec_ref_known(v_mulFn_x3f_954_, 1);
...
lean_dec_ref_known(v_powFn_x3f_1155_, 1);
...
lean_inc(v_m_1289_);
lean_dec_ref_known(v_m_1273_, 2);
...
lean_inc(v_m_1329_);
lean_dec_ref_known(v_m_1313_, 2);

...
v___x_563_ = l_Int_Linear_Poly_mul(v___y_537_, v___x_562_);
lean_dec(v___x_562_);
...
v___x_574_ = l_Int_Linear_Poly_mul(v___y_537_, v_k_542_);
lean_dec(v_k_542_);
...
{
uint8_t v_lia_1299_; 
v_lia_1299_ = lean_ctor_get_uint8(v_a_1295_, sizeof(void*)*13 + 23);
lean_dec(v_a_1295_);
if (v_lia_1299_ == 0)
{

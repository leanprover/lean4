...
v_exp_29_ = lean_ctor_get(v_a_25_, 9);
lean_inc(v_exp_29_);
lean_dec(v_a_25_);
...
{
lean_object* v_a_38_; uint8_t v_verbose_39_; 
v_a_38_ = lean_ctor_get(v___x_37_, 0);
lean_inc(v_a_38_);
lean_dec_ref_known(v___x_37_, 1);
v_verbose_39_ = lean_ctor_get_uint8(v_a_38_, 0);
lean_dec(v_a_38_);
if (v_verbose_39_ == 0)
{
lean_dec(v_a_36_);
...
v_exp_40_ = lean_ctor_get(v_a_36_, 9);
lean_inc(v_exp_40_);
lean_dec(v_a_36_);

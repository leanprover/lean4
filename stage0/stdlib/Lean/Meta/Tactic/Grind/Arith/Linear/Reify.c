...
v___x_233_ = l_Lean_mkApp8(v___x_225_, v_type_214_, v___y_229_, v___y_228_, v___y_231_, v___y_227_, v___y_230_, v___y_232_, v_a_199_);
lean_inc(v_a_210_);

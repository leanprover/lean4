...
lean_ctor_set(v_reuseFailAlloc_136_, 0, v_namePrefix_106_);
lean_ctor_set(v_reuseFailAlloc_136_, 1, v___x_113_);
v___x_115_ = v_reuseFailAlloc_136_;
goto v_reusejp_114_;
}
v_reusejp_114_:
{
lean_object* v___x_116_; lean_object* v_env_117_; lean_object* v_nextMacroScope_118_; lean_object* v_auxDeclNGen_119_; lean_object* v_traceState_120_; lean_object* v_cache_121_; lean_object* v_recordedDeps_122_; lean_object* v_messages_123_; lean_object* v_infoState_124_; lean_object* v_snapshotTasks_125_; lean_object* v___x_127_; uint8_t v_isShared_128_; uint8_t v_isSharedCheck_134_; 
...
v_recordedDeps_122_ = lean_ctor_get(v___x_116_, 6);
v_messages_123_ = lean_ctor_get(v___x_116_, 7);
v_infoState_124_ = lean_ctor_get(v___x_116_, 8);
v_snapshotTasks_125_ = lean_ctor_get(v___x_116_, 9);
v_isSharedCheck_134_ = !lean_is_exclusive(v___x_116_);
if (v_isSharedCheck_134_ == 0)
{
lean_object* v_unused_135_; 
v_unused_135_ = lean_ctor_get(v___x_116_, 2);
...
{
lean_ctor_set(v___x_127_, 2, v___x_115_);
...
lean_ctor_set(v_reuseFailAlloc_133_, 0, v_env_117_);
lean_ctor_set(v_reuseFailAlloc_133_, 1, v_nextMacroScope_118_);
lean_ctor_set(v_reuseFailAlloc_133_, 2, v___x_115_);
lean_ctor_set(v_reuseFailAlloc_133_, 3, v_auxDeclNGen_119_);
lean_ctor_set(v_reuseFailAlloc_133_, 4, v_traceState_120_);
lean_ctor_set(v_reuseFailAlloc_133_, 5, v_cache_121_);
lean_ctor_set(v_reuseFailAlloc_133_, 6, v_recordedDeps_122_);
lean_ctor_set(v_reuseFailAlloc_133_, 7, v_messages_123_);
lean_ctor_set(v_reuseFailAlloc_133_, 8, v_infoState_124_);
lean_ctor_set(v_reuseFailAlloc_133_, 9, v_snapshotTasks_125_);
...
v___x_131_ = lean_st_ref_put(v___y_102_, v___x_130_);
v___x_132_ = lean_alloc_ctor(0, 1, 0);
lean_ctor_set(v___x_132_, 0, v_r_111_);
return v___x_132_;
}
}
}

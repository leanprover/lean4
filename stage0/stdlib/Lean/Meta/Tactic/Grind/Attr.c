...
lean_inc_ref(v_toEnvExtension_2827_);
...
lean_inc(v_asyncMode_2839_);
lean_dec_ref(v_toEnvExtension_2827_);
...
lean_inc_ref(v_toEnvExtension_3647_);
...
lean_inc(v_asyncMode_3659_);
lean_dec_ref(v_toEnvExtension_3647_);

...
_start:
{
lean_object* v___x_14_; lean_object* v___x_63953__overap_15_; lean_object* v___x_16_; 
...
v___x_63953__overap_15_ = lean_panic_fn_borrowed(v___x_14_, v_msg_2_);
lean_inc(v___y_12_);
...
lean_inc(v___y_4_);
lean_inc(v___y_3_);
v___x_16_ = lean_apply_11(v___x_63953__overap_15_, v___y_3_, v___y_4_, v___y_5_, v___y_6_, v___y_7_, v___y_8_, v___y_9_, v___y_10_, v___y_11_, v___y_12_, lean_box(0));
return v___x_16_;
}
}
...
lean_inc(v___y_100_);
v___x_115_ = l_Lean_mkConst(v___y_100_, v___y_102_);

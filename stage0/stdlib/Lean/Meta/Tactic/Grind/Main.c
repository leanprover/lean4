...
lean_object* x_95; 
lean_inc_ref(x_88);
x_95 = l___private_Lean_Meta_Tactic_Grind_Main_0__Lean_Meta_Grind_splitDiagInfoToMessageData(x_93, x_89, x_86, x_88, x_90, x_92);
if (lean_obj_tag(x_95) == 0)
{

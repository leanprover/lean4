...
v___x_447_ = l_Lean_Expr_forallE___override(v___y_444_, v___y_442_, v___y_445_, v___y_441_);
...
{
uint8_t v___x_448_; 
v___x_448_ = l_Lean_instBEqBinderInfo_beq(v___y_441_, v___y_441_);
if (v___x_448_ == 0)
{
lean_object* v___x_449_; 
v___x_449_ = l_Lean_Expr_forallE___override(v___y_444_, v___y_442_, v___y_445_, v___y_441_);

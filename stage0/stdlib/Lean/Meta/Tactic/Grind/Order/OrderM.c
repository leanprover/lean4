...
lean_dec_ref_known(v_ringId_x3f_764_, 1);
v___x_770_ = 1;
...
lean_dec_ref_known(v_isPartialInst_x3f_814_, 1);
v___x_820_ = 1;
...
lean_dec_ref_known(v_isLinearPreInst_x3f_864_, 1);
v___x_870_ = 1;
...
lean_dec_ref_known(v_lawfulOrderLTInst_x3f_914_, 1);
v___x_920_ = 1;

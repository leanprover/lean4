...
v_numFields_694_ = lean_ctor_get(v___y_686_, 4);
...
v___x_726_ = l_Lean_Meta_getCtorNumPropFields(v___y_686_, v___y_688_, v___y_689_, v___y_690_, v___y_691_);
...
lean_inc(v___y_689_);
lean_inc_ref(v___y_688_);
v___x_789_ = lean_apply_5(v___y_685_, v___y_688_, v___y_689_, v___y_690_, v___y_691_, lean_box(0));

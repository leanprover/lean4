...
lean_inc(x_283);
lean_dec_ref(x_281);
x_284 = l_Lean_LocalDecl_type(x_282);
lean_dec(x_282);
lean_inc(x_7);
lean_inc_ref(x_6);
lean_inc(x_5);
...
lean_dec_ref(x_221);
lean_inc(x_222);
x_224 = l_Lean_mkApp(x_199, x_222);

...
v___x_442_ = lean_bool_not(v___x_441_);
if (v___x_442_ == 0)
{
...
lean_ctor_set(v___x_463_, 0, v_e_438_);
return v___x_463_;
}
}
}
...
_start:
{
lean_object* v_keyedConfig_893_; uint8_t v_trackZetaDelta_894_; lean_object* v_zetaDeltaSet_895_; lean_object* v_localInstances_896_; lean_object* v_defEqCtx_x3f_897_; lean_object* v_synthPendingDepth_898_; lean_object* v_canUnfold_x3f_899_; uint8_t v_univApprox_900_; uint8_t v_inTypeClassResolution_901_; uint8_t v_cacheInferType_902_; lean_object* v___x_903_; lean_object* v___x_904_; 
...
v_canUnfold_x3f_899_ = lean_ctor_get(v___y_888_, 6);
...
lean_ctor_set(v___x_903_, 6, v_canUnfold_x3f_899_);
...
v___x_948_ = lean_st_ref_set(v___y_934_, v___x_947_);
...
v___x_1222_ = lean_st_ref_set(v___y_1190_, v___x_1221_);

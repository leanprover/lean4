...
lean_object* x_18; 
lean_dec_ref(x_12);
x_18 = l_Lean_Meta_SavedState_restore___redArg(x_16, x_13, x_15);
lean_dec(x_15);
lean_dec(x_13);
lean_dec_ref(x_16);
if (lean_obj_tag(x_18) == 0)
...
lean_dec(x_38);
lean_inc_ref(x_39);
x_40 = l_Lean_Meta_Rewrites_dischargableWithRfl_x3f(x_39, x_30, x_31, x_34, x_32, x_35);
if (lean_obj_tag(x_40) == 0)
{
uint8_t x_41; 
x_41 = !lean_is_exclusive(x_40);
...
{
lean_object* x_64; 
x_64 = l_Lean_Meta_Rewrites_rewriteResultLemma(x_58);
...
lean_object* x_102; 
lean_dec_ref(x_98);
x_102 = l_Lean_Meta_SavedState_restore___redArg(x_97, x_96, x_100);
lean_dec(x_100);
lean_dec(x_96);
lean_dec_ref(x_97);

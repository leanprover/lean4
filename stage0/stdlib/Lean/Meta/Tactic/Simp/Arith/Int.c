...
LEAN_EXPORT lean_object* runtime_initialize_Lean_Meta_Tactic_Simp_Arith_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Meta_Tactic_Simp_Arith_Int(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Lean_Meta_Tactic_Simp_Arith_Int(uint8_t builtin) {
lean_object * res;

...
lean_inc_ref(x_12);
lean_inc_ref(x_11);
x_15 = l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_Nat_0__Nat_mkLENat(x_11, x_12);
lean_inc(x_8);
...
lean_dec_ref(x_16);
lean_inc_ref(x_13);
x_18 = l___private_Lean_Meta_Tactic_Simp_BuiltinSimprocs_Nat_0__Nat_mkLENat(x_13, x_14);

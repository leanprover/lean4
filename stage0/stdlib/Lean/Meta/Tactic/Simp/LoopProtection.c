...
x_115 = l_Lean_Option_get___at___00Lean_Meta_Simp_shouldCheckLoops_spec__0(x_106, x_114);
lean_inc(x_107);
lean_inc_ref(x_105);
lean_inc_ref(x_104);
x_95 = x_104;

...
v___x_2200_ = lean_string_utf8_next(v___y_2198_, v___y_2199_);
...
{
v___y_2198_ = v_inputString_2178_;
v___y_2199_ = v_i_2202_;
goto v___jp_2197_;
}
}
else
...
lean_ctor_set(v_info_2636_, 0, v___y_2633_);
...
lean_ctor_set(v_atom_2638_, 1, v___y_2632_);
lean_ctor_set(v_atom_2638_, 2, v_val_2626_);
lean_ctor_set(v_atom_2638_, 3, v___x_2637_);
v___x_2639_ = l_Lean_Parser_ParserState_pushSyntax(v___y_2634_, v_atom_2638_);
return v___x_2639_;
}
}
}

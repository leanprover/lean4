...
res = l_Lean_Parser_initFn____x40_Lean_Parser_Basic___hyg_9087_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
...
res = l_Lean_Parser_initFn____x40_Lean_Parser_Basic___hyg_9108_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

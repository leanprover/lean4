...
v_sym_3051_ = lean_string_utf8_extract(v_str_3048_, v_startInclusive_3049_, v_endExclusive_3050_);
...
v_sym_3118_ = lean_string_utf8_extract(v_str_3115_, v_startInclusive_3116_, v_endExclusive_3117_);
...
v_sym_3448_ = lean_string_utf8_extract(v_str_3435_, v_startInclusive_3436_, v_endExclusive_3437_);
lean_dec(v_endExclusive_3437_);
lean_dec(v_startInclusive_3436_);
lean_dec_ref(v_str_3435_);
v_asciiSym_3449_ = lean_string_utf8_extract(v_str_3445_, v_startInclusive_3446_, v_endExclusive_3447_);
...
v___x_5700_ = lean_string_utf8_extract(v_str_5696_, v_startInclusive_5697_, v_endExclusive_5698_);

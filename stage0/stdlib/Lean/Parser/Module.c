...
v___x_480_ = l_Lean_Syntax_getArg(v___y_475_, v___x_479_);
v___x_481_ = l_Lean_Syntax_getArgs(v___x_480_);
lean_dec(v___x_480_);
v_sz_482_ = lean_array_size(v___x_481_);
v___x_483_ = l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00Lean_Parser_parseHeader_spec__2(v_inputCtx_420_, v___y_477_, v___x_481_, v_sz_482_, v___y_478_, v___y_476_);
...
v___x_508_ = l_Lean_Name_mkStr4(v___y_497_, v___y_498_, v___y_499_, v___x_507_);

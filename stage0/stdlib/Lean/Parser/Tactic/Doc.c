...
{
lean_dec_ref_known(v_entry_1160_, 1);
return v___x_1200_;
}
}
v___jp_1201_:
...
lean_dec_ref_known(v___x_1394_, 14);
return v___x_1395_;
}
}
...
lean_inc(v_r_2541_);
lean_dec_ref_known(v_x_2537_, 5);
...
lean_dec_ref_known(v_lines_3760_, 2);
...
lean_dec_ref_known(v___x_3826_, 3);
...
{
lean_dec_ref_known(v_val_4543_, 5);
if (v___x_4494_ == 0)
{

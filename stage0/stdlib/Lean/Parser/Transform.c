...
lean_inc(x_21);
lean_dec(x_20);
x_22 = l_ULift_HasRepr___rarg___closed__2;
...
lean_dec(x_56);
lean_dec(x_55);
x_59 = l_Array_forMAux___main___at_Lean_Environment_displayStats___spec__9___closed__2;
...
lean_dec(x_76);
lean_dec(x_75);
x_79 = l_Array_forMAux___main___at_Lean_Environment_displayStats___spec__9___closed__2;

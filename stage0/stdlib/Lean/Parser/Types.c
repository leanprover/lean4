...
v___x_668_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00Lean_Parser_Error_toString_spec__1___redArg(v___y_663_, v___y_666_, v___y_665_, v___y_667_);
lean_dec(v___y_667_);
lean_dec(v___y_663_);
...
{
uint8_t v___x_676_; 
v___x_676_ = lean_nat_dec_le(v___y_675_, v___y_674_);
if (v___x_676_ == 0)
{
lean_dec(v___y_674_);
lean_inc(v___y_675_);

...
lean_inc(x_51);
lean_dec_ref(x_50);
x_52 = lean_alloc_closure((void*)(l_Lean_ParserCompiler_compileParserExpr___redArg___lam__1___boxed), 7, 0);
...
lean_inc_ref(x_62);
lean_inc(x_49);
x_78 = l_Lean_Attribute_add(x_49, x_64, x_76, x_77, x_62, x_63);

...
v___x_687_ = lean_st_ref_take(v___y_684_);
...
v___x_699_ = l_Lean_Kernel_enableDiag(v_env_688_, v___y_685_);
...
v___x_702_ = lean_st_ref_put(v___y_684_, v___x_701_);

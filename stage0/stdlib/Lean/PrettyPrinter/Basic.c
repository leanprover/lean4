...
LEAN_EXPORT lean_object* initialize_Lean_PrettyPrinter_Basic(lean_object* w) {
lean_object * res;
...
res = l_Lean_PrettyPrinter_initFn____x40_Lean_PrettyPrinter_Basic___hyg_5_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

...
lean_inc(x_19);
lean_dec(x_17);
x_20 = l_Lean_Kernel_Environment_isDiagnosticsEnabled(x_19);
lean_dec(x_19);
if (x_20 == 0)
{
if (x_14 == 0)
...
lean_dec(x_27);
x_28 = l_Lean_Kernel_Environment_enableDiag(x_26, x_14);
...
lean_inc(x_34);
lean_dec(x_23);
x_41 = l_Lean_Kernel_Environment_enableDiag(x_34, x_14);

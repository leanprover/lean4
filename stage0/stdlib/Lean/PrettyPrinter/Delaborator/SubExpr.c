...
lean_dec_ref_known(v_____x_844_, 3);
...
lean_dec_ref_known(v_____x_894_, 2);
...
lean_dec_ref_known(v_____x_933_, 4);
...
lean_dec_ref_known(v_____x_972_, 4);
...
lean_dec_ref_known(v_____x_1025_, 4);

...
v_ref_1364_ = lean_ctor_get(v___y_1360_, 5);
...
lean_ctor_set(v___x_1386_, 1, v___y_1358_);
...
v___x_1424_ = lean_array_get_size(v___y_1419_);
...
v___x_1456_ = 0;
v___y_1419_ = v_a_1449_;
v___y_1420_ = v___y_1355_;

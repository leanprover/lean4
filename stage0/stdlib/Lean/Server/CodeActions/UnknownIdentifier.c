...
lean_dec(x_1);
lean_inc(x_16);
x_17 = l___private_Lean_Data_Lsp_Internal_0__Lean_Lsp_fromJsonLeanQueryModuleResponse____x40_Lean_Data_Lsp_Internal___hyg_4107_(x_16);
if (lean_obj_tag(x_17) == 0)
{
...
lean_ctor_set(x_24, 0, x_22);
lean_ctor_set(x_24, 1, x_23);
x_25 = l_Array_forIn_x27Unsafe_loop___at___Lean_Server_FileWorker_handleResolveImportAllUnknownIdentifiersCodeAction_x3f_spec__1(x_11, x_12, x_19, x_13, x_14, x_17, x_24, x_4, x_16);
lean_dec(x_4);
lean_dec(x_13);
x_26 = lean_ctor_get(x_25, 0);
lean_inc(x_26);

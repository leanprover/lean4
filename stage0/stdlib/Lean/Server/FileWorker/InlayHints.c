...
v___x_17493__overap_704_ = lean_panic_fn_borrowed(v___f_703_, v_msg_699_);
...
v___x_19854__overap_800_ = lean_panic_fn_borrowed(v___x_799_, v_msg_782_);
lean_dec(v___x_799_);

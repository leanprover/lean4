...
v___x_2523_ = lean_alloc_closure((void*)(l_ReaderT_bind___boxed), 8, 7);
lean_closure_set(v___x_2523_, 0, lean_box(0));
lean_closure_set(v___x_2523_, 1, lean_box(0));
lean_closure_set(v___x_2523_, 2, v___x_2513_);
lean_closure_set(v___x_2523_, 3, lean_box(0));
lean_closure_set(v___x_2523_, 4, lean_box(0));
lean_closure_set(v___x_2523_, 5, v___x_2522_);
lean_closure_set(v___x_2523_, 6, v___f_2521_);
...
v___x_2609_ = lean_alloc_closure((void*)(l_ReaderT_bind___boxed), 8, 7);
lean_closure_set(v___x_2609_, 0, lean_box(0));
lean_closure_set(v___x_2609_, 1, lean_box(0));
lean_closure_set(v___x_2609_, 2, v___x_2599_);
lean_closure_set(v___x_2609_, 3, lean_box(0));
lean_closure_set(v___x_2609_, 4, lean_box(0));
lean_closure_set(v___x_2609_, 5, v___x_2608_);
lean_closure_set(v___x_2609_, 6, v___f_2607_);

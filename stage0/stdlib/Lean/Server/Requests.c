...
lean_inc(v_a_2027_);
lean_dec_ref_known(v_x_1993_, 1);
...
lean_dec_ref_known(v_response_x3f_2028_, 1);
...
lean_dec_ref_known(v_t_2209_, 2);
...
lean_dec_ref_known(v_response_x3f_3401_, 1);
...
lean_dec_ref_known(v_x_3602_, 2);

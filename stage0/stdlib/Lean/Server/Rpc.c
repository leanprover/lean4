...
lean_object* runtime_initialize_Lean_Server_Rpc_Deriving(uint8_t builtin);
lean_object* runtime_initialize_Lean_Server_Rpc_RequestHandling(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Lean_Server_Rpc(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Lean_Server_Rpc(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Lean_Server_Rpc_Deriving(uint8_t builtin);
lean_object* initialize_Lean_Server_Rpc_RequestHandling(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Lean_Server_Rpc(uint8_t builtin) {
lean_object * res;

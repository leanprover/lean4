...
res = l_Lean_Server_initFn____x40_Lean_Server_Rpc_RequestHandling___hyg_554_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
res = l_Lean_Server_initFn____x40_Lean_Server_Rpc_RequestHandling___hyg_1972_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

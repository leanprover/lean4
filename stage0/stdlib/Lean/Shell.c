...
if (lean_obj_tag(v___y_2922_) == 1)
{
lean_object* v_val_2927_; lean_object* v___x_2928_; 
v_val_2927_ = lean_ctor_get(v___y_2922_, 0);
...
lean_closure_set(v___x_2799_, 0, v___y_2795_);

...
lean_dec(v___y_2273_);
v___x_2277_ = l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any(lean_box(0), lean_box(0), v___y_2272_, v___y_2271_, v___y_2269_, v___x_2275_, v___x_2276_);
...
{
lean_dec(v_stop_2289_);
v___y_2269_ = v_array_2287_;
v___y_2270_ = v_start_2288_;
v___y_2271_ = v___f_2292_;
...
lean_ctor_set(v___x_2497_, 0, v___y_2495_);

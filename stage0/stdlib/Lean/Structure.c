...
lean_dec(v___y_2273_);
v___x_2277_ = l___private_Init_Data_Array_Basic_0__Array_anyMUnsafe_any(lean_box(0), lean_box(0), v___y_2271_, v___y_2269_, v___y_2270_, v___x_2275_, v___x_2276_);
...
v___x_2539_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort(lean_box(0), v___y_2534_, v___y_2535_, v___y_2536_, v___y_2537_, v___y_2538_, lean_box(0), lean_box(0), lean_box(0));
...
{
uint8_t v___x_2546_; 
v___x_2546_ = lean_nat_dec_le(v___y_2545_, v___y_2543_);
if (v___x_2546_ == 0)
{

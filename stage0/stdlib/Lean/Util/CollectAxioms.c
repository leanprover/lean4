...
v___x_199_ = l___private_Init_Data_Array_QSort_Basic_0__Array_qsort_sort___at___00__private_Lean_Util_CollectAxioms_0__Lean_CollectAxioms_collect_spec__2___redArg(v___y_194_, v___y_197_, v___y_196_, v___y_198_);
lean_dec(v___y_198_);
lean_dec(v___y_194_);

...
static const lean_array_object l_Lean_Expr_fvarsSubset___closed__3_value = {.m_header = {.m_rc = 0, .m_cs_sz = sizeof(lean_array_object) + sizeof(void*)*0, .m_other = 0, .m_tag = 246}, .m_size = 0, .m_capacity = 0, .m_data = {}};
static const lean_object* l_Lean_Expr_fvarsSubset___closed__3 = (const lean_object*)&l_Lean_Expr_fvarsSubset___closed__3_value;
static lean_once_cell_t l_Lean_Expr_fvarsSubset___closed__4_once = LEAN_ONCE_CELL_INITIALIZER;
...
v___x_33_ = l_Std_DHashMap_Internal_Raw_u2080_emptyKeyArray___redArg(v_cellCount_32_);
return v___x_33_;
}
}
...
_start:
{
lean_object* v_cellCount_34_; lean_object* v___x_35_; 
v_cellCount_34_ = lean_unsigned_to_nat(16u);
v___x_35_ = l_Std_DHashMap_Internal_Raw_u2080_emptyValueArray___redArg(v_cellCount_34_);
return v___x_35_;
}
}
...
v___x_36_ = lean_obj_once(&l_Lean_Expr_fvarsSubset___closed__1, &l_Lean_Expr_fvarsSubset___closed__1_once, _init_l_Lean_Expr_fvarsSubset___closed__1);
v___x_37_ = lean_obj_once(&l_Lean_Expr_fvarsSubset___closed__0, &l_Lean_Expr_fvarsSubset___closed__0_once, _init_l_Lean_Expr_fvarsSubset___closed__0);
...
static lean_object* _init_l_Lean_Expr_fvarsSubset___closed__4(void){
_start:
{
lean_object* v___x_42_; lean_object* v___x_43_; lean_object* v___x_44_; lean_object* v___x_45_; 
v___x_42_ = ((lean_object*)(l_Lean_Expr_fvarsSubset___closed__3));
v___x_43_ = lean_box(1);
v___x_44_ = lean_obj_once(&l_Lean_Expr_fvarsSubset___closed__2, &l_Lean_Expr_fvarsSubset___closed__2_once, _init_l_Lean_Expr_fvarsSubset___closed__2);
...
LEAN_EXPORT uint8_t l_Lean_Expr_fvarsSubset(lean_object* v_a_46_, lean_object* v_b_47_){
_start:
{
uint8_t v___x_48_; 
v___x_48_ = l_Lean_Expr_hasFVar(v_a_46_);
if (v___x_48_ == 0)
{
uint8_t v___x_49_; 
...
v___x_50_ = 0;
v___x_51_ = l_Lean_Expr_hasFVar(v_b_47_);
if (v___x_51_ == 0)
{
lean_dec_ref(v_b_47_);
return v___x_50_;
...
{
lean_object* v___x_52_; lean_object* v_s_53_; lean_object* v___f_54_; lean_object* v___x_55_; 
v___x_52_ = lean_obj_once(&l_Lean_Expr_fvarsSubset___closed__4, &l_Lean_Expr_fvarsSubset___closed__4_once, _init_l_Lean_Expr_fvarsSubset___closed__4);
v_s_53_ = l_Lean_collectFVars(v___x_52_, v_b_47_);
v___f_54_ = lean_alloc_closure((void*)(l_Lean_Expr_fvarsSubset___lam__0___boxed), 2, 1);
lean_closure_set(v___f_54_, 0, v_s_53_);
v___x_55_ = lean_find_ext_expr(v___f_54_, v_a_46_);
lean_dec_ref(v___f_54_);
...
LEAN_EXPORT uint8_t l_Std_DTreeMap_Internal_Impl_contains___at___00Lean_Expr_fvarsSubset_spec__0(lean_object* v_00_u03b2_60_, lean_object* v_k_61_, lean_object* v_t_62_){
_start:
{
uint8_t v___x_63_; 
...
LEAN_EXPORT lean_object* l_Std_DTreeMap_Internal_Impl_contains___at___00Lean_Expr_fvarsSubset_spec__0___boxed(lean_object* v_00_u03b2_64_, lean_object* v_k_65_, lean_object* v_t_66_){
_start:
{
uint8_t v_res_67_; lean_object* v_r_68_; 
v_res_67_ = l_Std_DTreeMap_Internal_Impl_contains___at___00Lean_Expr_fvarsSubset_spec__0(v_00_u03b2_64_, v_k_65_, v_t_66_);
lean_dec(v_t_66_);
lean_dec(v_k_65_);

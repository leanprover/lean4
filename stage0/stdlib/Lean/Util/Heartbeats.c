...
lean_inc_ref_n(v___y_271_, 2);
v___x_282_ = l_Lean_FileMap_toPosition(v___y_271_, v___y_269_);
lean_dec(v___y_269_);
v___x_283_ = l_Lean_FileMap_toPosition(v___y_271_, v___y_275_);
lean_dec(v___y_275_);
...
v___x_301_ = l_Lean_Syntax_getTailPos_x3f(v___y_297_, v___y_298_);
lean_dec(v___y_297_);

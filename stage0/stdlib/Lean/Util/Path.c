...
v___x_670_ = lean_string_utf8_extract_fast(v_a_641_, v___x_669_, v___x_667_);
lean_dec(v___x_669_);
lean_dec(v_a_641_);
...
v___x_833_ = lean_string_utf8_extract_fast(v_str_830_, v_startInclusive_831_, v_endExclusive_832_);

...
LEAN_EXPORT lean_object* l_Lean_initFn____x40_Lean_Util_Path___hyg_484_(lean_object*);
...
LEAN_EXPORT lean_object* l_Lean_initFn____x40_Lean_Util_Path___hyg_484_(lean_object* x_1) {
_start:
{
...
if (builtin) {res = l_Lean_initFn____x40_Lean_Util_Path___hyg_484_(lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;

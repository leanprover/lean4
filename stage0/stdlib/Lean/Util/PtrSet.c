...
// Imports: Init Lean.Data.HashSet
#include <lean/lean.h>
...
lean_dec(x_6);
lean_inc(x_2);
x_20 = l_List_replace___at_Lean_PtrSet_insert___spec__7___rarg(x_12, x_2, x_2);
lean_dec(x_2);
...
x_31 = l_List_elem___at_Lean_PtrSet_insert___spec__2___rarg(x_2, x_30);
if (x_31 == 0)
{
...
{
lean_object* x_37; 
x_37 = l_Lean_HashSetImp_expand___at_Lean_PtrSet_insert___spec__3___rarg(x_33, x_35);
return x_37;
}
else
{
...
lean_dec(x_24);
lean_inc(x_2);
x_39 = l_List_replace___at_Lean_PtrSet_insert___spec__7___rarg(x_30, x_2, x_2);
lean_dec(x_2);

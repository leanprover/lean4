...
_start:
{
uint8_t v___x_2594__boxed_84_; lean_object* v_res_85_; 
v___x_2594__boxed_84_ = lean_unbox(v___x_74_);
v_res_85_ = l_Lean_Elab_Command_reproveDecl___lam__0(v___x_73_, v___x_2594__boxed_84_, v___x_75_, v_tacticSeq_76_, v___y_77_, v___y_78_, v___y_79_, v___y_80_, v___y_81_, v___y_82_);
lean_dec(v___y_82_);

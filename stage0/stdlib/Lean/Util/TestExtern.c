...
_start:
{
uint8_t v___x_5038__boxed_326_; lean_object* v_res_327_; 
v___x_5038__boxed_326_ = lean_unbox(v___x_318_);
v_res_327_ = l_elabTestExtern___lam__0(v___x_316_, v___x_317_, v___x_5038__boxed_326_, v___y_319_, v___y_320_, v___y_321_, v___y_322_, v___y_323_, v___y_324_);
lean_dec(v___y_324_);

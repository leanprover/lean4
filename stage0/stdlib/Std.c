...
lean_object* runtime_initialize_Std_Sat(uint8_t builtin);
lean_object* runtime_initialize_Std_Sync(uint8_t builtin);
lean_object* runtime_initialize_Std_Time(uint8_t builtin);
lean_object* runtime_initialize_Std_Tactic(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal(uint8_t builtin);
lean_object* runtime_initialize_Std_Net(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Std_Sat(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
LEAN_EXPORT lean_object* meta_initialize_Std(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std(builtin);
}
#ifdef __cplusplus
}
#endif

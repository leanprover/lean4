...
// Module: Std.Classes.Ord.BitVec
// Imports: Std.Classes.Ord.Basic Init.Data.BitVec.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Classes_Ord_BitVec(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Std.Classes.Ord.SInt
// Imports: Std.Classes.Ord.Basic Init.Data.SInt.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Classes_Ord_SInt(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Std.Classes.Ord.String
// Imports: Std.Classes.Ord.Basic Init.Data.String.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Classes_Ord_String(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Module: Std.Classes.Ord.UInt
// Imports: Std.Classes.Ord.Basic Init.Data.UInt.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Classes_Ord_UInt(uint8_t builtin, lean_object* w) {
lean_object * res;

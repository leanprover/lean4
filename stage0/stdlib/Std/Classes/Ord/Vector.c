...
// Module: Std.Classes.Ord.Vector
// Imports: Std.Classes.Ord.Basic Init.Data.Vector.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Classes_Ord_Vector(uint8_t builtin, lean_object* w) {
lean_object * res;

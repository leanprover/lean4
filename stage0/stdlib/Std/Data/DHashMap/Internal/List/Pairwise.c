...
// Imports: Std.Data.DHashMap.Internal.List.Defs Std.Data.DHashMap.Internal.List.Perm Std.Data.DHashMap.Internal.List.Sublist
#include <lean/lean.h>
...
lean_object* initialize_Std_Data_DHashMap_Internal_List_Perm(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_Std_Data_DHashMap_Internal_List_Perm(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

...
lean_object* initialize_Std_Data_DHashMap_Iterator(uint8_t builtin, lean_object*);
...
lean_object* initialize_Std_Data_DHashMap_Iterator(uint8_t builtin, lean_object*);
lean_object* initialize_Init_Data_Iterators_Lemmas_Combinators(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Std_Data_DHashMap_IteratorLemmas(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Std_Data_DHashMap_Iterator(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Init_Data_Iterators_Lemmas_Combinators(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

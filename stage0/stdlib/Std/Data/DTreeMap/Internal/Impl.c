...
// Module: Std.Data.DTreeMap.Internal.Impl
// Imports: Std.Data.Classes.LawfulEqOrd Std.Data.DTreeMap.Internal.Impl.Attr Std.Data.DTreeMap.Internal.Impl.Operations Std.Data.Classes.TransOrd Lean.Elab.Tactic
#include <lean/lean.h>
...
lean_object* initialize_Std_Data_DTreeMap_Internal_Impl_Operations(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Std_Data_DTreeMap_Internal_Impl(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Std_Data_DTreeMap_Internal_Impl_Operations(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

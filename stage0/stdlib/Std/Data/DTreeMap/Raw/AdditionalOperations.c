...
// Imports: public import Std.Data.DTreeMap.Raw.Basic public import Std.Data.DTreeMap.AdditionalOperations
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* l_Std_DTreeMap_Raw_instCoeTypeForall(lean_object* x_1) {
_start:
{
return lean_box(0);
}

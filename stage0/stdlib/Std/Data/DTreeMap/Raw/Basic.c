...
v___x_4694_ = lean_nat_add(v___y_4691_, v___y_4693_);
...
lean_ctor_set(v___x_4673_, 3, v___y_4692_);
...
lean_ctor_set(v_reuseFailAlloc_4699_, 3, v___y_4692_);

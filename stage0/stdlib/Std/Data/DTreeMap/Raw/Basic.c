...
v___x_3827_ = lean_nat_add(v___y_3824_, v___y_3826_);
...
lean_ctor_set(v___x_3807_, 3, v___y_3825_);
...
lean_ctor_set(v_reuseFailAlloc_3832_, 3, v___y_3825_);

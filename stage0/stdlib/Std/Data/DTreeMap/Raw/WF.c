...
// Imports: public import Std.Data.DTreeMap.Raw.AdditionalOperations
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_DTreeMap_Raw_WF(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_DTreeMap_Raw_WF(uint8_t builtin) {
lean_object * res;

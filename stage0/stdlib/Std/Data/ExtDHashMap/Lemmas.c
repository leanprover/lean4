...
// Imports: public import Std.Data.ExtDHashMap.Basic import all Std.Data.ExtDHashMap.Basic import all Std.Data.DHashMap.Basic import all Std.Data.DHashMap.Raw import all Std.Data.DHashMap.Internal.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_ExtDHashMap_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_ExtDHashMap_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_ExtDHashMap_Lemmas(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = runtime_initialize_Std_Data_ExtDHashMap_Lemmas(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Data_ExtDHashMap_Lemmas(builtin)
;
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Data_ExtDHashMap_Lemmas(builtin);
}
#ifdef __cplusplus
}
#endif

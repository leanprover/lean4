...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_ExtDTreeMap(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_ExtDTreeMap(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_ExtDTreeMap(uint8_t builtin) {
lean_object * res;

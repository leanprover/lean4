...
lean_object* runtime_initialize_Std_Data_HashSet_Lemmas(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_HashSet_IteratorLemmas(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_HashSet_DecidableEquiv(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_HashSet(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_HashSet(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Data_HashSet(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Data_HashSet(builtin);
}
#ifdef __cplusplus
}
#endif

...
// Imports: public import Init.Data.Order.Ord import Init.RCases
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Internal_Cut(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Internal_Cut(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_Internal_Cut(uint8_t builtin) {
lean_object * res;

...
// Imports: public import Init.BinderPredicates
#include <lean/lean.h>
...
lean_inc(x_6);
lean_dec(x_4);
x_7 = l_Std_Internal_List_keys___redArg(x_5);
...
lean_inc(x_10);
lean_dec(x_8);
x_11 = l_Std_Internal_List_keys___redArg(x_9);
...
lean_inc(x_6);
lean_dec(x_4);
x_7 = l_Std_Internal_List_values___redArg(x_5);
lean_ctor_set(x_1, 1, x_7);
lean_ctor_set(x_1, 0, x_6);
return x_1;
}
...
lean_inc(x_10);
lean_dec(x_8);
x_11 = l_Std_Internal_List_values___redArg(x_9);
x_12 = lean_alloc_ctor(1, 2, 0);
lean_ctor_set(x_12, 0, x_10);
lean_ctor_set(x_12, 1, x_11);
return x_12;
...
LEAN_EXPORT lean_object* initialize_Std_Data_Internal_List_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;

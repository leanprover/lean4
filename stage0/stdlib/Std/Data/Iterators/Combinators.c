...
extern "C" {
#endif
lean_object* runtime_initialize_Std_Data_Iterators_Combinators_Monadic(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Combinators(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Combinators(uint8_t builtin) {
lean_object * res;

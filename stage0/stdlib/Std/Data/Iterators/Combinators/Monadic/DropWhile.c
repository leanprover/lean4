...
_start:
{
uint8_t v_dropping_boxed_143_; uint8_t v_____do__lift_309__boxed_144_; lean_object* v_res_145_; 
v_dropping_boxed_143_ = lean_unbox(v_dropping_141_);
v_____do__lift_309__boxed_144_ = lean_unbox(v_____do__lift_142_);
v_res_145_ = l_Std_Iterators_Types_DropWhile_instIterator___redArg___lam__0(v_it_138_, v_out_139_, v_toPure_140_, v_dropping_boxed_143_, v_____do__lift_309__boxed_144_);
return v_res_145_;
}
}
...
lean_inc(v_a_235_);
lean_dec_ref_known(v_____do__lift_234_, 1);

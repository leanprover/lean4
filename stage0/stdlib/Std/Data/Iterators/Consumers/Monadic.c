...
// Imports: public import Std.Data.Iterators.Consumers.Monadic.Set
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Consumers_Monadic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Consumers_Monadic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_Iterators_Consumers_Monadic(uint8_t builtin) {
lean_object * res;

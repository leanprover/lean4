...
extern "C" {
#endif
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Monadic(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Combinators(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Producers(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Equivalence(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Lemmas(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Lemmas(uint8_t builtin) {
lean_object * res;

...
// Module: Std.Data.Iterators.Lemmas.Basic
// Imports: Std.Data.Iterators.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Data_Iterators_Lemmas_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;

...
// Imports: public import Init.Data.Iterators.Lemmas.Consumers.Monadic.Collect public import Std.Data.Iterators.Lemmas.Equivalence.StepCongr import Init.Data.Iterators.Lemmas.Monadic.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Collect(builtin);
}
#ifdef __cplusplus
}
#endif

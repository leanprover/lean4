...
// Imports: public import Std.Data.Iterators.Consumers.Monadic.Set public import Init.Data.Iterators.Consumers.Monadic.Collect import all Std.Data.Iterators.Consumers.Monadic.Set import Init.Data.Iterators.Lemmas.Consumers.Monadic.Loop import Std.Data.ExtHashSet.Lemmas import Std.Data.ExtTreeSet.Lemmas
#include <lean/lean.h>
...
lean_object* runtime_initialize_Std_Data_ExtHashSet_Lemmas(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_ExtTreeSet_Lemmas(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Set(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Set(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Std_Data_ExtHashSet_Lemmas(uint8_t builtin);
lean_object* initialize_Std_Data_ExtTreeSet_Lemmas(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Std_Data_Iterators_Lemmas_Consumers_Monadic_Set(uint8_t builtin) {
lean_object * res;

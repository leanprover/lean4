...
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Producers_Monadic_Empty(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Producers_Monadic_List(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Lemmas_Producers_Monadic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Lemmas_Producers_Monadic(uint8_t builtin) {
lean_object * res;

...
extern "C" {
#endif
lean_object* runtime_initialize_Std_Data_Iterators_Producers_Monadic(uint8_t builtin);
...
lean_object* runtime_initialize_Std_Data_Iterators_Producers_Empty(uint8_t builtin);
...
lean_object* runtime_initialize_Std_Data_Iterators_Producers_Slice(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_Iterators_Producers(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_Iterators_Producers(uint8_t builtin) {
lean_object * res;

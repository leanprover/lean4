...
// Imports: public import Std.Data.Iterators.Producers.Monadic.Empty
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Data_Iterators_Producers_Empty(uint8_t builtin, lean_object* w) {
lean_object * res;

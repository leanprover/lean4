...
lean_object* runtime_initialize_Std_Data_TreeSet_Raw_Lemmas(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_TreeSet_Raw_WF(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_TreeSet_Raw_Iterator(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_TreeSet_Raw_Slice(uint8_t builtin);
lean_object* runtime_initialize_Std_Data_TreeSet_Raw_DecidableEquiv(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Data_TreeSet_Raw(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Data_TreeSet_Raw(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Std_Data_TreeSet_Raw_Lemmas(uint8_t builtin);

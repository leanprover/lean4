...
static const lean_string_object l_Std_Http_Version_ofString_x21___closed__0_value = {.m_header = {.m_rc = 0, .m_cs_sz = 0, .m_other = 0, .m_tag = 249}, .m_size = 22, .m_capacity = 22, .m_length = 21, .m_data = "Std.Http.Data.Version"};
...
LEAN_EXPORT uint8_t l_Std_Http_Version_ofNat(lean_object* v_n_159_){
_start:
{
lean_object* v___x_160_; uint8_t v___x_161_; 
v___x_160_ = lean_unsigned_to_nat(1u);
v___x_161_ = lean_nat_dec_le(v_n_159_, v___x_160_);
if (v___x_161_ == 0)
{
lean_object* v___x_162_; uint8_t v___x_163_; 
v___x_162_ = lean_unsigned_to_nat(2u);
v___x_163_ = lean_nat_dec_le(v_n_159_, v___x_162_);
if (v___x_163_ == 0)
{
uint8_t v___x_164_; 
v___x_164_ = 3;
...
v___x_167_ = lean_nat_dec_le(v_n_159_, v___x_166_);
if (v___x_167_ == 0)
{
uint8_t v___x_168_; 
v___x_168_ = 1;
...
LEAN_EXPORT lean_object* l_Std_Http_Version_ofNat___boxed(lean_object* v_n_170_){
_start:
{
uint8_t v_res_171_; lean_object* v_r_172_; 
v_res_171_ = l_Std_Http_Version_ofNat(v_n_170_);
lean_dec(v_n_170_);
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Http_Data_Version(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Http_Data_Version(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Http_Data_Version(uint8_t builtin) {
lean_object * res;

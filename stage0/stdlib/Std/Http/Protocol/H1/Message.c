...
v___x_456_ = lean_string_utf8_extract(v___x_436_, v___x_437_, v___x_438_);
...
v___x_468_ = lean_string_utf8_extract(v_name_439_, v_startInclusive_466_, v_endExclusive_467_);

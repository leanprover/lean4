...
v___x_621_ = lean_nat_sub(v___y_597_, v___y_596_);
lean_dec(v___y_596_);
lean_dec(v___y_597_);
...
lean_ctor_set_uint8(v___x_622_, sizeof(void*)*6 + 1, v___y_600_);
...
v___y_600_ = v_userClosedBody_635_;

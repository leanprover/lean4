...
v_data_606_ = lean_ctor_get(v___y_600_, 0);
v_size_607_ = lean_ctor_get(v___y_600_, 1);
v_isSharedCheck_628_ = !lean_is_exclusive(v___y_600_);
...
v_remaining_620_ = lean_nat_sub(v_limitSize_593_, v___y_596_);
lean_dec(v_limitSize_593_);
v___x_621_ = lean_nat_sub(v___y_595_, v___y_596_);
lean_dec(v___y_596_);
lean_dec(v___y_595_);
v___x_622_ = lean_alloc_ctor(0, 6, 3);
lean_ctor_set(v___x_622_, 0, v___y_604_);
lean_ctor_set(v___x_622_, 1, v_outputData_619_);
lean_ctor_set(v___x_622_, 2, v___y_603_);
lean_ctor_set(v___x_622_, 3, v___y_598_);
lean_ctor_set(v___x_622_, 4, v___y_601_);
lean_ctor_set(v___x_622_, 5, v___x_621_);
lean_ctor_set_uint8(v___x_622_, sizeof(void*)*6, v___y_597_);
lean_ctor_set_uint8(v___x_622_, sizeof(void*)*6 + 1, v___y_599_);
lean_ctor_set_uint8(v___x_622_, sizeof(void*)*6 + 2, v___y_602_);
...
v___y_595_ = v_userDataBytes_637_;
v___y_596_ = v_snd_641_;
v___y_597_ = v_sentMessage_634_;
v___y_598_ = v_knownSize_632_;
v___y_599_ = v_userClosedBody_635_;
v___y_600_ = v_outputData_630_;
v___y_601_ = v_messageHead_633_;
v___y_602_ = v_omitBody_636_;
v___y_603_ = v_state_631_;
v___y_604_ = v_fst_640_;

...
lean_object* runtime_initialize_Std_Internal_Async_UDP(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_DNS(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_Select(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_Process(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_System(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_Signal(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_Async_IO(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Internal_Async(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_Async(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_Async(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_Async(builtin);
}
#ifdef __cplusplus
}
#endif

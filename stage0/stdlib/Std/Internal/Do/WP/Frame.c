...
// Imports: public import Std.Internal.Do.WP.Basic public import Std.Internal.Do.WP.Conjunctive public import Std.Internal.Order.FrameClosure
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_Do_WP_Frame(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_Do_WP_Frame(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_Do_WP_Frame(builtin);
}
#ifdef __cplusplus
}
#endif

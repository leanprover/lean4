...
// Module: Std.Internal.ForIn.Basic
// Imports: public import Init.Control.Id public import Init.Data.List.Basic public import Init.Data.List.Control public import Init.Data.Array.Basic import Init.Data.Array.Bootstrap import Init.Data.Array.Lemmas import Init.Data.List.Monadic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Internal_ForIn_Basic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_ForIn_Basic(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Internal_ForIn_Basic(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_ForIn_Basic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_ForIn_Basic(builtin);
}
#ifdef __cplusplus
}
#endif

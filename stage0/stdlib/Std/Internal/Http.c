...
// Imports: public import Std.Internal.Http.Data
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_Http(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_Http(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_Http(builtin);
}
#ifdef __cplusplus
}
#endif

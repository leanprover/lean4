...
// Module: Std.Internal.Http.Data.Body.Any
// Imports: public import Std.Internal.Http.Data.Body.Basic
#include <lean/lean.h>
...
static const lean_object* l_Std_Http_Body_instAny___closed__1 = (const lean_object*)&l_Std_Http_Body_instAny___closed__1_value;
static const lean_closure_object l_Std_Http_Body_instAny___closed__2_value = {.m_header = {.m_rc = 0, .m_cs_sz = sizeof(lean_closure_object) + sizeof(void*)*0, .m_other = 0, .m_tag = 245}, .m_fun = (void*)l_Std_Http_Body_instAny___lam__2___boxed, .m_arity = 2, .m_num_fixed = 0, .m_objs = {} };
static const lean_object* l_Std_Http_Body_instAny___closed__2 = (const lean_object*)&l_Std_Http_Body_instAny___closed__2_value;
static const lean_closure_object l_Std_Http_Body_instAny___closed__3_value = {.m_header = {.m_rc = 0, .m_cs_sz = sizeof(lean_closure_object) + sizeof(void*)*0, .m_other = 0, .m_tag = 245}, .m_fun = (void*)l_Std_Http_Body_instAny___lam__3___boxed, .m_arity = 1, .m_num_fixed = 0, .m_objs = {} };
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_Http_Data_Body_Any(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Internal_Http_Data_Body_Any(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_Http_Data_Body_Any(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_Http_Data_Body_Any(builtin);
}
#ifdef __cplusplus
}
#endif

...
// Module: Std.Internal.Http.Protocol.H1.Config
// Imports: public import Std.Internal.Http.Data public import Std.Internal.Http.Internal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Internal_Http_Protocol_H1_Config(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_Http_Protocol_H1_Config(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_Internal_Http_Protocol_H1_Config(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Internal_Http_Protocol_H1_Config(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Internal_Http_Protocol_H1_Config(builtin);
}
#ifdef __cplusplus
}
#endif

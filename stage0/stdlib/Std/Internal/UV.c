...
LEAN_EXPORT lean_object* l___private_Std_Internal_UV_0__Std_Internal_UV_TimerImpl;
...
static lean_object* _init_l___private_Std_Internal_UV_0__Std_Internal_UV_TimerImpl() {
_start:
{
return lean_box(0);
}
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
l___private_Std_Internal_UV_0__Std_Internal_UV_TimerImpl = _init_l___private_Std_Internal_UV_0__Std_Internal_UV_TimerImpl();

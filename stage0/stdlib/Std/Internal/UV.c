...
extern "C" {
#endif
lean_object* runtime_initialize_Std_Internal_UV_Loop(uint8_t builtin);
...
lean_object* runtime_initialize_Std_Internal_UV_DNS(uint8_t builtin);
lean_object* runtime_initialize_Std_Internal_UV_Signal(uint8_t builtin);
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Internal_UV(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Internal_UV(uint8_t builtin) {
lean_object * res;

...
lean_object* runtime_initialize_Std_Sat_AIG_LawfulOperator(uint8_t builtin);
...
lean_object* runtime_initialize_Std_Sat_AIG_CachedGates(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Sat_AIG(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Sat_AIG(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_Sat_AIG(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_Sat_AIG(builtin);
}
#ifdef __cplusplus
}
#endif

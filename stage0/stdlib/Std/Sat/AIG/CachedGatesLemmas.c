...
// Imports: public import Std.Sat.AIG.CachedGates public import Std.Sat.AIG.LawfulOperator
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Sat_AIG_CachedGatesLemmas(uint8_t builtin, lean_object* w) {
lean_object * res;

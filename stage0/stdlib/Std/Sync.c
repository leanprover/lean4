...
lean_object* runtime_initialize_Std_Sync_StreamMap(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Sync(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Sync(uint8_t builtin) {
lean_object * res;

...
// Module: Std.Sync
// Imports: Std.Sync.Basic Std.Sync.Channel Std.Sync.Mutex Std.Sync.RecursiveMutex Std.Sync.Barrier Std.Sync.SharedMutex
#include <lean/lean.h>
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Std_Sync_SharedMutex(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

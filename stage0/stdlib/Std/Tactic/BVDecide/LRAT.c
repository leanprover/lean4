...
// Imports: public import Std.Tactic.BVDecide.LRAT.Actions public import Std.Tactic.BVDecide.LRAT.Checker public import Std.Tactic.BVDecide.LRAT.Internal public import Std.Tactic.BVDecide.LRAT.Parser
#include <lean/lean.h>
...
lean_object* runtime_initialize_Std_Tactic_BVDecide_LRAT_Internal(uint8_t builtin);
lean_object* runtime_initialize_Std_Tactic_BVDecide_LRAT_Parser(uint8_t builtin);
void lean_initialize_runtime_module();
static bool _G_runtime_initialized = false;
LEAN_EXPORT lean_object* runtime_initialize_Std_Tactic_BVDecide_LRAT(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Tactic_BVDecide_LRAT(uint8_t builtin) {
lean_object * res;
...
lean_object* initialize_Std_Tactic_BVDecide_LRAT_Internal(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Std_Tactic_BVDecide_LRAT_Internal(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);

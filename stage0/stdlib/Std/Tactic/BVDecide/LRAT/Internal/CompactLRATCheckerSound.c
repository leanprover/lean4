...
lean_inc(v_val_9_);
lean_dec_ref_known(v_step_1_, 1);
...
lean_inc(v_val_35_);
lean_dec_ref_known(v_step_27_, 1);
...
lean_dec_ref_known(v_val_35_, 3);
...
lean_dec_ref_known(v_val_35_, 5);

...
// Imports: Init.Data.BitVec Std.Tactic.BVDecide.Syntax
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Tactic_BVDecide_Normalize_Canonicalize(uint8_t builtin, lean_object* w) {
lean_object * res;

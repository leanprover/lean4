...
// Imports: public import Init.Data.Bool public import Init.Data.BitVec.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Std_Tactic_BVDecide_Normalize_Equal(uint8_t builtin, lean_object* w) {
lean_object * res;

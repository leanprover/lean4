...
lean_object* runtime_initialize_Std_Time_Notation(uint8_t builtin);
...
LEAN_EXPORT lean_object* runtime_initialize_Std_Time(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_Time(uint8_t builtin) {
lean_object * res;

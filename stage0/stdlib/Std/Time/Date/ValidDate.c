...
// Imports: Std.Internal.Rat Std.Time.Date.Unit.Day Std.Time.Date.Unit.Month Std.Time.Date.Unit.Month
#include <lean/lean.h>
...
x_3 = l_Std_Time_instInhabitedValidDate___closed__9;
x_4 = l_Std_Time_ValidDate_ofOrdinal___closed__0;

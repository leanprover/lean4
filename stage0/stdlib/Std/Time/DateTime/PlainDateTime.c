...
v___x_421_ = lean_nat_to_int(v___y_414_);
...
v_remDays_458_ = lean_int_sub(v___y_451_, v___x_457_);
lean_dec(v___x_457_);
lean_dec(v___y_451_);
...
v___x_470_ = lean_int_mul(v___x_410_, v___y_455_);
lean_dec(v___y_455_);

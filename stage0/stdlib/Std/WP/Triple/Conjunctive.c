...
// Module: Std.WP.Triple.Conjunctive
// Imports: public import Std.WP.Triple.Basic public import Std.WP.Conjunctive
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* runtime_initialize_Std_WP_Triple_Conjunctive(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* meta_initialize_Std_WP_Triple_Conjunctive(uint8_t builtin) {
lean_object * res;
...
LEAN_EXPORT lean_object* initialize_Std_WP_Triple_Conjunctive(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = meta_initialize_Std_WP_Triple_Conjunctive(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
return initialize_Std_WP_Triple_Conjunctive(builtin);
}
#ifdef __cplusplus
}
#endif

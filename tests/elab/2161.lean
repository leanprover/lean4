...
After unfolding the instances `Nat.decEq`, `instDecidableEqFoo`, `instDecidableEqFoo.decEq`, and `instDecidableEqNat`, reduction got stuck at the `Decidable` instance

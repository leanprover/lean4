...
theorem always_frame
  ...
  (f: Traceful α)
  (p: ProofTrace → Prop)
  : PredTrans.Frames Lean.Order.meet (fun _ E => E) (WP.wpTrans f) (Always' p) := by
  intro Q E
...
grind_pattern always_frame => PredTrans.Frames Lean.Order.meet (fun _ E => E) (WP.wpTrans f) (Always' p)

...
/--
error: Tactic `native_decide` failed. Error: failed to compile definition, compiler IR check failed at `_example._native.native_decide.decl_1._closed_0`. Error: depends on declaration 'funnyChoice', which has no executable code; consider marking definition as 'noncomputable'
-/
#guard_msgs in
example : False := by

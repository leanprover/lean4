...
-- Takes 24,000 heartbeats on master, ~1,000,000 on https://github.com/leanprover/lean4/pull/4595
-- During minimization it has shrunk a fair bit, but hopefully is still indicative.

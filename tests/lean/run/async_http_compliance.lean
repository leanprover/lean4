...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.".toUTF8, "1\r\nContent-Length: 3\r\nHost: test\r\n\r\nabc".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nCon".toUTF8, "tent-Length: 4\r\nHost: test\r\n\r\ndata".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 6\r\nX-Custom: val".toUTF8, "ue123\r\nHost: test\r\n\r\nfoobar".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 2\r".toUTF8, "\nHost: test\r\n\r\nab".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 7\r\nHost: test\r\n\r".toUTF8, "\ncontent".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST /".toUTF8, "api HTTP/1.1\r\nContent-Length: 8\r\nHost: t".toUTF8, "est\r\n\r\nmultipar".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 5\r\nHost: test\r\n\r\nexact".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 100\r\nHost: test\r\n\r\nshort".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 5\r\nHost: test\r\n\r\nhello extra data here".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 5\r\nHost: test\r\n\r\nfirstPOST / HTTP/1.1\r\nContent-Length: 6\r\nHost: test\r\n\r\nsecond".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response
...
#guard_msgs in
#eval show IO Unit from do
  let response ← sendRawBytes #["POST / HTTP/1.1\r\nContent-Length: 9\r\nConnection: keep-alive\r\nHost: test\r\n\r\nkeepalive".toUTF8] (maximumSizeHandlerEcho 150)
  IO.println <| String.quote <| String.fromUTF8! response

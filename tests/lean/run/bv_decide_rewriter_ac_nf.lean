...
that docstring also. -/
/-- warning: declaration `Unit.mul_mul_beq_mul_mul` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Unit.ex_1` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Unit.ex_2` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Unit.mul_beq_mul_eq_right` uses `sorry` -/
#guard_msgs in
...
-- This theorem is short-circuited and scales to standard bitwidths.
/-- warning: declaration `Unit.mul_beq_mul_eq_left` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Unit.short_circuit_triple_mul` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Normalize.mul_mul_eq_mul_mul` uses `sorry` -/
#guard_msgs in
...
/-- warning: declaration `Normalize.mul_eq_mul_eq_right` uses `sorry` -/
#guard_msgs in

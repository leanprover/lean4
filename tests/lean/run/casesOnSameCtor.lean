...
/--
info: Vec.casesOn2.{u_1, u} {α : Type u} {motive : {a : Nat} → (t t_1 : Vec α a) → t.ctorIdx = t_1.ctorIdx → Sort u_1}
  {a✝ : Nat} (t t✝ : Vec α a✝) (h : t.ctorIdx = t✝.ctorIdx) (nil : motive nil nil ⋯)
...
/--
info: List.casesOn2.{u_1, u} {α : Type u} {motive : (t t_1 : List α) → t.ctorIdx = t_1.ctorIdx → Sort u_1} (t t✝ : List α)
  (h : t.ctorIdx = t✝.ctorIdx) (nil : motive [] [] ⋯)
  (cons :

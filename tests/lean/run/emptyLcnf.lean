...
trace: [Compiler.result] size: 5
    def _eval._lam_0 _x.1 _x.2 _y.3 _y.4 _y.5 _y.6 _y.7 _y.8 _y.9 : EIO.Out Lean.Exception PUnit :=
      let _x.10 := Lean.Compiler.compile _x.1 _y.7 _y.8 _y.9;
      cases _x.10 : EIO.Out Lean.Exception PUnit
      | EIO.Out.ok a.11 a.12 =>
        let _x.13 := @EIO.Out.ok ◾ ◾ _x.2 a.12;
        return _x.13
      | EIO.Out.error a.14 a.15 =>
        return _x.10
...
[Compiler.result] size: 8
    def _eval a.1 a.2 a.3 : EIO.Out Lean.Exception PUnit :=

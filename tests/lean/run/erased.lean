...
trace: [Compiler.result] size: 5
    def _eval._lam_0 (_x.1 : Array
       Lean.Name) (_x.2 : PUnit) (_y.3 : Lean.Elab.Term.Context) (_y.4 : lcAny) (_y.5 : Lean.Meta.Context) (_y.6 : lcAny) (_y.7 : Lean.Core.Context) (_y.8 : lcAny) (_y.9 : lcAny) : EStateM.Result
      Lean.Exception lcAny PUnit :=
      let _x.10 : EStateM.Result Lean.Exception lcAny PUnit := compile _x.1 _y.7 _y.8 _y.9;
...
[Compiler.result] size: 9
    def _eval (a.1 : Lean.Elab.Command.Context) (a.2 : lcAny) (a.3 : lcAny) : EStateM.Result Lean.Exception lcAny
      PUnit :=
      ...
      let _f.11 : Lean.Elab.Term.Context →
        lcAny →
          Lean.Meta.Context →
            lcAny →
              Lean.Core.Context → lcAny → lcAny → EStateM.Result Lean.Exception lcAny PUnit := _eval._lam_0 _x.9 _x.10;

...
trace: [Compiler.result] size: 5
    def _eval._lam_0 (_x.1 : Array
       Lean.Name) (_x.2 : PUnit) (_y.3 : Lean.Elab.Term.Context) (_y.4 : lcAny) (_y.5 : Lean.Meta.Context) (_y.6 : lcAny) (_y.7 : Lean.Core.Context) (_y.8 : lcAny) (_y.9 : lcRealWorld) : EIO.Out
      Lean.Exception PUnit :=
      let _x.10 : EIO.Out Lean.Exception PUnit := compile _x.1 _y.7 _y.8 _y.9;
      cases _x.10 : EIO.Out Lean.Exception PUnit
      | EIO.Out.ok (a.11 : PUnit) (a.12 : lcRealWorld) =>
        let _x.13 : EIO.Out Lean.Exception PUnit := @EIO.Out.ok ◾ ◾ _x.2 a.12;
        return _x.13
      | EIO.Out.error (a.14 : Lean.Exception) (a.15 : lcRealWorld) =>
        return _x.10
...
[Compiler.result] size: 9
    def _eval (a.1 : Lean.Elab.Command.Context) (a.2 : lcAny) (a.3 : lcRealWorld) : EIO.Out Lean.Exception PUnit :=
      ...
      let _f.11 : Lean.Elab.Term.Context →
        lcAny →
          Lean.Meta.Context →
            lcAny → Lean.Core.Context → lcAny → lcRealWorld → EIO.Out Lean.Exception PUnit := _eval._lam_0 _x.9 _x.10;
      let _x.12 : EIO.Out Lean.Exception PUnit := Lean.Elab.Command.liftTermElabM._redArg _f.11 a.1 a.2 a.3;
      return _x.12
-/
#guard_msgs in

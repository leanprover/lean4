...
/--
info: instantiating `Array.range_add_one` triggers 19 additional `grind` theorem instantiations
---
info: Try this to display the actual theorem instances:
  [apply] set_option trace.grind.ematch.instance true in
  #grind_lint inspect Array.range_add_one
-/
#guard_msgs in
#grind_lint inspect Array.range_add_one

#grind_lint inspect (min := 100) Array.range_add_one
...
info: Try this to display the actual theorem instances:
  [apply] set_option trace.grind.ematch.instance true in
  #grind_lint inspect Array.range_add_one Array.range'_succ
-/
#guard_msgs in
#grind_lint inspect Array.range_add_one Array.range'_succ
...
-- This should show that Array.range_add_one triggers instantiations
/--
info: instantiating `Array.range_add_one` triggers 19 additional `grind` theorem instantiations
---
info: Try this to display the actual theorem instances:
...
-- Array.range_add_one and Array.range'_succ should NOT appear in the output
/--

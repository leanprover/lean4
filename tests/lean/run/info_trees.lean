...
info: • [Command] @ ⟨82, 0⟩-⟨82, 40⟩ @ Lean.Elab.Command.elabDeclaration
  • [Term] Nat : Type @ ⟨82, 15⟩-⟨82, 18⟩ @ Lean.Elab.Term.elabIdent
    • [Completion-Id] Nat : some Sort.{?_uniq.1} @ ⟨82, 15⟩-⟨82, 18⟩
    • [Term] Nat : Type @ ⟨82, 15⟩-⟨82, 18⟩
  • [Term] n (isBinder := true) : Nat @ ⟨82, 11⟩-⟨82, 12⟩
  • [Term] 0 ≤ n : Prop @ ⟨82, 22⟩-⟨82, 27⟩ @ «_aux_Init_Notation___macroRules_term_≤__2»
    • [MacroExpansion]
      0 ≤ n
      ===>
      binrel% LE.le✝ 0 n
      • [Term] 0 ≤ n : Prop @ ⟨82, 22⟩†-⟨82, 27⟩† @ Lean.Elab.Term.Op.elabBinRel
        • [Term] 0 ≤ n : Prop @ ⟨82, 22⟩†-⟨82, 27⟩†
          • [Completion-Id] LE.le✝ : none @ ⟨82, 22⟩†-⟨82, 27⟩†
          • [Term] 0 : Nat @ ⟨82, 22⟩-⟨82, 23⟩ @ Lean.Elab.Term.elabNumLit
          • [Term] n : Nat @ ⟨82, 26⟩-⟨82, 27⟩ @ Lean.Elab.Term.elabIdent
            • [Completion-Id] n : none @ ⟨82, 26⟩-⟨82, 27⟩
            • [Term] n : Nat @ ⟨82, 26⟩-⟨82, 27⟩
  • [CustomInfo(Lean.Elab.Term.AsyncBodyInfo)]
    • [Term] t (isBinder := true) : ∀ (n : Nat), 0 ≤ n @ ⟨82, 8⟩-⟨82, 9⟩
    • [Term] n (isBinder := true) : Nat @ ⟨82, 11⟩-⟨82, 12⟩
              ...
              • [Tactic] @ ⟨82, 34⟩-⟨82, 40⟩ @ Lean.Elab.LibrarySearch.evalExact
                ...
                • [UserWidget] Lean.Meta.Tactic.TryThis.tryThisWidget
                  {"suggestions": [{"suggestion": "exact Nat.zero_le n"}],
                   ...
                   "isInline": true,
                   "header": "Try this: "} • [Term] t (isBinder := true) : ∀ (n : Nat), 0 ≤ n @ ⟨82, 8⟩-⟨82, 9⟩
---

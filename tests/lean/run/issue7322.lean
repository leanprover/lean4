...
/-- warning: declaration `demo` uses `sorry` -/
#guard_msgs in
...
/--
warning: declaration `bar` uses `sorry`
---
warning: declaration `bar` uses `sorry`
---
warning: declaration `bar` uses `sorry`
---
warning: declaration `bar.eq_def` uses `sorry`
-/
#guard_msgs in
...
---
warning: declaration `bar.induct` uses `sorry`
-/
#guard_msgs in
#check bar.induct

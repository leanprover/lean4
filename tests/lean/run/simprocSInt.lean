...
-- #check_simp x = (8 : Int16).toNat ~> x = 8
-- #check_simp x = (65537 : Int16).toNat ~> x = 1
-- #check_simp x = (8 : Int32).toNat ~> x = 8
-- #check_simp x = (4294967297 : Int32).toNat ~> x = 1
-- #check_simp x = (8 : Int64).toNat ~> x = 8
-- #check_simp x = (18446744073709551617 : Int64).toNat ~> x = 1

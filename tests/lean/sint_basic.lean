...
def test8 : Option Int := Id.run do
...
#eval (20 : Int16) + 20 = 40
-- TODO: #eval (127 : Int16) + 1 = -128
#eval (-10 : Int16) + 10 = 0
#eval (1 : Int16) - 2 = -1
-- TODO: #eval (-128 : Int8) - 1 = 127
...
#eval (20 : Int32) + 20 = 40
-- TODO: #eval (127 : Int32) + 1 = -128
#eval (-10 : Int32) + 10 = 0
#eval (1 : Int32) - 2 = -1
-- TODO: #eval (-128 : Int8) - 1 = 127
#eval (1 : Int32) * 120 = 120
#eval (2 : Int32) * 10 = 20
#eval 4294967296 = 2^32 ∧ (2 : Int16) * 4294967296 = 0
#eval (-1 : Int32) * (-1) = 1
#eval (1 : Int32) * (-1) = -1
#eval (2 : Int32) * (-10) = -20
#eval (-5 : Int32) * (-5) = 25
...
#eval (20 : Int64) + 20 = 40
-- TODO: #eval (127 : Int64) + 1 = -128
#eval (-10 : Int64) + 10 = 0
#eval (1 : Int64) - 2 = -1
-- TODO: #eval (-128 : Int8) - 1 = 127
#eval (1 : Int64) * 120 = 120
#eval (2 : Int64) * 10 = 20
#eval 18446744073709551616 = 2^64 ∧ (2 : Int16) * 18446744073709551616 = 0
#eval (-1 : Int64) * (-1) = 1
#eval (1 : Int64) * (-1) = -1
#eval (2 : Int64) * (-10) = -20
#eval (-5 : Int64) * (-5) = 25

...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/emitzig-smoke.task_spawn.XXXXXX")"
TMP_INCLUDE_DIR="$TMP_DIR/include"
OUT_ZIG="$TMP_DIR/task_spawn.zig"
EMITZIG_O="$TMP_DIR/task_spawn.o"
DRIVER_O="$TMP_DIR/driver.o"
TASK_SHIMS_O="$TMP_DIR/task_api_shims.o"
COMPAT_O="$TMP_DIR/compat.o"
OUT_BIN="$TMP_DIR/task_spawn"
...
cd "$EMITZIG_DIR"
"$LAKE_BIN" exe emitzig "$SCRIPT_DIR/TaskSpawn.lean" -o "$OUT_ZIG"
